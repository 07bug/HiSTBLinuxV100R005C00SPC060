...
HI_S32 get_keyladder_type(KEYLADDER_TYPE_E *penKladType)
{
    ...
    if (0 == strncmp(value, "R2R", sizeof ("R2R")))
    {
        *penKladType = KEYLADDER_TYPE_R2R;
        return 0;
    }
    else if (0 == strncmp(value, "CSA2", sizeof ("CSA2")))
    {
        *penKladType = KEYLADDER_TYPE_CSA2;
        return 0;
    }
    else if (0 == strncmp(value, "CSA3", sizeof ("CSA3")))
    {
        *penKladType = KEYLADDER_TYPE_CSA3;
        return 0;
    }

    else if (0 == strncmp(value, "MISC", sizeof ("MISC")))
    {
        *penKladType = KEYLADDER_TYPE_MISC;
        return 0;
    }
    else if (0 == strncmp(value, "SP", sizeof ("SP")))
    {
        *penKladType = KEYLADDER_TYPE_SP;
        return 0;
    }
    else if (0 == strncmp(value, "DCAS", sizeof ("DCAS")))
    {
        *penKladType = KEYLADDER_TYPE_DCAS;
        return 0;
    }
    else
    {
...
HI_S32 get_keyladder_alg(HI_UNF_ADVCA_ALG_TYPE_E *penAlgType)
{
    ...
    {
        *penAlgType = HI_UNF_ADVCA_ALG_TYPE_AES;
        return 0;
    }

    if (0 == strncmp(value, "TDES", sizeof ("TDES")))
    {
        *penAlgType = HI_UNF_ADVCA_ALG_TYPE_TDES;
        return 0;
    }

    if (0 == strncmp(value, "SM4", sizeof ("SM4")))
    {
        *penAlgType = HI_UNF_ADVCA_ALG_TYPE_SM4;
        return 0;
    }
