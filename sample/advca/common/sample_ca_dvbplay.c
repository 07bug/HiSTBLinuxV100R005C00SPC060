...
HI_S32 setMiscCsa2Cw(HI_HANDLE hKey)
{
    HI_S32 Ret;
    ...
    {
        stKeyladderAttr.unKlAttr.stMiscKlAttr.enAlgType = HI_UNF_ADVCA_ALG_TYPE_AES;
        printf("Keyladder Alg  is AES\n");
    }
    Ret = HI_UNF_ADVCA_SetKeyLadderAttr(HI_UNF_ADVCA_KEYLADDER_MISC, &stKeyladderAttr);
    ...
    if(Ret != HI_SUCCESS)
    {
        printf("call HI_UNF_ADVCA_GetOtpFuse get MISC Key-ladder level failed\n");
        return HI_FAILURE;
    }
    ...
    if(stOtpFuseAttr.unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel >= HI_UNF_ADVCA_KEYLADDER_LEV2)
    {
        ...
        memcpy(stKeyladderAttr.unKlAttr.stMiscKlAttr.u8SessionKey, g_u8SessionKey1, 16);
        Ret |= HI_UNF_ADVCA_SetKeyLadderAttr(HI_UNF_ADVCA_KEYLADDER_MISC, &stKeyladderAttr);
    }
    ...
    if(stOtpFuseAttr.unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel >= HI_UNF_ADVCA_KEYLADDER_LEV3)
    {
        ...
        memcpy(stKeyladderAttr.unKlAttr.stMiscKlAttr.u8SessionKey, g_u8SessionKey2, 16);
        Ret |= HI_UNF_ADVCA_SetKeyLadderAttr(HI_UNF_ADVCA_KEYLADDER_MISC, &stKeyladderAttr);
    }
    ...
    if (HI_SUCCESS != Ret)
    {
        printf("Set Descrambler Even or ODD Key failed\n");
        return HI_FAILURE;
    }
