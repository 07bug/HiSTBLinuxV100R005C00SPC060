...
int main(int argc, char* argv[])
{
    ...
    const char *dhm_P[] = {MBEDTLS_DHM_RFC3526_MODP_2048_P, MBEDTLS_DHM_RFC5114_MODP_2048_P, MBEDTLS_DHM_INF_SEC_MODP_2048_P};
    const char *dhm_G[] = {MBEDTLS_DHM_RFC3526_MODP_2048_G, MBEDTLS_DHM_RFC5114_MODP_2048_G, MBEDTLS_DHM_INF_SEC_MODP_2048_G};
    HI_U8 *pu8P;
    HI_U8 *pu8G;
    HI_U8 *pu8PrivKeyA;
    HI_U8 *pu8PrivKeyB;
