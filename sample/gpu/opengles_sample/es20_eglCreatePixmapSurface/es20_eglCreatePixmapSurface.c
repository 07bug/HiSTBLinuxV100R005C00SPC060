...
int main(void)
{
    ...
    native_pixmap = HI_COMMON_CreateNativePixmap(window_width, window_height);
    ...
    mmz_vddr = (void*)malloc(window_width * window_height * 4);
    ...
    for(i = 0; i < 10; i++)
    {
        ...
        /* check the pixmap surface content */
        glReadPixels(0, 0, window_width, window_height, GL_RGBA, GL_UNSIGNED_BYTE, mmz_vddr);
