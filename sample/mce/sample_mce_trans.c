...
#define HI_LAYER_ZORDER_MOVEBOTTOM 2
...
#if defined(HI_DAC_YPBPR_Y) || defined(HI_DAC_YPBPR_PB) || defined(HI_DAC_YPBPR_PR) || defined(HI_DAC_CVBS)
...
HI_VOID PlayTransToVid(HI_VOID)
{
    ...
    Ret = HI_UNF_VO_SetWindowZorder(hWin,  HI_LAYER_ZORDER_MOVEBOTTOM);
    if (HI_SUCCESS != Ret)
    {
