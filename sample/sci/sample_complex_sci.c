...
HI_U32 t0_aidide_zeta_send_len[10] = {6, 5, 22, 5, 6, 5, 6, 5, 6, 5,};
HI_U32 t0_aidide_zeta_rcv_len[10] = { 2, 27, 2, 11, 2, 23, 2, 13, 2, 31};
...
HI_U32 t0_aidide_zeta_send_len[4] = { 6, 5, 6, 5};
HI_U32 t0_aidide_zeta_rcv_len[4] = { 2, 27, 2, 23};
...
/******************t14_aidide_access*************************************/
HI_U8 atr_aidide_access_t14[20] = {0x3b, 0x9f, 0x21,  0xe, 0x49, 0x52, 0x44, 0x45,
                                  0x54, 0x4f, 0x20, 0x41, 0x43, 0x53, 0x20, 0x56,
                                  0x32, 0x2e, 0x32, 0x98};
HI_U32 atr_aidide_access_t14_cnt = 20;
HI_U8 t14_aidide_access_send[][7] = {
...
HI_U8 t14_aidide_access_rcv[][73] = {
...
HI_U32 t14_aidide_access_send_len[5] = {7, 7, 7, 7, 7};
HI_U32 t14_aidide_access_rcv_len[5] = {29, 25, 25, 73, 33};
...
HI_S32 SelectCard(HI_U32 CardNo)
{
    if (0 == CardNo)
    {
        g_pSndBuf = (HI_CHAR*)t0_aidide_zeta_send;
        g_pSndLen = t0_aidide_zeta_send_len;
        g_u32MaxSndLen = sizeof(t0_aidide_zeta_send[0]);
        g_u32SndTimes = sizeof(t0_aidide_zeta_send) / sizeof(t0_aidide_zeta_send[0]);

        g_pRcvBuf = (HI_CHAR*)t0_aidide_zeta_rcv;
        g_pRcvLen = t0_aidide_zeta_rcv_len;
        g_u32MaxRcvLen = sizeof(t0_aidide_zeta_rcv[0]);
        g_bDropWord = HI_TRUE;
    }
    else if (1 == CardNo)
    {
    ...
    {
        g_pSndBuf = (HI_CHAR*)t14_aidide_access_send;
        g_pSndLen = t14_aidide_access_send_len;
        g_u32MaxSndLen = sizeof(t14_aidide_access_send[0]);
        g_u32SndTimes = sizeof(t14_aidide_access_send) / sizeof(t14_aidide_access_send[0]);

        g_pRcvBuf = (HI_CHAR*)t14_aidide_access_rcv;
        g_pRcvLen = t14_aidide_access_rcv_len;
        g_u32MaxRcvLen = sizeof(t14_aidide_access_rcv[0]);
        g_bDropWord = HI_FALSE;
    }
    else
    {
