...
HI_U32 t0_aidide_zeta_send_len[15] = {5, 1, 5, 5, 17, 5, 5, 1, 5, 5, 1, 5, 5, 1, 5};
HI_U32 t0_aidide_zeta_rcv_len[15] = {1, 2, 28, 1, 2, 12, 1, 2, 24, 1, 2, 14, 1, 2, 32};
...
HI_S32 SelectCard(HI_U32 CardNo)
{
    if (0 == CardNo)
    {
        g_pSndBuf = (HI_U8*)t0_aidide_zeta_send;
        ...
        g_pRcvBuf = (HI_U8*)t0_aidide_zeta_rcv;
    ...
    {
        g_pSndBuf = (HI_U8*)t14_aidide_access_send;
        ...
        g_pRcvBuf = (HI_U8*)t14_aidide_access_rcv;
