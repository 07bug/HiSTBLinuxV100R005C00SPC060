...
功能描述: hisilicon 基本的 “Hello, Secure World” 静态ta的ca用例
命令格式: sample_tee_demo 0
命令参考：sample_tee_demo 0

功能描述: hisilicon 基本的 “Hello, Secure World” 动态ta的ca用例
命令格式: sample_tee_dynamic_demo 0
命令参考：sample_tee_dynamic_demo 0