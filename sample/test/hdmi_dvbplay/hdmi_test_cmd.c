...
static HI_U32 Hdmi_ParseArg(HI_U32 argc)
{
    ...
    else if (0 == strcmp("cec_setcm", (char *)args[0]))
    {
        ...
        if((argc < 2) || (argc >= 3 && argc < 5))
        {
            ...
            printf("0   :       //0x36 <Standy> standy :ok\n");
            ...
            printf("8   :       //0x46 <Give OSD Name> :ok\n");
            printf("9   :       //0x64 <Set OSD String>:Maybe no support\n");
            printf("10  :       //0x8f <Give Device Power Status> :ok\n");
            printf("11  :       //0x44 <User Cotrol pressed> 0x41 <Set volume up> :ok\n");
            printf("12  :       //0x44 <User Cotrol pressed> 0x42 <Set volume down> :ok\n");
            printf("13  :       //0x44 <User Cotrol pressed> 0x43 <Set volume mute> :ok\n");
            printf("14-254:     //reserved \n");
