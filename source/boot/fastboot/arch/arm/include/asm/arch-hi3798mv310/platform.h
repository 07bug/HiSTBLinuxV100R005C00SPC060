...
#define PERI_CRG46_USB2CTRL             (REG_BASE_CRG + 0xb8)
#define PERI_CRG47_USB2PHY              (REG_BASE_CRG + 0xbc)
...
#define PERI_USB3_UTMI                  (REG_BASE_PERI_CTRL + 0x12c)
#define REG_BASE_WDG0                   (REG_BASE_PERI_CTRL + 0xC000)
#define REG_BASE_WDG1                   (REG_BASE_PERI_CTRL + 0xD000)
#define REG_BASE_IO_CONFIG              (REG_BASE_PERI_CTRL + 0x1000)

#define MEM_BASE_FMC                    0xFE200000
#define REG_BASE_FMC                    0xF9950000
#define REG_FMC_CFG                     0x0
#define REG_FMC_CFG_NFMODE              (7 << 13)
#define REG_BASE_USB2_PHY01             (0xf9865000)
...
#define EMMC_DRV_PS_315_157DOT5      (0b111 << 16)
...
#define EMMC_SAP_PS_315_157DOT5      (0b111 << 12)
...
#define EMMC_DRV_CAP_HS_CMD_DATA         (0b1101 << 4)
#define EMMC_DRV_CAP_HS_CLOCK            (0b1101 << 4)

#define EMMC_DRV_CAP_DDR50_CMD_DATA         (0b1101 << 4)
...
#define EMMC_DRV_CAP_HS400_CMD_DATA         (0b1000 << 4)
#define EMMC_DRV_CAP_HS400_CLOCK            (0b1000 << 4)
...
#define REG_SBL_START_FLAG              (REG_BASE_SCTL + REG_SC_GEN8)
