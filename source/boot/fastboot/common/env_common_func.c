...
#include <asm/arch/platform.h>
	...
	#undef CONFIG_ENV_IS_IN_EMMC
#endif

#ifdef CONFIG_ENV_IS_IN_MFTL
extern struct env_common_func_t mftl_env_cmn_func;
#endif
...
#ifdef CONFIG_ENV_IS_NOWHERE
extern struct env_common_func_t ddr_env_cmn_func;
...
#ifdef CONFIG_ENV_IS_IN_MFTL
			env_cmn_func = &mftl_env_cmn_func;
#else
#ifdef CONFIG_ENV_IS_IN_NAND
