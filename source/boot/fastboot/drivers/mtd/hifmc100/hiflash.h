...
#define FEATURE_TIMING_MODE_ADDR 0x01
...
struct flash_regop_info {
	...
	int sz_buf;
	int dummy;
	u32 wait_ready; /* only for nand, not for spi-nand */
};
...
extern struct nand_flash_special_dev nand_flash_ids_hisi[];
extern struct nand_flash_special_dev spinand_flash_ids_hisi[];
