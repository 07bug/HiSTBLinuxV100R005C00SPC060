...
#define HIFMC100_CFG_PAGE_PER_BLOCK_MASK         0x300
#define HIFMC100_CFG_PAGE_PER_BLOCK_64           0x0
#define HIFMC100_CFG_PAGE_PER_BLOCK_128          0x100
#define HIFMC100_CFG_PAGE_PER_BLOCK_256          0x200
#define HIFMC100_CFG_PAGE_PER_BLOCK_512          0x300
...
#define HIFMC100_GLOBAL_CFG_READ_RETRY_EN        (1 << 16)

#define HIFMC100_GLOBAL_CFG_READ_RETRY_OPTION_NUM_MASK (0x3 << 17)
#define HIFMC100_GLOBAL_CFG_READ_RETRY_OPTION_NUM_16   0x00000
#define HIFMC100_GLOBAL_CFG_READ_RETRY_OPTION_NUM_8    0x20000
#define HIFMC100_GLOBAL_CFG_READ_RETRY_OPTION_NUM_4    0x40000

#define HIFMC100_GLOBAL_CFG_ECC_SYNC_MODE        ~(1 << 19)
...
#define HIFMC100_DEFAULT_SYNCMODE_TIMING         0xaaaaaaa

/*****************************************************************************/
#define HIFMC100_INT                                       0x18
#define HIFMC100_INT_READRETRY_CNT_OVER          BIT(10)
#define HIFMC100_INT_READRETRY                   BIT(9)
...
#define HIFMC100_INT_EN_READRETRY_CNT_OVER       BIT(10)
#define HIFMC100_INT_EN_READRETRY                BIT(9)
...
#define HIFMC100_INT_EN_ALL                      0x7FF
#else
#define HIFMC100_INT_EN_ALL                      0x1FF
#endif
/*****************************************************************************/
#define HIFMC100_INT_CLR                                   0x20
#define HIFMC100_INT_CLR_READRETRY_CNT_OVER      BIT(10)
#define HIFMC100_INT_CLR_READRETRY               BIT(9)
...
#ifdef CONFIG_ARCH_HI3798MV310
#define HIFMC100_INT_CLR_ALL                     0x7FF
#else
...
#define HIFMC100_LP_CTRL_CLK_GATE_EN             BIT(0)
/*****************************************************************************/
#define HIFMC100_STATUS                                    0xac

/*****************************************************************************/
#define HIFMC100_OP_CNT                          0xb8
/*****************************************************************************/
