...
static struct nand_flash_special_dev nand_flash_special_dev[] =
{
	...
	{        /* Micron - L04A+ SLC-Mode 64bit/1k */
		.name      = "MT29F64G08CBCGBWP",
		.id        = {0x2C, 0x64, 0x44, 0x32, 0xA5, 0x00, 0x00, 0x00},
		.length    = 8,
		.chipsize  = _4G,
		.probe     = NULL,
		.pagesize  = _16K,
	...
	{        /* Micron - L05B+ SLC-Mode 64bit/1k (Bogus Read ID)*/
		.name      = "MT29F128G08CBCEBRT-37B",
		.id        = {0x2C, 0x84, 0xC4, 0x34, 0xAA, 0x00, 0x00, 0x00}, /* Initial Parts */
		.length    = 8,
		.chipsize  = _8G,
		.probe     = NULL,
		.pagesize  = _16K,
	...
	{        /* Micron - L05B+ SLC-Mode 64bit/1k */
		.name      = "MT29F128G08CBCEBRT-37B",
		.id        = {0x2C, 0x84, 0x44, 0x34, 0xAA, 0x00, 0x00, 0x00}, /* Supposedly Correct ID */
		.length    = 8,
		.chipsize  = _8G,
		.probe     = NULL,
		.pagesize  = _16K,
	...
	/********************** Spansion ******************************************/
	{        /* SLC 4bit/512 */
		.name      = "S34ML02G200BHI000",
		.id        = {0x01, 0xDA, 0x90, 0x95, 0x46, 0x01, 0xDA, 0x90, },
		.length    = 8,
		.chipsize  = _256M,
		.probe     = NULL,
		.pagesize  = _2K,
