...
#define SET_READ_DUAL_4(_dummy_, _size_, _clk_) \
	static struct spi_operation read_dual_4_##_dummy_##_size_##_clk_ = { \
	SPI_IF_READ_DUAL, SPI_CMD_READ_DUAL_4, _dummy_, _size_, _clk_ }

#define READ_DUAL_4(_dummy_, _size_, _clk_) read_dual_4_##_dummy_##_size_##_clk_
//-----------------------------------------------------------------------------
...
#define SET_WRITE_STD_4(_dummy_, _size_, _clk_) \
	static struct spi_operation write_std_4_##_dummy_##_size_##_clk_ = { \
	SPI_IF_WRITE_STD, SPI_CMD_PP_4, _dummy_, _size_, _clk_ }

#define WRITE_STD_4(_dummy_, _size_, _clk_) write_std_4_##_dummy_##_size_##_clk_
//-----------------------------------------------------------------------------
...
#define SET_ERASE_SECTOR_64K_4(_dummy_, _size_, _clk_) \
	static struct spi_operation erase_sector_64k_4_##_dummy_##_size_##_clk_ = { \
	SPI_IF_ERASE_SECTOR_64K, SPI_CMD_SE_64K_4, _dummy_, _size_, _clk_ }

#define ERASE_SECTOR_64K_4(_dummy_, _size_, _clk_) erase_sector_64k_4_##_dummy_##_size_##_clk_
//-----------------------------------------------------------------------------
...
SET_ERASE_SECTOR_64K_4(0, _64K, 50);
...
static struct spi_driver  spi_driver_w25q256j = {
	.wait_ready   = spi_general_wait_ready,
	.write_enable = spi_general_write_enable,
	.entry_4addr  = spi_special_entry_4addr,
	.bus_prepare  = spi_general_bus_prepare,
};
...
struct spi_info hisfc350_spi_info_table[] =
{
	...
	*/
	...
	{
		"W25Q256JVBIQ", {0xEF, 0x40, 0x19}, 3, _32M, _64K, 4,
		{
			&READ_DUAL_4(1, INFINITE, 54),
			0
		},

		{
			&WRITE_STD_4(0, 256, 50),
			0
		},

		{
			&ERASE_SECTOR_64K_4(0, _64K, 50),
			0
		},
