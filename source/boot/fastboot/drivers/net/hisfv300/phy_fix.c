...
static int __maybe_unused hieth_use_default_ate(struct eth_device *dev)
{
#if 0
...
static int __maybe_unused hieth_config_festa_phy_ate(struct eth_device *dev)
{
#if 0
	struct hieth_netdev_local *ld = (struct hieth_netdev_local *)dev->priv;
	void *otp_base;
...
int hieth_fix_festa_phy_ate(struct eth_device *dev)
{
	...
	if ((_HI3798M_V200 == chipid)
	    || (_HI3798M_V300 == chipid)
	    || (_HI3798M_V310 == chipid)
	    || (_HI3798M_V300_H == chipid)
	    || (_HI3796M_V200_15X15 == chipid)
	    || (_HI3796M_V200_21X21 == chipid)
	    || (_HI3716M_V450_21X21 == chipid))
