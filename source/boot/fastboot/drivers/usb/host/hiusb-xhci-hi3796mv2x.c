...
static void nano_phy_config_0(void)
{
	...
	*/
	...
	//eye diagram
	writel(0x3c, USB2_PHY01_REGBASE + 0x008);
	mdelay(2);
	writel(0x1e, USB2_PHY01_REGBASE + 0x074);
	mdelay(2);
	//EOP pre-emph off
	writel(0x18, USB2_PHY01_REGBASE + 0x000);
	mdelay(2);
	//disconnect =625
	writel(0xd7, USB2_PHY01_REGBASE + 0x010);
	mdelay(2);
...
static int usb_cpu_init(void)
{
	...
	*/
	...
	writel(0x23180000, REG_BASE_XHCI + GRXTHRCFG);
