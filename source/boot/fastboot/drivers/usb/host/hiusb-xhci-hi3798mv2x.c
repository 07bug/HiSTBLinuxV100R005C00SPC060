...
#define USB3_NANOPHY_REGBASE           (REG_BASE_PERI_CTRL+0x850)
/******************************************************************************/
...
static void nano_phy_config_0(void)
{
	...
	*/
	...
	if (_HI3798M_V200 == chipid) {
		writel(0x203000, USB3_NANOPHY_REGBASE);
		udelay(20);
		writel(0x1203000, USB3_NANOPHY_REGBASE);
		udelay(20);
		writel(0x203000, USB3_NANOPHY_REGBASE);
		udelay(20);
		writel(0x0, USB3_NANOPHY_REGBASE);	
		udelay(20);
	} else if (_HI3798M_V300 == chipid) {	
		writel(0x81b000, USB3_NANOPHY_REGBASE);
		udelay(20);
		writel(0x181b000, USB3_NANOPHY_REGBASE);
		udelay(20);
		writel(0x81b000, USB3_NANOPHY_REGBASE);
		udelay(20);
		writel(0x0, USB3_NANOPHY_REGBASE);	
		udelay(20);
		writel(0x81a000, USB3_NANOPHY_REGBASE);
		udelay(20);	
		writel(0x181a000, USB3_NANOPHY_REGBASE);
		udelay(20);	
		writel(0x81a000, USB3_NANOPHY_REGBASE);
		udelay(20);	
		writel(0x0, USB3_NANOPHY_REGBASE);	
...
static void inno_phy_config_1p(void)
{
	...
	if (_HI3798M_V200 == chipid) {
		...
		writel(0x1c, REG_BASE_USB2_PHY2);
		asm volatile ("dsb");
		udelay(20);
		writel(0xc1, REG_BASE_USB2_PHY2 + 0x44);
		asm volatile ("dsb");
		udelay(20);
		writel(0x5b, REG_BASE_USB2_PHY2 + 0x28);
		asm volatile ("dsb");
		udelay(20);
		writel(0x7, REG_BASE_USB2_PHY2 + 0x18);
		asm volatile ("dsb");
		udelay(20);
		writel(0x92, REG_BASE_USB2_PHY2 + 0x14);
		asm volatile ("dsb");
		udelay(20);
		mdelay(2);
	} else if (_HI3798M_V300 == chipid) {
		...
		/* eye height 450mv */
		writel(0x0c, REG_BASE_USB2_PHY2 + 0x08);
		mdelay(2);

		/* pre-emphasis */
		writel(0x18, REG_BASE_USB2_PHY2);
		udelay(20);
		...
		writel(0x1e, REG_BASE_USB2_PHY2 + 0x74);
		udelay(20);

		/* Second handshake */
		writel(0x6e, REG_BASE_USB2_PHY2 + 0x7c);
		udelay(20);
	}
}
/******************************************************************************/
