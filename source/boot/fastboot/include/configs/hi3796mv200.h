...
#ifndef __CONFIG_HI3796MV2X_H__
#define __CONFIG_HI3796MV2X_H__
#define CONFIG_ARCH_HI3796MV2X
...
#include "hi3796mv200_config.h"

#define CONFIG_TEE_SUPPORT	y

#undef CONFIG_BOOT_SIMULATE

#ifdef CONFIG_BOOT_SIMULATE
#define step(x)  writel(x, REG_BASE_SCTL + REG_SC_GEN31)
#undef CFG_HI3796MV2X_FPGA
#else
#define step(x)
#endif

#if CFG_HI3796MV2X_FPGA
#  define CONFIG_HI3796MV2X_FPGA
#else
#  undef CONFIG_HI3796MV2X_FPGA
#endif
...
#define CONFIG_PRODUCTNAME            "hi3796mv200"
...
#  define CONFIG_NET_HISFV300_HI3796MV2X      1
...
#define CONFIG_SCPU_SUPPORT		y
#define CONFIG_ASC_SUPPORT		y
#define CONFIG_SUPPORT_BLACKLIST_REG    y
