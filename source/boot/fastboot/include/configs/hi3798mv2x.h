...
#ifndef CONFIG_ENABLE_CONSOLE_OUTPUT
...
/* Some customer needs to run PM MCU which use timer0/1
   while boot is running, the procedure likes as
   'FBL->TEE(start up MCU, using timer0/1)->SBL(miniboot, using timer2/4/5)' */
#define CFG_TIMERBASE           REG_BASE_TIMER23
#else
...
/* Enable Ctrl+C to stop autoboot.*/
#  define CONFIG_AUTOBOOT_KEYED      1
#  define CONFIG_AUTOBOOT_PROMPT     "Press Ctrl+C to stop autoboot\n"
#  define CONFIG_AUTOBOOT_DELAY_STR  "hisilicon #"
#  define CONFIG_AUTOBOOT_STOP_STR   "\x03"
...
#define CONFIG_SUPPORT_EXT_AREA_POS     0x40c
#define CONFIG_SUPPORT_EXT_AREA_LEN_POS 0X410

#define CONFIG_SUPPORT_EXT_AREA_VAL     0x83855248
