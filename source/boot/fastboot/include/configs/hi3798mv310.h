...
#ifndef __CONFIG_HI3798MV310_H__
#define __CONFIG_HI3798MV310_H__
#define CONFIG_ARCH_HI3798MV310
...
#define CONFIG_OPTIMIZE_BOOTTIME
...
#include "hi3798mv310_config.h"

#undef CONFIG_BOOT_SIMULATE

#ifdef CONFIG_BOOT_SIMULATE
#define step(x)  writel(x, REG_BASE_SCTL + REG_SC_GEN31)
#undef CFG_HI3798MV310_FPGA
#else
#define step(x)
#endif

#if CFG_HI3798MV310_FPGA
#  define CONFIG_HI3798MV310_FPGA
#else
#  undef CONFIG_HI3798MV310_FPGA
#endif
...
#define CONFIG_BL31_BASE                       0x7aa00000
#elif defined(CONFIG_TEE_MEM_LAYOUT_1G)
#define CONFIG_BL31_BASE                       0x3aa00000
#elif defined(CONFIG_TEE_MEM_LAYOUT_1_5G)
#define CONFIG_BL31_BASE                       0x5aa00000
#elif defined(CONFIG_TEE_MEM_LAYOUT_512M)
#define CONFIG_BL31_BASE                       0x1aa00000
#else
#define CONFIG_BL31_BASE                       0x8020000
#endif
#else
#define CONFIG_BL31_BASE                       0x4400000
#endif*/
...
#define CONFIG_PRODUCTNAME            "hi3798mv310"
...
#  define CONFIG_HIMCI_V300                   1
#  define CONFIG_EMMC_PARAM_TAG
#endif

#ifdef CONFIG_HIMCI_V300
...
#  define CONFIG_MMC_BOOT_MODE_BUS_WIDTH      0x2  /* 8 bit */
#  define CONFIG_GENERIC_MMC
#endif /* CONFIG_HIMCI_V300 */
...
#define CONFIG_ASC_SUPPORT		y
#define CONFIG_TEE_ATF_SUPPORT		y
...
#define CONFIG_KEY_RIGHTS_POS		0x210
#define CONFIG_AUXAREA_LEN_POS		0x214
#define CONFIG_ASCAREA_LEN_POS		0x218
#define CONFIG_PROTECT_KEY1_POS		0x220
#define CONFIG_PROTECT_KEY2_POS		0x230
#define CONFIG_PROTECT_KEY3_POS		0x240
#define CONFIG_AUXKEY_POS			0x250
#define CONFIG_KEY_AREA_SIG_POS		0x300
#define CONFIG_KEY_RIGHTS           (0x3C78962D)
#define CONFIG_HEAD_AREA_LEN        0x3000
#ifdef CHIP_TYPE_hi3798mv200_a
#define CONFIG_AUXAREA_LEN              0x3400
#else
#define CONFIG_AUXAREA_LEN              0x6000
#endif
#define CONFIG_ASCAREA_LEN          0x6000

#define CONFIG_AUXKEY_0             0x13AA0526
#define CONFIG_AUXKEY_1             0x0A6D872F
#define CONFIG_AUXKEY_2             0x2FCCC6E0
#define CONFIG_AUXKEY_3             0xA529DF9F
...
#define CONFIG_FLASH_BOOT_ENC_FLAG_POS	0x40C
#define CONFIG_BOOT_ENTRY_POS			0x420
#define CONFIG_EXT_PARAMS_AREA_FLAG_POS	0x428
#define CONFIG_EXT_PARAMS_AREA_LEN_POS	0x42C
#define CONFIG_EXT_PARAMS_AREA_NUM_POS 0x430
#define CONFIG_DEFAULT_BOOT_REG_POS		0x4B0
...
#define CONFIG_EXT_PARAMS_AREA_NUM		(6)
...
//#define  CONFIG_AUX_ENC_FLAG_VAL 	0
...
#endif /* __CONFIG_HI3798MV310_H__ */
