...
#ifndef __CONFIG_HI3798MX_H__
#define __CONFIG_HI3798MX_H__
#define CONFIG_ARCH_HI3798MX
...
#include "hi3798mx_config.h"

#if CFG_HI3798MX_FPGA
#  define CONFIG_HI3798MX_FPGA
#else
#  undef CONFIG_HI3798MX_FPGA
#endif
/*-----------------------------------------------------------------------
...
#define CONFIG_PRODUCTNAME            "hi3798mx"
...
/******************************************************************************/
/* NAND MFTL Configuration */
/******************************************************************************/
#ifdef CONFIG_MFTL_SUPPORT
#  define CONFIG_ENV_IS_IN_MFTL               1
#  define CONFIG_CMD_MFTL
#  define CONFIG_MMC_CMD_AS_MFTL /* Remove or revert 'cmd_mmc.c' after HiTool MFTL Support */
#endif
...
#  define CONFIG_NET_HISFV300_HI3798MX             1
...
#  define CONFIG_DDR_TRAINING_HI3798MX
