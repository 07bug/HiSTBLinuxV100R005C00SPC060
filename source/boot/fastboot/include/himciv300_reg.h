...
/*MMC_GPIO details*/
#define DTO_FIX_ENABLE		(0x1<<23)

/*CRG231 emmc_sap_dll_dsel details*/
#define EMMC_SAP_DLL_DSEL_STEP0		(0b00<<2)
#define EMMC_SAP_DLL_DSEL_STEP1		(0b01<<2)
#define EMMC_SAP_DLL_DSEL_MASK		(0b11<<2)
