...
struct cmd_word_t cw_sreset = {
	"sreset", CMDWORD_TYPE_KEYWORD, _T("soft reset system, modules, ...")
};
...
struct cmd_word_t cw_read_rpmb = {
	"read.rpmb", CMDWORD_TYPE_KEYWORD, _T("mmc rpmb read operation")
};

struct cmd_word_t cw_write_rpmb = {
	"write.rpmb", CMDWORD_TYPE_KEYWORD, _T("mmc rpmb write operation")
};

struct cmd_word_t cw_key_rpmb = {
	"rpmbkey", CMDWORD_TYPE_KEYWORD, _T("mmc rpmb key program")
};

struct cmd_word_t cw_counter_rpmb = {
	"rpmbwcnt", CMDWORD_TYPE_KEYWORD, _T("mmc rpmb write counter get")
};
