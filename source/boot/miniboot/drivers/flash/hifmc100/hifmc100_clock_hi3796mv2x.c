...
#define HIFMC100_SPI_NAND_CLK_SEL_187M		0x00
/******************************************************************************/
...
struct spinor_chip_xfer hifmc100_spinor_chip_xfer[] = {
	...
	{ "MX25L25645G", {0xc2, 0x20, 0x19}, 3,
		...
		.erase =  SPIFLASH_XFER(SPINOR_OP_SE_64K_4B, 0, _64K, 80),},
...
int hifmc100_clock2reg(unsigned int value, int _to_reg)
{
	...
	unsigned int sysclk[] = {
		...
		187, HIFMC100_SPI_NAND_CLK_SEL_187M,
	};
	...
	if (_to_reg) {
		if (value <= 12)
			...
			return HIFMC100_SPI_NAND_CLK_SEL_187M;
