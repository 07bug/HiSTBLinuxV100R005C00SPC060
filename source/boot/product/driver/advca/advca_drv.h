...
typedef union
{
    struct
    {
        ...
        HI_U32 mc_des_hardonly_en   : 1;//0x03[0], use as "itcsa3_disable"
        HI_U32 mc_rc4_hardonly_en   : 1;//0x03[1], used as "itcsa3_enable"
        HI_U32 mckl_des_hard_disable: 1;//0x03[2], use as "runcheck_lv_0"
