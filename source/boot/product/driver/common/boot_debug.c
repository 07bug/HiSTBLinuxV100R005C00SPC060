...
HI_VOID HI_LOG_Init(HI_VOID)
{
    ...
    HI_OSAL_Strncpy(g_astModuleLogLevel[HI_ID_FB].aszName, "graphic", HI_BOOT_MAX_MODULE_NAME);
...
HI_VOID HI_LogOut(HI_U32 u32Level, HI_MOD_ID_E enModId, HI_U8 *pFuncName, HI_U32 u32LineNum, const char *format, ...)
{
    ...
    printf("%s[%d]%s: %s", pFuncName, u32LineNum, g_astModuleLogLevel[enModId].aszName, LogStr);
