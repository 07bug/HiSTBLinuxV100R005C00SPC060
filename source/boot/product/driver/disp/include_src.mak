...
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/drv/drv_cgms.c)
...
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/hal_specific/hal_xdr_policy.c)
...
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_gfx.c)
CFLAGS  += -I$(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/hal_specific
endif

ifneq ($(findstring $(CFG_HI_CHIP_TYPE), hi3798mv310),)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/hal_specific/sd_date_driver.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_ip_fdr.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_ip_region.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_ip_para.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_ip_master.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_ip_cap.c)
SRC     += $(wildcard $(DISP_DIR)/$(DRIVER_PATH)/hal/$(HAL_DIR)/vdp_hal_gfx.c)
endif
