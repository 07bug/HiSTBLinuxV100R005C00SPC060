...
HI_S32 ParseVersion(HI_U8 *pData1,HI_U8 *pData2)
{
    ...
    CHECK_POINTER(pData1);
    CHECK_POINTER(pData2);
...
{
    HI_U32 u32Temp;
    DETAILED_TIMING_BLOCK *pDetailed = HI_NULL;
    HI_UNF_EDID_TIMING_S *pEdidTiming = &g_stEdidInfo.stPerferTiming;

    CHECK_POINTER(pData);
    pDetailed = (DETAILED_TIMING_BLOCK*)pData;
     //pixel clock
...
{
    EDID_FIRST_BLOCK_INFO *pEdidInfo = HI_NULL;
    
    CHECK_POINTER(pData);
    pEdidInfo = (EDID_FIRST_BLOCK_INFO*)pData;
