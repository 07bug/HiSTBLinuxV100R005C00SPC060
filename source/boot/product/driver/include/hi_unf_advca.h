...
{
    HI_ADVCA_CAVENDOR_ATTR_IRDETO_CBCMAC_CALC,  /**<To calculate the high level code CBC-MAC.*/
    HI_ADVCA_CAVENDOR_ATTR_IRDETO_CBCMAC_AUTH,  /**<To authenticate the high level code CBC-MAC.*/
...
/**Defines the attribute of the high level code CBC-MAC.*/
...
typedef struct hiUNF_ADVCA_VERSION_NUMBER_S
{
    HI_U32 u32OTPAddr;
    HI_U32 u32OTPLength;
    HI_U32 u32VersionNumber;
}HI_UNF_ADVCA_ANTIROLLBACK_VERSION_S;
...
typedef enum hiHI_UNF_ADVCA_OTP_FUSE_E
{
    ...
    HI_UNF_ADVCA_OTP_ANTIROLLBACK_VERSION,
...
typedef struct hiUNF_ADVCA_OTP_ATTR_S
{
	union
	{
        ...
        HI_UNF_ADVCA_ANTIROLLBACK_VERSION_S stVersionNumber;       /**<for ree and tee version number*/
