...
void ir_protocols_lock(void);
void ir_protocols_unlock(void);
...
enum IR_MATCH_RESULT rstep_match(enum IR_MATCH_TYPE type,struct ir_buffer *head,struct ir_protocol *ip);
enum IR_MATCH_RESULT rstep_match_error_handle(enum IR_MATCH_TYPE type,struct ir_buffer *head,struct ir_protocol *ip);
int parse_rstep(struct ir_priv *ir, struct ir_protocol *ip, struct ir_buffer *rd, struct ir_buffer *wr);
void rstep_parse_error_handle(struct ir_priv *ir, struct ir_protocol *ip,
		 struct ir_buffer *symb_head, struct ir_buffer *key_head);
#endif
