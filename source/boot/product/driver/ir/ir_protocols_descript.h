...
static struct ir_protocol ir_protocols[] __attribute__((unused))= 
{
	...
	{
		{0},				/* list */
		RSTEP_18BIT,		/* protocol name */
		IR_PROT_RSTEP,			/* protocol */
		INFR_UNIQUE | INFR_NO_REPEAT
			| INFR_HAS_ERR_HANDLE,	/* flag */
		{				/* protocol attr */
			{360, 360, 42},		/* header phase */
			{0, 0, 0},		/* second header */
			0,			/* second header at */
			{315, 315, 30},		/* b0 phase */
			{315, 315, 30},		/* b1 phase */
			{315, 90000, 50},	/* burst phase */
			{0, 0},			/* repeate phase */
			315,			/* time slice */
			18,			/* wanna bits */
			13			/* burst at */
		},
		rstep_match,			/* phase matcher */
		0,				/* private data */
		parse_rstep,			/* frame parser */
		rstep_match_error_handle,		/* match error handle */
		rstep_parse_error_handle		/* parse error handle */	
	},
	/* DO NOT REMOVE THIS. */
