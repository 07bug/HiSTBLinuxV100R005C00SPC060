...
#define CMD_KLAD_GEN_CLEAR_KEY              BOOT_ADVCA_IOWR(HI_ID_KLAD, 0xb, KLAD_CTL_ENC_CLEAR_KEY_S)
#define CMD_KLAD_GET_DBG                    BOOT_ADVCA_IOWR(HI_ID_KLAD, 0xc, KLAD_CTL_DBG_S)
#define CMD_KLAD_BOOT2CIPHER                BOOT_ADVCA_IOW (HI_ID_KLAD, 0xd, HI_HANDLE)
#define CMD_KLAD_SET_MISC_KWMCWC            BOOT_ADVCA_IOW (HI_ID_KLAD, 0xe, KLAD_CTL_KWMCWC_S)
#define CMD_KLAD_SET_SP_KWMCWC              BOOT_ADVCA_IOW (HI_ID_KLAD, 0xf, KLAD_CTL_KWMCWC_S)
#define CMD_KLAD_SET_COM_CA_CONTENT_KEY     BOOT_ADVCA_IOW (HI_ID_KLAD, 0x10, KLAD_CTL_CONTENT_KEY_S)
