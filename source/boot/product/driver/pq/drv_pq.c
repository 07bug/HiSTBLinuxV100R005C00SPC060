...
HI_VOID HI_PQ_Init(HI_BOOL bDispParmValid, HI_DISP_PARAM_S* pstDispParam0, HI_DISP_PARAM_S* pstDispParam1)
{
    ...
    if ((HI_TRUE == sg_bInitState) || (HI_NULL == pstDispParam0) || (HI_NULL == pstDispParam1))
    {
        return;
    }
    ...
    {
        u32PQ_Brightness[HI_UNF_DISPLAY0] =  pstDispParam0->u32Brightness;
        u32PQ_Brightness[HI_UNF_DISPLAY1] =  pstDispParam1->u32Brightness;

        u32PQ_Contrast[HI_UNF_DISPLAY0] =  pstDispParam0->u32Contrast;
        u32PQ_Contrast[HI_UNF_DISPLAY1] =  pstDispParam1->u32Contrast;

        u32PQ_Saturation[HI_UNF_DISPLAY0] =  pstDispParam0->u32Saturation;
        u32PQ_Saturation[HI_UNF_DISPLAY1] =  pstDispParam1->u32Saturation;

        u32PQ_HuePlus[HI_UNF_DISPLAY0] =  pstDispParam0->u32HuePlus;
        u32PQ_HuePlus[HI_UNF_DISPLAY1] =  pstDispParam1->u32HuePlus;
    }
