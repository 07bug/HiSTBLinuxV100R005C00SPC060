...
#define CA_OTP_ADVCA_ID_WORD_ADDR  (0xa8)
#define CA_OTP_ADVCA_ID_WORD       (0x6EDBE953)

#if defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100) || defined(CHIP_TYPE_hi3798cv200) \
...
HI_S32 HI_Android_Auth_Recovery(HI_VOID)
{
    ...
    u32IDWord = HI_UNF_OTP_Read(CA_OTP_ADVCA_ID_WORD_ADDR);
    HI_INFO_CA("secure chip flag = %d\n", (u32IDWord == CA_OTP_ADVCA_ID_WORD) ? 1 : 0);
    CA_ASSERT(HI_UNF_ADVCA_GetSecBootStat(&CAFlag, &enCAFlashType), ret);
    if (u32IDWord == CA_OTP_ADVCA_ID_WORD && CAFlag == HI_TRUE)
    {
