...
HI_S32 CA_GetExternRsaKey(cmd_tbl_t *cmdtp, HI_S32 flag, HI_S32 argc, char *argv[])
{
    ...
    else if (EnvFlashType == HI_FLASH_TYPE_EMMC_0 || EnvFlashType == HI_FLASH_TYPE_SD)
    {
...
#if defined(CHIP_TYPE_hi3719mv100) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798mv310) || defined(CHIP_TYPE_hi3798mv300h)
       if (((HI_CHIP_TYPE_HI3719M == enChipType) && (HI_CHIP_VERSION_V100 == u32ChipVersion)) || \
          ...
          ((HI_CHIP_TYPE_HI3798M == enChipType) && (HI_CHIP_VERSION_V300 == u32ChipVersion)) || \
          ((HI_CHIP_TYPE_HI3798M == enChipType) && (HI_CHIP_VERSION_V310 == u32ChipVersion)) || \
          ((HI_CHIP_TYPE_HI3798M_A == enChipType) && (HI_CHIP_VERSION_V200 == u32ChipVersion)) || \
          ((HI_CHIP_TYPE_HI3798M_H == enChipType) && (HI_CHIP_VERSION_V300 == u32ChipVersion)))
       {
