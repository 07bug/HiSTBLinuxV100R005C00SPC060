...
typedef enum hiIOC_NR_SYS_E
{
    ...
    IOC_NR_SYS_GET_SYS_ATTR,
    IOC_NR_SYS_DISABLE_VIDEOCODEC,
} IOC_NR_SYS_E;
...
#define SYS_GET_SYS_ATTR            _IOR(HI_ID_SYS, IOC_NR_SYS_GET_SYS_ATTR, HI_SYS_ATTR_S)
#define SYS_DISABLE_VIDEOCODEC      _IOW(HI_ID_SYS, IOC_NR_SYS_DISABLE_VIDEOCODEC, HI_SYS_VIDEO_CODEC_E)
