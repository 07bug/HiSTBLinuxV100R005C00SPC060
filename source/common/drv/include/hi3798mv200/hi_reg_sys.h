...
// History       :    2017/06/01 11:18:23 Create file
// ******************************************************************************
...
typedef union
{
    /* Define the struct bits for Hi3798MV200*/
    struct
    {
    ...
    /* Define the struct bits  for Hi3798MV210*/
    struct
    {
...
typedef struct
{
    ...
    volatile unsigned int           reserved_6[800]                     ; /* 0x250~0xecc */
