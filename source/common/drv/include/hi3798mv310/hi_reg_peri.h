...
typedef union
{
    ...
    struct
    {
        unsigned int    bd_sel0_in            : 1   ; /* [0]  */
        unsigned int    bd_sel1_in            : 1   ; /* [1]  */
        unsigned int    bd_sel2_in            : 1   ; /* [2]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_1            : 6   ; /* [12..7]  */
        ...
        unsigned int    sdio0_pd_mux_bypass   : 1   ; /* [28]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_1            : 17  ; /* [23..7]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_2            : 1   ; /* [19]  */
        unsigned int    reserved_3            : 8   ; /* [27..20]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_1            : 13  ; /* [19..7]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    usb2_2p_ohci_12m_avilable : 1   ; /* [10]  */
        unsigned int    reserved_1            : 11  ; /* [21..11]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    ahb0_m1_x2x_mst_priority : 2   ; /* [17..16]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    gpu_cactive_adb_m     : 1   ; /* [6]  */
        unsigned int    gpu_cactive_adb_s     : 1   ; /* [7]  */
        unsigned int    reserved_0            : 24  ; /* [31..8]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    ddr_wkup_dot          : 8   ; /* [7..0]  */
        unsigned int    reserved_0            : 24  ; /* [31..8]  */
    } bits;
...
/* Define the union U_ASC_AREA_DOT */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    asc_vry               : 8   ; /* [7..0]  */
        unsigned int    asc_dec               : 4   ; /* [11..8]  */
...
typedef struct
{
    ...
    volatile unsigned int           reserved_6[2]                     ; /* 0x158~0x15c */
    ...
    volatile unsigned int           reserved_7[17]                     ; /* 0x170~0x1b0 */
    ...
    volatile unsigned int           reserved_10[403]                     ; /* 0x1f4~0x83c */
    ...
    volatile unsigned int           reserved_12[18]                     ; /* 0x878~0x8bc */
    volatile U_PERI_QOS_CFG8        PERI_QOS_CFG8            ; /* 0x8c0 */
    volatile unsigned int           reserved_13[2]                     ; /* 0x8c4~0x8c8 */
    volatile U_PERI_QOS_MEDIA3AXI   PERI_QOS_MEDIA3AXI       ; /* 0x8cc */
    volatile unsigned int           reserved_14[12]                     ; /* 0x8d0~0x8fc */
    volatile U_PERI_CPU_STATE       PERI_CPU_STATE           ; /* 0x900 */
    volatile unsigned int           reserved_15[7]                     ; /* 0x904~0x91c */
    volatile unsigned int           PERI_ECO_VERSION         ; /* 0x920 */
    volatile unsigned int           reserved_16[2]                     ; /* 0x924~0x928 */
    volatile U_PERI_RAM_CFG         PERI_RAM_CFG             ; /* 0x92c */
    volatile unsigned int           reserved_17[16]                     ; /* 0x930~0x96c */
