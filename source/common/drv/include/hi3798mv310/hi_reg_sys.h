...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    cpu_standbywfi_l2     : 1   ; /* [20]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_2            : 3   ; /* [17..15]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    HDMITX_CEC_ds         : 2   ; /* [7..6]  */
        unsigned int    HDMITX_CEC_sw         : 4   ; /* [11..8]  */
        unsigned int    hdmitx_hotplug_sel    : 1   ; /* [12]  */
        unsigned int    hdmitx_sda_sel        : 1   ; /* [13]  */
        unsigned int    hdmitx_scl_sel        : 1   ; /* [14]  */
        unsigned int    hdmitx_cec_sel        : 1   ; /* [15]  */
        unsigned int    uart_rx_sel           : 2   ; /* [17..16]  */
        unsigned int    uart_tx_sel           : 2   ; /* [19..18]  */
...
typedef struct
{
    ...
    volatile unsigned int           reserved_0[10]                     ; /* 0xc~0x30 */
    ...
    volatile unsigned int           reserved_6[620]                     ; /* 0x250~0xbfc */
    ...
    volatile unsigned int           reserved_7[176]                     ; /* 0xc10~0xecc */
    ...
    volatile unsigned int           reserved_8                     ; /* 0xedc */
    volatile unsigned int           SC_SYSID                 ; /* 0xee0 */
    volatile unsigned int           reserved_9[7]                     ; /* 0xee4~0xefc */
