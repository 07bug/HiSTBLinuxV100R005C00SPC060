...
typedef struct
{
    ...
    U_TNR_NOISEPOINTCNT_MIN   TNR_NOISEPOINTCNT_MIN          ; /* 0x2500 */
    U_TNR_NOISEPOINTCNT_MED   TNR_NOISEPOINTCNT_MED          ; /* 0x2504 */
    U_TNR_NOISEPOINTCNT_MAX   TNR_NOISEPOINTCNT_MAX          ; /* 0x2508 */
    U_TNR_NOISEPOINTNUM    TNR_NOISEPOINTNUM                 ; /* 0x250c */
    U_TNR_SUMNOISEINFO_MIN   TNR_SUMNOISEINFO_MIN            ; /* 0x2510 */
    U_TNR_SUMNOISEINFO_MED   TNR_SUMNOISEINFO_MED            ; /* 0x2514 */
    U_TNR_SUMNOISEINFO_MAX   TNR_SUMNOISEINFO_MAX            ; /* 0x2518 */
    U_TNR_SUMNOISEINFO     TNR_SUMNOISEINFO                  ; /* 0x251c */
