...
#define HI_FATAL_DEV(fmt...)    HI_TRACE(HI_LOG_LEVEL_FATAL,    HI_ID_LOG, fmt)
#define HI_ERR_DEV(fmt...)      HI_TRACE(HI_LOG_LEVEL_ERROR,    HI_ID_LOG, fmt)
#define HI_WARN_DEV(fmt...)     HI_TRACE(HI_LOG_LEVEL_WARNING,  HI_ID_LOG, fmt)
#define HI_INFO_DEV(fmt...)     HI_TRACE(HI_LOG_LEVEL_INFO,     HI_ID_LOG, fmt)
