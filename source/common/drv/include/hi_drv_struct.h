...
#define HI_MOD_TSIO                "tsio"
#define UMAP_DEVNAME_TSIO          UMAP_NAME HI_MOD_TSIO
#define UMAP_DEV_NUM_TSIO          1
#define UMAP_MIN_MINOR_TSIO        (UMAP_MAX_MINOR_HDMIRX + 1)
#define UMAP_MAX_MINOR_TSIO        (UMAP_MIN_MINOR_TSIO + UMAP_DEV_NUM_TSIO - 1)

#define HI_MOD_PLCIPHER               "plcipher"
#define UMAP_DEVNAME_PLCIPHER         UMAP_NAME HI_MOD_PLCIPHER
#define UMAP_DEV_NUM_PLCIPHER         1
#define UMAP_MIN_MINOR_PLCIPHER       (UMAP_MIN_MINOR_TSIO + 1)
#define UMAP_MAX_MINOR_PLCIPHER       (UMAP_MIN_MINOR_PLCIPHER + UMAP_DEV_NUM_PLCIPHER - 1)


#define HI_MOD_CERT                   "cert"
#define UMAP_DEVNAME_CERT             UMAP_NAME HI_MOD_CERT
...
#define HI_MOD_SM                     "sm"
#define UMAP_DEVNAME_SM               UMAP_NAME HI_MOD_SM
#define UMAP_DEV_NUM_SM               1
#define UMAP_MIN_MINOR_SM             (UMAP_MAX_MINOR_CERT + 1)
#define UMAP_MAX_MINOR_SM             (UMAP_MIN_MINOR_SM + UMAP_DEV_NUM_SM - 1)

#define HI_MOD_RUNTIMECHECK           "runtimecheck"
#define UMAP_DEVNAME_RUNTIMECHECK     UMAP_NAME HI_MOD_RUNTIMECHECK
#define UMAP_DEV_NUM_RUNTIMECHECK     1
#define UMAP_MIN_MINOR_RUNTIMECHECK   (UMAP_MAX_MINOR_SM + 1)
#define UMAP_MAX_MINOR_RUNTIMECHECK   (UMAP_MIN_MINOR_RUNTIMECHECK + UMAP_DEV_NUM_RUNTIMECHECK - 1)


#define HI_MOD_MAILBOX                "mailbox"
#define UMAP_DEVNAME_MAILBOX          UMAP_NAME HI_MOD_MAILBOX
#define UMAP_DEV_NUM_MAILBOX          1
#define UMAP_MIN_MINOR_MAILBOX        (UMAP_MAX_MINOR_RUNTIMECHECK + 1)
#define UMAP_MAX_MINOR_MAILBOX        (UMAP_MIN_MINOR_MAILBOX + UMAP_DEV_NUM_MAILBOX - 1)

#define HI_MOD_CASIMAGE                "casimage"
#define UMAP_DEVNAME_CASIMAGE          UMAP_NAME HI_MOD_CASIMAGE
#define UMAP_DEV_NUM_CASIMAGE          1
#define UMAP_MIN_MINOR_CASIMAGE        (UMAP_MAX_MINOR_MAILBOX + 1)
#define UMAP_MAX_MINOR_CASIMAGE        (UMAP_MIN_MINOR_CASIMAGE + UMAP_DEV_NUM_CASIMAGE - 1)


#define UMAP_DEV_NUM_TOTAL            UMAP_MAX_MINOR_CASIMAGE
