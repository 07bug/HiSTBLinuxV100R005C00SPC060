...
{
    int ret;
    ret=HI_DRV_UserCopy(file->f_path.dentry->d_inode, file, cmd, arg, CMPI_Mem_Ioctl);
...
{
    int ret;
    ret=HI_DRV_UserCopy(file->f_path.dentry->d_inode, file, cmd, arg, CMPI_Mem_Compat_Ioctl);
