...
/*HI_S32 AribCC_CharFlash(HI_VOID)
{
    return ARIBCC_OSD_CharFlash();
}*/

HI_S32 ARIBCC_DISP_Init(CCDISP_INIT_PARAM_S *pstInitParam)
{
    return ARIBCC_GRAPHIC_DispInit(pstInitParam);
}

HI_S32 ARIBCC_DISP_DeInit(HI_VOID)
{
    return ARIBCC_GRAPHIC_DispDeInit();
}
