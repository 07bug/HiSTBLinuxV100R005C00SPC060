...
#else
    //palette 0,Index 0-15
    {{0,0,0,255},  {0,0,255,255},  {0,255,0,255},  {0,255,255,255},   //black,red,green,Yellow
     {255,0,0,255},{255,0,255,255},{255,255,0,255},{255,255,255,255}, //blue,Magenta,Cyan,White
     {0,0,0,0},    {0,0,170,255},  {0,170,0,255},  {0,170,170,255},   //Transparent,Half brightness Red,Half brightness Green,Half brightness Yellow
     {170,0,0,255},{170,0,170,255},{170,170,0,255},{170,170,170,255}},//Half brightness Blue,Half brightness magenta,Half brightness Cyan,Half brightness White(Gray)

    //palette 1,Index 16-31
    {{85,0,0,255},   {0,85,0,255},  {85,85,0,255},  {170,85,0,255},
     {255,85,0,255}, {85,170,0,255},{255,170,0,255},{85,255,0,255},
     {170,255,0,255},{0,0,85,255},  {85,0,85,255},  {170,0,85,255},
     {255,0,85,255}, {0,85,85,255}, {85,85,85,255}, {170,85,85,255}},

    //palette 2,Index 32-47
    {{255,85,85,255}, {0,170,85,255},  {85,170,85,255}, {170,170,85,255},
     {255,170,85,255},{0,255,85,255},  {85,255,85,255}, {170,255,85,255},
     {255,255,85,255},{85,0,170,255},  {255,0,170,255}, {0,85,170,255},
     {85,85,170,255}, {170,85,170,255},{255,85,170,255},{85,170,170,255}},

    //palette 3,Index 48-63
    {{255,170,170,255},{0,255,170,255},  {85,255,170,255}, {170,255,170,255},
     {255,255,170,255},{85,0,255,255},   {170,0,255,255},  {0,85,255,255},
     {85,85,255,255},  {170,85,255,255}, {255,85,255,255}, {0,170,255,255},
     {85,170,255,255}, {170,170,255,255},{255,170,255,255},{85,255,255,255}},

    //palette 4,Index 64-79
    {{170,255,255,255},{0,0,0,128},    {0,0,255,128},  {0,255,0,128},     //,,Black,Red,Green
     {0,255,255,128},  {255,0,0,128},  {255,0,255,128},{255,255,0,128},   //Yellow,blue,Magenta,Cyan
     {255,255,255,128},{0,0,170,128},  {0,170,0,128},  {0,170,170,128},   //White,Half brightness Red ,Half brightness Green,Half brightness Yellow
     {170,0,0,128},    {170,0,170,128},{170,170,0,128},{170,170,170,128}},//Half brightness Blue ,Half brightness magenta,Half brightness Cyan,Half brightness White(Gray)

    //palette 5,Index 80-95
    {{85,0,0,128},   {0,85,0,128},  {85,85,0,128},  {170,85,0,128},
     {255,85,0,128}, {85,170,0,128},{255,170,0,128},{85,255,0,128},
     {170,255,0,128},{0,0,85,128},  {85,0,85,128},  {170,0,85,128},
     {255,0,85,128}, {0,85,85,128}, {85,85,85,128}, {170,85,85,128}},

    //palette 6,Index:96-111
    {{255,85,85,128}, {0,170,85,128},  {85,170,85,128}, {170,170,85,128},
     {255,170,85,128},{0,255,85,128},  {85,255,85,128}, {170,255,85,128},
     {255,255,85,128},{85,0,170,128},  {255,0,170,128}, {0,85,170,128},
     {85,85,170,128}, {170,85,170,128},{255,85,170,128},{85,170,170,128}},

    //palette 7,Index 112-127
    {{255,170,170,128},{0,255,170,128},  {85,255,170,128}, {170,255,170,128},
     {255,255,170,128},{85,0,255,128},   {170,0,255,128},  {0,85,255,128},
     {85,85,255,128},  {170,85,255,128}, {255,85,255,128}, {0,170,255,128},
     {85,170,255,128}, {170,170,255,128},{255,170,255,128},{85,255,255,128}}
...
{
    ARIBCC_OSD_ClearScreen((HI_S32)enInCCType, HI_TRUE);
    return HI_SUCCESS;
}
...
static HI_S32 _ARIBCC_8BitCode_Time(ARIBCC_CaptionType_E enInCCType,ARIBCC_Control_S *pstControl)
{
    ...
    switch( pstControl->enControlId )
    {
        ...
        case ARIB_C1_TIME_1:
            ...
            {
                u32WaitTime = (HI_U32)(*ps32ControlData) * 100UL;
                CC_SLEEP(u32WaitTime);
            }
            break;
...
static HI_S32 _ARIBCC_ParseMessage(ARIBCC_CaptionType_E enInCCType,HI_U8 *pInMessage)
{
    ...
    if(stManagementUnit.pstManagement)
    {
        ...
        if(gCaptionInfo[enInCCType].bScrollFlg)
        {
            ...
            ARIBCC_OSD_ClearScreen(enInCCType, HI_TRUE);
    ...
    while( u32Length < pstGroup->u32UnitGroupLength )
    {
        switch( pstUnit->u32UnitId )
        {
            ...
            case DATA_UNIT_ADD_SOUND:
                HI_INFO_CC("----Currently not support u32UnitId = \n",pstUnit->u32UnitId);
                break;
...
HI_S32 ARIBCC_DISP_Stop(ARIBCC_CaptionType_E enCaptionType)
{
    ...
    if(g_bRcvManageFlg[enCaptionType] != HI_FALSE)
    {
        ...
        ARIBCC_OSD_ClearScreen(enCaptionType, HI_TRUE);
