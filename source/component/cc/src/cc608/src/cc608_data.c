...
/*source monitor*/
static void CC608_DATA_Caption_ModeText(HI_U8 module_id, HI_U16 *pu16CaptionData, HI_U8 u8Len, CC608_OBJECT_S *pstObject)
{
...
void CC608_DATA_Caption(HI_U8 module_id, HI_U16 *pu16CaptionData, HI_U8 u8Len)
{
    ...
    {
        (void)CC608_DATA_Caption_ModeText(module_id, pu16CaptionData, u8Len, pstObject);
    }
...
HI_S32 CC608_DATA_Substitute(HI_U8 module_id)
{
    ...
    if(pstObject->enCurMode == CC608_MODE_CAPTION)
    {
        ...
        if(pstObject->stScreen.u8CurColumn > 0 )
        {
            ...
            //for non-monospaced font, the char width should reacquire.
            {
                HI_S32 s32Width = 0;
                HI_S32 s32Height = 0;
                HI_U16 *pu16Str = &(pstObject->stOnBuffer.stCaption[row][column].u16Text);
                (HI_VOID)CCDISP_Text_GetSize(pstObject->enWindowId, pu16Str, 1, &s32Width, &s32Height);
                cap_len = s32Width;
                pstObject->stOnBuffer.stCaption[row][column].u16Text = 0;
            }
