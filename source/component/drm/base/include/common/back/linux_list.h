 ...
 */
static INLINE void list_add_tail(struct list_head * const pstrunew, struct list_head *head)
{
    __list_add(pstrunew, head->prev, head);
}
...
static INLINE void __list_splice(const struct list_head * const list,
 ...
 */
static INLINE void list_splice(const struct list_head * const list,
                            struct list_head * const head)
{
    if (!list_empty(list))
