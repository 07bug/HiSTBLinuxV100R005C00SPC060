...
void MyTestService::instantiate(char* pServiceName)
{
    pInstance = new MyTestService();
    defaultServiceManager()->addService(String16(pServiceName), pInstance);
}
...
void MyTestService:: func_getData_sleep_n_second(int32_t nSec)
{
    sleep((nSec));//sleep  seconds
