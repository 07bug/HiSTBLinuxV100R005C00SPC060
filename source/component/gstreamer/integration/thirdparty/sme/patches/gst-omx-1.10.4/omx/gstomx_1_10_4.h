#ifndef __GST_OMX_1_10_2_H__
#define __GST_OMX_1_10_2_H__

#include <OMX_Core.h>
#include <OMX_Component.h>

#define OMX_VERSION_1_10_2 ((0<<24) | (0<<16) | (2<<8) | 1)

/**< Currently gst-omx only supports openmax IL 1.10.2, need to define some
 *   MACROs to match the definitions of two versions.
 */
#if (OMX_VERSION == OMX_VERSION_1_10_2)
