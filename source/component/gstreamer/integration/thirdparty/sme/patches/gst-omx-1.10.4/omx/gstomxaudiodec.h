...
struct _GstOMXAudioDecClass
{
  ...
  OMX_U32 (*get_header_len)     (GstOMXAudioDec * self, OMX_U8 * buf, OMX_U32 len);
  gboolean (*check_need_header) (GstOMXAudioDec * self, OMX_U8 * buf, OMX_U32 len, OMX_U8 ** header_buf, OMX_U32 *header_len);
#endif
};
