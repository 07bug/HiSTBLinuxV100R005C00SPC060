    ...
    gpointer user_data)
{
  ...
  /* patch here for deadlock in finish playing */
#define PATCH_FOR_DEADLOCK_IN_FINISH

#ifdef PATCH_FOR_DEADLOCK_IN_FINISH
  change_state (self, GST_PLAYER_STATE_STOPPED); // change_state befor handle SIGNAL_END_OF_STREAM
  if (g_signal_handler_find (self, G_SIGNAL_MATCH_ID,
