...
$(PRIVATE_PKG_GLIB_NAME_CONFIGURE):$(PRIVATE_PKG_GLIB_NAME_PREPARE)
	...
	$(NC)cp -af $(SME_THIRDPARTY_PATCH_DIR)/$(PKG_GLIB_NAME)/$(PRIVATE_PKG_GLIB_CACHE_FILE_NAME) $(SME_THIRDPARTY_MERGE_DIR)/$(PKG_GLIB_NAME)/
...
$(PRIVATE_PKG_GLIB_NAME_PREPARE):
	...
	tar -xvf $(SME_THIRDPARTY_ORG_DIR)/../../../../../../third_party/open_source/$(PKG_GLIB_NAME).$(EXT_TYPE_XZ) -C $(SME_THIRDPARTY_MERGE_DIR)
