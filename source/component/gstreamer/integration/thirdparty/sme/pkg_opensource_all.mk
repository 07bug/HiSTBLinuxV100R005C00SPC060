...
PKG_ALL_TARGETS := pkg_glib_all pkg_gst_core pkg_gst_base pkg_gst_good_all pkg_gmp pkg_nettle pkg_gst_omx pkg_ffmpeg
PKG_ALL_TARGETS_DEPS := pkg_gst_soup-deps pkg_gmp-deps pkg_nettle-deps pkg_gst_omx-deps pkg_ffmpeg
else
