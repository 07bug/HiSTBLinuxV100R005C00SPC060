...
$(PRIVATE_PKG_SOUP_NAME_INSTALL):$(PRIVATE_PKG_SOUP_NAME_MAKE)
	...
	cp -af $(THIRDPARTY_OBJ_DIR)/lib/libsoup-2.4.so.1.8.0 $(TARGET_OUT_LIB_DIR)/
ifeq ($(STRIP_IN_RELEASE_VERSION), y)
	$(TARGET_STRIP) $(TARGET_OUT_LIB_DIR)/libsoup-2.4.so.1.8.0
endif
...
$(PRIVATE_PKG_SOUP_NAME_PREPARE):
	...
	tar -xf $(SME_THIRDPARTY_ORG_DIR)/../../../../../../third_party/open_source/$(PKG_SOUP_NAME).$(EXT_TYPE_XZ) -C $(SME_THIRDPARTY_MERGE_DIR)
...
$(LOCAL_MODULE)-clean:
	...
	$(NC)rm -rf $(TARGET_OUT_LIB_DIR)/libsoup-2.4.so.1.8.0
