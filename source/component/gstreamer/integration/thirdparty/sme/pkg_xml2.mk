...
$(PRIVATEPKG_XML2_NAMEINSTALL):$(PRIVATEPKG_XML2_NAMEMAKE)
	...
	#cp -af $(THIRDPARTY_OBJ_DIR)/lib/libxml2.so.2.9.4 $(TARGET_OUT_LIB_DIR)/libxml2.so.2.9.4
...
$(PRIVATEPKG_XML2_NAMEPREPARE):
	...
	tar -xf $(SME_THIRDPARTY_ORG_DIR)/../../../../../../third_party/open_source/$(PKG_XML2_NAME).$(EXT_TYPE_GZ) -C $(SME_THIRDPARTY_MERGE_DIR)
...
$(LOCAL_MODULE)-clean:
	...
	$(NC)rm -rf $(TARGET_OUT_LIB_DIR)/libxml2.so.2.9.4
