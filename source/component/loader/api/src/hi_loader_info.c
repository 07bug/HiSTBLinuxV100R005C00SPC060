...
HI_S32 HI_LOADER_ReadParameters(HI_LOADER_PARAMETER_S* pstParameter)
{
    ...
    switch (stLoaderInfo.stUPDParamData.enUpgradeType)
    {
        case HI_LOADER_UPGRADE_TYPE_OTA:
        {
            ...
            pstParameter->eUpdateType = HI_LOADER_TYPE_OTA;
            ...
            {
                LOADER_PrintErrCode(LOADER_ERR_UNSUPPORTED);
                return LOADER_ERR_UNSUPPORTED;
            }
        ...
        case HI_LOADER_UPGRADE_TYPE_IP:
        {
            ...
            pstParameter->eUpdateType = HI_LOADER_TYPE_IP;

            LOADER_StrNCpy((HI_CHAR*)pstIPParam1->as8FileName, (HI_CHAR*)pstIPParam2->as8FileName, HI_LOADER_FILENAME_LEN - 1);
            LOADER_StrNCpy((HI_CHAR*)pstIPParam1->as8UserName, (HI_CHAR*)pstIPParam2->as8UserName, HI_LOADER_USERNAME_LEN - 1);
            LOADER_StrNCpy((HI_CHAR*)pstIPParam1->as8Password, (HI_CHAR*)pstIPParam2->as8Password, HI_LOADER_PASSWORD_LEN - 1);
        ...
        {
            pstParameter->eUpdateType = HI_LOADER_TYPE_USB;

            LOADER_StrNCpy((HI_CHAR*)pstParameter->stPara.stUSBParam.as8FileName,
...
HI_S32 HI_LOADER_WriteParameters(HI_LOADER_PARAMETER_S* pstParameter)
{
    ...
    LOADER_CHECK_PARAM(HI_NULL_PTR == pstParameter);
    LOADER_CHECK_PARAM(HI_LOADER_TYPE_BUTT <= pstParameter->eUpdateType);
    ...
    switch (pstParameter->eUpdateType)
    {
        case HI_LOADER_TYPE_OTA:
        {
            ...
            stLoaderInfo.stUPDParamData.enUpgradeType = HI_LOADER_UPGRADE_TYPE_OTA;
        ...
        case HI_LOADER_TYPE_IP:
        {
            ...
            stLoaderInfo.stUPDParamData.enUpgradeType = HI_LOADER_UPGRADE_TYPE_IP;
        ...
        {
            stLoaderInfo.stUPDParamData.enUpgradeType = HI_LOADER_UPGRADE_TYPE_USB;

            LOADER_StrNCpy((HI_CHAR*)stLoaderInfo.stUPDParamData.unParam.stUSBParam.as8FileName,
        ...
        default:
        {
            LOADER_PrintErrCode(LOADER_ERR_UNKNOWNED);
            return LOADER_ERR_UNKNOWNED;
        }
    }
...
HI_S32 HI_LOADER_ReadSTBInfo(HI_LOADER_STB_INFO_S* pstStbinfo)
{
    ...
    LOADER_CHECK_PARAM(HI_NULL_PTR == pstStbinfo);
