...
#ifndef __LOADER_DBINFO_H__
#define __LOADER_DBINFO_H__
...
#define LDDB_D_LEN_MACADDR          (18)                    /**< Max length of Mac address */
#define LDDB_D_LEN_PARTNAME         (32)                    /**< Max length of partiton name */
#define LDDB_D_CNT_PARTITION        (32)                    /**< Max length of partiton name */
...
typedef struct hiLDDB_SOFTWARE_INFO_S
{
    ...
    LDDB_PARTITION_INFO_S astPartitionInfo[LDDB_D_CNT_PARTITION];   /**< Partition Description */
