...
#define SC_GEN60   0xf70
#define SC_GEN61   0xf74
#define SC_GEN62   0xf78
...
#define DATA_GPIO0     (0x68)
#define DATA_GPIO1     (0x6c)

#define DATA_DISPMODE  (0x70)
#define DATA_DISPVAL   (0x74)
...
#define DATA_WAKEUPKEYLOW 	(CFG_BASE_ADDR + SC_GEN59)
#define DATA_WAKEUPKEYHIGH 	(CFG_BASE_ADDR + SC_GEN60)
#define DATA_WAKEUPTYPE 	(CFG_BASE_ADDR + SC_GEN61)
#define DATA_PERIOD    		(CFG_BASE_ADDR + SC_GEN62)
