...
HI_U8    TTX_Parse_FindStartPosition(TTX_PAGE_CONTEXT_S*  pstCurrentPoint, HI_U8* au8szSubPage);
...
HI_VOID  TTX_SetPgActPos (TTX_PAGE_CONTEXT_S* pstCurrentPoint, HI_U32 u32Row, HI_U32 u32Column, HI_U32 u32Code, HI_U32 u32Char, HI_U32 u32Masks);
