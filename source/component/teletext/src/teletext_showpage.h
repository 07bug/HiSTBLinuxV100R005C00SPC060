...
#define TTX_MAX_SHOW_TIMEOUT      (3 * 1000)

#define TTX_COLOR_CONVERT(color) (0xff000000 |(((color) & 0xf00) << 12) |(((color) & 0xf0) << 8) | (((color) & 0xf) << 4))
#define TTX_COLOR_ABGR(color) (0xff000000 |(((color) & 0xf) << 20) |(((color) & 0xf0) << 8) | (((color) &0xf00) >> 4))
...
typedef  struct tagTTX_PAGE_CONTEXT_S
{
    ...
    HI_U8            u8BandLeft[3];
    HI_U32           u32ColumnNum;
    HI_BOOL          bCancel;                    /**show or hide page data */
    HI_BOOL          bBoxPage;                   /**box page data */

    HI_BOOL          bShowTime;                  /**show or hide time */
    ...
    HI_U32  u32ShowTimeout;
    HI_U32  u32C10;
    HI_UNF_TTX_G0SET_E enDefG0Set;
    HI_U32 au32TimeColor[TTX_TIME_CHAR_NUM];
...
HI_VOID  TTX_Show_SetArea(HI_UNF_TTX_PAGEAREA_S* pstPageArea, HI_U32 u32Row, HI_U32 u32Colunm, HI_U32 u32RowCount, HI_U32 u32ColumnCount);
