...
HI_S32 TTX_PesQueue_En(TTX_SEGMENT_QUEUE_S* pstQueue, TTX_SEGMENT_S* pSegment)
{
    ...
    {
        pstQueue->pstSegmentRear->pu8SegmentData = (HI_U8*)((size_t)pstQueue->pu8BaseAddr + u32DataTypeSize);
    }
    else
    {
        pstQueue->pstSegmentRear->pu8SegmentData = (HI_U8*)((size_t)pstQueue->pstSegmentRear + u32DataTypeSize);
    }
