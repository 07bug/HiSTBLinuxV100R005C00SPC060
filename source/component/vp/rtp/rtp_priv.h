...
#define H264_HEAD_LEN  (5)               /*the head contain nal head(1byte) and start coder(4byte)*/
#define H265_HEAD_LEN  (6)               /*the head contain nal head(2byte) and start coder(4byte)*/
#define H264_FU_HEAD_LEN  (2)         /*the head len contain FU indicator (1byte) and FU header(1byte) */
#define H265_FU_HEAD_LEN  (3)         /*the head len contain FU indicator (2byte) and FU header(1byte) */
