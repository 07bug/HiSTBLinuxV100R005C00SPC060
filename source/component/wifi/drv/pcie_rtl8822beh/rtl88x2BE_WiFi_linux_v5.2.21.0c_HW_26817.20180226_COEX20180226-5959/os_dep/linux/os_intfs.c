...
module_param(rtw_short_gi, int, 0644);
...
module_param(rtw_ampdu_factor, int, 0644);
...
u8 rtw_init_default_value(_adapter *padapter)
{
	...
	padapter->tx_amsdu = 2;
	padapter->tx_amsdu_rate_24g = 400;
	padapter->tx_amsdu_rate_5g = 0;
	padapter->tx_amsdu_rate_cur = 0;
#endif
