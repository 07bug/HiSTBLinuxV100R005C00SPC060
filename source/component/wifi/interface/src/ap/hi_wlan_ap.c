...
static HI_S32 ap_load_driver(HI_VOID)
{
    ...
    if (device_id < 0) {
#ifdef WIFI_DEVICE_AP6356S
        DBGPRINT("No supported usb or pcie device found, set id to chosen AP6356S\n");
        device_id = 28;
#else
        ...
        case WIFI_REALTEK_RTL8192EU:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/rtl8192eu.ko", "rtl8192eu ", NULL))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            break;
        case WIFI_REALTEK_RTL8812AE:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/rtl8812ae.ko", "rtl8812ae ", NULL))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            break;
        ...
        case WIFI_REALTEK_RTL8822BU:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/rtl8822bu.ko", "rtl8822bu ", NULL))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            break;
        case WIFI_HISI_HI1131C:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/plat.ko", "plat ", NULL)
              || wlan_util_insmod_module("/kmod/wifi.ko", "wifi ", NULL))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            break;
        case WIFI_AMPAK_AP6356S:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/bcmdhd.ko", "bcmdhd ", "firmware_path=/lib/firmware/fw_bcm4356a2_ag_apsta.bin nvram_path=/lib/firmware/nvram_ap6356s.txt"))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            else
                sleep(2);
            break;
        case WIFI_REALTEK_RTL8822BEH:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/rtl8822be.ko", "rtl8822be ", NULL))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            break;
        case WIFI_ATHEROS_QCA6174:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/qca6174.ko", "qca6174 ", NULL))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            break;
        default:
...
static HI_S32 ap_unload_driver(HI_VOID)
{
    ...
    switch(device_id) {
        ...
        case WIFI_REALTEK_RTL8812AU:
            ...
            break;
        case WIFI_REALTEK_RTL8812AE:
            if ((wlan_util_rmmod_module("rtl8812ae") == 0)
              && (wlan_util_rmmod_module("cfg80211") == 0))
                ret = HI_SUCCESS;
            break;
        case WIFI_BROADCOM_BCM43236:
        ...
        case WIFI_REALTEK_RTL8822BU:
            ...
            break;
        case WIFI_HISI_HI1131C:
            if ((wlan_util_rmmod_module("wifi") == 0)
              && (wlan_util_rmmod_module("plat") == 0)
              && (wlan_util_rmmod_module("cfg80211") == 0))
                ret = HI_SUCCESS;
            break;
        case WIFI_AMPAK_AP6356S:
            ...
            break;
        case WIFI_REALTEK_RTL8822BEH:
            if ((wlan_util_rmmod_module("rtl8822be") == 0)
              && (wlan_util_rmmod_module("cfg80211") == 0))
                ret = HI_SUCCESS;
            break;
        case WIFI_ATHEROS_QCA6174:
            if ((wlan_util_rmmod_module("qca6174") == 0)
              && (wlan_util_rmmod_module("cfg80211") == 0))
                ret = HI_SUCCESS;
            break;
        default:
...
static HI_S32 ap_start_hostapd(const HI_CHAR *config_file, const HI_CHAR *entropy_file)
{
    ...
    if(device_id == WIFI_HISI_HI1131C) {
        spawn_args[0]= "hisi_hostapd";
    }
            ...
            HI_WLAN_AP_CONFIG_S *pstApCfg, const HI_CHAR *config_file)
{
     ...
     */
    if (device_id == WIFI_BROADCOM_BCM43236 || device_id == WIFI_AMPAK_AP6356S)
        memset(ht40, 0, sizeof(ht40));
