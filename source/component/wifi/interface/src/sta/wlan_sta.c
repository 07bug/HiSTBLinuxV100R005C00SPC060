...
HI_S32 sta_load_driver(HI_VOID)
{
    ...
    switch(sta->device_id) {
        ...
        case WIFI_AMPAK_AP6356S:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/bcmdhd.ko", "bcmdhd ", "firmware_path=/lib/firmware/fw_bcm4356a2_ag.bin nvram_path=/lib/firmware/nvram_ap6356s.txt"))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            else
                sleep(2);
            break;
        ...
        case WIFI_ATHEROS_QCA6174:
            if (wlan_util_insmod_module("/kmod/cfg80211.ko", "cfg80211 ", NULL)
              || wlan_util_insmod_module("/kmod/qca6174.ko", "qca6174 ", "country_code=CN"))
                ret = HI_WLAN_LOAD_DRIVER_FAIL;
            break;
        default:
                            ...
                            const HI_CHAR *config_file)
{
    ...
    if(sta->device_id == WIFI_HISI_HI1131C) {
        spawn_args[0]= "hisi_supplicant";
    }
