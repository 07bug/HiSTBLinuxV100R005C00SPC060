...
#define ADEC_MAX_UNCONSUMEBYTECNT 100       /* about 1s time not consume byte */
...
typedef struct
{
	...
	HI_BOOL                 bSonicCreated;
    ADEC_TPLAY_S            stTplayAttr;
    HI_VOID*                pSonic;
    FILE*                   pfEs;
    FILE*                   pfPcm;
    ADEC_INFO_S             decAttr;
    ...
    HI_U32 u32OutputDelay;          /**<Output delay for decoder.*/        /**<CNcomment:解码器输出的延时 */
} ADEC_CHAN_S;
...
HI_S32 ADEC_CheckTplayParam(HI_U32 u32SpeedInt, HI_U32 u32SpeedDeci);
