...
{
    CHECK_AENC_NULL_PTR(pstCapability);

    pstCapability->u32SupportTypeNum  = HI_UNF_AENC_MAX_TYPE;
    pstCapability->u32MaxAencInstance = AENC_INSTANCE_MAXNUM;
    pstCapability->stCapInfo[0].enCodecType = HA_AUDIO_ID_AAC;
