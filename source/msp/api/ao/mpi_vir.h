...
#ifndef  __MPI_VIR_H__
#define  __MPI_VIR_H__
...
#define CHECK_VIRTUAL_Track(track)                          \
    do {                                                    \
        ...
        {                                               \
            HI_INFO_AO("Virtual Track(0x%x) don't support this function\n", track);  \
            return HI_SUCCESS;                          \
        }                                               \
    } while(0)
...
#define CHECK_REAL_Track(track)                          \
    do {                                                    \
        ...
        {                                               \
            HI_ERR_AO("Real Track(0x%x) don't support this function\n", track);  \
            return HI_FAILURE;                          \
        }                                               \
    } while(0)
...
#define CHECK_Track(track)                          \
    do {                                                    \
        ...
        {                                               \
            HI_ERR_AO("Virtual Track(0x%x) don't support this function\n", track);  \
            return HI_FAILURE;                          \
        }                                               \
    } while(0)
