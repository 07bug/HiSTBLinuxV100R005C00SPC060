...
typedef enum CONFIG_TYPE_E
{
    ...
    CONFIG_SETATMOSLOCKOUTPUT = 0x00001005,
    CONFIG_SETCONTINUOUSOUTPUTWITHDEEPBUF = 0x00001006,
    CONFIG_GETAUDIOOUTPUTUSECASE = 0x00001007,
    CONFIG_BUTT,
} CONFIG_TYPE_E;
...
typedef struct _SETATMOSLOCK_CONFIG_S
{
    HI_BOOL bEnable;
} SETATMOSLOCK_CONFIG_S;

typedef struct
{
    HI_BOOL bEnable;
} SETDEEPBUFCONTINUOUSOUTPUT_CONFIG_S;

typedef struct
{
    HI_U32 u32UseCase;
} GETAUDIOOUTPUTUSECASE_CONFIG_S;
