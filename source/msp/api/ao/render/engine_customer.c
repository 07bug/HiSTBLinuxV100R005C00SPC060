...
HI_S32 PTSMUTEQUEUE_Add(HI_VOID* pHandle, HI_U32 u32StartPts, HI_U32 u32StopPts)
{
    ...
    u32WIdx = (pstPtsMute->u32Count + pstPtsMute->u32Index) & (ENGINE_MAX_PTS_MUTE_NUM - 1);

    pstPtsMute->stPtsMuteAttr[u32WIdx].u32StartPts = u32StartPts;
    pstPtsMute->stPtsMuteAttr[u32WIdx].u32StopPts = u32StopPts;
    pstPtsMute->stPtsMuteAttr[u32WIdx].bActivate = HI_FALSE;
