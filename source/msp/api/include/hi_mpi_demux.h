...
typedef struct hiMPI_ES_EXT_DATA_S
{
    HI_BOOL bValid;     /* valid flag of pesprivData */
    HI_U8 au8PesPrivData[PES_PRIVATE_DATA_SIZE];   /* pes private data section */
}HI_MPI_ES_EXT_DATA_S;
...
/* support multithread operate one ts buffer */
...
/* not support multithread operate one ts buffer */
...
HI_S32 HI_MPI_DMX_AcquireEs(HI_HANDLE hChannel, HI_UNF_ES_BUF_S *pAudioEsBuf, HI_MPI_ES_EXT_DATA_S *pEsExtData);
