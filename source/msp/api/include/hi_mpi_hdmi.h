...
/**HDMI suspend mode*/
/**CNcomment: HDMI 待机模式*/
typedef enum hiMPI_HDMI_SUSPEND_MODE_E
{
    HI_MPI_HDMI_SUSPEND_MODE_NONE = 0x00,       /**< Suspend none. *//**<CNcomment:无待机模式*/
    HI_MPI_HDMI_SUSPEND_MODE_FAKE,              /**< Suspend fake mode. *//**<CNcomment:假待机模式*/
    HI_MPI_HDMI_SUSPEND_MODE_REAL,              /**< Suspend real mode. *//**<CNcomment:真待机模式*/
}HI_MPI_HDMI_SUSPEND_MODE_E;
...
HI_S32 HI_MPI_HDMI_ComHdcpEnable(HI_UNF_HDMI_ID_E enHdmi,HI_UNF_HDMI_HDCP_PARAM_S *pstParm);
