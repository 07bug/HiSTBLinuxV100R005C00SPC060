...
#define HI_VDEC_SUPPORT_USERDATA_TYPE_NUM (2)
...
typedef struct hiVDEC_ES_BUF_S
{
    ...
    HI_BOOL bDualLayer;    /* 0: DV single Layer stream | 1 : DV Dual Layer stream*/
...
typedef struct hiVDEC_FRMSTATUSINFO_S
{
    ...
    HI_U32  u32FrameStoreNum;  /*decode frame store number*/
...
#if defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450)  || defined(CHIP_TYPE_hi3798mv310)
