...
static HI_S32 ProcFindAvalidDirIndex(HI_U8* pu8Index)
{
    ...
    strncpy(aPathName, PROC_OMXAUDIO_ABSOLUTE_PATH, sizeof(aPathName));
...
HI_S32 OMX_HA_PROC_Init(HI_AUDDATATYPE* pHAData)
{
    ...
    strncpy(aProcOmxName, PROC_OMXAUDIO_NODE_NAME, PROC_OMXAUDIO_NAME_LENGTH);
