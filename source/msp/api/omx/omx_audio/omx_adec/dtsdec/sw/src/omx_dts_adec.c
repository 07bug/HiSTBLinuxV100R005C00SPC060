                                        ...
                                        OMX_INOUT OMX_PTR     pParamStructure)
{
    ...
    switch ((HI_U32)nParamIndex)
    {
        ...
        {
            OMX_PORT_PARAM_TYPE* portParams = (OMX_PORT_PARAM_TYPE*)pParamStructure;

            portParams->nVersion.nVersion = OMX_VERSION;
            portParams->nPorts = 2;
            portParams->nSize = sizeof(OMX_PORT_PARAM_TYPE);
            portParams->nStartPortNumber = OMX_IN_PORT_IDX;
            break;
        }
