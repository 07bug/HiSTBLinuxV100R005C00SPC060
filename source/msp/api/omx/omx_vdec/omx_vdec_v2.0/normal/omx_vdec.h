...
#define METADATA_ALLOC_SIZE                (4 * 1024)
#define DEF_MIN_OUT_BUF_SIZE               (4 * 1024)
/***********************************************************************
   NOTICE!!
...
#define DEF_MAX_IN_BUF_CNT_ON_LIVE         (320)//(400)



#define MAX_IN_BUF_SLOT_NUM                (4)
#define MAX_IN_BUF_SLOT_NUM_ON_LIVE        (320)
...
enum {
    ...
    OMX_GENERATE_SYNTAX_ERROR           = 0x11,
    OMX_GENERATE_ERROR_RATIO_NOT_ZEOR   = 0x12,
    OMX_GENERATE_UNUSED                 = 0x13,
};
...
#ifdef ANDROID
    OMX_TUNNEL_INFO tunnel_infoo;
    ColorAspects usrAspects;
#endif
    OMXVDEC_DEC_COLOR_ASPECTS decAspects;
