...
HI_S32 Transfer_DispType(HI_UNF_DISP_HDR_TYPE_E* pU, HI_DRV_DISP_OUT_TYPE_E* pM, HI_BOOL bu2m)
{
    if (bu2m)
    {
        switch (*pU)
        {
            ...
            case HI_UNF_DISP_HDR_TYPE_AUTO:
            {
                *pM = HI_DRV_DISP_TYPE_AUTO;
                break;
            }
            ...
            case HI_UNF_DISP_HDR_TYPE_HLG:
            {
                *pM = HI_DRV_DISP_TYPE_HLG;
                break;
            }

            case HI_UNF_DISP_HDR_TYPE_AUTO_FOLLOW_FIRSTFRAME:
            {
                *pM = HI_DRV_DISP_TYPE_AUTO_FOLLOW_FIRSTFRAME;
                break;
            }
            default:
                *pM = HI_DRV_DISP_TYPE_NORMAL;
    ...
    else
    {
        switch (*pM)
        {
            ...
            {
                *pU = HI_UNF_DISP_HDR_TYPE_HLG;
                break;
            }

            case HI_DRV_DISP_TYPE_AUTO_FOLLOW_FIRSTFRAME:
            {
                *pU = HI_UNF_DISP_HDR_TYPE_AUTO_FOLLOW_FIRSTFRAME;
                break;
            }
...
HI_S32 Transfer_VbiCfg(HI_UNF_DISP_VBI_CFG_S *pU, HI_DRV_DISP_VBI_CFG_S *pM, HI_BOOL bu2m)
{
    if (bu2m)
    {
        switch (pU->enType)
        {
            case HI_UNF_DISP_VBI_TYPE_TTX:
                pM->eType = HI_DRV_DISP_VBI_TTX;
                break;

            case HI_UNF_DISP_VBI_TYPE_CC:
                pM->eType = HI_DRV_DISP_VBI_CC;
                break;
            case HI_UNF_DISP_VBI_TYPE_WSS:
                pM->eType = HI_DRV_DISP_VBI_WSS;
                break;
            case HI_UNF_DISP_VBI_TYPE_BUTT:
            default:
                pM->eType = HI_DRV_DISP_VBI_TYPE_BUTT;
                break;
        }
    ...
    else
    {
        switch (pM->eType)
        {
            case HI_DRV_DISP_VBI_TTX:
                pU->enType = HI_UNF_DISP_VBI_TYPE_TTX;
                break;

            case HI_DRV_DISP_VBI_CC:
                pU->enType = HI_UNF_DISP_VBI_TYPE_CC;
                break;
            case HI_DRV_DISP_VBI_WSS:
                pU->enType = HI_UNF_DISP_VBI_TYPE_WSS;
                break;
            case HI_DRV_DISP_VBI_TYPE_BUTT:
            default:
                pU->enType = HI_UNF_DISP_VBI_TYPE_BUTT;
                break;
        }
...
static HI_VOID TransferPixelFormatFromU2M(HI_UNF_VIDEO_FORMAT_E  *pU, HI_DRV_PIX_FORMAT_E *pM)
{
    switch (*pU)
    {
        ...
        *pM = HI_DRV_PIX_FMT_YUV_444;
        ...
        break;
        case HI_UNF_FORMAT_RGB_888:
            *pM = HI_DRV_PIX_FMT_RGB24;
        break;
        case HI_UNF_FORMAT_ARGB_8888:
            *pM = HI_DRV_PIX_FMT_ARGB8888;
        break;
        default:
        return ;
    }
...
static HI_VOID TransferPixelFormatFromM2U(HI_UNF_VIDEO_FORMAT_E  *pU, HI_DRV_PIX_FORMAT_E *pM)
{
    switch (*pM)
    {
        ...
        *pU = HI_UNF_FORMAT_YUV_SEMIPLANAR_420_UV;
        ...
        case HI_DRV_PIX_FMT_RGB24:
            *pU = HI_UNF_FORMAT_RGB_888;
        break;
        case HI_DRV_PIX_FMT_ARGB8888:
            *pU = HI_UNF_FORMAT_ARGB_8888;
        break;
        default:
        return;
...
HI_S32 Transfer_VideoFormat(HI_UNF_VIDEO_FORMAT_E  *pU, HI_DRV_PIX_FORMAT_E *pM, HI_BOOL bu2m)
{
    if (bu2m)
    {
        TransferPixelFormatFromU2M(pU, pM);
    }
    else
    {
        TransferPixelFormatFromM2U(pU, pM);
    }
...
HI_S32 Transfe_FrostMode(HI_UNF_WINDOW_FROST_E *pU, HI_DRV_WINDOW_FROST_E *pM, HI_BOOL bu2m)
{
    if (bu2m)
    {
        switch(*pU)
        {
            case HI_UNF_WINDOW_FROST_CLOSE:
                *pM = HI_DRV_WINDOW_FROST_CLOSE;
                break;
            case HI_UNF_WINDOW_FROST_LOW:
                *pM = HI_DRV_WINDOW_FROST_LOW;
                break;
            case HI_UNF_WINDOW_FROST_MIDDLE:
                *pM = HI_DRV_WINDOW_FROST_MIDDLE;
                break;
            case HI_UNF_WINDOW_FROST_HIGH:
                *pM = HI_DRV_WINDOW_FROST_HIGH;
                 break;
            default:
                *pM = HI_DRV_WINDOW_FROST_CLOSE;
                 break;
    ...
    else
    {
        switch(*pM)
        {
            case HI_DRV_WINDOW_FROST_CLOSE:
                *pU = HI_UNF_WINDOW_FROST_CLOSE;
                break;
            case HI_DRV_WINDOW_FROST_LOW:
                *pU = HI_UNF_WINDOW_FROST_LOW;
                break;
            case HI_DRV_WINDOW_FROST_MIDDLE:
                *pU = HI_UNF_WINDOW_FROST_MIDDLE;
                break;
            case HI_DRV_WINDOW_FROST_HIGH:
                *pU = HI_UNF_WINDOW_FROST_HIGH;
                 break;
            default:
                *pU = HI_UNF_WINDOW_FROST_CLOSE;
                 break;
...
HI_S32 Transfe_SwitchMode(HI_UNF_WINDOW_FREEZE_MODE_E *pU, HI_DRV_WIN_SWITCH_E *pM, HI_BOOL bu2m)
{
    if (bu2m)
    {
        switch (*pU)
        {
            case HI_UNF_WINDOW_FREEZE_MODE_LAST:
                *pM = HI_DRV_WIN_SWITCH_LAST;
                break;
            case HI_UNF_WINDOW_FREEZE_MODE_BLACK:
                *pM = HI_DRV_WIN_SWITCH_BLACK;
                break;
            case HI_UNF_WINDOW_FREEZE_MODE_BUTT:
                *pM = HI_DRV_WIN_SWITCH_BUTT;
                break;
            default:
                *pM = HI_DRV_WIN_SWITCH_BUTT;
                break;
    ...
    else
    {
        switch (*pM)
        {
            case HI_DRV_WIN_SWITCH_LAST:
                *pU = HI_UNF_WINDOW_FREEZE_MODE_LAST;
                break;
            case HI_DRV_WIN_SWITCH_BLACK:
                *pU = HI_UNF_WINDOW_FREEZE_MODE_BLACK;
                break;
            case HI_DRV_WIN_SWITCH_BUTT:
                *pU = HI_UNF_WINDOW_FREEZE_MODE_BUTT;
                break;
            default:
                *pU = HI_UNF_WINDOW_FREEZE_MODE_BUTT;
                break;
...
HI_S32 Transfer_Frame(HI_UNF_VIDEO_FRAME_INFO_S  *pU, HI_DRV_VIDEO_FRAME_S *pM, HI_BOOL bu2m)
{
    ...
    if (bu2m)
    {
        ...
        if ((pU->enVideoFormat >= HI_UNF_FORMAT_RGB_BUTT)
...
HI_S32 Transfer_DispColorSpace(HI_UNF_DISP_COLOR_SPACE_E* pU, HI_DRV_DISP_COLOR_SPACE_E* pM, HI_BOOL bu2m)
{
    if (bu2m)
    {
        switch (*pU)
        {
            case HI_UNF_DISP_COLOR_SPACE_BT601:
            {
                *pM = HI_DRV_DISP_COLOR_SPACE_BT601;
                break;
            }

            case HI_UNF_DISP_COLOR_SPACE_BT709:
            {
                *pM = HI_DRV_DISP_COLOR_SPACE_BT709;
                break;
            }

            case HI_UNF_DISP_COLOR_SPACE_BT2020:
            {
                *pM = HI_DRV_DISP_COLOR_SPACE_BT2020;
                break;
            }

            case HI_UNF_DISP_COLOR_SPACE_AUTO:
            {
                *pM = HI_DRV_DISP_COLOR_SPACE_AUTO;
                break;
            }
    ...
    else
    {
        switch (*pM)
        {
            case HI_DRV_DISP_COLOR_SPACE_BT601:
            {
                *pU = HI_UNF_DISP_COLOR_SPACE_BT601;
                break;
            }

            case HI_DRV_DISP_COLOR_SPACE_BT709:
            {
                *pU = HI_UNF_DISP_COLOR_SPACE_BT709;
                break;
            }

            case HI_DRV_DISP_COLOR_SPACE_BT2020:
            {
                *pU = HI_UNF_DISP_COLOR_SPACE_BT2020;
                break;
            }

            case HI_DRV_DISP_COLOR_SPACE_AUTO:
            {
                *pU = HI_UNF_DISP_COLOR_SPACE_AUTO;
                break;
            }
