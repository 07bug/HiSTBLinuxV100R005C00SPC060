...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    fifo_latency          : 7   ; /* [16..10]  */
        unsigned int    fifo_latency_real     : 7   ; /* [23..17]  */
        unsigned int    fifo_bypass           : 1   ; /* [24]  */
        unsigned int    Reserved_22           : 7   ; /* [31..25]  */
    } bits;
...
typedef struct
{
    ...
    volatile unsigned int         AIP_RESERVED[0x60 / 4 - 23]; // max = 24
} S_AIP_REGS_TYPE;
