...
#if   (defined(CHIP_TYPE_hi3798cv200) && !defined(HI_TEE_SUPPORT) &&  !defined(HI_DRV_WORK_IN_NON_SECURE_MODE))  \
   || (defined(CHIP_TYPE_hi3798mv200) && !defined(HI_TEE_SUPPORT) &&  !defined(HI_DRV_WORK_IN_NON_SECURE_MODE))  \
   || (defined(CHIP_TYPE_hi3798mv300) && !defined(HI_TEE_SUPPORT) &&  !defined(HI_DRV_WORK_IN_NON_SECURE_MODE))  \
   || (defined(CHIP_TYPE_hi3798mv310) && !defined(HI_TEE_SUPPORT) &&  !defined(HI_DRV_WORK_IN_NON_SECURE_MODE))
...
#define CA_V300_SEC_STORE_KL_CTRL      (CA_V300_BASE_ADDR + 0x198)//CAUK¿ØÖÆ¼Ä´æÆ÷
#define CA_V300_KL_SEC_EN              (CA_V300_BASE_ADDR + 0x200) // secure keyladder enable
#define CA_V300_MISC_RK_SEL            (CA_V300_BASE_ADDR + 0x338)
...
typedef union
{
    struct
    {
        HI_U32 level_sel      : 2; //[1:0]
        HI_U32 tdes_aes_sel   : 1; //[2]
        HI_U32 payload_mode   : 1; //[3]          //used for 98mv310
        HI_U32 reserved0      : 3; //[6:4]
        HI_U32 sm4_sel        : 1; //[7]          //used for 98mv310
...
typedef union
{
    ...
    {
        HI_U32 level_sel      : 2; //[1:0]
        HI_U32 tdes_aes_sel   : 1; //[2]          //used for 98mv310
...
typedef union
{
    struct
    {
        ...
        HI_U32 model_sel               : 1; //[5]          //new added for 98mv310
        HI_U32 module_id_sel           : 1; //[6]          //new added for 98mv310
        HI_U32 sm4_sel                 : 1; //[7]          //new added for 98mv310
        HI_U32 profile_sel             : 4; //[11:8]       //new added for 98mv310
