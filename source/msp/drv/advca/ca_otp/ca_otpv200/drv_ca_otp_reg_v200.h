...
typedef union
{
    struct
    {
        ...
        HI_U32 SecCpuMode_0             : 1; //0x1a[6]
        HI_U32 SecCpuMode_1             : 1; //0x1a[7]
...
#define JTAG_MODE_BAK_C6_PROTECT                 (0x63)
...
#define CA_OTP_V200_INTERNAL_DBG_PORT_MODE        (0X1B)
#endif
...
typedef union
{
    struct
    {
        ...
        HI_U32 stbsn1_lock              : 1;//  0x10[5]
        HI_U32 stbsn2_lock              : 1;//  0x10[6]
        HI_U32 stbsn3_lock              : 1;//  0x10[7] used as ITCSA3_IMLB LOCK
        HI_U32 msid_lock                : 1;//  0x11[0]
        HI_U32 version_id_lock          : 1;//  0x11[1]
