...
HI_S32 DRV_CA_OTP_V200_Set_UniqueSOSMarketId(HI_U8 *pu8Id)
{
    HI_S32    ret = HI_SUCCESS;
    CA_OTP_V200_INTERNAL_DATALOCK_0_U DataLock_0;
    HI_U32 i = 0;
    ...
    DataLock_0.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_DATALOCK_0);
    if (1 == DataLock_0.bits.stbsn1_lock)
    {
        /*if market Id has been set, HI_ERR_CA_SETPARAM_AGAIN should be returned*/
        return HI_ERR_CA_SETPARAM_AGAIN;
    }
    ...
    for ( i = 0 ; i < 4 ; i++ )
    {
        ret = (g_pOTPExportFunctionList->HAL_OTP_V200_WriteByte)(CA_OTP_V200_INTERNAL_STB_SN_1 + i, pu8Id[i]);
        if (HI_SUCCESS != ret)
        {
            HI_ERR_CA("Fail to write OTP!\n");
            return ret;
...
HI_S32 DRV_CA_OTP_V200_Set_UniqueREEMarketId(HI_U8 *pu8Id)
{
    HI_S32    ret = HI_SUCCESS;
    CA_OTP_V200_INTERNAL_DATALOCK_0_U DataLock_0;
    HI_U32 i = 0;
    ...
    DataLock_0.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_DATALOCK_0);
    if (1 == DataLock_0.bits.stbsn2_lock)
    {
        /*if market Id has been set, HI_ERR_CA_SETPARAM_AGAIN should be returned*/
        return HI_ERR_CA_SETPARAM_AGAIN;
    }
    ...
    for ( i = 0 ; i < 4 ; i++ )
    {
        ret = (g_pOTPExportFunctionList->HAL_OTP_V200_WriteByte)(CA_OTP_V200_INTERNAL_STB_SN_2 + i, pu8Id[i]);
        if (HI_SUCCESS != ret)
        {
            HI_ERR_CA("Fail to write OTP!\n");
            return ret;
...
HI_S32 DRV_CA_OTP_V200_Get_UniqueSOSMarketId(HI_U8 *pu8MarketID)
{
    HI_U32    i   = 0;
    HI_S32    ret = HI_SUCCESS;
    ...
    for ( i = 0 ; i < 4 ; i++ )
    {
        pu8MarketID[i] = (g_pOTPExportFunctionList->HAL_OTP_V200_ReadByte)(CA_OTP_V200_INTERNAL_STB_SN_1 + i);
    }

    return ret;
}

HI_S32 DRV_CA_OTP_V200_Get_UniqueREEMarketId(HI_U8 *pu8MarketID)
{
    HI_U32    i   = 0;
    HI_S32    ret = HI_SUCCESS;
    ...
    for ( i = 0 ; i < 4 ; i++ )
    {
        pu8MarketID[i] = (g_pOTPExportFunctionList->HAL_OTP_V200_ReadByte)(CA_OTP_V200_INTERNAL_STB_SN_2 + i);
    }
...
#if defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798mv200) \
...
HI_S32 DRV_CA_OTP_V200_SetBootMode(CA_OTP_FLASH_TYPE_E type)
{
    ...
    switch (type)
    {
        ...
        case HI_UNF_ADVCA_FLASH_TYPE_SPI_NAND:
            ...
            PV_1.bits.boot_mode_sel_2 = 1;
            break;
#elif defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798mv310)
        case HI_UNF_ADVCA_FLASH_TYPE_SPI:
            PV_0.bits.boot_mode_sel_0 = 0;
            PV_0.bits.boot_mode_sel_1 = 0;
            PV_1.bits.boot_mode_sel_2 = 0;
        ...
        case HI_UNF_ADVCA_FLASH_TYPE_SPI_NAND:
            ...
            PV_1.bits.boot_mode_sel_2 = 1;
            break;
#elif defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100) || defined(CHIP_TYPE_hi3716cv200)
    ...
    PVLOCK_0.u32 = 0;
    PVLOCK_1.u32 = 0;
#if defined (CHIP_TYPE_hi3716mv420) || defined (CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798mv200) \
        || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798mv310)
...
#if defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100) || defined(CHIP_TYPE_hi3716cv200)
...
HI_S32 DRV_CA_OTP_V200_SetJtagProtectMode(CA_OTP_JTAG_MODE_E JtagMode)
{
    ...
    switch (JtagMode)
    {
        ...
        case CA_OTP_JTAG_MODE_PROTECT :
        {
            ...
            {
                u32ProtectBak = JTAG_MODE_BAK_C6_PROTECT;
            }
            else
            {
...
HI_S32 DRV_CA_OTP_V200_SetOTPTzData(CA_OTP_TZ_DATA_S *pstInputParam)
{
    ...
    if( (CA_OTP_V200_INTERNAL_TZ_OTP_BASE > u32Start)
     ...
     || ((CA_OTP_V200_INTERNAL_SEC_OTP_END - CA_OTP_V200_INTERNAL_TZ_OTP_BASE) < u32Round) )
    {
...
HI_S32 DRV_CA_OTP_V200_GetOTPTzData(CA_OTP_TZ_DATA_S *pstInputParam)
{
    ...
    if( (CA_OTP_V200_INTERNAL_TZ_OTP_BASE > u32Addr)
     || ((CA_OTP_V200_INTERNAL_SEC_OTP_END - CA_OTP_V200_INTERNAL_TZ_OTP_BASE) < u32Len)
     || ((CA_OTP_V200_INTERNAL_SEC_OTP_END) < (u32Addr + u32Len)) )
    {
        HI_ERR_CA("Invalid address or length!\n");
        return HI_FAILURE;
    }
...
HI_S32 DRV_CA_OTP_V200_SetMiscKlLevel(HI_UNF_ADVCA_KEYLADDER_LEV_E enLevel)
{
    HI_S32 ret = HI_SUCCESS;
    CA_OTP_V200_INTERNAL_PV_1_U PV_1;
    CA_OTP_V200_INTERNAL_PV_1_U PV_2;
    CA_OTP_V200_INTERNAL_PVLOCK_1_U PVLOCK_1;

    if((HI_UNF_ADVCA_KEYLADDER_LEV2 > enLevel) || (HI_UNF_ADVCA_KEYLADDER_LEV5 < enLevel))
    {
        HI_ERR_CA("Check set misc keyladder level failed. keyladder level=%d\n", enLevel+1);
        return HI_FAILURE;
    }
    /* read OTP */
    PVLOCK_1.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_PVLOCK_1);
    ...
    {
        /*keyladder level = (misc_lv_sel_2*2 + misc_lv_sel) + HI_UNF_ADVCA_KEYLADDER_LEV2*/
        if(PV_1.bits.misc_lv_sel_2*2 + PV_1.bits.misc_lv_sel + HI_UNF_ADVCA_KEYLADDER_LEV2 == enLevel)
        {
            return HI_SUCCESS;
        }
        else
        {
            HI_ERR_CA("misc keyladder level is locked\n");
            return HI_FAILURE;
        }
    }

    PV_2.bits.misc_lv_sel = (enLevel - HI_UNF_ADVCA_KEYLADDER_LEV2) % 2;
    PV_2.bits.misc_lv_sel_2 = (enLevel - HI_UNF_ADVCA_KEYLADDER_LEV2) / 2;

    //write OTP control bit
    if((0x01 == PVLOCK_1.bits.misc_lv_sel_lock) && (PV_2.bits.misc_lv_sel != PV_1.bits.misc_lv_sel))
    {
        HI_ERR_CA("misc keyladder level low bit is locked\n");
        return HI_FAILURE;
    }
    if((0x01 == PVLOCK_1.bits.misc_lv_sel_2_lock) && (PV_2.bits.misc_lv_sel_2 != PV_1.bits.misc_lv_sel_2))
    {
        HI_ERR_CA("misc keyladder level high bit is locked\n");
        return HI_FAILURE;
    }
...
HI_S32 DRV_CA_OTP_V200_Get_VMXBLFuse(HI_U32 *pu32Value)
{
    ...
    PV_1.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_PV_1);
    *pu32Value = PV_1.bits.c6_bl_fuse;
...
HI_S32 DRV_CA_OTP_V200_SetItCsa3Enable(HI_U32 u32Enable)
{
    ...
    PVLOCK_0.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_PVLOCK_0);
    if (1 == PVLOCK_0.bits.mc_rc4_hardonly_en)
    {
        PV_0.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_PV_0);
        if (u32Enable == PV_0.bits.mc_rc4_hardonly_en)
        {
            /*value already set to the right one, return HI_SUCCESS*/
            return HI_SUCCESS;
        }
    ...
    {
        PV_0.u32 = 0;
        PV_0.bits.mc_rc4_hardonly_en = 1;
        ret = (g_pOTPExportFunctionList->HAL_OTP_V200_Write)(CA_OTP_V200_INTERNAL_PV_0, PV_0.u32);
        if (HI_SUCCESS != ret)
        {
            HI_ERR_CA("Fail to write OTP!\n");
    ...
    /*lock value*/
    PVLOCK_0.u32 = 0;
    PVLOCK_0.bits.mc_rc4_hardonly_en = 1;
    ret = (g_pOTPExportFunctionList->HAL_OTP_V200_Write)(CA_OTP_V200_INTERNAL_PVLOCK_0, PVLOCK_0.u32);
    if (HI_SUCCESS != ret)
    {
        HI_ERR_CA("Fail to write OTP!\n");
...
HI_S32 DRV_CA_OTP_V200_GetItCsa3Enable(HI_U32 *pu32Enable)
{
    ...
    PV_0.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_PV_0);
    *pu32Enable = PV_0.bits.mc_rc4_hardonly_en;
...
HI_S32 DRV_CA_OTP_V200_SetITCSA3IMLB(HI_U8 *pu8IMLB)
{
    ...
    DataLock_0.u32 = (g_pOTPExportFunctionList->HAL_OTP_V200_Read)(CA_OTP_V200_INTERNAL_DATALOCK_0);
    if (1 == DataLock_0.bits.stbsn3_lock)
    {
...
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SECURE_BOOT_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_SUCCESS;

    if (pstOtpAttr->unOtpFuseAttr.stEnableSecureBoot.bEnable)
    {
        ret = DRV_CA_OTP_V200_SetSCSActive();
        if(HI_SUCCESS == ret)
        {
            ret = DRV_CA_OTP_V200_SetBootMode(pstOtpAttr->unOtpFuseAttr.stEnableSecureBoot.enFlashType);
        }
        if(HI_SUCCESS == ret)
        {
...
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SECURE_BOOT_ACTIVATION_ONLY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_SUCCESS;

    if (pstOtpAttr->unOtpFuseAttr.stDefaultAttr.bEnable)
    {
        ret = DRV_CA_OTP_V200_SetSCSActive();
    }
    return ret;
...
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_BOOT_FLASH_TYPE(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_SUCCESS;

    if (pstOtpAttr->unOtpFuseAttr.stBootFlashType.bBootSelCtrl)
    {
        ret = DRV_CA_OTP_V200_SetBootMode((CA_OTP_FLASH_TYPE_E)pstOtpAttr->unOtpFuseAttr.stBootFlashType.enFlashType);
        if (HI_SUCCESS == ret)
        {
            ret = DRV_CA_OTP_V200_SetBootSelCtrl(1);
        }
...
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_BOOT_DECRYPTION_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetBloadDecEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_BOOT_ENCRYPTION_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetBloadEncDisable(pstOtpAttr->unOtpFuseAttr.stDefaultAttr.bEnable);
}
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SELF_BOOT_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_DisableSelfBoot(HI_TRUE);
}
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_DDR_WAKEUP_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetLowPowerDisable(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA2_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return HAL_ADVCA_V300_SetCWLadderLevel(pstOtpAttr->unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_R2R_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return HAL_ADVCA_V300_SetR2RLadderLevel(pstOtpAttr->unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SP_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return HAL_ADVCA_V300_SetSPLadderLevel(pstOtpAttr->unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA3_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetCSA3LadderLevel(pstOtpAttr->unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_LP_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_DisableLinkProtect();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA2_CW_HARDONLY_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_LockHardCwSel();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SP_CW_HARDONLY_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetTSSPEHardonlyEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA3_CW_HARDONLY_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetTSCSA3HardonlyEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA2_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetTSCWDeactive(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SP_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetTSSPDeactive(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA3_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetTSCSA3Deactive(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_MISC_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetMiscKLDisable(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_GOOGLE_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetGgKLDisable(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_DCAS_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetDcasKLDisable(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_DDR_SCRAMBLE_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetDDRScrambleEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_GLOBAL_LOCK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetOtpGlobalLockEn(pstOtpAttr->unOtpFuseAttr.stDefaultAttr.bEnable);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_RUNTIME_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetRuntimeCheckEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_DDR_WAKEUP_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetWakeupDDRCheckEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_VERSION_ID_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetVersionIdCheckEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_BOOT_MSID_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetBlMSIDCheckEn(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_JTAG_MODE(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetJtagProtectMode(pstOtpAttr->unOtpFuseAttr.stJtagPrtMode.enJtagMode);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_JTAG_READ_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetJtagReadDisable();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA2_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetCSA2RootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_R2R_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetR2RRootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SP_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetSPRootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CSA3_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetCSA3RootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_MISC_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetMISCRootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_OEM_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetOEMRootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_JTAG_KEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetJtagKey(pstOtpAttr->unOtpFuseAttr.stJtagKey.u8JtagKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_CHIP_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetUniqueChipId(pstOtpAttr->unOtpFuseAttr.stChipId.au8ChipId);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_ESCK_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetESCK(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_MARKET_SEGMENT_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_SUCCESS;
    HI_U8 u8TmpBuf[512];
    HI_U8 *pu8TmBuf = NULL;
    ...
    pu8TmBuf = pstOtpAttr->unOtpFuseAttr.stMarketId.u8MSID;
...
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SOS_MARKET_SEGMENT_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_SUCCESS;
    HI_U8 u8TmpBuf[512];
    HI_U8 *pu8TmBuf = NULL;
    ...
    u8TmpBuf[2] = pu8TmBuf[1];
    u8TmpBuf[3] = pu8TmBuf[0];
    ret = DRV_CA_OTP_V200_Set_UniqueSOSMarketId(u8TmpBuf);

    return ret;
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_REE_MARKET_SEGMENT_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_SUCCESS;
    HI_U8 u8TmpBuf[512];
    HI_U8 *pu8TmBuf = NULL;
    ...
    u8TmpBuf[2] = pu8TmBuf[1];
    u8TmpBuf[3] = pu8TmBuf[0];
    ret = DRV_CA_OTP_V200_Set_UniqueREEMarketId(u8TmpBuf);

    return ret;
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_VERSION_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_U8 u8TmpBuf[512];
    HI_U8 *pu8TmBuf = NULL;

    pu8TmBuf = pstOtpAttr->unOtpFuseAttr.stVersionId.u8VersionId;
    memset(u8TmpBuf, 0, sizeof(u8TmpBuf));
    u8TmpBuf[0] = pu8TmBuf[3];
    u8TmpBuf[1] = pu8TmBuf[2];
    u8TmpBuf[2] = pu8TmBuf[1];
    u8TmpBuf[3] = pu8TmBuf[0];
    return DRV_CA_OTP_V200_Set_UniqueVersionId(u8TmpBuf);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_MISC_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return HAL_ADVCA_V300_SetMiscKlLevel(pstOtpAttr->unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_VMX_BL_FUSE(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_Set_VMXBLFuse();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_IRDETO_ITCSA3_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetItCsa3Enable(HI_TRUE);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_BOOTINFO_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetBootInfoDisable();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_ITCSA3_IMLB(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetITCSA3IMLB(pstOtpAttr->unOtpFuseAttr.stItCsa3IMLB.au8ItCsa3IMLB);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_RSA_KEY_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
...
static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SERIAL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetUARTDisable();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_ETHERNET_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetEthernetDisable();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SM4_CRYPTO_ENGINE_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetSM4Disable();
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_TDES_CRYPTO_ENGINE_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetTDESDisable();
}
#endif

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_BOOT_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetBootRootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static HI_S32 DRV_CA_OTP_V200_SetOtpFuse_SEC_STORE_ROOTKEY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    return DRV_CA_OTP_V200_SetSecStoreRootKey(pstOtpAttr->unOtpFuseAttr.stKeyladderRootKey.u8RootKey);
}

static DRV_ADVCA_OTP_FUSE_FUNC_MAP_S g_astSetOtpFuseFuncMap[] =
{
    {HI_UNF_ADVCA_OTP_NULL   ,                           HI_NULL},
    {HI_UNF_ADVCA_OTP_SECURE_BOOT_ACTIVATION,            DRV_CA_OTP_V200_SetOtpFuse_SECURE_BOOT_ACTIVATION},
    {HI_UNF_ADVCA_OTP_BOOT_DECRYPTION_ACTIVATION,        DRV_CA_OTP_V200_SetOtpFuse_BOOT_DECRYPTION_ACTIVATION},
    {HI_UNF_ADVCA_OTP_SELF_BOOT_DEACTIVATION,            DRV_CA_OTP_V200_SetOtpFuse_SELF_BOOT_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_DDR_WAKEUP_DEACTIVATION,           DRV_CA_OTP_V200_SetOtpFuse_DDR_WAKEUP_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_KL_LEVEL_SEL,                 DRV_CA_OTP_V200_SetOtpFuse_CSA2_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_R2R_KL_LEVEL_SEL,                  DRV_CA_OTP_V200_SetOtpFuse_R2R_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_SP_KL_LEVEL_SEL,                   DRV_CA_OTP_V200_SetOtpFuse_SP_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_CSA3_KL_LEVEL_SEL,                 DRV_CA_OTP_V200_SetOtpFuse_CSA3_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_LP_DEACTIVATION,                   DRV_CA_OTP_V200_SetOtpFuse_LP_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_CW_HARDONLY_ACTIVATION,       DRV_CA_OTP_V200_SetOtpFuse_CSA2_CW_HARDONLY_ACTIVATION},
    {HI_UNF_ADVCA_OTP_SP_CW_HARDONLY_ACTIVATION,         DRV_CA_OTP_V200_SetOtpFuse_SP_CW_HARDONLY_ACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA3_CW_HARDONLY_ACTIVATION,       DRV_CA_OTP_V200_SetOtpFuse_CSA3_CW_HARDONLY_ACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_KL_DEACTIVATION,              DRV_CA_OTP_V200_SetOtpFuse_CSA2_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_SP_KL_DEACTIVATION,                DRV_CA_OTP_V200_SetOtpFuse_SP_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA3_KL_DEACTIVATION,              DRV_CA_OTP_V200_SetOtpFuse_CSA3_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_MISC_KL_DEACTIVATION,              DRV_CA_OTP_V200_SetOtpFuse_MISC_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_GOOGLE_KL_DEACTIVATION,            DRV_CA_OTP_V200_SetOtpFuse_GOOGLE_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_DCAS_KL_DEACTIVATION,              DRV_CA_OTP_V200_SetOtpFuse_DCAS_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_DDR_SCRAMBLE_ACTIVATION,           DRV_CA_OTP_V200_SetOtpFuse_DDR_SCRAMBLE_ACTIVATION},
    {HI_UNF_ADVCA_OTP_GLOBAL_LOCK_ACTIVATION,            DRV_CA_OTP_V200_SetOtpFuse_GLOBAL_LOCK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_RUNTIME_CHECK_ACTIVATION,          DRV_CA_OTP_V200_SetOtpFuse_RUNTIME_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_DDR_WAKEUP_CHECK_ACTIVATION,       DRV_CA_OTP_V200_SetOtpFuse_DDR_WAKEUP_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_VERSION_ID_CHECK_ACTIVATION,       DRV_CA_OTP_V200_SetOtpFuse_VERSION_ID_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_BOOT_MSID_CHECK_ACTIVATION,        DRV_CA_OTP_V200_SetOtpFuse_BOOT_MSID_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_JTAG_MODE,                         DRV_CA_OTP_V200_SetOtpFuse_JTAG_MODE},
    {HI_UNF_ADVCA_OTP_JTAG_READ_DEACTIVATION,            DRV_CA_OTP_V200_SetOtpFuse_JTAG_READ_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_ROOTKEY,                      DRV_CA_OTP_V200_SetOtpFuse_CSA2_ROOTKEY},
    {HI_UNF_ADVCA_OTP_R2R_ROOTKEY,                       DRV_CA_OTP_V200_SetOtpFuse_R2R_ROOTKEY},
    {HI_UNF_ADVCA_OTP_SP_ROOTKEY,                        DRV_CA_OTP_V200_SetOtpFuse_SP_ROOTKEY},
    {HI_UNF_ADVCA_OTP_CSA3_ROOTKEY,                      DRV_CA_OTP_V200_SetOtpFuse_CSA3_ROOTKEY},
    {HI_UNF_ADVCA_OTP_MISC_ROOTKEY,                      DRV_CA_OTP_V200_SetOtpFuse_MISC_ROOTKEY},
    {HI_UNF_ADVCA_OTP_OEM_ROOTKEY,                       DRV_CA_OTP_V200_SetOtpFuse_OEM_ROOTKEY},
    {HI_UNF_ADVCA_OTP_ESCK_ROOTKEY,                      DRV_CA_OTP_V200_SetOtpFuse_ESCK_ROOTKEY},
    {HI_UNF_ADVCA_OTP_JTAG_KEY,                          DRV_CA_OTP_V200_SetOtpFuse_JTAG_KEY},
    {HI_UNF_ADVCA_OTP_CHIP_ID,                           DRV_CA_OTP_V200_SetOtpFuse_CHIP_ID},
    {HI_UNF_ADVCA_OTP_MARKET_SEGMENT_ID,                 DRV_CA_OTP_V200_SetOtpFuse_MARKET_SEGMENT_ID},
    {HI_UNF_ADVCA_OTP_VERSION_ID,                        DRV_CA_OTP_V200_SetOtpFuse_VERSION_ID},
    {HI_UNF_ADVCA_OTP_MISC_KL_LEVEL_SEL,                 DRV_CA_OTP_V200_SetOtpFuse_MISC_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_VMX_BL_FUSE,                       DRV_CA_OTP_V200_SetOtpFuse_VMX_BL_FUSE},
    ...
    {HI_UNF_ADVCA_OTP_SM4_CRYPTO_ENGINE_DEACTIVATION,    DRV_CA_OTP_V200_SetOtpFuse_SM4_CRYPTO_ENGINE_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_TDES_CRYPTO_ENGINE_DEACTIVATION,   DRV_CA_OTP_V200_SetOtpFuse_TDES_CRYPTO_ENGINE_DEACTIVATION},
#else
    {HI_UNF_ADVCA_OTP_USB_DEACTIVATION,                  HI_NULL},
    {HI_UNF_ADVCA_OTP_SERIAL_DEACTIVATION,               HI_NULL},
    {HI_UNF_ADVCA_OTP_ETHERNET_DEACTIVATION,             HI_NULL},
    {HI_UNF_ADVCA_OTP_SM4_CRYPTO_ENGINE_DEACTIVATION,    HI_NULL},
    {HI_UNF_ADVCA_OTP_TDES_CRYPTO_ENGINE_DEACTIVATION,   HI_NULL},
#endif
    {HI_UNF_ADVCA_OTP_SECURE_BOOT_ACTIVATION_ONLY,       DRV_CA_OTP_V200_SetOtpFuse_SECURE_BOOT_ACTIVATION_ONLY},
    {HI_UNF_ADVCA_OTP_BOOT_FLASH_TYPE,                   DRV_CA_OTP_V200_SetOtpFuse_BOOT_FLASH_TYPE},
    {HI_UNF_ADVCA_OTP_RSA_KEY_LOCK_FLAG,                 DRV_CA_OTP_V200_SetOtpFuse_RSA_KEY_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_STBSN_LOCK_FLAG,                   HI_NULL},
    {HI_UNF_ADVCA_OTP_MSID_LOCK_FLAG,                    HI_NULL},
    {HI_UNF_ADVCA_OTP_VERSIONID_LOCK_FLAG,               HI_NULL},
    {HI_UNF_ADVCA_OTP_OEM_ROOTKEY_LOCK_FLAG,             HI_NULL},
    {HI_UNF_ADVCA_OTP_R2R_ROOTKEY_LOCK_FLAG,             HI_NULL},
    {HI_UNF_ADVCA_OTP_JTAG_KEY_LOCK_FLAG,                HI_NULL},
    {HI_UNF_ADVCA_OTP_TZ_AREA_LOCK_FLAG,                 HI_NULL},
    {HI_UNF_ADVCA_OTP_BOOT_ENCRYPTION_DEACTIVATION,      DRV_CA_OTP_V200_SetOtpFuse_BOOT_ENCRYPTION_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_BOOT_ROOTKEY,                      DRV_CA_OTP_V200_SetOtpFuse_BOOT_ROOTKEY},
    {HI_UNF_ADVCA_OTP_SEC_STORE_ROOTKEY,                 DRV_CA_OTP_V200_SetOtpFuse_SEC_STORE_ROOTKEY},
    {HI_UNF_ADVCA_OTP_BOOT_ROOTKEY_LOCK_FLAG,            HI_NULL},
    {HI_UNF_ADVCA_OTP_SEC_STORE_ROOTKEY_LOCK_FLAG,       HI_NULL},
    {HI_UNF_ADVCA_OTP_SOS_MSID,             DRV_CA_OTP_V200_SetOtpFuse_SOS_MARKET_SEGMENT_ID},
    {HI_UNF_ADVCA_OTP_REE_MSID,             DRV_CA_OTP_V200_SetOtpFuse_REE_MARKET_SEGMENT_ID},
};

HI_S32 DRV_CA_OTP_V200_SetOtpFuse(CA_OTP_ATTR_S *pstOtpAttr)
{
    if (HI_NULL == pstOtpAttr)
    {
        HI_ERR_CA("Invalid parameter\n");
        return HI_FAILURE;
    }
    if (pstOtpAttr->enOtpFuseId >= HI_UNF_ADVCA_OTP_FUSE_BUTT)
    {
        HI_ERR_CA("invalid OTP fuse ID: %d\n", pstOtpAttr->enOtpFuseId);
        return HI_FAILURE;
    }
    if (HI_NULL == g_astSetOtpFuseFuncMap[pstOtpAttr->enOtpFuseId].pfnOtpFuse)
    {
        HI_ERR_CA("not support fuse ID: %d\n", pstOtpAttr->enOtpFuseId);
        return HI_ERR_CA_NOT_SUPPORT;
    }

    return g_astSetOtpFuseFuncMap[pstOtpAttr->enOtpFuseId].pfnOtpFuse(&(pstOtpAttr->stOtpAttr));
}

static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SECURE_BOOT_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    ...
    if (ret != HI_SUCCESS)
    {
        HI_ERR_CA("DRV_CA_OTP_V200_GetSCSActive failed, ret: 0x%x\n", ret);
        return ret;
    }
    ret = DRV_CA_OTP_V200_GetBootSelCtrl(&u32BootSel);
    if (ret != HI_SUCCESS)
    {
        HI_ERR_CA("DRV_CA_OTP_V200_GetBootSelCtrl failed, ret: 0x%x\n", ret);
        return ret;
    }
    ret = DRV_CA_OTP_V200_GetBootMode(&enFlashType);
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stEnableSecureBoot.bEnable = bEnable;
        if(u32BootSel)  // boot flash type is defined by boot_mode_sel_n in OTP
        {
            pstOtpAttr->unOtpFuseAttr.stEnableSecureBoot.enFlashType = (HI_UNF_ADVCA_FLASH_TYPE_E)enFlashType;
        }
        else    // boot flash type is defined by chipset pin
        {
            pstOtpAttr->unOtpFuseAttr.stEnableSecureBoot.enFlashType = HI_UNF_ADVCA_FLASH_TYPE_BUTT;
        }
    }
    return ret;
}

static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SECURE_BOOT_ACTIVATION_ONLY(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
    ...
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stDefaultAttr.bEnable = bEnable;
    }

    return ret;
}
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_BOOT_FLASH_TYPE(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_U32 u32BootSel = 0;
    HI_UNF_ADVCA_FLASH_TYPE_E enFlashType = HI_UNF_ADVCA_FLASH_TYPE_BUTT;
    ...
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stBootFlashType.bBootSelCtrl = u32BootSel;
        if(u32BootSel)  // boot flash type is defined by boot_mode_sel_n in OTP
        {
            ret = DRV_CA_OTP_V200_GetBootMode(&enFlashType);
            if (HI_SUCCESS == ret)
            {
                pstOtpAttr->unOtpFuseAttr.stBootFlashType.enFlashType = (HI_UNF_ADVCA_FLASH_TYPE_E)enFlashType;
            }
        }
        else    // boot flash type is defined by chipset pin
        {
            pstOtpAttr->unOtpFuseAttr.stBootFlashType.enFlashType = HI_UNF_ADVCA_FLASH_TYPE_BUTT;
        }
    }
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_BOOT_DECRYPTION_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_BOOT_ENCRYPTION_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SELF_BOOT_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_DDR_WAKEUP_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;

    ret = DRV_CA_OTP_V200_GetDDRWakeup((HI_U32*)&bEnable);
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stDefaultAttr.bEnable = bEnable;
    }
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_CSA2_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    ...
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stKeyladderLevSel.enKeyladderLevel = enKeyladderLevel;
    }

    return ret;
}

static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_R2R_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_UNF_ADVCA_KEYLADDER_LEV_E enKeyladderLevel = HI_UNF_ADVCA_KEYLADDER_BUTT;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SP_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_UNF_ADVCA_KEYLADDER_LEV_E enKeyladderLevel = HI_UNF_ADVCA_KEYLADDER_BUTT;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_CSA3_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_UNF_ADVCA_KEYLADDER_LEV_E enKeyladderLevel = HI_UNF_ADVCA_KEYLADDER_BUTT;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_LP_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_CSA2_CW_HARDONLY_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SP_CW_HARDONLY_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_CSA3_CW_HARDONLY_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_CSA2_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SP_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_CSA3_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_MISC_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;

    ret = DRV_CA_OTP_V200_GetMiscKlDisable((HI_U32*)&bEnable);
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stDefaultAttr.bEnable = bEnable;
    }
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_GOOGLE_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_DCAS_KL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_DDR_SCRAMBLE_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_GLOBAL_LOCK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_RUNTIME_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_DDR_WAKEUP_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_VERSION_ID_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_BOOT_MSID_CHECK_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_JTAG_MODE(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_UNF_ADVCA_JTAG_MODE_E enJtagPrtMode = HI_UNF_ADVCA_JTAG_MODE_BUTT;

    ret = DRV_CA_OTP_V200_GetJtagProtectMode((CA_OTP_JTAG_MODE_E *)&enJtagPrtMode);
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stJtagPrtMode.enJtagMode = enJtagPrtMode;
    }

    return ret;
}

static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_JTAG_READ_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;

    ret = DRV_CA_OTP_V200_GetJtagReadDisable((HI_U32*)&bEnable);
    if (HI_SUCCESS == ret)
    {
        pstOtpAttr->unOtpFuseAttr.stDefaultAttr.bEnable = bEnable;
    }
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_CHIP_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_U32 u32ChipId;
    ...
    if ((CA_OTP_VENDOR_CONAX == enVendorId) || (CA_OTP_VENDOR_NAGRA == enVendorId))
    {
        ...
        memcpy(pstOtpAttr->unOtpFuseAttr.stChipId.au8ChipId, (HI_U8 *)&u32ChipId, 4);
    }
    else
    {
        HI_U32 index = 0;
        ...
        memcpy(pstOtpAttr->unOtpFuseAttr.stChipId.au8ChipId, u8TmpBuf, 8);
    }
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_MARKET_SEGMENT_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_U8 *pu8TmBuf = NULL;
    HI_U8 u8TmpBuf[512] = {0};
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SOS_MARKET_SEGMENT_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_U8 *pu8TmBuf = NULL;
    HI_U8 u8TmpBuf[512] = {0};
    ...
    ret = DRV_CA_OTP_V200_Get_UniqueSOSMarketId(u8TmpBuf);
    pu8TmBuf[0] = u8TmpBuf[3];
    pu8TmBuf[1] = u8TmpBuf[2];
    pu8TmBuf[2] = u8TmpBuf[1];
    pu8TmBuf[3] = u8TmpBuf[0];
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_REE_MARKET_SEGMENT_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_U8 *pu8TmBuf = NULL;
    HI_U8 u8TmpBuf[512] = {0};
    ...
    ret = DRV_CA_OTP_V200_Get_UniqueREEMarketId(u8TmpBuf);
    pu8TmBuf[0] = u8TmpBuf[3];
    pu8TmBuf[1] = u8TmpBuf[2];
    pu8TmBuf[2] = u8TmpBuf[1];
    pu8TmBuf[3] = u8TmpBuf[0];
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_VERSION_ID(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_U8 *pu8TmBuf = NULL;
    HI_U8 u8TmpBuf[512] = {0};
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_MISC_KL_LEVEL_SEL(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_UNF_ADVCA_KEYLADDER_LEV_E enKeyladderLevel = HI_UNF_ADVCA_KEYLADDER_BUTT;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_IRDETO_ITCSA3_ACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_BOOTINFO_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_ITCSA3_IMLB(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_U8 *pu8TmBuf = NULL;

    pu8TmBuf = pstOtpAttr->unOtpFuseAttr.stItCsa3IMLB.au8ItCsa3IMLB;
    ...
    return ret;
        ...
        || defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798mv310)
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SERIAL_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_ETHERNET_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SM4_CRYPTO_ENGINE_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_TDES_CRYPTO_ENGINE_DEACTIVATION(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
#endif
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_RSA_KEY_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_STBSN_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_MSID_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_VERSIONID_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_OEM_ROOTKEY_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_R2R_ROOTKEY_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_JTAG_KEY_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_BOOT_ROOTKEY_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static HI_S32 DRV_CA_OTP_V200_GetOtpFuse_SEC_STORE_ROOTKEY_LOCK_FLAG(HI_UNF_ADVCA_OTP_ATTR_S *pstOtpAttr)
{
    HI_S32 ret = HI_FAILURE;
    HI_BOOL bEnable = HI_FALSE;
...
static DRV_ADVCA_OTP_FUSE_FUNC_MAP_S g_astGetOtpFuseFuncMap[] =
{
    {HI_UNF_ADVCA_OTP_NULL    ,                          HI_NULL},
    {HI_UNF_ADVCA_OTP_SECURE_BOOT_ACTIVATION,            DRV_CA_OTP_V200_GetOtpFuse_SECURE_BOOT_ACTIVATION},
    {HI_UNF_ADVCA_OTP_BOOT_DECRYPTION_ACTIVATION,        DRV_CA_OTP_V200_GetOtpFuse_BOOT_DECRYPTION_ACTIVATION},
    {HI_UNF_ADVCA_OTP_SELF_BOOT_DEACTIVATION,            DRV_CA_OTP_V200_GetOtpFuse_SELF_BOOT_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_DDR_WAKEUP_DEACTIVATION,           DRV_CA_OTP_V200_GetOtpFuse_DDR_WAKEUP_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_KL_LEVEL_SEL,                 DRV_CA_OTP_V200_GetOtpFuse_CSA2_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_R2R_KL_LEVEL_SEL,                  DRV_CA_OTP_V200_GetOtpFuse_R2R_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_SP_KL_LEVEL_SEL,                   DRV_CA_OTP_V200_GetOtpFuse_SP_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_CSA3_KL_LEVEL_SEL,                 DRV_CA_OTP_V200_GetOtpFuse_CSA3_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_LP_DEACTIVATION,                   DRV_CA_OTP_V200_GetOtpFuse_LP_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_CW_HARDONLY_ACTIVATION,       DRV_CA_OTP_V200_GetOtpFuse_CSA2_CW_HARDONLY_ACTIVATION},
    {HI_UNF_ADVCA_OTP_SP_CW_HARDONLY_ACTIVATION,         DRV_CA_OTP_V200_GetOtpFuse_SP_CW_HARDONLY_ACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA3_CW_HARDONLY_ACTIVATION,       DRV_CA_OTP_V200_GetOtpFuse_CSA3_CW_HARDONLY_ACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_KL_DEACTIVATION,              DRV_CA_OTP_V200_GetOtpFuse_CSA2_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_SP_KL_DEACTIVATION,                DRV_CA_OTP_V200_GetOtpFuse_SP_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA3_KL_DEACTIVATION,              DRV_CA_OTP_V200_GetOtpFuse_CSA3_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_MISC_KL_DEACTIVATION,              DRV_CA_OTP_V200_GetOtpFuse_MISC_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_GOOGLE_KL_DEACTIVATION,            DRV_CA_OTP_V200_GetOtpFuse_GOOGLE_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_DCAS_KL_DEACTIVATION,              DRV_CA_OTP_V200_GetOtpFuse_DCAS_KL_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_DDR_SCRAMBLE_ACTIVATION,           DRV_CA_OTP_V200_GetOtpFuse_DDR_SCRAMBLE_ACTIVATION},
    {HI_UNF_ADVCA_OTP_GLOBAL_LOCK_ACTIVATION,            DRV_CA_OTP_V200_GetOtpFuse_GLOBAL_LOCK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_RUNTIME_CHECK_ACTIVATION,          DRV_CA_OTP_V200_GetOtpFuse_RUNTIME_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_DDR_WAKEUP_CHECK_ACTIVATION,       DRV_CA_OTP_V200_GetOtpFuse_DDR_WAKEUP_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_VERSION_ID_CHECK_ACTIVATION,       DRV_CA_OTP_V200_GetOtpFuse_VERSION_ID_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_BOOT_MSID_CHECK_ACTIVATION,        DRV_CA_OTP_V200_GetOtpFuse_BOOT_MSID_CHECK_ACTIVATION},
    {HI_UNF_ADVCA_OTP_JTAG_MODE,                         DRV_CA_OTP_V200_GetOtpFuse_JTAG_MODE},
    {HI_UNF_ADVCA_OTP_JTAG_READ_DEACTIVATION,            DRV_CA_OTP_V200_GetOtpFuse_JTAG_READ_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_CSA2_ROOTKEY,                      HI_NULL},
    {HI_UNF_ADVCA_OTP_R2R_ROOTKEY,                       HI_NULL},
    {HI_UNF_ADVCA_OTP_SP_ROOTKEY,                        HI_NULL},
    {HI_UNF_ADVCA_OTP_CSA3_ROOTKEY,                      HI_NULL},
    {HI_UNF_ADVCA_OTP_MISC_ROOTKEY,                      HI_NULL},
    {HI_UNF_ADVCA_OTP_OEM_ROOTKEY,                       HI_NULL},
    {HI_UNF_ADVCA_OTP_ESCK_ROOTKEY,                      HI_NULL},
    {HI_UNF_ADVCA_OTP_JTAG_KEY,                          HI_NULL},
    {HI_UNF_ADVCA_OTP_CHIP_ID,                           DRV_CA_OTP_V200_GetOtpFuse_CHIP_ID},
    {HI_UNF_ADVCA_OTP_MARKET_SEGMENT_ID,                 DRV_CA_OTP_V200_GetOtpFuse_MARKET_SEGMENT_ID},
    {HI_UNF_ADVCA_OTP_VERSION_ID,                        DRV_CA_OTP_V200_GetOtpFuse_VERSION_ID},
    {HI_UNF_ADVCA_OTP_MISC_KL_LEVEL_SEL,                 DRV_CA_OTP_V200_GetOtpFuse_MISC_KL_LEVEL_SEL},
    {HI_UNF_ADVCA_OTP_VMX_BL_FUSE,                       HI_NULL},
    ...
    {HI_UNF_ADVCA_OTP_SM4_CRYPTO_ENGINE_DEACTIVATION,    DRV_CA_OTP_V200_GetOtpFuse_SM4_CRYPTO_ENGINE_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_TDES_CRYPTO_ENGINE_DEACTIVATION,   DRV_CA_OTP_V200_GetOtpFuse_TDES_CRYPTO_ENGINE_DEACTIVATION},
#else
    {HI_UNF_ADVCA_OTP_USB_DEACTIVATION,                  HI_NULL},
    {HI_UNF_ADVCA_OTP_SERIAL_DEACTIVATION,               HI_NULL},
    {HI_UNF_ADVCA_OTP_ETHERNET_DEACTIVATION,             HI_NULL},
    ...
    {HI_UNF_ADVCA_OTP_TDES_CRYPTO_ENGINE_DEACTIVATION,   HI_NULL},
#endif
    {HI_UNF_ADVCA_OTP_SECURE_BOOT_ACTIVATION_ONLY,       DRV_CA_OTP_V200_GetOtpFuse_SECURE_BOOT_ACTIVATION_ONLY},
    {HI_UNF_ADVCA_OTP_BOOT_FLASH_TYPE,                   DRV_CA_OTP_V200_GetOtpFuse_BOOT_FLASH_TYPE},
    {HI_UNF_ADVCA_OTP_RSA_KEY_LOCK_FLAG,                 DRV_CA_OTP_V200_GetOtpFuse_RSA_KEY_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_STBSN_LOCK_FLAG,                   DRV_CA_OTP_V200_GetOtpFuse_STBSN_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_MSID_LOCK_FLAG,                    DRV_CA_OTP_V200_GetOtpFuse_MSID_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_VERSIONID_LOCK_FLAG,               DRV_CA_OTP_V200_GetOtpFuse_VERSIONID_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_OEM_ROOTKEY_LOCK_FLAG,             DRV_CA_OTP_V200_GetOtpFuse_OEM_ROOTKEY_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_R2R_ROOTKEY_LOCK_FLAG,             DRV_CA_OTP_V200_GetOtpFuse_R2R_ROOTKEY_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_JTAG_KEY_LOCK_FLAG,                DRV_CA_OTP_V200_GetOtpFuse_JTAG_KEY_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_TZ_AREA_LOCK_FLAG,                 HI_NULL},
    {HI_UNF_ADVCA_OTP_BOOT_ENCRYPTION_DEACTIVATION,      DRV_CA_OTP_V200_GetOtpFuse_BOOT_ENCRYPTION_DEACTIVATION},
    {HI_UNF_ADVCA_OTP_BOOT_ROOTKEY,                      HI_NULL},
    {HI_UNF_ADVCA_OTP_SEC_STORE_ROOTKEY,                 HI_NULL},
    {HI_UNF_ADVCA_OTP_BOOT_ROOTKEY_LOCK_FLAG,            DRV_CA_OTP_V200_GetOtpFuse_BOOT_ROOTKEY_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_SEC_STORE_ROOTKEY_LOCK_FLAG,       DRV_CA_OTP_V200_GetOtpFuse_SEC_STORE_ROOTKEY_LOCK_FLAG},
    {HI_UNF_ADVCA_OTP_SOS_MSID,             DRV_CA_OTP_V200_GetOtpFuse_SOS_MARKET_SEGMENT_ID},
    {HI_UNF_ADVCA_OTP_REE_MSID,             DRV_CA_OTP_V200_GetOtpFuse_REE_MARKET_SEGMENT_ID},
};
...
HI_S32 DRV_CA_OTP_V200_GetOtpFuse(CA_OTP_ATTR_S *pstOtpAttr)
{
    ...
    if (HI_NULL == g_astGetOtpFuseFuncMap[pstOtpAttr->enOtpFuseId].pfnOtpFuse)
    {
        HI_ERR_CA("not support fuse ID: %d\n", pstOtpAttr->enOtpFuseId);
        return HI_ERR_CA_NOT_SUPPORT;
    }

    return g_astGetOtpFuseFuncMap[pstOtpAttr->enOtpFuseId].pfnOtpFuse(&(pstOtpAttr->stOtpAttr));
}
