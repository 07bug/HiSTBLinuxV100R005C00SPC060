...
HI_S32                  SND_CreateOp(SND_CARD_STATE_S* pCard, HI_UNF_SND_ATTR_S* pstAttr, HI_BOOL bResume);
...
HI_S32                  SND_SetLowLatency(SND_CARD_STATE_S* pCard, HI_UNF_SND_OUTPUTPORT_E enOutPort, HI_U32 u32LatencyMs);
...
HI_S32 SND_StopCastOp(SND_CARD_STATE_S* pCard, HI_U32 s32CastID);
HI_S32 SND_StartCastOp(SND_CARD_STATE_S* pCard, HI_U32 s32CastID);
HI_S32 SND_CreateCastOp(SND_CARD_STATE_S* pCard,  HI_U32* ps32CastId, HI_UNF_SND_CAST_ATTR_S* pstAttr, MMZ_BUFFER_S* pstMMz);
