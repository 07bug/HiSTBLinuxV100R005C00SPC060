...
/* TIANLAI V600 & TIANLAI V700 */
#define AO_SND_MUTE_DISABLE_TIMEMS_RESUME (700)
...
/* TV */
#define AO_SND_MUTE_DISABLE_TIMEMS_RESUME (800)
#else
/* TIANLAI V500 */
...
typedef enum
{
    ...
    SND_AIP_TYPE_SPDIF_RAW = 1,
    SND_AIP_TYPE_HDMI_RAW = 2,
    SND_AIP_TYPE_BUTT
} SND_AIP_TYPE_E;
...
typedef struct
{
    ...
    HI_VOID*                pAefProc[AOE_AEF_MAX_CHAN_NUM];
...
typedef struct tagAO_SND_ENTITY_S
{
    ...
    MMZ_BUFFER_S          stISBMmz[AO_RENDER_TRACK_NUM];  /* mmz dont release at suspend */
#if defined (HI_SND_DRV_SUSPEND_SUPPORT)
