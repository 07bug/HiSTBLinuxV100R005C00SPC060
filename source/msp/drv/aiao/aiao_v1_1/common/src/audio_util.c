...
HI_U32  AUTIL_IEC61937DataType(HI_U16* pu16IecData, HI_U32 u32IecDataSize)
{
    ...
    {
        HI_U16* pu16Data;
        if (0 != copy_from_user(u16Data, pu16IecData, 8 * sizeof(HI_U16)))
        {
            return IEC61937_DATATYPE_NULL;
        }
        pu16Data = u16Data;

        if ((0 == pu16Data[0]) && (0 == pu16Data[1]) && (0 == pu16Data[2]) && (0 == pu16Data[3]))
        {
            pu16Data += 4;          /* 4 word16 Burst spacing */
        }

        if (IEC_61937_SYNC1 == pu16Data[0]) //&& (IEC_61937_SYNC2 == pu16Data[1])
        {
            u32IEC61937DataType = pu16Data[2] & 0x3f;
        }
        else
        {
...
HI_BOOL AUTIL_IsChipMV300(HI_VOID)
{
    ...
    return (HI_CHIP_TYPE_HI3798M == enChipType &&
            HI_CHIP_VERSION_V300 == enChipVersion);
}

HI_BOOL AUTIL_IsChipMV310(HI_VOID)
{
    HI_CHIP_TYPE_E enChipType = HI_CHIP_TYPE_BUTT;
    HI_CHIP_VERSION_E enChipVersion = HI_CHIP_VERSION_BUTT;
    ...
    return ((HI_CHIP_TYPE_HI3798M == enChipType && HI_CHIP_VERSION_V310 == enChipVersion) || (HI_CHIP_TYPE_HI3798M_H == enChipType && HI_CHIP_VERSION_V300 == enChipVersion));
}

HI_BOOL AUTIL_CheckSysMode(HI_VOID)
{
    /*
    ...
    s32Ret = HI_DRV_SYS_GetFlag(&u32Value);

    return (HI_SUCCESS == s32Ret && 0 != u32Value);
#else
    return HI_FALSE;
#endif
}
 ...
 */
HI_S32  AUTIL_GetPllCfg(HI_U32* pu32Frac, HI_U32* pu32Int)
{
    ...
    /* EPLL cfg algorithm value */
    *pu32Frac = 0x11e353f8;
    *pu32Int = 0x08201025;

    return HI_SUCCESS;
#elif defined(CHIP_TYPE_hi3798cv200)
    /* hi3798cv200 EPLL cfg algorithm value */
    *pu32Frac = 0x12a5e354;
    *pu32Int = 0x0800209b;
    ...
    if (HI_TRUE == AUTIL_CheckSysMode())
    {
        /* hi3798mv200 vp9 chip EPLL cfg algorithm value */
        *pu32Frac = 0x12560418;
        *pu32Int = 0x0800310e;
    }
    else if (HI_TRUE == AUTIL_IsChipMV300())
    {
        /* hi3798mv300 EPLL cfg algorithm value */
        *pu32Frac = 0x125c28f6;
        *pu32Int = 0x0020208f;
    }
    else
    {
        /* hi3798mv200 EPLL cfg algorithm value */
        *pu32Frac = 0x12ed9169;
        *pu32Int = 0x0800207c;
    }
    ...
    /* hi3796mv200 EPLL cfg algorithm value, adjust to 0x11e363f8 in audio test */
    *pu32Frac = 0x11e353f8;
    *pu32Int = 0x08201025;
