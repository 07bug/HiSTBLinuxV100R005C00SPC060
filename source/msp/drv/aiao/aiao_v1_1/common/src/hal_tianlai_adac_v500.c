...
#ifdef HI_SND_MUTECTL_SUPPORT
HI_VOID ADAC_TIANLAI_V500_FastPowerEnable(HI_BOOL bEnable)
{
    SC_PERI_TIANLAI_ADAC0 Adac0;
...
HI_VOID ADAC_TIANLAI_V500_Init(HI_UNF_SAMPLE_RATE_E enSR, HI_BOOL bResume)
{
    Digfi_ADACEnable();
    msleep(1);   //discharge
...
HI_VOID ADAC_TIANLAI_V500_DeInit(HI_BOOL bSuspend)
{
