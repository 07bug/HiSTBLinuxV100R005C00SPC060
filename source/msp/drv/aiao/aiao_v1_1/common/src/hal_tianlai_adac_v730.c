...
#include "hal_tianlai_adac_v730.h"
...
#ifdef HI_SND_MUTECTL_SUPPORT
HI_VOID ADAC_TIANLAI_V730_FastPowerEnable(HI_BOOL bEnable)
{
    U_PERI_TIANLA_ADAC2 Adac2;
...
HI_VOID ADAC_TIANLAI_V730_Init(HI_UNF_SAMPLE_RATE_E enSR, HI_BOOL bResume)
{
    Digfi_ADACEnable();
    msleep(1);
#if 1
...
HI_VOID ADAC_TIANLAI_V730_DeInit(HI_BOOL bSuspend)
{
