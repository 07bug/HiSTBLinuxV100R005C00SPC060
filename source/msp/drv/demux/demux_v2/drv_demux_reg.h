...
* main\1    2009-09-27    sdk     NULL            create this file.
*******************************************************************************/
...
#define ENA_TEI                         (0x20C)     /* TEI interrupt enable */
#define ENA_CC_DISC0(offset)            (0x214 + ((offset) << 2))  /* CC DISC interrupt enable */
...
typedef union
{
    struct
    {
        unsigned int  pvr_csa3_clken      : 1;    // bit[0]
        unsigned int  pvr_debug_clken     : 1;    // bit[1]
        unsigned int  pvr_davcnt_clken    : 1;    // bit[2]
        unsigned int  pvr_ip0_6_clken     : 7;    // bit[9:3]
        unsigned int  reserved0           : 4;    // bit[13:10]
        unsigned int  pvr_inf_clken       : 1;    // bit[14]
        unsigned int  pvr_scd_clken       : 1;    // bit[15]
        unsigned int  reserved1           : 8;    // bit[23:16]
        unsigned int  mdsc_core_clk_gt_en : 1;    // bit[24]
        unsigned int  mdsc_sm4_clk_dis    : 1;    // bit[25]
        unsigned int  mdsc_asa_clk_dis    : 1;    // bit[26]
        unsigned int  reserved2           : 5;    // bit[31:27]
    } bits;
...
// Define the union U_ENA_CC_DISC
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    ena_cc_disc_chn0            : 1   ; // [0]
        unsigned int    ena_cc_disc_chn1            : 1   ; // [1]
        unsigned int    ena_cc_disc_chn2            : 1   ; // [2]
        unsigned int    ena_cc_disc_chn3            : 1   ; // [3]
        unsigned int    ena_cc_disc_chn4            : 1   ; // [4]
        unsigned int    ena_cc_disc_chn5            : 1   ; // [5]
        unsigned int    ena_cc_disc_chn6            : 1   ; // [6]
        unsigned int    ena_cc_disc_chn7            : 1   ; // [7]
        unsigned int    ena_cc_disc_chn8            : 1   ; // [8]
        unsigned int    ena_cc_disc_chn9            : 1   ; // [9]
        unsigned int    ena_cc_disc_chn10           : 1   ; // [10]
        unsigned int    ena_cc_disc_chn11           : 1   ; // [11]
        unsigned int    ena_cc_disc_chn12           : 1   ; // [12]
        unsigned int    ena_cc_disc_chn13           : 1   ; // [13]
        unsigned int    ena_cc_disc_chn14           : 1   ; // [14]
        unsigned int    ena_cc_disc_chn15           : 1   ; // [15]
        unsigned int    ena_cc_disc_chn16           : 1   ; // [16]
        unsigned int    ena_cc_disc_chn17           : 1   ; // [17]
        unsigned int    ena_cc_disc_chn18           : 1   ; // [18]
        unsigned int    ena_cc_disc_chn19           : 1   ; // [19]
        unsigned int    ena_cc_disc_chn20           : 1   ; // [20]
        unsigned int    ena_cc_disc_chn21           : 1   ; // [21]
        unsigned int    ena_cc_disc_chn22           : 1   ; // [22]
        unsigned int    ena_cc_disc_chn23           : 1   ; // [23]
        unsigned int    ena_cc_disc_chn24           : 1   ; // [24]
        unsigned int    ena_cc_disc_chn25           : 1   ; // [25]
        unsigned int    ena_cc_disc_chn26           : 1   ; // [26]
        unsigned int    ena_cc_disc_chn27           : 1   ; // [27]
        unsigned int    ena_cc_disc_chn28           : 1   ; // [28]
        unsigned int    ena_cc_disc_chn29           : 1   ; // [29]
        unsigned int    ena_cc_disc_chn30           : 1   ; // [30]
        unsigned int    ena_cc_disc_chn31           : 1   ; // [31]
    } bits;
...
#define TS_AFIFO_WFULL_STATUS(PortId)   (0x1118 + ((PortId) << 8))  /* TS afifo wfull status register */
#define TS_SYNC_LEN(PortId)             (0x11a0 + ((PortId) << 8))
#define DBG_DUMMY_FORCE(PortId)         (0x11D0 + ((PortId) << 8))  /* force dummy sync register */

typedef union
{
    struct
    {
        HI_U32 mux0_dvb_inf_sel           :4;    //[3:0]
        HI_U32 mux1_dvb_inf_sel           :4;    //[7:4]
...
typedef union
{
    struct
    {
        ...
        HI_U32  reserved_1          : 2;    // [7:6]
        HI_U32  inf_fifo_rate       : 3;    // [10:8]
        HI_U32  inf_fifo_mode       : 1;    // [11]
        HI_U32  ser_2bit_mode       : 1;    // [12]
        HI_U32  ser_2bit_rev        : 1;    // [13]
        HI_U32  ser_nosync          : 1;    // [14]
        HI_U32  sw_valid_burst      : 1;    // [15] serial novalid
        HI_U32  nosync_fixed_204    : 1;    // [16]
        HI_U32  reserved_3          : 2;    // [18:17]
        HI_U32  sw_dummy_sync       : 1;    // [19]
...
// Define the union U_TS_SYNC_LEN
typedef union
{
    struct
    {
        unsigned int nosync_188_len     : 8 ;  // [7 .. 0]
        unsigned int nosync_204_len       : 8;  // [15 .. 8]
        unsigned int sw_tsp_out_nolimit    : 1 ; // [16]
        unsigned int reserved_1                 : 3 ; // [19 .. 17]
        unsigned int sw_tag_deal_syncts_sel : 1 ; // [20]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_0                     : 7  ; // [7..1]
        unsigned int    dbg_cnt_wfull                  : 4  ; // [11..8]
        unsigned int    Reserved_1                     : 4  ; // [15..12]
        unsigned int    dbg_cnt_sync_err               : 8  ; // [23..16]
...
#define DBG_DMX_STATE0(DmxId)           (0x3E70 + ((DmxId) << 2))  /*[31:16]:TEI error Cnt [15: 0] CC Dist err Cnt*/
...
typedef union
{
    struct
    {
        ...
        HI_U32  reserved_2              : 11;   // [27:17]
        HI_U32  serial_2bit_mode        : 1;   // [28]
        HI_U32  vld_as_b1               : 1;   // [29]
        HI_U32  tsp_cnt_en              : 1;   // [30]
        HI_U32  tsout0_dbg_auto         : 1;   // [31]
    } bits;
    HI_U32  u32;
} U_TSOUT_CFG;
...
typedef union
{
    ...
    struct
    {
        unsigned int    dav_buff_cfg                 : 7   ; // [6..0]
        unsigned int    Reserved_1                 : 1  ; // [7]
        unsigned int    wrr_mode                   : 1  ; // [8]
        unsigned int    dbg_rate_dis               : 1  ; // [9]
        unsigned int    dbg_rate_mode           : 1  ; // [10]
        unsigned int    Reserved_2                 : 17  ; // [27..11]
        unsigned int    fake_clrreq_disover     : 1  ; // [28]
        unsigned int    fake_clrreq_1st           : 1  ; // [29]
        unsigned int    fake_cnt_clr                : 1  ; // [30]
        unsigned int    fake_push_en             : 1  ; // [31]
    } bits;
...
// Define the union U_DMX_DEBUG_STATE
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int cc_disc_err_cnt   : 16; //[15..0]
        unsigned int tei_err_cnt       : 16; //[31..16]
    }bits;
...
// Define the union U_IP_DBG_SYNC_ERR_CNT
typedef union
{
    // Define the struct bits
    struct
    {
        ...
        unsigned int    ip_dbg_sync_err_cnt    : 8  ; // [23..16]
...
} U_IP_DBG_SYNC_ERR_CNT;

// Define the union U_IP_DBG_SYNC_LOST_CNT
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    Reserved_0              : 16 ; // [15..0]
        unsigned int    ip_dbg_sync_lost_cnt    : 8  ; // [23..16]
        unsigned int    Reserved_1              : 8  ; // [31..24]
    } bits;
...
#define TSIO_FQ_BP_CFG(FqId)             (0x0d00 + (FqId << 2))
#define TSIO_FQ_BP_EN0                   0x0da0
#define TSIO_FQ_BP_EN1                   0x0da4
#define TSIO_FQ_BP_STA                   0x0db0
...
typedef union
{
    ...
    struct
    {
        HI_U32  fp2dmx_aful_ena                     : 1;    // [0]
        HI_U32  rp2dmx_aful_ena                     : 1;    // [1]
        HI_U32  reserved_0                              : 6;    // [7:2]
        HI_U32  fp2dmx_aful_cfg                      : 4;    // [11:8]
        HI_U32  rp2dmx_aful_cfg                      : 6;    // [17:12]
        HI_U32  rp2bm_aful_ovfl_upper_lvl        : 6;    // [23:18]
        HI_U32  rp2bm_aful_ovfl_below_lvl       : 6;    // [29:24]
