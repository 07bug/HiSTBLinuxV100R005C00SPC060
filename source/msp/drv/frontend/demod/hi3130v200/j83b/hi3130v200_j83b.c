...
/* TDA18250 HI3130V200_J83B CONFIG */
...
/* TDA18250B HI3130V200_J83B CONFIG */
...
/*R850 HI3130V200_J83B CONFIG*/
static REGVALUE_S s_stR850Qam16[]=
{
#include "qamdata/R850/R850_QAM16_J83B.txt"
};

static REGVALUE_S s_stR850Qam32[]=
{
#include "qamdata/R850/R850_QAM32_J83B.txt"
};

static REGVALUE_S s_stR850Qam64[]=
{
#include "qamdata/R850/R850_QAM64_J83B.txt"
};

static REGVALUE_S s_stR850Qam128[]=
{
#include "qamdata/R850/R850_QAM128_J83B.txt"
};

static REGVALUE_S s_stR850Qam256[]=
{
#include "qamdata/R850/R850_QAM256_J83B.txt"
};
...
/* TDA18215 HI3130V200_J83B CONFIG */
static REGVALUE_S s_stTda182I5aQam16[]=
{
#include "qamdata/TDA182I5a/TDA18215_QAM16_J83B.txt"
};

static REGVALUE_S s_stTda182I5aQam32[]=
{
#include "qamdata/TDA182I5a/TDA18215_QAM32_J83B.txt"
};

static REGVALUE_S s_stTda182I5aQam64[]=
{
#include "qamdata/TDA182I5a/TDA18215_QAM64_J83B.txt"
};

static REGVALUE_S s_stTda182I5aQam128[]=
{
#include "qamdata/TDA182I5a/TDA18215_QAM128_J83B.txt"
};

static REGVALUE_S s_stTda182I5aQam256[]=
{
#include "qamdata/TDA182I5a/TDA18215_QAM256_J83B.txt"
};
...
/*R858 HI3130V200_J83B CONFIG*/
static REGVALUE_S s_stR858Qam16[]=
{
#include "qamdata/R858/R858_QAM16_J83B.txt"
};

static REGVALUE_S s_stR858Qam32[]=
{
#include "qamdata/R858/R858_QAM32_J83B.txt"
};

static REGVALUE_S s_stR858Qam64[]=
{
#include "qamdata/R858/R858_QAM64_J83B.txt"
};

static REGVALUE_S s_stR858Qam128[]=
{
#include "qamdata/R858/R858_QAM128_J83B.txt"
};

static REGVALUE_S s_stR858Qam256[]=
{
#include "qamdata/R858/R858_QAM256_J83B.txt"
};
...
static char *s_stHi3130v200J83BQamRegName[]=
{
...
HI_VOID hi3130v200_j83b_set_hard_reg_value(HI_U32 u32TunerPort)
{
    HI_S32  i = 0;
    HI_S32  s32RegSum;
    REGVALUE_S *pstReg;
...
HI_VOID hi3130v200_j83b_test_single_agc( HI_U32 u32TunerPort, AGC_TEST_S * pstAgcTest )
{
    HI_S32 s32Ret = 0;
    HI_U8  u8RegVal = 0;
    HI_U8  au8Tmp[2] = {0};
...
static HI_VOID hi3130v200_j83b_chip_reset(HI_U32 u32TunerPort, qam_module_e enResetModule)
{
    hi3130v200_j83b_select_qam_block(u32TunerPort);
...
HI_VOID hi3130v200_j83b_get_registers(HI_U32 u32TunerPort, void *p)
{
    HI_U8   u8Value = 0;
    HI_S32  i = 0;
    HI_S32  s32RegSum = 0;
    ...
    for( i = 0; i < s32RegSum; i++ )
    {
        ...
        pstReg++;
        PROC_PRINT(p, "{%s  ,0x%02x },  ", s_stHi3130v200J83BQamRegName[i], u8Value);
    }
    PROC_PRINT(p, "\n\n");
...
static HI_VOID hi3130v200_j83b_set_customreg_value(HI_U32 u32TunerPort, HI_BOOL bInversion, HI_U32 u32SymbolRate)
{
    HI_U8 u8Val = 0;
...
static HI_VOID hi3130v200_j83b_set_reg_value(HI_U32 u32TunerPort)
{
    HI_S32  i = 0;
    HI_S32  s32RegSum;
    HI_U32  u32QamType;
...
HI_S32 hi3130v200_j83b_get_status (HI_U32 u32TunerPort, HI_UNF_TUNER_LOCK_STATUS_E  *penTunerStatus)
{
    HI_U8  u8Status = 0;
...
HI_VOID hi3130v200_j83b_manage_after_chipreset(HI_U32 u32TunerPort)
{
    HI_S32  s32Cnt = 0;
...
static HI_U32 s_u32Hi3130v200J83bConnectTimeout = HI3130J83B_CONNCECT_TIMEOUT;
HI_VOID hi3130v200_j83b_connect_timeout(HI_U32 u32ConnectTimeout)
{
    s_u32Hi3130v200J83bConnectTimeout = u32ConnectTimeout;
    return;
}
HI_S32 hi3130v200_j83b_connect(HI_U32 u32TunerPort, TUNER_ACC_QAM_PARAMS_S *pstChannel)
{
    ...
    hi3130v200_j83b_set_reg_value(u32TunerPort);    /*set for qam and tunner*/

    /*set for different usr request about symbolrate, ts type, demo in or out,  inversion or not*/
    hi3130v200_j83b_set_customreg_value(u32TunerPort, pstChannel->bSI, u32SymbolRate);

    /*step 3:reset chip*/
    hi3130v200_j83b_chip_reset(u32TunerPort, ALL_CHIP);

   return HI_SUCCESS;

}

HI_S32 hi3130v200_j83b_get_signal_info(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo)
{
    pstInfo->enSigType = HI_UNF_TUNER_SIG_TYPE_J83B;
    return HI_SUCCESS;
}

HI_S32 hi3130v200_j83b_get_signal_strength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength)
{
    HI_U8  au8RegVal[2] = {0};
...
HI_S32 hi3130v200_j83b_get_ber(HI_U32 u32TunerPort, HI_U32 *pu32ber)
{
...
HI_S32 hi3130v200_j83b_get_rs(HI_U32 u32TunerPort, HI_U32 *pu32Rs)
{
...
HI_S32 hi3130v200_j83b_get_snr(HI_U32 u32TunerPort, HI_U32* pu32SNR)
{
    HI_U32 u32Snr = 0;
    HI_U8  u8RdVal = 0;
    HI_U32 i ;
...
HI_S32 hi3130v200_j83b_set_ts_type(HI_U32 u32TunerPort, HI_UNF_TUNER_OUPUT_MODE_E enTsType)
{
...
HI_S32 hi3130v200_j83b_get_freq_symb_offset(HI_U32 u32TunerPort, HI_U32 * pu32Freq, HI_U32 * pu32Symb )
{
    HI_U8  au8Freq[4] = { 0 };
...
HI_S32 hi3130v200_j83b_set_ts_out(HI_U32 u32TunerPort, HI_UNF_TUNER_TSOUT_SET_S *pstTSOut)
{
    HI_U8 u8Temp= 0;
    HI_U32  i = 0;
