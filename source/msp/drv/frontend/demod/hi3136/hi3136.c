...
static HI_U32 hi3136_get_ber_dvbs_directv(HI_U32 u32TunerPort, HI_U32 u32SigMode)
{
    ...
    temp3 = (temp1 << 8) + temp2;
    u32ErrorRate = tuner_get_div(temp3, total_num, 9);
...
static HI_VOID hi3136_get_signal_info_s2(HI_U32 u32TunerPort, HI_UNF_TUNER_SIGNALINFO_S *pstInfo)
{
    ...
    if(HI_SUCCESS != s32Ret)
    {
        HI_ERR_TUNER("hi3136_get_total_isi_number err:%d.\n",s32Ret);
        return ;
    }

    qam_read_byte(u32TunerPort, CR_PLS_CODE, &u8PlsCode);
    ...
    switch (u8Temp >> 6)
    {
        ...
        case 3:
            ...
            break;
        default:
            pstInfo->unSignalInfo.stSat.enRollOff = HI_UNF_TUNER_SAT_STREAM_TYPE_BUTT;
            break;
    }
