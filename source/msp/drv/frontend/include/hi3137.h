...
#define Hi3137_CELL_ID_H                0xD9
#define Hi3137_CELL_ID_L                0xDA
#define Hi3137_NETWORK_ID_H             0xDB
#define Hi3137_NETWORK_ID_L             0xDC
#define Hi3137_SYSTEM_ID_H              0xDD
#define Hi3137_SYSTEM_ID_L              0xDE

#define HI3137_MCU_PAUSE \
    if(HI_UNF_DEMOD_DEV_TYPE_3137 == g_stTunerOps[u32TunerPort].enDemodDevType) \
    {   \
        qam_write_byte(u32TunerPort, Hi3137_MCU_HOLD, 0);   \
    }

#define HI3137_MCU_RESUME \
    if(HI_UNF_DEMOD_DEV_TYPE_3137 == g_stTunerOps[u32TunerPort].enDemodDevType) \
    {   \
...
extern HI_VOID hi3137_read_registers(HI_U32 u32TunerPort, void *p);
