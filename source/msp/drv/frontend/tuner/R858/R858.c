...
//0.
//1.
UINT8	R858_NA_TYPE = 1;  //(0 is default)

//User mode
//1. R858_SINGLE: one R858
//2. R858_DUAL: two R858
UINT8   R858_User_Mode = R858_SINGLE;
...
UINT8   R858_SHARE_XTAL = R858_NO_SHARE_XTAL;
UINT8   R858_XTAL_CAP = 28;  //(range 0~31)

#define R858_SHARE_XTAL 0
...
UINT32 R858_ADC_READ_DELAY = 2;
UINT8  R858_ADC_READ_COUNT = 1;
...
UINT8 R858_iniArray[2][R858_REG_NUM] = {     //Tuner1/2
		...
		//  0x26  0x27  0x28  0x29  0x2A  0x2B  0x2C  0x2D  0x2E  0x2F
			0x22, 0x02, 0x00, 0x57, 0xAC, 0xF6, 0x77, 0x1A},
...
UINT8   R858_Divider_Manual = 0;					//*not release
...
static UINT8 R858_SBY2[R858_MAX_NUM][R858_REG_NUM - 48];           //tuner 1, R42~R47
...
R858_ErrCode R858_Slow_Function(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum);
...
*/
	...
	case R858_DVB_C_6M:
		...
		R858_Sys_Info.FILT_EXT_POINT=2;			//lna=max-1 & Buf 4
		break;
	case R858_J83B_IF_5300:
		R858_Sys_Info.IF_KHz=5300;
		R858_Sys_Info.BW=0;                       //BW=7M   R17[5:4] [8M(0), 7M(1), 6M(2)]
		R858_Sys_Info.FILT_CAL_IF=8100;          //CAL IF
		R858_Sys_Info.HPF_COR=2;
		R858_Sys_Info.FILT_EXT_ENA=0;			 //R19[6] filter ext disable [off(0), on(1)]
		R858_Sys_Info.FILT_EXT_WIDEST=0x00;		//R30[2]=0, ext normal
		R858_Sys_Info.FILT_EXT_POINT=2;			//lna=max-1 & Buf 4
		break;
	...
	case R858_ATSC_IF_5M:
		R858_Sys_Info.IF_KHz=5070;
		R858_Sys_Info.BW=1;                      //BW=7M   R17[5:4] [8M(0), 7M(1), 6M(2)]
		R858_Sys_Info.FILT_CAL_IF=7920;          //CAL IF
		R858_Sys_Info.HPF_COR=6;                //R18[6:3] [0~15 ; input: "0~15"]
		R858_Sys_Info.FILT_EXT_ENA=0;		     //R19[6] filter ext disable [off(0), on(1)]
		R858_Sys_Info.FILT_EXT_WIDEST=0x00;		//R30[2]=0, ext normal
		R858_Sys_Info.FILT_EXT_POINT=2;			//lna=max-1 & Buf 4
	...
	case R858_ATSC_IF_5500:
		R858_Sys_Info.IF_KHz=5570;
		R858_Sys_Info.BW=1;                      //BW=7M   R17[5:4] [8M(0), 7M(1), 6M(2)]
		R858_Sys_Info.FILT_CAL_IF=8420;          //CAL IF
		R858_Sys_Info.HPF_COR=4;                //R18[6:3] [0~15 ; input: "0~15"]
		R858_Sys_Info.FILT_EXT_ENA=0;		     //R19[6] filter ext disable [off(0), on(1)]
		R858_Sys_Info.FILT_EXT_WIDEST=0x00;		//R30[2]=0, ext normal
		R858_Sys_Info.FILT_EXT_POINT=2;			//lna=max-1 & Buf 4
...
*/
	...
	case R858_DVB_T2_1_7M_IF_5M:
		...
		//PW
		R858_SysFreq_Info.NA_PWR_DET = 0;				//R44[1]   ["off" (0), "on" (1)] v  co-use ; tuner 1 control v
		//Clock
	...
	case R858_DVB_C_6M_IF_5M:
		...
		R858_SysFreq_Info.RF_VTL_H=0x29;				//R31[7:0] RF VTL/H = 0.64(3) / 1.34(A)
		...
		//R858_SysFreq_Info.FILTER_VTL_H=0x49;			//R37[7:0]  Flter VTL/H = 0.74(4) / 1.24(9) v
		R858_SysFreq_Info.FILTER_VTL_H=0x39;			//R37[7:0]  Flter VTL/H = 0.64(3) / 1.24(9) v
		...
		R858_SysFreq_Info.LNA_RF_CHARGE_CUR=0;			//R32[5]  ["4x chargeI" (0), "2x chargeI" (1)]
		R858_SysFreq_Info.RF_DIS_SLOW_FAST=11;			//R45[7:4]		0.15u (1) / 0.6u (4)  => 0 + 0 = 0
		R858_SysFreq_Info.LNA_RF_DIS_MODE=1;			//Both (fast+slow) b'07(R55[4]=1,R55[1]=1,R53[5]=1) 
														//slow			   b'06(R55[4]=1,R55[1]=1,R53[5]=0)
														//normal		   b'01(R55[4]=0,R55[1]=0,R53[5]=1)
		//R858_SysFreq_Info.LNA_DIS_SLOW_FAST=16;			//R44[7:4]		0.3u (1) / 1.5u (8)   => 1 + 8 = 9  ?
		R858_SysFreq_Info.BB_DIS_CURR=1;                //R40[0]		["x1" (0) , "x1/2" (1)]
		R858_SysFreq_Info.MIXER_FILTER_DIS=3;			//R39[7:6]		["highest" (0), "high" (1), "low" (2), "lowest" (3)]
	...
	case R858_ATSC_IF_5500:
		...
		if(RF_freq<=340000)
			...
			R858_SysFreq_Info.FILT_3TH_LPF_GAIN=1;			//R17[7:6]	[normal (0), +1.7dB (1), +3.4dB (2), +4.7dB (3)]
...
*/
	...
	{
	case 0:
		R858_SysFreq_Info.PUL_FLAG_RANGE = 2;	//R40[2:1]	["4~12"(0), "5~13"(1), "6~14"(2), "7~15"(3)]
		R858_SysFreq_Info.FAST_DEGLITCH = 1;	//R40[6:5]	["70ms"(0), "45ms"(1), "20ms"(2), "10ms"(3)]
		R858_SysFreq_Info.PULG_CNT_THRE = 0;	//R45[1]	["threshold =14"(0), "threshold =15"(1)]

		break;

	case 1:
		R858_SysFreq_Info.PUL_FLAG_RANGE = 2;	//R40[2:1]	["4~12"(0), "5~13"(1), "6~14"(2), "7~15"(3)]
		R858_SysFreq_Info.FAST_DEGLITCH = 2;	//R40[6:5]	["70ms"(0), "45ms"(1), "20ms"(2), "10ms"(3)]
		R858_SysFreq_Info.PULG_CNT_THRE = 0;	//R45[1]	["threshold =14"(0), "threshold =15"(1)]
        //printk("   ccp  [PUL_FLAG_RANGE=%d][FAST_DEGLITCH=%d][PULG_CNT_THRE=%d]  \n", R858_SysFreq_Info.PUL_FLAG_RANGE, R858_SysFreq_Info.FAST_DEGLITCH,R858_SysFreq_Info.PULG_CNT_THRE);
		break;
	default:
		R858_SysFreq_Info.PUL_FLAG_RANGE = 2;	//R40[2:1]	["4~12"(0), "5~13"(1), "6~14"(2), "7~15"(3)]
		R858_SysFreq_Info.FAST_DEGLITCH = 1;	//R40[6:5]	["70ms"(0), "45ms"(1), "20ms"(2), "10ms"(3)]
...
R858_ErrCode R858_Dump_Data(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum)
{
 	UINT8   R858_PulseFlag;
	UINT8   RF_gain1, RF_gain2, RF_gain3, RF_gain4, RF_gain5, gain_flag;
    //int i ;
	...
	if(R858_I2C_Read_Len(R858_Num , &R858_I2C_Len) != RT_Success)
	{
		R858_I2C_Read_Len(R858_Num , &R858_I2C_Len);
	}

	//R858_Delay_MS(R858_Num, 10);

	RF_gain1 = ((R858_I2C_Len.Data[4] & 0xF8)>>3);       //lna

	RF_gain2 = (R858_I2C_Len.Data[5] & 0x0F);            //rf

	RF_gain3 = (R858_I2C_Len.Data[5] & 0xF0)>>4;       //mixer

	RF_gain4 = (R858_I2C_Len.Data[6] & 0x0F);             //filter
    gain_flag= (R858_I2C_Len.Data[19] & 0x02);        //gain_flag
	RF_gain5 = ((R858_Array[R858_Num][IntTunerNum][37] & 0xF0)>>4);             //filter

	R858_PulseFlag = ((R858_I2C_Len.Data[4] & 0x01));

	//for customer to dump data

	printk("===v1.7B===IntTunerNum=%d, LNA=%d, RF=%d, Mixer=%d, Filter=%d, Manual_Filter=%d, gain_flag=%d\n", IntTunerNum,RF_gain1, RF_gain2, RF_gain3, RF_gain4, RF_gain5, gain_flag);
...
R858_ErrCode R858_InitReg(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum)
{
	...
	if(R858_I2C_Write_Len(R858_Num, &R858_I2C_Len) != RT_Success)
		return RT_Fail;
...
R858_ErrCode R858_Xtal_Check(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum)
{
    ...
    if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
	    return RT_Fail;
...
R858_ErrCode R858_IMR(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, UINT8 IMR_MEM, UINT8 IM_Flag ,UINT8 Rev_Mode)
{
	...
	if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
	 ...
	 for(LPF_Count=15; LPF_Count>=1; LPF_Count--)  //start from 5 (??)
	 {
		...
		if(ADC_Read_Value < 50*R858_ADC_READ_COUNT)
			break;
	 }
	//Mixer Amp LPF???
...
R858_ErrCode R858_IQ(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, R858_SectType* IQ_Pont)
{
	...
	R858_I2C.I2cAddr = R858_ADDRESS[R858_Num][IntTunerNum];
	 ...
	 for(LPF_Count=0; LPF_Count<16; LPF_Count++)  //start from 5 (??)
	 {
		...
		if(ADC_Read_Value > 40*R858_ADC_READ_COUNT)
			break;
	 }
...
*/
		...
		else if((StepTemp.Value - 2*R858_ADC_READ_COUNT) > StepArry[0].Value)
		{
			break;
		}
...
R858_ErrCode R858_Muti_Read(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, UINT8* IMR_Result_Data)
{
    ...
    R858_Delay_MS(R858_Num, R858_ADC_READ_DELAY);//2

	for(ReadCunt = 0; ReadCunt < (R858_ADC_READ_COUNT+2); ReadCunt ++)
	{
		R858_I2C_Len.RegAddr = 0x00;
...
R858_ErrCode R858_SetStandard(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, R858_Standard_Type RT_Standard)
{
	...
	switch(RT_Standard)
	{
		case R858_ATSC_IF_5M:
		case R858_ATSC_IF_5500:
			Vga_out_atten = 0x00;//-7dB
			break;
		default:
			Vga_out_atten = 0xC0;//bypass
			break;
	}
	// Vga output atten
	R858_I2C.RegAddr = 44;
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0x3F) | Vga_out_atten  ;  //R44[7:6]
	R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
	if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
	    return RT_Fail;
	// Set LPF Lsb bit
 ...
 //      u4RingFreq = 72000;
  ...
  //  //Ring PLL pw off
	 ...
	 for(u1FilterCode=0; u1FilterCode<16; u1FilterCode++)
	 {
		 ...
		 if((u1FilterCalValue+FilCal_Gap*R858_ADC_READ_COUNT) < u1FilterCalValuePre)
		 {
...
R858_ErrCode R858_SetFrequency(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, R858_Set_Info R858_INFO)
{
	...
	R858_I2C_Len.I2cAddr=R858_ADDRESS[R858_Num][IntTunerNum];
	 ...
	 if(IntTunerNum == 0)
		R858_INFO.R858_Standard = R858_INFO.R858_Standard;
	else
		R858_INFO.R858_Standard = R858_INFO.R858_Standard_2;

	//printk("Set Fre Standard=%d\n",  (int)R858_INFO.R858_Standard);
	...
	default:
	  ...
	  if(R858_Num == 1)
	  {
			R858_I2C.I2cAddr=R858_ADDRESS[R858_Num][IntTunerNum];
			R858_I2C.RegAddr = 29;
			R858_Array[R858_Num][IntTunerNum][29] = (R858_Array[R858_Num][IntTunerNum][29] & 0x06);  //R[7]=0  R[6:3] R[0] = 0
			R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][29];
			if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
				return RT_Fail;
	...
	// Filter auto mode [0:manual, 1:auto] R19[1]
	R858_I2C.RegAddr = 19;
    ...
    if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
       return RT_Fail;*/
	//NA
	R858_I2C.RegAddr = 40;//R40[2:1]
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xF9) | (SysFreq_Info1.PUL_FLAG_RANGE << 1);

	R858_I2C.RegAddr = 40;//R40[6:5]
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0x9F) | (SysFreq_Info1.FAST_DEGLITCH << 5);

	R858_I2C.RegAddr = 45;//R45[1]
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xFD) | (SysFreq_Info1.PULG_CNT_THRE << 1);
   ...
   /* R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
	...
	{
	    R858_Array[R858_Num][R858_TUNER1][53] = (R858_Array[R858_Num][R858_TUNER1][53] & 0xDF) | 0x20;	//1
		R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xED) ;        //00

	}
	else if(SysFreq_Info1.LNA_RF_DIS_MODE==6)  //slow
	{
		R858_Array[R858_Num][R858_TUNER1][53] = (R858_Array[R858_Num][R858_TUNER1][53] & 0xDF) ;		//0
		R858_Array[R858_Num][R858_TUNER1][55] = (R858_Array[R858_Num][R858_TUNER1][55] & 0xED) | 0x12;  //11
	...
	//lna charge current R55[2]
	R858_I2C.RegAddr = 55;
	R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = (R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0xFB) | (SysFreq_Info1.LNA_RF_CHARGE_CUR<<2);  
	//PW
	...
	switch(R858_INFO.R858_Standard)
	{
		...
		case R858_ATSC_IF_5500:
			...
			if((R858_INFO.RF_KHz>=330000) && (R858_INFO.RF_KHz<620000))
				...
				R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = ((R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0x9F) | 0x00 );//highest
			else
				R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = ((R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0x9F) | 0x40 );// low
...
//=======================================fixed filter gain=================================================================
	//wait 50ms, read filter gain and set filter manual gain
	R858_Delay_MS(R858_Num, 200);
	...
	//Set Filter manual mode [0:manual, 1:auto]   R19[1]
	R858_I2C.RegAddr=19;
	R858_I2C.I2cAddr=R858_ADDRESS[R858_Num][IntTunerNum];
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xFD) | 0x00 ;
	R858_I2C.Data=R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
	if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
		return RT_Fail;

	
	//Set Filter manual gain   R37[7:4]
	R858_I2C.RegAddr=37;
	R858_I2C.I2cAddr=R858_ADDRESS[R858_Num][IntTunerNum];
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = ((R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0x0F)|((R858_I2C_Len.Data[6] & 0x0F)<<4));
	R858_I2C.Data=R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
	if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
		return RT_Fail;
...
R858_ErrCode R858_GetRfGain(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum, R858_RF_Gain_Info *pR858_rf_gain)
{
	...
	//Set Filter manual mode [0:manual, 1:auto]   R19[1]
	if((R858_Array[R858_Num][IntTunerNum][19] & 0x02)==0x02)  //auto mode
	{
		pR858_rf_gain->RF_gain4 = (R858_I2C_Len.Data[6] & 0x0F);             //filter
	}
	else
	{
		pR858_rf_gain->RF_gain4 = ((R858_Array[R858_Num][IntTunerNum][37] & 0xF0)>>4);             //filter manual gain   R37[7:4]
	}
...
//	UINT8 	rf_limit;
	...
	{
		rf_gain_info.RF_gain4 = ((R858_Array[R858_Num][IntTunerNum][37] & 0xF0)>>4);             //filter manual gain   R37[7:4]
	}
...
//Optimize value
	...
	if(R858_I2C_Write(R858_Num, &Dlg_I2C) != RT_Success)
		return RT_Fail;
	...
	R858_I2C_Len.RegAddr = 0x00;
	R858_I2C_Len.Len = 4;
	if(R858_I2C_Read_Len(R858_Num , &R858_I2C_Len) != RT_Success) // read data length
	{
		R858_I2C_Read_Len(R858_Num , &R858_I2C_Len);
	}
...
R858_ErrCode R858_NA_Ctrl(R858_ExtTunerNum_Type R858_Num, UINT8 FEC_Lock_1, UINT8 FEC_Lock_2)  //Tuner1 & Tuner2 FEC Lock  Lock=1, unlock=0
{
	R858_I2C.I2cAddr=R858_ADDRESS[R858_Num][R858_TUNER1];
	R858_I2C.RegAddr = 51;

    //printk("[%s] R858_Num=%d, FEC_Lock_1=%d, FEC_Lock_2=%d \n", __FUNCTION__, R858_Num, FEC_Lock_1, FEC_Lock_2);

	//Demod_FEC_Lock[R858_Num][IntTunerNum] = FEC_Lock;

	if((FEC_Lock_1==1) || (FEC_Lock_2==1))  //1: one of demod FEC lock
	{
		R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = (R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0x7F) | 0x00; //Off
	}
	else  //0: both demod FEC unlock
	{
		R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] = (R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr] & 0x7F) | 0x80; //On
	}

	//Set NA det power R51[7]
	R858_I2C.Data = R858_Array[R858_Num][R858_TUNER1][R858_I2C.RegAddr];
	if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
		return RT_Fail;
...
R858_ErrCode R858_Slow_Function(R858_ExtTunerNum_Type R858_Num, R858_IntTunerNum_Type IntTunerNum)
{
	...
	R858_I2C.RegAddr = 37;
	//R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = ((R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0x00) | 0x3A);
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = ((R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0x00) | 0x2A);
	R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
		if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
			return RT_Fail;

	R858_I2C.RegAddr = 38;
	R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] = (R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr] & 0xCF) | (3<<4);  
	R858_I2C.Data = R858_Array[R858_Num][IntTunerNum][R858_I2C.RegAddr];
	if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
		return RT_Fail;
	/*printk("<<<Slow(in)-1 Tuner1 Log>>>\n");
	R858_Dump_Data(R858_NUM1, R858_TUNER1);
	printk("\n");
	printk("<<<Slow(in)-1 Tuner2 Log>>>\n");
	R858_Dump_Data(R858_NUM1, R858_TUNER2);
	printk("\n");*/
	...
	if(R858_I2C_Write(R858_Num, &R858_I2C) != RT_Success)
    	return RT_Fail;
	/*printk("<<<Slow(in)-2 Tuner1 Log>>>\n");
	R858_Dump_Data(R858_NUM1, R858_TUNER1);
	printk("\n");
	printk("<<<Slow(in)-2 Tuner2 Log>>>\n");
	R858_Dump_Data(R858_NUM1, R858_TUNER2);
	printk("\n");*/
...
HI_S32 r858_init_tuner(HI_U32 u32TunerPort)
{
    ...
    R858_ExtTunerNum = u32TunerPort / 2;
    R858_IntTunerNum = u32TunerPort % 2;
    ...
    if ((u32TunerPort == 0)||(u32TunerPort == 2))
    {
		switch (g_stTunerOps[u32TunerPort].enSigType)
		{
			case HI_UNF_TUNER_SIG_TYPE_J83B:
				R858_Info_Msg.R858_Standard = R858_J83B_IF_5M;
				R858_Info_Msg.R858_Standard_2 = R858_J83B_IF_5500;
				break;
			case HI_UNF_TUNER_SIG_TYPE_CAB:
				R858_Info_Msg.R858_Standard = R858_DVB_C_8M_IF_5M;
				R858_Info_Msg.R858_Standard_2 = R858_DVB_C_8M_IF_5500;
				break;
			case HI_UNF_TUNER_SIG_TYPE_DVB_T:
				R858_Info_Msg.R858_Standard = R858_DVB_T_8M_IF_5M;
				R858_Info_Msg.R858_Standard_2 = R858_DVB_T_8M_IF_5M;
				break;
			case HI_UNF_TUNER_SIG_TYPE_DVB_T2:
				R858_Info_Msg.R858_Standard = R858_DVB_T2_8M_IF_5M;
				R858_Info_Msg.R858_Standard_2 = R858_DVB_T2_8M_IF_5M;
				break;
			default:
...
UINT32 R858_RF_KHz_Tuner1 = 435000;
UINT32 R858_RF_KHz_Tuner2 = 435000;
HI_S32 r858_set_tuner(HI_U32 u32TunerPort, HI_U8 enI2cChannel, HI_U32 puRF)
{
    ...
    if(u32TunerPort == 0)
    {
        R858_RF_KHz_Tuner1 = puRF;
    }
    else
    {
        R858_RF_KHz_Tuner2 = puRF;
    }
...
HI_S32 r858_get_signal_strength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength)
{
    ...
    R858_Set_Info R858_Info_Msg;
    HI_U8  u8Temp   = 0;
    UINT8  R858_FEC_Lock_1 = 0;
    UINT8  R858_FEC_Lock_2 = 0;

    R858_ExtTunerNum = u32TunerPort / 2;
    R858_IntTunerNum = u32TunerPort % 2;

    qam_read_byte(0, 0x4a, &u8Temp);
    if((u8Temp & 0xf8) == 0xf8)
        R858_FEC_Lock_1 = TRUE;
    else
        R858_FEC_Lock_1 = FALSE;

    qam_read_byte(1, 0x4a, &u8Temp);
    if((u8Temp & 0xf8) == 0xf8)
        R858_FEC_Lock_2 = TRUE;
    else
        R858_FEC_Lock_2 = FALSE;

    R858_NA_Ctrl(R858_ExtTunerNum,R858_FEC_Lock_1,R858_FEC_Lock_2);

    if(u32TunerPort == 0)
    {
        R858_Info_Msg.RF_KHz = R858_RF_KHz_Tuner1;
    }
    else
    {
        R858_Info_Msg.RF_KHz = R858_RF_KHz_Tuner2;
    }
