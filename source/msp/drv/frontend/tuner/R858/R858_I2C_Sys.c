...
int R858_I2C_Write_Len(R858_ExtTunerNum_Type R858_Num, I2C_LEN_TYPE *I2C_Info)
{
    ...
    status = tuner_i2c_send_data(g_stTunerOps[g_r858_tuner_port].enTunerI2cChannel,g_stTunerOps[g_r858_tuner_port].u32TunerAddress, &I2cDataStr);
...
int R858_I2C_Read_Len(R858_ExtTunerNum_Type R858_Num, I2C_LEN_TYPE *I2C_Info)
{
    //implement your I2C code here//
    //return TRUE;
    ...
    s32status = tuner_i2c_receive_data(g_stTunerOps[g_r858_tuner_port].enTunerI2cChannel,g_stTunerOps[g_r858_tuner_port].u32TunerAddress, &stDataStruct);
...
int R858_I2C_Write(R858_ExtTunerNum_Type R858_Num, I2C_TYPE *I2C_Info)
{
    //implement your I2C code here//
    //return TRUE;
