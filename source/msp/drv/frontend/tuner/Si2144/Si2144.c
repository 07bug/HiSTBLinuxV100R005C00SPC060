...
#define FRONT_END_COUNT TUNER_NUM
int  si2144_fe = 0;

L1_Si2144_Context         FrontEnd_Table[FRONT_END_COUNT];
L1_Si2144_Context         *Si2144[FRONT_END_COUNT];

HI_S32 si2144_init_tuner(HI_U32 u32TunerPort,HI_U32 u32I2cChannel)
{
    Si2144[u32TunerPort] = &(FrontEnd_Table[u32TunerPort]);

    Si2144[u32TunerPort]->i2c->channel = (HI_U8)u32I2cChannel;
    Si2144_L1_API_Init(u32TunerPort,Si2144[u32TunerPort], g_stTunerOps[u32TunerPort].u32TunerAddress,u32I2cChannel);

    Si2144[u32TunerPort]->cmd->power_up.clock_mode =  Si2144_POWER_UP_CMD_CLOCK_MODE_XTAL;
    Si2144[u32TunerPort]->cmd->power_up.en_xout    =  Si2144_POWER_UP_CMD_EN_XOUT_EN_XOUT;
    Si2144[u32TunerPort]->cmd->config_clocks.clock_mode = Si2144_CONFIG_CLOCKS_CMD_CLOCK_MODE_XTAL;

    Si2144[u32TunerPort]->i2c->trackRead = Si2144[u32TunerPort]->i2c->trackWrite = 1;
    if (Si2144_Init(Si2144[u32TunerPort]) == 0 )
    {
        Si2144_Configure(Si2144[u32TunerPort]);
    }
    else
    {
...
HI_S32 si2144_set_tuner (HI_U32 u32TunerPort, HI_U32 u32Frequency,HI_U32 u32BandWidth)
{
    ...
    u32Ret = Si2144_DTVTune (Si2144[u32TunerPort], u32Frequency, u8BW, Si2144_DTV_MODE_PROP_MODULATION_DVBT, Si2144_DTV_MODE_PROP_INVERT_SPECTRUM_NORMAL);
...
HI_S32 si2144_init_tuner_dvbc (HI_U32 u32TunerPort)
{
    ...
    /* Software Init */
      ...
      Si2144_L1_API_Init(u32TunerPort,Si2144[u32TunerPort], g_stTunerOps[u32TunerPort].u32TunerAddress,g_stTunerOps[u32TunerPort].enI2cChannel);
      Si2144[u32TunerPort]->i2c->connectionType = CUSTOMER;
    ...
    s32Ret = Si2144_L1_CONFIG_PINS (Si2144[u32TunerPort],
...
HI_S32 si2144_set_tuner_dvbc (HI_U32 u32TunerPort, HI_U8 enI2cChannel, HI_U32 u32PuRF)
{
    ...
    {
        s32Ret = Si2144_DTVTune(Si2144[u32TunerPort], RFMaster, Si2144_DTV_MODE_PROP_BW_BW_6MHZ, Si2144_DTV_MODE_PROP_MODULATION_DVBC, Si2144_DTV_MODE_PROP_INVERT_SPECTRUM_NORMAL);
    }
    else
    {
        s32Ret = Si2144_DTVTune(Si2144[u32TunerPort], RFMaster, Si2144_DTV_MODE_PROP_BW_BW_8MHZ, Si2144_DTV_MODE_PROP_MODULATION_DVBC, Si2144_DTV_MODE_PROP_INVERT_SPECTRUM_NORMAL);
    }
...
HI_S32 si2144_get_signal_strength(HI_U32 u32TunerPort, HI_U32 *pu32SignalStrength)
{
    ...
    Si2144_GetRF(Si2144[u32TunerPort]);

    pu32SignalStrength[0] = 0;
    pu32SignalStrength[2] = 0;
    pu32SignalStrength[1] = (HI_U32)Si2144[u32TunerPort]->rsp->tuner_status.rssi;

    pu32SignalStrength[1] = pu32SignalStrength[1] + 108;
