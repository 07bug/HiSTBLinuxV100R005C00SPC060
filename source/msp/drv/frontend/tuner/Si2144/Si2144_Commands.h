...
/* Si2144_POWER_UP8_1 command definition */
#define   Si2144_POWER_UP8_1_CMD 0xc0

#ifdef    Si2144_POWER_UP8_1_CMD
  #define Si2144_POWER_UP8_1_CMD_CODE 0x0500c0

    typedef struct { /* Si2144_POWER_UP8_1_CMD_struct */
     unsigned char   subcode;
     unsigned char   clock_mode;
     unsigned char   en_xout;
     unsigned char   config_1p8v;
     ...
     unsigned char   reserved5;
     unsigned char   reserved6;
   } Si2144_POWER_UP8_1_CMD_struct;


    typedef struct { /* Si2144_POWER_UP8_1_CMD_REPLY_struct */
       Si2144_COMMON_REPLY_struct * STATUS;
   }  Si2144_POWER_UP8_1_CMD_REPLY_struct;

   /* POWER_UP8_1 command, SUBCODE field definition (address 1,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_SUBCODE_LSB         0
   #define  Si2144_POWER_UP8_1_CMD_SUBCODE_MASK        0xff
   #define  Si2144_POWER_UP8_1_CMD_SUBCODE_MIN         0
   #define  Si2144_POWER_UP8_1_CMD_SUBCODE_MAX         0
    #define Si2144_POWER_UP8_1_CMD_SUBCODE_CODE  0
   /* POWER_UP8_1 command, CLOCK_MODE field definition (address 2,size 2, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_CLOCK_MODE_LSB         0
   #define  Si2144_POWER_UP8_1_CMD_CLOCK_MODE_MASK        0x03
   #define  Si2144_POWER_UP8_1_CMD_CLOCK_MODE_MIN         1
   #define  Si2144_POWER_UP8_1_CMD_CLOCK_MODE_MAX         3
    #define Si2144_POWER_UP8_1_CMD_CLOCK_MODE_EXTCLK  3
    #define Si2144_POWER_UP8_1_CMD_CLOCK_MODE_XTAL    1
   /* POWER_UP8_1 command, EN_XOUT field definition (address 2,size 3, lsb 2, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_EN_XOUT_LSB         2
   #define  Si2144_POWER_UP8_1_CMD_EN_XOUT_MASK        0x07
   #define  Si2144_POWER_UP8_1_CMD_EN_XOUT_MIN         0
   #define  Si2144_POWER_UP8_1_CMD_EN_XOUT_MAX         3
    #define Si2144_POWER_UP8_1_CMD_EN_XOUT_DIS_XOUT  0
    #define Si2144_POWER_UP8_1_CMD_EN_XOUT_EN_XOUT   3
   /* POWER_UP8_1 command, CONFIG_1P8V field definition (address 3,size 4, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_CONFIG_1P8V_LSB         0
   #define  Si2144_POWER_UP8_1_CMD_CONFIG_1P8V_MASK        0x0f
   #define  Si2144_POWER_UP8_1_CMD_CONFIG_1P8V_MIN         6
   #define  Si2144_POWER_UP8_1_CMD_CONFIG_1P8V_MAX         14
    #define Si2144_POWER_UP8_1_CMD_CONFIG_1P8V_EXTERNAL_PNP_LDO  7
    #define Si2144_POWER_UP8_1_CMD_CONFIG_1P8V_EXTERNAL_SUPPLY   6
    #define Si2144_POWER_UP8_1_CMD_CONFIG_1P8V_INTERNAL_REG      14
   /* POWER_UP8_1 command, RESERVED3 field definition (address 4,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_RESERVED3_LSB         0
   #define  Si2144_POWER_UP8_1_CMD_RESERVED3_MASK        0xff
   #define  Si2144_POWER_UP8_1_CMD_RESERVED3_MIN         0
   #define  Si2144_POWER_UP8_1_CMD_RESERVED3_MAX         0
    #define Si2144_POWER_UP8_1_CMD_RESERVED3_RESERVED  0
   /* POWER_UP8_1 command, RESERVED4 field definition (address 5,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_RESERVED4_LSB         0
   #define  Si2144_POWER_UP8_1_CMD_RESERVED4_MASK        0xff
   #define  Si2144_POWER_UP8_1_CMD_RESERVED4_MIN         1
   #define  Si2144_POWER_UP8_1_CMD_RESERVED4_MAX         1
    #define Si2144_POWER_UP8_1_CMD_RESERVED4_RESERVED  1
   /* POWER_UP8_1 command, RESERVED5 field definition (address 6,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_RESERVED5_LSB         0
   #define  Si2144_POWER_UP8_1_CMD_RESERVED5_MASK        0xff
   #define  Si2144_POWER_UP8_1_CMD_RESERVED5_MIN         1
   #define  Si2144_POWER_UP8_1_CMD_RESERVED5_MAX         1
    #define Si2144_POWER_UP8_1_CMD_RESERVED5_RESERVED  1
   /* POWER_UP8_1 command, RESERVED6 field definition (address 7,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_1_CMD_RESERVED6_LSB         0
   #define  Si2144_POWER_UP8_1_CMD_RESERVED6_MASK        0xff
   #define  Si2144_POWER_UP8_1_CMD_RESERVED6_MIN         1
   #define  Si2144_POWER_UP8_1_CMD_RESERVED6_MAX         1
    #define Si2144_POWER_UP8_1_CMD_RESERVED6_RESERVED  1
#endif /* Si2144_POWER_UP8_1_CMD */

/* Si2144_POWER_UP8_2 command definition */
#define   Si2144_POWER_UP8_2_CMD 0xc0

#ifdef    Si2144_POWER_UP8_2_CMD
  #define Si2144_POWER_UP8_2_CMD_CODE 0x0600c0

    typedef struct { /* Si2144_POWER_UP8_2_CMD_struct */
     unsigned char   subcode;
     unsigned char   reserved7;
     unsigned char   reserved8;
   } Si2144_POWER_UP8_2_CMD_struct;


    typedef struct { /* Si2144_POWER_UP8_2_CMD_REPLY_struct */
       Si2144_COMMON_REPLY_struct * STATUS;
   }  Si2144_POWER_UP8_2_CMD_REPLY_struct;

   /* POWER_UP8_2 command, SUBCODE field definition (address 1,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_2_CMD_SUBCODE_LSB         0
   #define  Si2144_POWER_UP8_2_CMD_SUBCODE_MASK        0xff
   #define  Si2144_POWER_UP8_2_CMD_SUBCODE_MIN         6
   #define  Si2144_POWER_UP8_2_CMD_SUBCODE_MAX         6
    #define Si2144_POWER_UP8_2_CMD_SUBCODE_CODE  6
   /* POWER_UP8_2 command, RESERVED7 field definition (address 2,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_2_CMD_RESERVED7_LSB         0
   #define  Si2144_POWER_UP8_2_CMD_RESERVED7_MASK        0xff
   #define  Si2144_POWER_UP8_2_CMD_RESERVED7_MIN         1
   #define  Si2144_POWER_UP8_2_CMD_RESERVED7_MAX         1
    #define Si2144_POWER_UP8_2_CMD_RESERVED7_RESERVED  1
   /* POWER_UP8_2 command, RESERVED8 field definition (address 3,size 8, lsb 0, unsigned) */
   #define  Si2144_POWER_UP8_2_CMD_RESERVED8_LSB         0
   #define  Si2144_POWER_UP8_2_CMD_RESERVED8_MASK        0xff
   #define  Si2144_POWER_UP8_2_CMD_RESERVED8_MIN         3
   #define  Si2144_POWER_UP8_2_CMD_RESERVED8_MAX         3
    #define Si2144_POWER_UP8_2_CMD_RESERVED8_RESERVED  3
...
#define   Si2144_SET_PROPERTY_CMD 0x14
  ...
  #define Si2144_SET_PROPERTY_CMD_CODE 0x010014
   ...
   #define  Si2144_SET_PROPERTY_CMD_RESERVED_MAX         255
...
#define   Si2144_WAKE_UP_CMD 0xc0
  ...
  #define Si2144_WAKE_UP_CMD_CODE 0x0800c0
   ...
   #define  Si2144_WAKE_UP_CMD_FUNC_MIN         0
   #define  Si2144_WAKE_UP_CMD_FUNC_MAX         0
    #define Si2144_WAKE_UP_CMD_FUNC_BOOTLOADER  0
  ...
  typedef struct { /* Si2144_CmdObj struct */
    ...
    #endif /* Si2144_POWER_UP_CMD */
    #ifdef    Si2144_POWER_UP8_1_CMD
              Si2144_POWER_UP8_1_CMD_struct      power_up8_1;
    #endif /* Si2144_POWER_UP8_1_CMD */
    #ifdef    Si2144_POWER_UP8_2_CMD
              Si2144_POWER_UP8_2_CMD_struct      power_up8_2;
    #endif /* Si2144_POWER_UP8_2_CMD */
    #ifdef    Si2144_REREAD_REPLY_CMD
  ...
  typedef struct { /* Si2144_CmdReplyObj struct */
    ...
    #endif /* Si2144_POWER_UP_CMD */
    #ifdef    Si2144_POWER_UP8_1_CMD
              Si2144_POWER_UP8_1_CMD_REPLY_struct      power_up8_1;
    #endif /* Si2144_POWER_UP8_1_CMD */
    #ifdef    Si2144_POWER_UP8_2_CMD
              Si2144_POWER_UP8_2_CMD_REPLY_struct      power_up8_2;
    #endif /* Si2144_POWER_UP8_2_CMD */
    #ifdef    Si2144_REREAD_REPLY_CMD
