/*************************************************************************************
 ...
 | To customize properties for your application please edit the settings in Si2144_User_Properties.c
 |---------------------------------------------------------------------------------------------------------------------|
 ...
 ***********************************************************************************************************************/
unsigned char Si2144_L1_SetProperty         (L1_Si2144_Context *api, unsigned int prop_code, signed   int  data) {
...
/***********************************************************************************************************************
  ...
  Returns:    0 if no error, an error code otherwise
 ***********************************************************************************************************************/
unsigned char Si2144_L1_GetProperty         (L1_Si2144_Context *api, unsigned int prop_code, signed   int *data) {
...
unsigned char Si2144_L1_SetProperty2        (L1_Si2144_Context *api, unsigned int prop_code) {
    ...
    if (res != NO_Si2144_ERROR) {
      SiTRACE("Si2144_L1_SetProperty2: %s 0x%04x\n", Si2144_L1_API_ERROR_TEXT(res), prop_code);
...
#ifdef    Si2144_WIDE_BAND_ATT_THRS_PROP
  if (Si2144_L1_SetProperty2(api, Si2144_WIDE_BAND_ATT_THRS_PROP_CODE          ) != NO_Si2144_ERROR) {return ERROR_Si2144_SENDING_COMMAND;}
#endif /* Si2144_WIDE_BAND_ATT_THRS_PROP */
return NO_Si2144_ERROR;
}
...
#ifdef    TER_TUNER_SILABS
    /* Re-definition of SiTAG for Si2144_PropObj */
    #ifdef    SiTRACES
        #undef  SiTAG
        #define SiTAG   ""
    #endif /* SiTRACES */
...
unsigned char Si2144_PackProperty            (Si2144_PropObj   *prop, unsigned int prop_code, signed   int *data) {
    ...
    #endif /*     Si2144_TUNER_RETURN_LOSS_PROP */
    #ifdef        Si2144_WIDE_BAND_ATT_THRS_PROP
     case         Si2144_WIDE_BAND_ATT_THRS_PROP_CODE:
      *data = (prop->wide_band_att_thrs.wb_att_thrs & Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK) << Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB ;
     break;
    #endif /*     Si2144_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2144_XOUT_PROP
...
unsigned char Si2144_UnpackProperty          (Si2144_PropObj   *prop, unsigned int prop_code, signed   int  data) {
    ...
    #ifdef        Si2144_WIDE_BAND_ATT_THRS_PROP
     case         Si2144_WIDE_BAND_ATT_THRS_PROP_CODE:
               prop->wide_band_att_thrs.wb_att_thrs = (data >> Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB) & Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK;
     break;
    #endif /*     Si2144_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2144_XOUT_PROP
     case         Si2144_XOUT_PROP_CODE:
...
#ifdef    Si2144_WIDE_BAND_ATT_THRS_PROP
  prop->wide_band_att_thrs.wb_att_thrs       = Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_AUTO ; /* (default 'AUTO') */
#endif /* Si2144_WIDE_BAND_ATT_THRS_PROP */
...
unsigned char Si2144_L1_PropertyText          (Si2144_PropObj   *prop, unsigned int prop_code, const char *separator, char *msg) {
    switch (prop_code) {
     ...
     case         Si2144_TUNER_RETURN_LOSS_PROP_CODE:
      snprintf(msg,1000,"TUNER_RETURN_LOSS");
       strncat(msg,separator,1000); strncat(msg,"-RESERVED ",1000);
           if  (prop->tuner_return_loss.reserved   ==   383) strncat(msg,"RESERVED ",1000);
      else                                                  STRING_APPEND_SAFE(msg,1000,"%d", prop->tuner_return_loss.reserved);
    ...
    #ifdef        Si2144_WIDE_BAND_ATT_THRS_PROP
     case         Si2144_WIDE_BAND_ATT_THRS_PROP_CODE:
      snprintf(msg,1000,"WIDE_BAND_ATT_THRS");
       strncat(msg,separator,1000); strncat(msg,"-WB_ATT_THRS ",1000);
           if  (prop->wide_band_att_thrs.wb_att_thrs ==     0) strncat(msg,"AUTO    ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==     6) strncat(msg,"P6DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==     7) strncat(msg,"P5DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==     8) strncat(msg,"P4DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==     9) strncat(msg,"P3DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    10) strncat(msg,"P2DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    11) strncat(msg,"P1DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    12) strncat(msg,"0DBM    ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    13) strncat(msg,"M1DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    14) strncat(msg,"M2DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    15) strncat(msg,"M3DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    16) strncat(msg,"M4DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    17) strncat(msg,"M5DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    18) strncat(msg,"M6DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    19) strncat(msg,"M7DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    20) strncat(msg,"M8DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    21) strncat(msg,"M9DBM   ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    22) strncat(msg,"M10DBM  ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    23) strncat(msg,"M11DBM  ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==    24) strncat(msg,"M12DBM  ",1000);
      else if  (prop->wide_band_att_thrs.wb_att_thrs ==   255) strncat(msg,"DISABLE ",1000);
      else                                                    STRING_APPEND_SAFE(msg,1000,"%d", prop->wide_band_att_thrs.wb_att_thrs);
     break;
    #endif /*     Si2144_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2144_XOUT_PROP
     case         Si2144_XOUT_PROP_CODE:
     ...
     break;
    #endif /*     Si2144_XOUT_PROP */
     default : snprintf(msg,1000,"Unknown property code '0x%06x'\n", prop_code); return ERROR_Si2144_UNKNOWN_PROPERTY; break;
  }
  return NO_Si2144_ERROR;
}
/***********************************************************************************************************************
...
unsigned char Si2144_L1_GetPropertyString     (L1_Si2144_Context *api, unsigned int prop_code, const char *separator, char *msg) {
    ...
    if (res!=NO_Si2144_ERROR) { snprintf(msg,1000, "%s",Si2144_L1_API_ERROR_TEXT(res)); return res; }
    Si2144_L1_PropertyText(api->prop, prop_code, separator, msg);
    return NO_Si2144_ERROR;
}
