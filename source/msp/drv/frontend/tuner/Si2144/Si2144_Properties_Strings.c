...
Si2144_optionStruct    Si2144_TUNER_RETURN_LOSS_PROP_RESERVED[] =
{
  {"RESERVED",   383},
};
...
{
  {"RESERVED",   Si2144_UNSIGNED_INT, &Si2144_prop.tuner_return_loss.reserved  , sizeof(Si2144_TUNER_RETURN_LOSS_PROP_RESERVED  )/sizeof(Si2144_optionStruct), Si2144_TUNER_RETURN_LOSS_PROP_RESERVED  },
...
Si2144_optionStruct    Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS[] =
{
  {"AUTO",        0},
  {"P6DBM",       6},
  {"P5DBM",       7},
...
Si2144_fieldDicoStruct Si2144_WIDE_BAND_ATT_THRS_PROP_FIELDS[] =
{
  {"WB_ATT_THRS", Si2144_UNSIGNED_CHAR, &Si2144_prop.wide_band_att_thrs.wb_att_thrs, sizeof(Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS)/sizeof(Si2144_optionStruct), Si2144_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS},
};
...
Si2144_propertyInfoStruct Si2144_propertyDictionary[] =
{
  ...
  {Si2144_TUNER , "WIDE_BAND_ATT_THRS"          , sizeof(Si2144_WIDE_BAND_ATT_THRS_PROP_FIELDS          )/sizeof(Si2144_fieldDicoStruct), Si2144_WIDE_BAND_ATT_THRS_PROP_FIELDS           , Si2144_WIDE_BAND_ATT_THRS_PROP           },
};
...
int   Si2144_PropertyIndex        (L1_Si2144_Context *api, const char *property)
{
  ...
  for (propIndex=0; propIndex <size; propIndex++)
  {
    if (strcmp_nocase(property, Si2144_propertyDictionary[propIndex].name)==0)
    {
      return propIndex;
    }
  }
...
int   Si2144_PropertyFieldIndex   (L1_Si2144_Context *api, int propIndex, char *field)
{
  ...
  for (fieldIndex=0; fieldIndex < Si2144_propertyDictionary[propIndex].nbFields; fieldIndex++)
  {
    if (strcmp_nocase(field, Si2144_propertyDictionary[propIndex].field[fieldIndex].name)==0)
    {
      return fieldIndex;
    }
  }
...
void  Si2144_showProperty         (L1_Si2144_Context *api, int propIndex)
{
  ...
  for (fieldIndex=0; fieldIndex<Si2144_propertyDictionary[propIndex].nbFields; fieldIndex++)
  {
    printf("%s:%s:%s = ", Si2144_featureText[Si2144_propertyDictionary[propIndex].feature], Si2144_propertyDictionary[propIndex].name, Si2144_propertyDictionary[propIndex].field[fieldIndex].name);
...
void  Si2144_setupProperty        (L1_Si2144_Context *api, int propIndex)
{
  ...
  for (fieldIndex=0; fieldIndex<Si2144_propertyDictionary[propIndex].nbFields; fieldIndex++)
  {
    isRangeType = (strcmp_nocase(Si2144_propertyDictionary[propIndex].field[fieldIndex].option->name,"MIN_RANGE") == 0);
