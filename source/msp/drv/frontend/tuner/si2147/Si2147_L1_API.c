 ...
 ***********************************************************************************************************************/
unsigned char    Si2147_L1_API_Init      (unsigned int u32TunerId,L1_Si2147_Context *api, int add,unsigned int u32I2cChannel) {
    api->i2c = &(api->i2cObj);
...
/***********************************************************************************************************************
  ...
  Porting:    May not be required for the final application, can be removed if not used.
 ***********************************************************************************************************************/
char*            Si2147_L1_API_TAG_TEXT(void) { return (char *)"ROM50_3_4_build_4_V0.1";}
