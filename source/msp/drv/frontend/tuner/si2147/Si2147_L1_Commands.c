 ...
 ***********************************************************************************************************************/
unsigned char Si2147_convert_to_byte (const unsigned char* buffer, unsigned char shift, unsigned char mask) {
   unsigned int rspBuffer = *buffer;
   return ((rspBuffer >> shift) & mask);
}
unsigned long Si2147_convert_to_ulong(const unsigned char* buffer, unsigned char shift,unsigned long mask) {
    return ((( ( (unsigned long)buffer[0]) | ((unsigned long)buffer[1] << 8) | ((unsigned long)buffer[2]<<16) | ((unsigned long)buffer[3]<<24)) >> shift) & mask );
}
unsigned int  Si2147_convert_to_uint (const unsigned char* buffer, unsigned char shift,unsigned int mask) {
    return (( ( (unsigned int)buffer[0]) | (((unsigned int)buffer[1]) << 8) >> shift) & mask);
}
short  Si2147_convert_to_int (const unsigned char* buffer, unsigned char shift,unsigned int mask) {
    return (( ( (unsigned int)buffer[0]) | (((unsigned int)buffer[1]) << 8) >> shift) & mask);
}
/***********************************************************************************************************************
...
{
    api->status->tunint =     Si2147_convert_to_byte(&ptDataBuffer, 0, 0x01);
    api->status->atvint =     Si2147_convert_to_byte(&ptDataBuffer, 1, 0x01);
    api->status->dtvint =     Si2147_convert_to_byte(&ptDataBuffer, 2, 0x01);
    api->status->err    =     Si2147_convert_to_byte(&ptDataBuffer, 6, 0x01);
    api->status->cts    =     Si2147_convert_to_byte(&ptDataBuffer, 7, 0x01);
...
unsigned char Si2147_L1_ATV_RESTART     (L1_Si2147_Context *api)
{
    ...
    SiTRACE("Si2147 ATV_RESTART ");
    SiTRACE("\n");
    cmdByteBuffer[0] = Si2147_ATV_RESTART_CMD;
                                         ...
                                         unsigned char   intack)
{
    ...
    SiTRACE("Si2147 ATV_STATUS ");
  #ifdef   DEBUG_RANGE_CHECK
    if ((intack > Si2147_ATV_STATUS_CMD_INTACK_MAX) ) {error_code++; SiTRACE("\nOut of range: ");}; SiTRACE("INTACK %d ", intack );
    if (error_code) {
      SiTRACE("%d out of range parameters\n", error_code);
      return ERROR_Si2147_PARAMETER_OUT_OF_RANGE;
    }
    ...
    SiTRACE("\n");
    cmdByteBuffer[0] = Si2147_ATV_STATUS_CMD;
    cmdByteBuffer[1] = (unsigned char) ( ( intack & Si2147_ATV_STATUS_CMD_INTACK_MASK ) << Si2147_ATV_STATUS_CMD_INTACK_LSB);

    if (L0_WriteCommandBytes(api->i2c, 2, cmdByteBuffer) != 2) {
      SiTRACE("Error writing ATV_STATUS bytes!\n");
      return ERROR_Si2147_SENDING_COMMAND;
    }
    error_code = Si2147_pollForResponse(api, 9, rspByteBuffer);
    if (error_code) {
      SiTRACE("Error polling ATV_STATUS response\n");
      return error_code;
    }
    api->rsp->atv_status.chlint    = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_ATV_STATUS_RESPONSE_CHLINT_LSB     , Si2147_ATV_STATUS_RESPONSE_CHLINT_MASK    );
    api->rsp->atv_status.pclint    = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_ATV_STATUS_RESPONSE_PCLINT_LSB     , Si2147_ATV_STATUS_RESPONSE_PCLINT_MASK    );
    api->rsp->atv_status.chl       = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_ATV_STATUS_RESPONSE_CHL_LSB        , Si2147_ATV_STATUS_RESPONSE_CHL_MASK       );
    api->rsp->atv_status.pcl       = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_ATV_STATUS_RESPONSE_PCL_LSB        , Si2147_ATV_STATUS_RESPONSE_PCL_MASK       );
    api->rsp->atv_status.afc_freq  = Si2147_convert_to_int  (&rspByteBuffer[ 4] , Si2147_ATV_STATUS_RESPONSE_AFC_FREQ_LSB   , Si2147_ATV_STATUS_RESPONSE_AFC_FREQ_MASK  );
    api->rsp->atv_status.video_sys = Si2147_convert_to_byte  (&rspByteBuffer[ 8] , Si2147_ATV_STATUS_RESPONSE_VIDEO_SYS_LSB  , Si2147_ATV_STATUS_RESPONSE_VIDEO_SYS_MASK );
    api->rsp->atv_status.color     = Si2147_convert_to_byte  (&rspByteBuffer[ 8] , Si2147_ATV_STATUS_RESPONSE_COLOR_LSB      , Si2147_ATV_STATUS_RESPONSE_COLOR_MASK     );
                                         ...
                                         unsigned char   reserved3)
{
    ...
    api->rsp->config_pins.gpio1_mode  = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_CONFIG_PINS_RESPONSE_GPIO1_MODE_LSB   , Si2147_CONFIG_PINS_RESPONSE_GPIO1_MODE_MASK  );
    api->rsp->config_pins.gpio1_state = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_CONFIG_PINS_RESPONSE_GPIO1_STATE_LSB  , Si2147_CONFIG_PINS_RESPONSE_GPIO1_STATE_MASK );
    api->rsp->config_pins.gpio2_mode  = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_CONFIG_PINS_RESPONSE_GPIO2_MODE_LSB   , Si2147_CONFIG_PINS_RESPONSE_GPIO2_MODE_MASK  );
    api->rsp->config_pins.gpio2_state = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_CONFIG_PINS_RESPONSE_GPIO2_STATE_LSB  , Si2147_CONFIG_PINS_RESPONSE_GPIO2_STATE_MASK );
    api->rsp->config_pins.reserved1   = Si2147_convert_to_byte  (&rspByteBuffer[ 3] , Si2147_CONFIG_PINS_RESPONSE_RESERVED1_LSB    , Si2147_CONFIG_PINS_RESPONSE_RESERVED1_MASK   );
    api->rsp->config_pins.reserved2   = Si2147_convert_to_byte  (&rspByteBuffer[ 4] , Si2147_CONFIG_PINS_RESPONSE_RESERVED2_LSB    , Si2147_CONFIG_PINS_RESPONSE_RESERVED2_MASK   );
    api->rsp->config_pins.reserved3   = Si2147_convert_to_byte  (&rspByteBuffer[ 5] , Si2147_CONFIG_PINS_RESPONSE_RESERVED3_LSB    , Si2147_CONFIG_PINS_RESPONSE_RESERVED3_MASK   );
                                         ...
                                         unsigned char   intack)
{
    ...
    api->rsp->dtv_status.chlint     = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_DTV_STATUS_RESPONSE_CHLINT_LSB      , Si2147_DTV_STATUS_RESPONSE_CHLINT_MASK     );
    api->rsp->dtv_status.chl        = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_DTV_STATUS_RESPONSE_CHL_LSB         , Si2147_DTV_STATUS_RESPONSE_CHL_MASK        );
    api->rsp->dtv_status.bw         = Si2147_convert_to_byte  (&rspByteBuffer[ 3] , Si2147_DTV_STATUS_RESPONSE_BW_LSB          , Si2147_DTV_STATUS_RESPONSE_BW_MASK         );
    api->rsp->dtv_status.modulation = Si2147_convert_to_byte  (&rspByteBuffer[ 3] , Si2147_DTV_STATUS_RESPONSE_MODULATION_LSB  , Si2147_DTV_STATUS_RESPONSE_MODULATION_MASK );
    return NO_Si2147_ERROR;
}
                                         ...
                                         unsigned int    prop)
{
    ...
    api->rsp->get_property.reserved = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_GET_PROPERTY_RESPONSE_RESERVED_LSB  , Si2147_GET_PROPERTY_RESPONSE_RESERVED_MASK );
    api->rsp->get_property.data     = Si2147_convert_to_uint  (&rspByteBuffer[ 2] , Si2147_GET_PROPERTY_RESPONSE_DATA_LSB      , Si2147_GET_PROPERTY_RESPONSE_DATA_MASK     );
...
unsigned char Si2147_L1_GET_REV         (L1_Si2147_Context *api)
{
    ...
    api->rsp->get_rev.pn       = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_GET_REV_RESPONSE_PN_LSB        , Si2147_GET_REV_RESPONSE_PN_MASK       );
    api->rsp->get_rev.fwmajor  = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_GET_REV_RESPONSE_FWMAJOR_LSB   , Si2147_GET_REV_RESPONSE_FWMAJOR_MASK  );
    api->rsp->get_rev.fwminor  = Si2147_convert_to_byte  (&rspByteBuffer[ 3] , Si2147_GET_REV_RESPONSE_FWMINOR_LSB   , Si2147_GET_REV_RESPONSE_FWMINOR_MASK  );
    api->rsp->get_rev.patch    = Si2147_convert_to_uint  (&rspByteBuffer[ 4] , Si2147_GET_REV_RESPONSE_PATCH_LSB     , Si2147_GET_REV_RESPONSE_PATCH_MASK    );
    api->rsp->get_rev.cmpmajor = Si2147_convert_to_byte  (&rspByteBuffer[ 6] , Si2147_GET_REV_RESPONSE_CMPMAJOR_LSB  , Si2147_GET_REV_RESPONSE_CMPMAJOR_MASK );
    api->rsp->get_rev.cmpminor = Si2147_convert_to_byte  (&rspByteBuffer[ 7] , Si2147_GET_REV_RESPONSE_CMPMINOR_LSB  , Si2147_GET_REV_RESPONSE_CMPMINOR_MASK );
    api->rsp->get_rev.cmpbuild = Si2147_convert_to_byte  (&rspByteBuffer[ 8] , Si2147_GET_REV_RESPONSE_CMPBUILD_LSB  , Si2147_GET_REV_RESPONSE_CMPBUILD_MASK );
    api->rsp->get_rev.chiprev  = Si2147_convert_to_byte  (&rspByteBuffer[ 9] , Si2147_GET_REV_RESPONSE_CHIPREV_LSB   , Si2147_GET_REV_RESPONSE_CHIPREV_MASK  );
...
unsigned char Si2147_L1_PART_INFO       (L1_Si2147_Context *api)
{
    ...
    api->rsp->part_info.chiprev  = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_PART_INFO_RESPONSE_CHIPREV_LSB   , Si2147_PART_INFO_RESPONSE_CHIPREV_MASK  );
    api->rsp->part_info.part     = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_PART_INFO_RESPONSE_PART_LSB      , Si2147_PART_INFO_RESPONSE_PART_MASK     );
    api->rsp->part_info.pmajor   = Si2147_convert_to_byte  (&rspByteBuffer[ 3] , Si2147_PART_INFO_RESPONSE_PMAJOR_LSB    , Si2147_PART_INFO_RESPONSE_PMAJOR_MASK   );
    api->rsp->part_info.pminor   = Si2147_convert_to_byte  (&rspByteBuffer[ 4] , Si2147_PART_INFO_RESPONSE_PMINOR_LSB    , Si2147_PART_INFO_RESPONSE_PMINOR_MASK   );
    api->rsp->part_info.pbuild   = Si2147_convert_to_byte  (&rspByteBuffer[ 5] , Si2147_PART_INFO_RESPONSE_PBUILD_LSB    , Si2147_PART_INFO_RESPONSE_PBUILD_MASK   );
    api->rsp->part_info.reserved = Si2147_convert_to_uint  (&rspByteBuffer[ 6] , Si2147_PART_INFO_RESPONSE_RESERVED_LSB  , Si2147_PART_INFO_RESPONSE_RESERVED_MASK );
    api->rsp->part_info.serial   = Si2147_convert_to_ulong (&rspByteBuffer[ 8] , Si2147_PART_INFO_RESPONSE_SERIAL_LSB    , Si2147_PART_INFO_RESPONSE_SERIAL_MASK   );
    api->rsp->part_info.romid    = Si2147_convert_to_byte  (&rspByteBuffer[12] , Si2147_PART_INFO_RESPONSE_ROMID_LSB     , Si2147_PART_INFO_RESPONSE_ROMID_MASK    );
                                         ...
                                         unsigned char   reserved8)
{
    ...
    error_code = Si2147_pollForResetState(api);
    if (error_code) {
                                         ...
                                         unsigned int    data)
{
    ...
    api->rsp->set_property.reserved = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_SET_PROPERTY_RESPONSE_RESERVED_LSB  , Si2147_SET_PROPERTY_RESPONSE_RESERVED_MASK );
    api->rsp->set_property.data     = Si2147_convert_to_uint  (&rspByteBuffer[ 2] , Si2147_SET_PROPERTY_RESPONSE_DATA_LSB      , Si2147_SET_PROPERTY_RESPONSE_DATA_MASK     );
   ...
   /* Update propShadow with latest data if correctly set */
    ...
    {
        SiTRACE("\nSi2147_L1_SetProperty: Skipping Property Setting 0x%04x because value unchanged 0x%04x\n", prop,data);
                                         ...
                                         unsigned char   intack)
{
   ...
   SiTRACE("Si2147 TUNER_STATUS ");
    ...
    api->rsp->tuner_status.tcint    = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_TUNER_STATUS_RESPONSE_TCINT_LSB     , Si2147_TUNER_STATUS_RESPONSE_TCINT_MASK    );
    api->rsp->tuner_status.rssilint = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_TUNER_STATUS_RESPONSE_RSSILINT_LSB  , Si2147_TUNER_STATUS_RESPONSE_RSSILINT_MASK );
    api->rsp->tuner_status.rssihint = Si2147_convert_to_byte  (&rspByteBuffer[ 1] , Si2147_TUNER_STATUS_RESPONSE_RSSIHINT_LSB  , Si2147_TUNER_STATUS_RESPONSE_RSSIHINT_MASK );
    api->rsp->tuner_status.tc       = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_TUNER_STATUS_RESPONSE_TC_LSB        , Si2147_TUNER_STATUS_RESPONSE_TC_MASK       );
    api->rsp->tuner_status.rssil    = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_TUNER_STATUS_RESPONSE_RSSIL_LSB     , Si2147_TUNER_STATUS_RESPONSE_RSSIL_MASK    );
    api->rsp->tuner_status.rssih    = Si2147_convert_to_byte  (&rspByteBuffer[ 2] , Si2147_TUNER_STATUS_RESPONSE_RSSIH_LSB     , Si2147_TUNER_STATUS_RESPONSE_RSSIH_MASK    );
    api->rsp->tuner_status.rssi     = Si2147_convert_to_byte  (&rspByteBuffer[ 3] , Si2147_TUNER_STATUS_RESPONSE_RSSI_LSB      , Si2147_TUNER_STATUS_RESPONSE_RSSI_MASK     );
    api->rsp->tuner_status.freq     = Si2147_convert_to_ulong (&rspByteBuffer[ 4] , Si2147_TUNER_STATUS_RESPONSE_FREQ_LSB      , Si2147_TUNER_STATUS_RESPONSE_FREQ_MASK     );
    api->rsp->tuner_status.mode     = Si2147_convert_to_byte  (&rspByteBuffer[ 8] , Si2147_TUNER_STATUS_RESPONSE_MODE_LSB      , Si2147_TUNER_STATUS_RESPONSE_MODE_MASK     );
    api->rsp->tuner_status.vco_code = Si2147_convert_to_int  (&rspByteBuffer[10] , Si2147_TUNER_STATUS_RESPONSE_VCO_CODE_LSB  , Si2147_TUNER_STATUS_RESPONSE_VCO_CODE_MASK );
    return NO_Si2147_ERROR;
}
...
unsigned char   Si2147_L1_SendCommand2(L1_Si2147_Context *api, unsigned int cmd_code) {
    ...
    #endif /*     Si2147_ATV_CW_TEST_CMD */
    #ifdef        Si2147_ATV_RESTART_CMD
     case         Si2147_ATV_RESTART_CMD_CODE:
       return Si2147_L1_ATV_RESTART (api );
     break;
    #endif /*     Si2147_ATV_RESTART_CMD */
    #ifdef        Si2147_ATV_SCAN_TUNE_CMD
    ...
    #endif /*     Si2147_ATV_SCAN_TUNE_CMD */
    #ifdef        Si2147_ATV_STATUS_CMD
     case         Si2147_ATV_STATUS_CMD_CODE:
       return Si2147_L1_ATV_STATUS (api, api->cmd->atv_status.intack );
     break;
    #endif /*     Si2147_ATV_STATUS_CMD */
    #ifdef        Si2147_CONFIG_CLOCKS_CMD
