...
static long hi_gpio_ioctl(struct file *filp, HI_U32 cmd, unsigned long arg)
{
    ...
    GPIO_INT_S GpioIntValue = {0};

    if(HI_NULL == argp)
    {
		HI_INFO_GPIO("invalid para\n");
		return HI_FAILURE;
    }
    ...
    {
        GPIO_OUTPUT_TYPE_S stOutputType = {0};
