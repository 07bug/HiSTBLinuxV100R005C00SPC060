...
static char *clock_table_15_15[3] = {"operating-points-ff-15x15", "operating-points-tt-15x15", "operating-points-ss-15x15"};
static char *clock_table_21_21[3] = {"operating-points-ff-21x21", "operating-points-tt-21x21", "operating-points-ss-21x21"};
#endif
...
char* opps_get_svb_type(void)
{
...
#if defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450)
    HI_CHIP_PACKAGE_TYPE_E PackageType;
#endif
...
#if defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450)
    HI_DRV_SYS_GetChipPackageType(&PackageType);

    /* 96mv200 ChipType had 2 solutions */
    if(PackageType == HI_CHIP_PACKAGE_TYPE_BGA_21_21)
    {
        /* 21x21 package */
	s_MaxFreq = 864000000;

        return clock_table_21_21[svb_type - 1];
    }
    else
    {
        /* 15x15 package */
	s_MaxFreq = 750000000;
        ...
        return clock_table_15_15[svb_type - 1];
    }
#endif
...
#else
    operating_points = "operating-points-tt";
#endif
...
#ifdef GPU_SUPPORT_SVB
#if !(defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450))		/* in 96mv200, gpu and core have different power domain */
