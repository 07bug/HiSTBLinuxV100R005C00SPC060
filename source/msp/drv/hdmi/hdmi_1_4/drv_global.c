...
static HDMI_COMM_ATTR_S g_stHdmiCommParam = {0};

static HDMI_CHN_ATTR_S  g_stHdmiChnParam[HI_UNF_HDMI_ID_BUTT] = { {0} };

static HI_UNF_EDID_BASE_INFO_S g_stEdidInfo[HI_UNF_HDMI_ID_BUTT] = { {0} };

static HDMI_PRIVATE_EDID_S g_stPriEdidInfo[HI_UNF_HDMI_ID_BUTT] = { {0} };
...
HI_DRV_HDMI_AUDIO_CAPABILITY_S g_stHdmiOldAudio = {{0},{0},0};
...
HDMI_EDID_S g_ExtEdid[HI_UNF_HDMI_ID_BUTT] = { {0} };
...
HI_U32 DRV_Calculate_TMDSCLK(HI_UNF_ENC_FMT_E fmt, HI_UNF_HDMI_DEEP_COLOR_E enDeepColorMode)
{
    ...
    switch(enDeepColorMode)
    {
        ...
        case HI_UNF_HDMI_DEEP_COLOR_30BIT   : 
            u32PClk = (u32PClk * 5) / 4 ;      //Ratio 1.25
            break;
