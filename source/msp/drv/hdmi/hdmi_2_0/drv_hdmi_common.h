...
#define FMT_PIX_CLK_594000               594000
...
typedef enum {
    HDMI_HDCP_ERR_UNDO = 0x0,
    HDMI_HDCP_ERR_NONE,
    HDMI_HDCP_ERR_UNHPD,
    HDMI_HDCP_ERR_NO_TIMMING,
    HDMI_HDCP_ERR_LOADKEY_FAIL,
    HDMI_HDCP_ERR_ON_REVOCATION_LIST,
    HDMI_HDCP_ERR_RECEIVER_FAIL,
    HDMI_HDCP_ERR_MAXDEV_EXCEEDED,
    HDMI_HDCP_ERR_MAXCASCADE_EXCEEDED,
    HDMI_HDCP_ERR_REPEATER_FAIL,
}HDMI_HDCP_ERR_E;
typedef enum
{
...
typedef enum
{
    HDMI_QUANTIZATION_LIMITED,
    HDMI_QUANTIZATION_FULL,
}HDMI_QUANTIZATION_E;
...
typedef struct
{
    ...
    HDMI_QUANTIZATION_E         enInQuantization;           /* only for VO in */
    HDMI_QUANTIZATION_E         enOutQuantization;          /* only for reg */
...
typedef union
{
    ...
    HDMI_CEC_UICMD_E                 enUIOpcode; // discard member
}HDMI_CEC_Operand_S;
...
typedef enum hiHDMI_HDCP_STAT_EN
{
    HDMI_HDCP_UNDO,              /**<HDCP operation is un-do */
    HDMI_HDCP_TRUE,              /**<HDCP operation is finished,and the result is true */
    HDMI_HDCP_FALSE,             /**<HDCP operation is finished,and the result is false */
    HDMI_HDCP_ERROR,             /**<HDCP operation is error in processing */
    HDMI_HDCP_BUTT,
}HDMI_HDCP_STAT_EN;

typedef struct hiHDMI_HDCP_CAPABILITY_S
{
    HDMI_HDCP_STAT_EN       enHdcp14Cap;
    HDMI_HDCP_STAT_EN       enHdcp22Cap;
}HDMI_HDCP_CAPABILITY_S;

#define HDMI_HDCP14_MAX_KEY_SIZE    332

typedef struct
{
    HDMI_HDCP_MODE_E        enHdcpMode;
    HDMI_HDCP_CAPABILITY_S  stHdcpCap;
    HI_BOOL                 bHdcpEnable;
    HI_BOOL                 bHdcp14LoadKey;
    HI_BOOL                 bHdcp22LoadCode;
    HI_BOOL                 bHdcpAuthSuc;
    HI_BOOL                 bHdcpDdcBusy;
    HDMI_HDCP_ERR_E         enHdcpErrCode;
    HDMI_HDCP_VERSION_E     enHdcpVersion;
    HDMI_LOAD_KEY_S         stLoadInfo;
    HI_U8                   au8KeyData[HDMI_HDCP14_MAX_KEY_SIZE];
}HDMI_HDCP_INFO_S;
...
typedef struct
{
    ...
    HDMI_QUANTIZATION_E     enInQuantization;
    HDMI_QUANTIZATION_E     enOutQuantization;
    HDMI_COLORSPACE_E       enInColorSpace;
    HDMI_COLORSPACE_E       enOutColorSpace;
    HDMI_DEEP_COLOR_E       enDeepColor;
    HDMI_VIDEO_BITDEPTH_E   enInBitDepth;
    HI_BOOL                 bEmiEnable;
    HDMI_HDR_MODE_E         enHdrMode;
}HDMI_VIDEO_CONFIG_S;
...
typedef struct{
    HI_BOOL     bFillterEnable;     /* hpd_fillter_en */
    HI_U32      u32FillTerHigh;     /* hpd_high_reshold */
    HI_U32      u32FillTerLow;      /* hpd_low_reshold */
}HDMI_HPD_FILLTER_S;
