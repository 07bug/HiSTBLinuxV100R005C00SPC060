...
typedef struct hiHDMI_EDID_DOLBY_CAPS_VER_2_S
{
    HI_BOOL     bYUV422_12Bit;          /* support(HI_TRUE) or not support(HI_FALSE) a YUV422-12Bit dolby singal */
    ...
    HI_U16      u16Blue_X;              /* blue primary chromaticity coordinate x   ,bit[11:0]valid.Real value =SUM OF bit[N]*2^-(12-N) */
    HI_U16      u16Blue_Y;              /* blue primary chromaticity coordinate y   ,bit[11:0]valid.Real value =SUM OF bit[N]*2^-(12-N) */
}HDMI_EDID_DOLBY_CAPS_VER_2_S;

typedef union hiHDMI_EDID_DOLBY_CAPS_U
{
    HDMI_EDID_DOLBY_CAPS_VER_0_S stVer0;
    HDMI_EDID_DOLBY_CAPS_VER_1_S stVer1;
    HDMI_EDID_DOLBY_CAPS_VER_2_S stVer2;
...
typedef struct hiHDMI_EDID_DOLBY_CAP_S
{
    ...
    HDMI_EDID_DOLBY_CAPS_U unVersionCaps; /* other caps in Dolby VSVDB. distinction between V0(u8VSVDBVersion=0) and V1(u8VSVDBVersion=1).*//**<CNcomment:Dolby的其他能力，依据Dolby VSVDB版本V0(u8VSVDBVersion=0)或V1来区分(u8VSVDBVersion=1)*/
...
typedef struct
{
    ...
    HI_U32                          u32VideoLatency ;
    HI_U32                          u32AudioLatency;
    HI_U32                          u32InterlacedVideoLatency;
    HI_U32                          u32InterlacedAudioLatency;
