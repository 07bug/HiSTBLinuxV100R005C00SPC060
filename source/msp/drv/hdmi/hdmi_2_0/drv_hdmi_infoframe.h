...
#define HDMI_SPD_IF_VN_SIZE        8
#define HDMI_SPD_IF_PD_SIZE        16
#define HDMI_AVI_COLORSPACE_MASK   0x60
...
enum hdmi_rgb_quantization_range {
...
struct hdmi_avi_infoframe {
    ...
    enum hdmi_rgb_quantization_range quantization_range;
    enum hdmi_nups nups;
...
typedef struct
{
    enum hdmi_infoframe_type type;                             /* HDMI_INFOFRAME_TYPE_SPD = 0x83, */
    HI_U8               version;                          /* 01 */
    HI_U8               length;                           /* 25 */
    HI_U8               u8CheckSum;
    HI_U8               u8VendorName[HDMI_SPD_IF_VN_SIZE];  /* Vendo r Nam e Char ac ter ,size=8 */
    HI_U8               u8ProductDesc[HDMI_SPD_IF_PD_SIZE];  /* Product Description Product Description ,size=16 */
    HI_U8               u8SrcDevInfo;
}HDMI_SPD_INFOFRAME_S;
...
typedef enum hdmi_rgb_quantization_range HDMI_QUANTIZATION_RANGE;
...
typedef struct
{
    ...
    HDMI_SPD_INFOFRAME_S    stSpdInfoFrame;
