...
//#define LOG_BUF_SIZE               (0x400000)           //default to use 4MB memory
#endif
...
#define HDMI_LOG_INFO(fmt...)      DRV_HDMI_LogRecord(LOG_LEVEL_INFO, LOG_TYPE_FUNC_API, (HI_U8*)__FUNCTION__, fmt)
#define HDMI_LOG_WARN(fmt...)      DRV_HDMI_LogRecord(LOG_LEVEL_WARN, LOG_TYPE_FUNC_API, (HI_U8*)__FUNCTION__, fmt)
#define HDMI_LOG_ERR(fmt...)       DRV_HDMI_LogRecord(LOG_LEVEL_ERROR, LOG_TYPE_FUNC_API, (HI_U8*)__FUNCTION__, fmt)
#define HDMI_LOG_FATAL(fmt...)     DRV_HDMI_LogRecord(LOG_LEVEL_FATAL, LOG_TYPE_FUNC_API, (HI_U8*)__FUNCTION__, fmt)
#endif
