...
#define TIMER_START__AVMUTE_CLR_STOP_MAX    65535
#define TIMER_START__AVMUTE_CNT_MAX         3855
...
/*****************************************************************************/
/**
* @brief Software reset resent avi.
*
* @param[in]  inst       Handle to instance
*
*****************************************************************************/
...
/*****************************************************************************/
/**
* @brief null packet enable/disable control.
*
* @param[in]  inst        Handle to instance
* @param[in]  onOff       Boolean to control enable/disable info-frames/packets
*                         - @ref true       Enable Info-frame/packet transmission.
...
/*****************************************************************************/
/**
* @brief HDCP Error code Get.
*
* @param[in]  inst        Handle to instance
* @param[in]  pstHdcpErrCode     HDCP error code
*
*****************************************************************************/
...
/*****************************************************************************/
/**
* @brief HDCP encryption set.
*
* @param[in]  inst            Handle to instance
* @param[in]  bEnable         en/de cryption.
*                             - @ref TRUE      encryption
*                             - @ref FALSE     decryption
*****************************************************************************/
...
/*****************************************************************************/
/**
* @brief Configure Dihter.
*
* @param[in]  inst    Handle to instance
* @param[in]  pstDitherMode Video path Dither mode.(USE CSC1 ,sdk)
*
*****************************************************************************/
