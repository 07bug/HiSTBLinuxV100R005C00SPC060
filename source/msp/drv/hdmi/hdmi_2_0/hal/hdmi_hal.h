...
typedef enum{
    ...
    HDMI_DEBUG_CMD_DUMP,
    HDMI_DEBUG_CMD_SW_MODE,
    HDMI_DEBUG_CMD_SWCTS,
    HDMI_DEBUG_CMD_N,
    HDMI_DEBUG_CMD_AUDIO_DELAY,
    HDMI_DEBUG_CMD_HPD_FILLTER,
    HDMI_DEBUG_CMD_HPD_SIMULATE,
    HDMI_DEBUG_CMD_CEC_DEVICE_TYPE,
    HDMI_DEBUG_CMD_ENCRYPTION,
...
typedef struct hiHDMI_HAL_S
{
    ...
    HI_VOID (*HAL_HDMI_BaseAddrGet)(struct hiHDMI_HAL_S *pstHdmiHal, HI_U32 **pu32Addr);
    HI_VOID (*HAL_HDMI_HWInitSet)(struct hiHDMI_HAL_S *pstHdmiHal, HI_BOOL bEnable);
    ...
    HI_S32 (*HAL_HDMI_HdcpStatusGet)(struct hiHDMI_HAL_S *pstHdmiHal, HDMI_HDCP_ERR_E *penHdcpErrCode);
