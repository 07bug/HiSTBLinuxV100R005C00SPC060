...
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm  auxrterm|*/
/**** diff mode */
    {{ 25000, 100000}, { 5,  0,  0,  0, 18, 25, 25, 25,  2,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20,      0}},
    {{100001, 165000}, { 5,  5,  5,  5, 22, 23, 23, 23, 10, 25, 25, 25, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20,      0}},
    {{165001, 340000}, { 9,  9,  9,  9, 22, 25, 25, 25, 30, 30, 30, 30, 20, 40, 40, 40, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20,      0}},
    {{340001, 600000}, { 5,  0,  0,  0, 29, 43, 43, 43,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_SOURCE, 0x00, PHY_RTERM_MODE_LOAD  , 0x80, PHY_RTERM_MODE_LOAD  , 0x80, PHY_RTERM_MODE_LOAD  , 0x80,      0}},
};

static PHY_HWSPEC_ENHANCE_S s_stPhyHWSpecTab_98mv300[] =
{
...
/**** double + diff mode */
    ...
    {{165001, 340000}, { 0,  2,  2,  2, 22, 29, 29, 29, HI_FALSE,  HI_TRUE,  HI_TRUE,  HI_TRUE, PHY_FEEDTHRU_CAP_DELAY_45PS, PHY_FEEDTHRU_CAP_DELAY_45PS, PHY_FEEDTHRU_CAP_DELAY_45PS, PHY_FEEDTHRU_CAP_DELAY_45PS, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_SRC_LD, 0x10, PHY_RTERM_MODE_SRC_LD, 0x10, PHY_RTERM_MODE_SRC_LD, 0x10, 0x51}},
...
static PHY_HWSPEC_ENHANCE_S s_stPhyHWSpecTab_98mv310[] =
{
/****|-TmdsclkRange---||DeIMain/0.25mA||-iMain/0.5mA--||-----------FeedThruCapEn-------------||---------------------------------------------------FeedThruCap delay----------------------------------------------||------------------------RTerm----------------------------------------------------------------------------------------------|**
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||  clk        d0        d1        d2  ||             clk                         d0                            d1                               d2        ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm VCM-sel|*/
/**** double + diff mode */
...
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm  auxrterm|*/
/**** double mode */
    {{ 25000, 100000}, { 0,  3,  3,  3, 27, 21, 21, 21,  0, 20, 20, 20, 20, 20, 20, 20, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0xf0, PHY_RTERM_MODE_SOURCE, 0x04, PHY_RTERM_MODE_SOURCE, 0x04, PHY_RTERM_MODE_SOURCE, 0x04,      0}},
    {{100001, 165000}, { 0,  4,  4,  4, 27, 22, 22, 22,  0, 25, 25, 25, 20, 20, 20, 20, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0xf0, PHY_RTERM_MODE_SOURCE, 0x04, PHY_RTERM_MODE_SOURCE, 0x04, PHY_RTERM_MODE_SOURCE, 0x04,      0}},
    {{165001, 340000}, { 0,  6,  6,  6, 27, 21, 21, 21,  0, 30, 30, 30, 40, 40, 40, 40, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RTERM_MODE_LOAD  , 0xf0, PHY_RTERM_MODE_SOURCE, 0x04, PHY_RTERM_MODE_SOURCE, 0x04, PHY_RTERM_MODE_SOURCE, 0x04,      0}},
    {{340001, 600000}, { 5,  0,  0,  0, 32, 43, 43, 43,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_SRC_LD, 0x00, PHY_RTERM_MODE_LOAD  , 0xb0, PHY_RTERM_MODE_LOAD  , 0xb0, PHY_RTERM_MODE_LOAD  , 0xb0,  0x3c0}},
};
#else
static PHY_HWSPEC_S s_stPhyHWSpecTab[] =
{
...
{
    {{ 25000,  70000}, {  0,     0}},  //0ppm
    {{ 70001,  90000}, {150, 45000}},  //0.37%=3700ppm
    {{ 90001, 110000}, { 70, 45000}},  //0.29%
    {{110001, 145000}, { 50, 45000}},  //0.24%
    {{145001, 180000}, {100, 45000}},  //0.17%
    {{180001, 220000}, { 40, 45000}},  //0.13%
    {{220001, 250000}, { 40, 45000}},  //0.10%
    {{250001, 300000}, { 40, 45000}},  //0.05%
    {{300001, 600000}, {  0,     0}},  //0
};
#else
static PHY_SSC_S s_stPhySscCfgTab[] =
...
#else
    pstPhyHWSpec  = &s_stPhyHWSpecTab[0];
    u32ArraySize  = PHY_ARRAY_SIZEOF(s_stPhyHWSpecTab);
#endif

    for( ;(pstPhyHWSpec && (i<u32ArraySize));pstPhyHWSpec++, i++)
    {
...
static PHY_HWSPEC_ENHANCE_CFG_S *PhyHWEnhanceSpecDataGet(HI_U32 u32TmdsClk)
{
    ...
    {
        pstPhyHWEnhanceSpec = &s_stPhyHWSpecTab_98mv310[0];
        u32ArraySize        = PHY_ARRAY_SIZEOF(s_stPhyHWSpecTab_98mv310);
    }
#endif
...
static PHY_SSC_CFG_S *PhySscDataGet(HI_U32 u32TmdsClk)
{
    ...
    else if (HDMI_CHIP_HI3798MV200 == DRV_HDMI_ProdChipGet() )
    {
        pstPhySsc    = &s_stPhySscCfgTab_98mv200[0];
        u32ArraySize = PHY_ARRAY_SIZEOF(s_stPhySscCfgTab_98mv200);
    }
    else if (HDMI_CHIP_HI3798MV310 == DRV_HDMI_ProdChipGet() )
    {
...
static HI_S32 PhyHWSpecSet(PHY_HWSPEC_CFG_S *pstHWSpecCfg)
{
    ...
    /* Auxiliary R Term*/
    // when RTermMode is SOURCE(double) those bits can be valid, then rterm resistance can go down 80Ohm below
    HDMI_APHY_TEST_CTRL_reg_test_dcSet(pstHWSpecCfg->u32AuxRtem);
...
static HI_S32 PhyHWEnhanceSpecSet(PHY_HWSPEC_ENHANCE_CFG_S *pstHWSpecCfg)
{
    ...
    /* status info set */
    HDMI_MEMCPY(&s_stHDMIPhyInfo.stHWSpecEnhanceCfg, pstHWSpecCfg, sizeof(PHY_HWSPEC_ENHANCE_CFG_S));

    return HI_SUCCESS;
}

static HI_VOID PhySWReset(HI_BOOL bReset)
{
    HDMI_HDMITX_DPHY_RST_reg_dphy_srst_reqSet(bReset);
    bReset = !bReset;
    HDMI_HDMITX_DPHY_RST_reg_dphy_srst_reqSet(bReset);
...
HI_S32 HAL_HDMI_PhyTmdsSet(HDMI_PHY_TMDS_CFG_S *pstHdmiTmdsCfg)
{
    ...
    if (   HDMI_CHIP_HI3798MV300 == u32LogicVersion
        || HDMI_CHIP_HI3798MV310 == u32LogicVersion
        || HDMI_CHIP_HI3796MV200 == u32LogicVersion
        || HDMI_CHIP_HI3716MV450 == u32LogicVersion )
    {
        PhySWReset(HI_TRUE);
    }
...
HI_S32 HAL_HDMI_PhySpecSet(HDMI_PHY_HWSPEC_CFG_S * pstHdmiSpecCfg)
{
    ...
    HDMI_CHIP_TYPE_E eLogicVersion;

    PHY_INIT_CHK;
    PHY_NULL_CHK(pstHdmiSpecCfg);

    eLogicVersion = DRV_HDMI_ProdChipGet();

    /* set HardWare Specification */
    if ((HDMI_CHIP_HI3798MV300 != eLogicVersion) && (HDMI_CHIP_HI3798MV310 != eLogicVersion))
    {
