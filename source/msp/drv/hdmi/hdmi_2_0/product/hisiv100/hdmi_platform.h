...
#define HDMI_COLOR_BAR_BASE            0xf8ccc200
#else
...
#ifndef HDMI_BUILD_IN_BOOT
#define HDMI_VMALLOC(size)     HI_VMALLOC(HI_ID_HDMI, size)
...
//#define HDMI_IO_MAP(phys_addr)      ioremap_nocache(phys_addr, 4)
...
#define HDMI_VMALLOC(size)     malloc(size)
#define HDMI_KMALLOC(size)     malloc(size)
#define HDMI_KFREE(viraddr)    free(viraddr)
#define HDMI_VFREE(viraddr)    free(viraddr)
