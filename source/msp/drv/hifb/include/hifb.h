...
#define FBIOGET_CANVAS_BUFFER                  _IOR(IOC_TYPE_HIFB, 123, HIFB_SURFACE_S)
...
typedef struct hiHI_FB_LOWPOWER_INFO_S
{
    HI_BOOL LowPowerEn;
...
#define CONFIG_HIFB_LAYER_BUFFER_NUM_MAX   10
...
typedef struct
{
    ...
    HI_BOOL bOutBufBusy[CONFIG_HIFB_LAYER_BUFFER_NUM_MAX];
    HI_U32 u32LayerAddr;
    HI_U32 u32Stride;
