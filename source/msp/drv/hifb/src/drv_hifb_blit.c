...
static HI_S32  HIFB_DRV_QuickCopy(HIFB_BUFFER_S *pSrcImg, HIFB_BUFFER_S *pDstImg, HI_BOOL mmz_to_smmu);
...
static HI_BOOL HIFB_DRV_TdeSupportFmt(HIFB_COLOR_FMT_E fmt);
...
static inline HI_BOOL HIFB_IsTdeColorFmtClut(TDE2_COLOR_FMT_E enColorFmt)
{
    if (enColorFmt >= TDE2_COLOR_FMT_CLUT1 && enColorFmt <= TDE2_COLOR_FMT_ACLUT88)
    {
        return HI_TRUE;
    }
...
static HI_S32 HIFB_DRV_QuickCopy(HIFB_BUFFER_S *pSrcImg, HIFB_BUFFER_S *pDstImg, HI_BOOL mmz_to_smmu)
{
    ...
    HIFB_CHECK_NULLPOINTER_RETURN(pSrcImg, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(pDstImg, HI_FAILURE);
    ...
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeBeginJob,  HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeQuickCopy, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeEndJob,    HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeCancelJob, HI_FAILURE);
    ...
    s32Ret = Gfx2dExportFuncs->pfnTdeEndJob(handle,HI_TRUE,2000,HI_FALSE,HI_NULL,HI_NULL);
    if (s32Ret != HI_SUCCESS)
    {
...
static HI_S32 HIFB_DRV_Blit(HIFB_BUFFER_S *pSrcImg, HIFB_BUFFER_S *pDstImg,  HIFB_BLIT_OPT_S *pstOpt, HI_BOOL bRefreshScreen)
{
    ...
    HIFB_CHECK_NULLPOINTER_RETURN(pSrcImg, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(pDstImg, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(pstOpt, HI_FAILURE);

    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeSetDeflickerLevel, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeEnableRegionDeflicker, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeBeginJob, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeBlit, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeEndJob, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeCancelJob, HI_FAILURE);

    HIFB_CHECK_EQUAL_RETURN(0, pSrcImg->stCanvas.u32PhyAddr, HI_FAILURE);
    HIFB_CHECK_EQUAL_RETURN(0, pDstImg->stCanvas.u32PhyAddr, HI_FAILURE);
    ...
    s32Ret = Gfx2dExportFuncs->pfnTdeBlit(handle, NULL, NULL, &stSrcSur, &stSrcRect, &stDstSur, &stDstRect, &stOpt);
    if (s32Ret != HI_SUCCESS)
    {
...
static inline TDE_DEFLICKER_LEVEL_E HIFB_BLIT_GetAntiflickerLevel(HIFB_LAYER_ANTIFLICKER_LEVEL_E enAntiflickerLevel,TDE2_DEFLICKER_MODE_E *penDeflickerMode)
{
   HIFB_CHECK_NULLPOINTER_RETURN(penDeflickerMode,TDE_DEFLICKER_BUTT);
...
static HI_S32 HIFB_DRV_MbBlitEx(HIFB_BLIT_BUFFER_S *pSrcImg, HIFB_BLIT_BUFFER_S *pDstImg,  HIFB_BLIT_OPT_S *pstOpt)
{
    ...
    HIFB_CHECK_EQUAL_RETURN(0, pSrcImg->stCanvas.YAddr,    HI_FAILURE);
    HIFB_CHECK_EQUAL_RETURN(0, pSrcImg->stCanvas.CbCrAddr, HI_FAILURE);
    HIFB_CHECK_EQUAL_RETURN(0, pDstImg->stCanvas.YAddr,    HI_FAILURE);
    ...
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeBeginJob,     HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeSingleBlitEx, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeEndJob,       HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeCancelJob,    HI_FAILURE);
...
static HI_S32 HIFB_DRV_ClearRect(HIFB_SURFACE_S* pDstImg, HIFB_BLIT_OPT_S* pstOpt)
{
    ...
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeBeginJob, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeQuickFill, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeEndJob, HI_FAILURE);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeCancelJob, HI_FAILURE);
...
static HI_S32 HIFB_DRV_WaitAllTdeDone(HI_BOOL bSync)
{
    TDE_EXPORT_FUNC_S *Gfx2dExportFuncs = NULL;
    DRV_HIFB_GET_GFX2D_EXPORTFUNCS(Gfx2dExportFuncs);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeWaitAllDone, HI_FAILURE);
                                    ...
                                    TDE2_RECT_S* pstRectInSrc, TDE2_RECT_S* pstRectInDst)
{
    ...
    DRV_HIFB_GET_GFX2D_EXPORTFUNCS(Gfx2dExportFuncs);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeCalScaleRect, HI_FAILURE);
...
static HI_S32 HIFB_DRV_WaitForDone(TDE_HANDLE s32Handle, HI_U32 u32TimeOut)
{
    ...
    DRV_HIFB_GET_GFX2D_EXPORTFUNCS(Gfx2dExportFuncs);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeWaitForDone, HI_FAILURE);
...
static HI_S32 DRV_HIFB_Gfx2dOpen(HI_VOID)
{
    ...
    DRV_HIFB_GET_GFX2D_EXPORTFUNCS(Gfx2dExportFuncs);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeOpen, HI_FAILURE);
...
static HI_S32 DRV_HIFB_Gfx2dClose(HI_VOID)
{
    ...
    DRV_HIFB_GET_GFX2D_EXPORTFUNCS(Gfx2dExportFuncs);
    HIFB_CHECK_NULLPOINTER_RETURN(Gfx2dExportFuncs->pfnTdeClose, HI_FAILURE);
...
{
    HIFB_CHECK_NULLPOINTER_UNRETURN(Gfx2dCallBackFunction);
...
{
#if 1
    HI_UNUSED(pSrcSurface);
    HI_UNUSED(pstSrcRect);
    HI_UNUSED(pDstSurface);
