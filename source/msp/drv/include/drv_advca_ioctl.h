...
typedef struct
{
    ...
    HI_U8 u8TranData[2048];                                         /**<Transformation data*/
    HI_U32 u32TranDataLen;                                  /**<Transformation data length*/
}DRV_ADVCA_KEYLADDER_TA_ATTR_S;
...
typedef struct
{
    union
    {
        ...
        DRV_ADVCA_KEYLADDER_TA_ATTR_S           stTAKlAttr;         /**<TA keyladder attribute*/
        ...
        HI_UNF_ADVCA_KEYLADDER_SWPKDEC_ATTR_S   stSwpkDecAttr;     /**<BL DEC  keyladder attribute*/
        HI_UNF_ADVCA_KEYLADDER_SWPKENC_ATTR_S   stSwpkEncAttr;     /**<BL DEC  keyladder attribute*/
    }unKlAttr;
}DRV_ADVCA_KEYLADDER_ATTR_S;


typedef struct hiCA_KEYLADDER_ATTR_S
{
    HI_UNF_ADVCA_KEYLADDER_TYPE_E enKeyLadderType;
    DRV_ADVCA_KEYLADDER_ATTR_S stKeyladderAttr;
}CA_KEYLADDER_ATTR_S;
...
#define C1_REVISION "V1.0.1.4_20130607\0"
#else
...
typedef union
{
    struct
    {
        ...
        HI_U32 LP_RootKey        :1; //[15]
        HI_U32 reserve          :16; //[16~31]
    }bits;
    HI_U32 u32;
