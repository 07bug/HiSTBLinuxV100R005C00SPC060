...
typedef struct hiAO_SND_ConOutput_Enable_S
{
    HI_UNF_SND_E            enSound;
    HI_BOOL                 bConOutputEnable;
} AO_SND_ConOutput_Enable_S, *AO_SND_ConOutput_Enable_S_PTR;

typedef struct hiAO_SND_OutputLatency_Mode_S
{
    HI_UNF_SND_E            enSound;
    HI_UNF_SND_OUTPUTLATENCY_E     enOutputMode;
} AO_SND_OutputLatency_Mode_S, *AO_SND_OutputLatency_Mode_S_PTR;

typedef struct hiAO_SND_OutputAtmos_Enable_S
{
    HI_UNF_SND_E            enSound;
    HI_BOOL                 bOutputAtmosEnable;
} AO_SND_OutputAtmos_Enable_S, *AO_SND_OutputAtmos_Enable_S_PTR;
...
typedef struct
{
    ...
    HI_U32                  u32BufSize;
} AO_SND_ISB_Param_S, *AO_SND_ISB_Param_S_PTR;

typedef struct
{
    HI_UNF_SND_E            enSound;
    AO_RENDER_ATTR_S        stRenderAttr;
} AO_SND_Render_Param_S, *AO_SND_Render_Param_S_PTR;
...
typedef struct hiAO_Track_Fade_Param_S
{
    HI_HANDLE                    hTrack;
    AO_TRACK_FADE_S              stFade;
} AO_Track_Fade_Param_S, *AO_Track_Fade_Param_S_PTR;
...
typedef struct hiAO_Track_Fifo_Latency_S
{
    HI_HANDLE               hTrack;
    HI_U32                  u32LatencyMs;
} AO_Track_Fifo_Latency_S, *AO_Track_Fifo_Latency_S_PTR;
...
{
    HI_HANDLE hTrack;
    HI_U32    u32ThresholdMs;
} AO_Track_ResumeThreshold_S, *AO_Track_ResumeThreshold_S_PTR;
...
typedef struct hiAO_Track_Info_Param_S
{
    HI_HANDLE             hTrack;
    HI_VIRT_ADDR_T        tUserVirtAddr;
    HI_PHYS_ADDR_T        tPhyAddr;
} AO_Track_Info_Param_S, *AO_Track_Info_Param_S_PTR;
...
#define CMD_AO_SND_SETCONOUTPUTENABLE              _IOW  (HI_ID_AO, CMD_ID_AO_SND_SETCONOUTPUTENABLE, AO_SND_ConOutput_Enable_S)
#define CMD_AO_SND_GETCONOUTPUTENABLE              _IOWR (HI_ID_AO, CMD_ID_AO_SND_GETCONOUTPUTENABLE, AO_SND_ConOutput_Enable_S)

#define CMD_AO_SND_CREATESB                         _IOWR (HI_ID_AO, CMD_ID_AO_SND_CREATESB, AO_SND_ISB_Param_S)
#define CMD_AO_SND_DESTROYSB                        _IOW  (HI_ID_AO, CMD_ID_AO_SND_DESTROYSB, AO_SND_ISB_Param_S)

#define CMD_AO_SND_SETRENDERPARAM                   _IOW  (HI_ID_AO, CMD_ID_AO_SND_SETRENDERPARAM, AO_SND_Render_Param_S)
#define CMD_AO_SND_GETRENDERPARAM                   _IOWR (HI_ID_AO, CMD_ID_AO_SND_GETRENDERPARAM, AO_SND_Render_Param_S)

#define CMD_AO_SND_SETOUTPUTATMOSENABLE             _IOW  (HI_ID_AO, CMD_ID_AO_SND_SETOUTPUTATMOSENABLE, AO_SND_OutputAtmos_Enable_S)
#define CMD_AO_SND_GETOUTPUTATMOSENABLE             _IOWR (HI_ID_AO, CMD_ID_AO_SND_GETOUTPUTATMOSENABLE, AO_SND_OutputAtmos_Enable_S)

#define CMD_AO_SND_SETCONOUTPUTSTATUS               _IOW  (HI_ID_AO, CMD_ID_AO_SND_SETCONOUTPUTSTATUS, AO_SND_ConOutput_Enable_S)
#define CMD_AO_SND_GETCONOUTPUTSTATUS               _IOWR (HI_ID_AO, CMD_ID_AO_SND_GETCONOUTPUTSTATUS, AO_SND_ConOutput_Enable_S)

#define CMD_AO_SND_SETOUTPUTLATENCYMODE             _IOW  (HI_ID_AO, CMD_ID_AO_SND_SETOUTPUTLATENCYMODE, AO_SND_OutputLatency_Mode_S)
#define CMD_AO_SND_GETOUTPUTLATENCYMODE             _IOWR (HI_ID_AO, CMD_ID_AO_SND_GETOUTPUTLATENCYMODE, AO_SND_OutputLatency_Mode_S)
...
#define CMD_AO_TRACK_SETFIFOLATENCY                _IOW  (HI_ID_AO, CMD_ID_AO_TRACK_SETFIFOLATENCY, AO_Track_Fifo_Latency_S)
#define CMD_AO_TRACK_GETFIFOLATENCY                _IOWR (HI_ID_AO, CMD_ID_AO_TRACK_GETFIFOLATENCY, AO_Track_Fifo_Latency_S)
...
#define CMD_AO_TRACK_SETRESUMETHRESHOLD            _IOW  (HI_ID_AO, CMD_ID_AO_TRACK_SETRESUMETHRESHOLD, AO_Track_ResumeThreshold_S)
#define CMD_AO_TRACK_GETRESUMETHRESHOLD            _IOWR (HI_ID_AO, CMD_ID_AO_TRACK_GETRESUMETHRESHOLD, AO_Track_ResumeThreshold_S)

#define CMD_AO_TRACK_SETFADEATTR                   _IOWR (HI_ID_AO, CMD_ID_AO_TRACK_SETFADEATTR, AO_Track_Fade_Param_S)
#define CMD_AO_TRACK_SETINFO                       _IOW  (HI_ID_AO, CMD_ID_AO_TRACK_SETINFO, AO_Track_Info_Param_S)
#define CMD_AO_TRACK_GETINFO                       _IOWR (HI_ID_AO, CMD_ID_AO_TRACK_GETINFO, AO_Track_Info_Param_S)
