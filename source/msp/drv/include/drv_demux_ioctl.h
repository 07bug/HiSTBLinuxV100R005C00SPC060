...
typedef struct hiDMX_Tag_GetAttr_S
{
    ...
    HI_U32                     PortId;
    HI_U32                     DmxId;
    HI_UNF_DMX_TAG_PORT_ATTR_S TagAttr;
}DMX_Tag_GetAttr_S;
...
typedef struct hiDMX_PortPacketNum_S
{
    ...
    DMX_PORT_MODE_E         PortMode;
    HI_U32                  PortId;
    HI_UNF_DMX_PORT_PACKETNUM_S PortPacket;
} DMX_PortPacketNum_S;
...
typedef struct hiDMX_ChanPacktNum_S
{
    HI_HANDLE       hChannel;
    HI_U32          CCDisCnt;
} DMX_ChanPacktNum_S;
...
typedef struct hiDMX_PesBufGetEx_S
{
    HI_HANDLE hChannel;
    HI_U32 TimeoutMs;
}DMX_PesBufGetEx_S;
...
#define CMD_DEMUX_CHAN_GETPACKETNUM         _IOWR(HI_ID_DEMUX, 0x3E, DMX_ChanPacktNum_S)        /* get channel CC Disconuity*/
...
#define CMD_DEMUX_ES_BUFFER_GET_MSG         _IOWR(HI_ID_DEMUX, 0x83, DMX_PesBufGetEx_S)         /* Get ES buff status */
