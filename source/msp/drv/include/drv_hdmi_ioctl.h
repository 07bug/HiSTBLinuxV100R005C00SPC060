...
{
    HDMI_DEVICE_ID_E        enHdmiID;
    HDMI_SUSPEND_E          enSuspend;
}DRV_HDMI_SUSPEND_STAT_S;
...
#define CMD_HDMI_READ_EDID           _IOWR(HI_ID_HDMI, IOCTL_HDMI_READ_EDID,        DRV_HDMI_EDID_RAWDATA_S)
...
#define CMD_HDMI_HDCP_CAP            _IOWR(HI_ID_HDMI, IOCTL_HDMI_HDCP_CAP,        DRV_HDMI_HDCP_CAP_S)
#define CMD_HDMI_HDCP_ENABLE         _IOWR(HI_ID_HDMI, IOCTL_HDMI_HDCP_ENABLE,     DRV_HDMI_HDCP_EN_PARAM_S)
#define CMD_HDMI_HDCP_STAT           _IOWR(HI_ID_HDMI, IOCTL_HDMI_HDCP_STAT,       DRV_HDMI_HDCP_STAT_S)
...
#define CMD_HDMI_SET_SUSPEND_STAT    _IOWR(HI_ID_HDMI, IOCTL_HDMI_SET_SUSPEND_STAT, DRV_HDMI_SUSPEND_STAT_S)
