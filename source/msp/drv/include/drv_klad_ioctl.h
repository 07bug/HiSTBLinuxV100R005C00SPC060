...
typedef struct
{
    ...
    HI_U32  cur_index;
    HI_UNF_KLAD_LEVEL_E level;
    HI_U8 data[HI_UNF_KLAD_MAX_KEY_LEN];
} KLAD_CTL_TA_DATA_S;
...
#define CMD_KLAD_CW_TA_SET_DATA             _IOW (HI_ID_CA, 0x16, KLAD_CTL_TA_DATA_S)
#define CMD_KLAD_SSUK2CIPHER                _IOW (HI_ID_CA, 0x17, HI_HANDLE)
