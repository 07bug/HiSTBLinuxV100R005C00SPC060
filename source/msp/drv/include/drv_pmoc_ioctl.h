...
typedef struct hiC51_PmocNet_S
{
    ...
    unsigned int timeToDeepStandby;
}C51_PmocNet_S;
...
typedef struct hiC51_CPUMinFreq_S
{
    HI_BOOL bSetMinFreqFlag;
    HI_U32  u32CPUMinFreq;
}C51_CPU_MINFREQ_S;
...
#define HI_PMOC_SET_CPU_MIN_FREQ_CMD    _IOW(HI_ID_PM, 0x11, C51_CPU_MINFREQ_S)
