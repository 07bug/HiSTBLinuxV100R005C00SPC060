...
typedef HI_S32  (*FN_TDE_ModInit)(HI_VOID);
typedef HI_VOID (*FN_TDE_ModeExit)(HI_VOID);
...
typedef HI_S32  (*FN_TDE_SetWorkingFlag)(HI_BOOL);

typedef struct
{
    FN_TDE_ModInit          pfnTdeModInit;
    FN_TDE_ModeExit         pfnTdeModExit;
    ...
    FN_TDE_SetWorkingFlag      pfnTdeSetWorkingFlag;
}TDE_EXPORT_FUNC_S;
