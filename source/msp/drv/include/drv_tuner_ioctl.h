...
typedef struct hiTUNER_DVBT2_PARAM_S
{
    HI_U8                       u8PlpId;                /**<PLP id*/
    HI_U8                       u8CommPlpId;        /**<common PLP id*/
    HI_U8                       u8Combination;      /**<PLP combination*/
    HI_UNF_TUNER_TER_MODE_E     enChannelAttr;      /**<dvb-t2 */
} TUNER_DVBT2_PARAM_S;
...
typedef struct hiTUNER_ACC_QAM_PARAMS_S
{
    ...
    union
    {
            TUNER_DVBT2_PARAM_S stDVBT2Param;
            HI_UNF_TUNER_TS_PRIORITY_E enDVBT;
    }unTer;
    HI_U8 u8DVBTMode;   //0  dvb-t2;1  dvb-t
    HI_U32 u32TunerBandWidth;   //6000  dvb-c 6M;else dvb-c 8M
...
typedef struct _TUNER_OPS_S
{
    ...
    /* Added begin:sdk 2011-11-28 For DVB-S/S2 */
    HI_S32 (*demod_init)(HI_U32 u32TunerPort, HI_U8 enI2cChannel, HI_UNF_TUNER_DEV_TYPE_E enTunerDevType);
    HI_S32 (*tuner_init)(HI_U32 u32TunerPort);
    ...
    /* Added end:sdk 2011-11-28 For DVB-S/S2 */
} TUNER_OPS_S;
...
#define TUNER_SET_PLPNO_CMD _IOW(HI_TUNER_IOC_MAGIC, 32, TUNER_DATABUF_S)
#define TUNER_GET_PLPNUM_CMD _IOWR(HI_TUNER_IOC_MAGIC, 33, TUNER_DATA_S)
#define TUNER_GET_CURPLPTYPE_CMD _IOWR(HI_TUNER_IOC_MAGIC, 34, TUNER_DATA_S)
...
#define TUNER_GET_SAMPLE_DATA_CMD _IOWR(HI_TUNER_IOC_MAGIC, 38, TUNER_SAMPLEDATA_S)
...
#define TUNER_GET_AGC_CMD _IOWR(HI_TUNER_IOC_MAGIC, 42, TUNER_DATABUF_S)
...
#define TUNER_GET_POWER_SPECTRUM_DATA_CMD _IOWR(HI_TUNER_IOC_MAGIC, 50, TUNER_SPECTRUMDATA_S)
