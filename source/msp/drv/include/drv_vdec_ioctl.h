...
typedef struct hiVDEC_CMD_SET_UVMOS_CTRL_S
{
    HI_HANDLE  hHandle;
    HI_BOOL    bUVMOSEnable;
} VDEC_CMD_SET_UVMOS_CTRL_S;
...
typedef struct hiVDEC_CMD_KEEP_SPSPPS_CTRL_S
{
    HI_HANDLE  hHandle;
    HI_BOOL    bKeepSpsPps;
} VDEC_CMD_KEEP_SPSPPS_CTRL_S;
...
typedef struct hiVDEC_GET_VFMW_HANDLE
{
    HI_HANDLE  hHandle;
    HI_HANDLE  hVfmwHandle;
} VDEC_GET_VFMW_HANDLE;
...
typedef struct hiVDEC_CMD_SET_IDRPTS_S
{
    HI_HANDLE  hHandle;
    HI_U32     IDRPts;
} VDEC_CMD_SET_IDRPTS_S;
...
#define UMAPC_VDEC_CHAN_ACQUSERDATA     _IOWR(HI_ID_VDEC, 0x99, VDEC_CMD_USERDATA_S)
#define UMAPC_VDEC_CHAN_RLSUSERDATA     _IOW (HI_ID_VDEC, 0x9a, VDEC_CMD_USERDATA_S)
#define UMAPC_VDEC_CHAN_KEEPSPSPPS      _IOWR (HI_ID_VDEC, 0x9b, VDEC_CMD_KEEP_SPSPPS_CTRL_S)
...
#define UMAPC_VDEC_CHAN_UVMOS      _IOW (HI_ID_VDEC, 0xb7, VDEC_CMD_SET_UVMOS_CTRL_S)
...
#define UMAPC_VDEC_GET_VFMW_HANDLE          _IOWR(HI_ID_VDEC, 0xda, VDEC_GET_VFMW_HANDLE)
#define UMAPC_VDEC_CHAN_SETIDRPTS           _IOWR(HI_ID_VDEC, 0xd5, VDEC_CMD_SET_IDRPTS_S)
#define UMAPC_VDEC_CHAN_GET_NEWEST_DECODED_FRAME    _IOWR(HI_ID_VDEC, 0xe1, VDEC_CMD_VO_FRAME_S)
