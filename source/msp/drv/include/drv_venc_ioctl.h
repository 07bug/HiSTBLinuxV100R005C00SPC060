...
typedef struct hiVENC_CHN_VIRADDR_S
{
    ...
    void*  pSliceBufVirAddr;//add for 96mv200
...
typedef struct hiVENC_INFO_RATECONTROL_S
{
    HI_HANDLE                   hVencChn;
    VENC_DRV_CONTROLRATETYPE_E  eRCType;
} VENC_INFO_RATECONTROL_S;

typedef struct hiVENC_INFO_FRMRATE_S
{
    HI_HANDLE                   hVencChn;
    VENC_DRV_FRMRATETYPE_E      eFrmRateType;
} VENC_INFO_FRMRATE_S;
...
#define CMD_VENC_GET_CAP _IOWR(IOC_TYPE_VENC, 0x15, HI_UNF_VENC_CAP_S)

#define CMD_VENC_SET_RC_TYPE _IOWR(IOC_TYPE_VENC, 0x16, VENC_INFO_RATECONTROL_S)
#define CMD_VENC_GET_RC_TYPE _IOWR(IOC_TYPE_VENC, 0x17, VENC_INFO_RATECONTROL_S)

#define CMD_VENC_SET_INPUT_FRMRATE_TYPE _IOWR(IOC_TYPE_VENC, 0x18, VENC_INFO_RATECONTROL_S)
#define CMD_VENC_GET_INPUT_FRMRATE_TYPE _IOWR(IOC_TYPE_VENC, 0x19, VENC_INFO_RATECONTROL_S)
