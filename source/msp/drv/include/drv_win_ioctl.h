...
typedef struct hiWIN_XDR_FRAME_S
{
    HI_HANDLE                  hWindow;
    HI_BOOL                    bEnhanceValid; /* dolby frame may has enhance frame(EL). */
    HI_DRV_VIDEO_FRAME_S       stBaseFrm;     /* SDR/HDR10/HLG/SLF/BL frame.*/
    HI_DRV_VIDEO_FRAME_S       stEnhanceFrm;  /* EL frame.*/
    HI_DRV_DOLBY_META_INFO_S   stDolbyInfo;
    HI_DRV_DISP_OUT_TYPE_E     enDispOutType;
    HI_DRV_DISP_XDR_ENGINE_E   enXdrEngine;
}WIN_XDR_FRAME_S;
...
#define CMD_WIN_QU_FRAME           _IOW(HI_ID_VO, IOC_WIN_QU_FRAME, WIN_XDR_FRAME_S)
#define CMD_WIN_QUDOLBY_FRAME      _IOW(HI_ID_VO, IOC_WIN_QUDOLBY_FRAME, WIN_XDR_FRAME_S)
...
#define CMD_WIN_GET_OUT_TYPE_AND_ENGINE  _IOWR(HI_ID_VO,IOC_WIN_GET_OUT_TYPE_AND_ENGINE, WIN_OUT_TYPE_AND_ENGINE_S)
...
#define CMD_WIN_GET_ALPHA _IOWR(HI_ID_VO,IOC_WIN_GET_ALPHA, WIN_ALPHA_S)

#define CMD_WIN_RESET_FIRST_FRAME_STATUS _IOWR(HI_ID_VO,IOC_WIN_RESET_FIRST_FRAME_STATUS, WIN_ALPHA_S)
