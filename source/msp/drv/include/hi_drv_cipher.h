...
HI_S32 HI_DRV_CIPHER_ConfigChn(HI_HANDLE hCipher, HI_UNF_CIPHER_CTRL_S *pConfig);
...
HI_S32 HI_DRV_CIPHER_HashStart(HI_HANDLE *hCipher, HI_UNF_CIPHER_HASH_TYPE_E type, HI_U8 *key, HI_U32 keylen);
HI_S32 HI_DRV_CIPHER_HashUpdate(HI_HANDLE hCipher, HI_U8 *input, HI_U32 length);
HI_S32 HI_DRV_CIPHER_HashFinish(HI_HANDLE hCipher, HI_U8 *hash, HI_U32 *hashlen);
