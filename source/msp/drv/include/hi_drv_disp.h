...
typedef enum hiDRV_DISP_OUT_TYPE_E
{
    ...
    HI_DRV_DISP_TYPE_AUTO,          /* 自动匹配最佳输出信号 */
    ...
    HI_DRV_DISP_TYPE_AUTO_FOLLOW_FIRSTFRAME,  /* for smooth requirement , choose the 1st frame's type as output.
                                               * will influence output type and colorspace.
                                               */
