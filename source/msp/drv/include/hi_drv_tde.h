...
{
    HI_U32 u32PhyAddr;              /**<Header address of a bitmap or the Y component*/
    ...
    HI_U32 u32ClutPhyAddr;          /**<Address of the color look-up table (CLUT), for color extension or color correction*/
    ...
    HI_U32 u32CbCrPhyAddr;          /**<Address of the CbCr component, pilot                         */
...
#define TDE_TRIGGER_SEL                            _IOW(TDE_IOC_MAGIC, 16, TDE_HANDLE)
