...
#define DEF_HI_DRV_FRAME_INFO_SIZE 86
...
typedef struct hiDRV_VIDEO_FRAME_S
{
    ...
    HI_U32                      u32Width;
    HI_U32                      u32Height;
    HI_U16                      DispCtrlWidth;
    HI_U16                      DispCtrlHeight;

    HI_U8                       DVDualLayer;
    HI_U32                      u32SrcPts;  /* original pts from the stream */
    HI_U32                      u32Pts;     /* pts after adjust */
    HI_S64                      s64OmxPts;  /* pts for OMX */
    HI_BOOL                     bDiscard;  //when error_level than error_thread, this frame is discard and is_Discard is 1

    /*U-vMOS param start*/
    HI_U32                      u32FrameStreamSize;
    HI_U32                      u32AvgQp;
    HI_U32                      u32FrameType;    /*I  P  B frame*/
    ...
    HI_U32                      u32DisplayHorizontalSize;
    HI_U32                      u32DisplayVerticalSize;
...
typedef struct hiDRV_VIDEO_PRIVATE_S
{
    ...
    HI_U32                  u32Reserve[36];     /* Reserve Bytes * the store struct is HI_VDEC_PRIV_FRAMEINFO_S
