...
#define DEF_MAX_WIN_NUM_ON_SINGLE_DISP 36
#define DEF_MAX_WIN_NUM_ON_VIRTUAL_DISP 36
#else
...
typedef enum hiDRV_WIN_SWITCH_E
{
    ...
    HI_DRV_WIN_SWITCH_DEATTACHMODE_LAST = 2,
...
typedef struct tagWIN_FIRST_FRAME_STATUS_S
{
    HI_BOOL                 bSenceChange;  /* indicate whether sence has changed, true when receive first frm under follow first frm mode . */
    HI_DRV_DISP_OUT_TYPE_E  enDispOutType;
    HI_DRV_COLOR_SPACE_E    enOutColorSpace;
}WIN_FIRST_FRAME_STATUS_S;
