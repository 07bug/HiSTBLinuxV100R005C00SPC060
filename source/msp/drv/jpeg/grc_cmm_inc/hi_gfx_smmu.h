...
static inline HI_S32 HI_GFX_InitSmmu(HI_U32 u32SmmuAddr)
{
    ...
    if (NULL == s_pstMmuReg)
    {
        HI_PRINT("++++++++++gfx smmu init failure\n");
        return HI_FAILURE;
    }
    ...
    if (0 == s_pstMmuReg->u32ScbTtbr)
    {
        HI_PRINT("++++++++++gfx smmu init failure\n");
        return HI_FAILURE;
    }

    if (0 == s_pstMmuReg->u32CbTtbr)
    {
        HI_PRINT("++++++++++gfx smmu init failure\n");
        return HI_FAILURE;
    }

    if (0 == s_pstMmuReg->u32ErrRdAddr)
    {
        HI_PRINT("++++++++++gfx smmu init failure\n");
        return HI_FAILURE;
    }

    if (0 == s_pstMmuReg->u32ErrWrAddr)
    {
        HI_PRINT("++++++++++gfx smmu init failure\n");
        return HI_FAILURE;
    }
...
#ifdef CONFIG_GFX_MMU_SUPPORT
    if ((NULL == s_pstMmuReg) || (NULL == pValue))
    {
        return;
    }
