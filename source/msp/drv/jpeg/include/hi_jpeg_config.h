...
/************************************************************************************************/
   ...
   extern "C" {
    ...
    /** CNcomment:统一解码输出yuv420sp,硬件和软件都不支持yuv400 -> yuv420 要是需要支持填充0x80 */
    ...
    //#define CONFIG_JPEG_SAVE_SCEN
       ...
       && !defined(CONFIG_GFX_ANDROID_VERSION_26)
       ...
       || defined(CHIP_TYPE_hi3716mv330) || defined(CHIP_TYPE_hi3110ev500)
        ...
        || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3716mv450)  \
        || defined(CHIP_TYPE_hi3796mv200) && !defined(HI_BUILD_IN_BOOT)
        /**hi3798mv310 not support**/
        #define CONFIG_JPEG_HARDDEC2ARGB
    #endif

    #if  !defined(CHIP_TYPE_hi3798mv200) && !defined(CHIP_TYPE_hi3798mv300) \
      && !defined(CHIP_TYPE_hi3796mv200) && !defined(CHIP_TYPE_hi3798mv310) \
      && !defined(CHIP_TYPE_hi3716mv450) && !defined(CONFIG_GFX_ANDROID_VERSION_26)
        #undef CONFIG_JPEG_LOW_DELAY_SUPPORT
    #endif

    #ifndef CONFIG_GFX_PROC_SUPPORT
