...
typedef enum
{
    ...
    KL_CLEAR_CW_LOCK_STATUS_LOCK_REE    = 0x01,
    KL_CLEAR_CW_LOCK_STATUS_LOCK_PANDA  = 0x03,
...
{
    KL_CLEAR_CW_LOCK_STATUS_UNLOCK      = 0x00,
    KL_CLEAR_CW_LOCK_STATUS_LOCK_TEE    = 0x01,
    KL_CLEAR_CW_LOCK_STATUS_LOCK_REE    = 0x02,
    KL_CLEAR_CW_LOCK_STATUS_LOCK_PANDA  = 0x03,
    KL_CLEAR_CW_LOCK_STATUS_BUTT
} KL_CLEAR_CW_LOCK_STATUS_E;
#endif
