...
#define OTP_V200_SHADOW_BASE        (0x10180080)
#else
#define OTP_V200_BASE_OFFSET        (0xF8AB0000)
#define OTP_V200_SHADOW_BASE        (0xF8AB0080)
#endif
...
#define OTP_V200_SOFTRST_REQ                   (0xF8AB01E4)
...
#if defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798mv310)
...
#define OTP_V200_INTERNAL_CHECKSUM_STBTA_ROOT_KEY       (0x42C)

#define OTP_V200_INTERNAL_STBTA_ROOTKEY       (0x1B0)
...
typedef union
{
    struct
    {
        ...
        HI_U32 CRC_CA_TA_RootKey_lock   :1;// 0x431[3]
        HI_U32 CRC_STB_TA_RootKey_lock  :1;// 0x431[4]
        HI_U32 reserved3                :19;// 0x431[5] ~
    }bits;
    HI_U32 u32;
...
typedef union
{
    struct
    {
        ...
        HI_U32 OTP_TZ_AREA_lock           : 8; //0x1d
        ...
        HI_U32 reserved0                  : 8; //0x1f
    } bits;
    HI_U32 u32;
} OTP_V200_INTERNAL_DATALOCK_2_U;//Offset:0x1c
