...
HI_S32 PQ_HAL_EnableCSC(HAL_DISP_LAYER_E enLayer, HI_BOOL bCscEn)
{
    ...
    else if ((enLayer >= HAL_DISP_LAYER_V2) && (enLayer < HAL_DISP_LAYER_V4))
    {
    ...
    else if ((enLayer >= HAL_DISP_LAYER_V4) && (enLayer < HAL_DISP_LAYER_BUTT))
    {
        //There is not V4 in 3716MV410
        V0_CSC_IDC.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_IDC.u32) + 3 * VDP_VID_OFFSET);
        V0_CSC_IDC.bits.csc_en = bCscEn;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_IDC.u32) + 3 * VDP_VID_OFFSET), V0_CSC_IDC.u32);
    }
    else
    {
...
HI_S32 PQ_HAL_SetCscCoef(HAL_DISP_LAYER_E enChan, CSC_COEF_S *pstCscCoef)
{
    ...
    else if ((enChan >= HAL_DISP_LAYER_V2) && (enChan < HAL_DISP_LAYER_V4))
    {
    ...
    else if ((enChan >= HAL_DISP_LAYER_V4) && (enChan < HAL_DISP_LAYER_BUTT))
    {
        //There is not V4 in 3716MV410
        V0_CSC_P0.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_P0.u32) + 3 * VDP_VID_OFFSET);
        V0_CSC_P0.bits.cscp00 = pstCscCoef->csc_coef00;
        V0_CSC_P0.bits.cscp01 = pstCscCoef->csc_coef01;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_P0.u32) + 3 * VDP_VID_OFFSET), V0_CSC_P0.u32);

        V0_CSC_P1.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_P1.u32) + 3  * VDP_VID_OFFSET);
        V0_CSC_P1.bits.cscp02 = pstCscCoef->csc_coef02;
        V0_CSC_P1.bits.cscp10 = pstCscCoef->csc_coef10;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_P1.u32) + 3 * VDP_VID_OFFSET), V0_CSC_P1.u32);

        V0_CSC_P2.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_P2.u32) + 3  * VDP_VID_OFFSET);
        V0_CSC_P2.bits.cscp11 = pstCscCoef->csc_coef11;
        V0_CSC_P2.bits.cscp12 = pstCscCoef->csc_coef12;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_P2.u32) + 3 * VDP_VID_OFFSET), V0_CSC_P2.u32);

        V0_CSC_P3.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_P3.u32) + 3  * VDP_VID_OFFSET);
        V0_CSC_P3.bits.cscp20 = pstCscCoef->csc_coef20;
        V0_CSC_P3.bits.cscp21 = pstCscCoef->csc_coef21;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_P3.u32) + 3 * VDP_VID_OFFSET), V0_CSC_P3.u32);

        V0_CSC_P4.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_P4.u32) + 3 * VDP_VID_OFFSET);
        V0_CSC_P4.bits.cscp22 = pstCscCoef->csc_coef22;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_P4.u32) + 3 * VDP_VID_OFFSET), V0_CSC_P4.u32);
    }
    else
    {
...
HI_S32 PQ_HAL_SetCscDcCoef(HAL_DISP_LAYER_E enChan, CSC_DCCOEF_S *pstCscCoef)
{
    ...
    else if ((enChan >= HAL_DISP_LAYER_V4) && (enChan < HAL_DISP_LAYER_BUTT))
    {
        ...
        V0_CSC_ODC.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_ODC.u32) + 3 * VDP_VID_OFFSET);
        V0_CSC_ODC.bits.cscodc1 = pstCscCoef->csc_out_dc1;
        V0_CSC_ODC.bits.cscodc0 = pstCscCoef->csc_out_dc0;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_ODC.u32) + 3 * VDP_VID_OFFSET), V0_CSC_ODC.u32);

        V0_CSC_IODC.u32 = PQ_HAL_RegRead((HI_U32) & (pstVDPReg->V0_CSC_IODC.u32) + 3 * VDP_VID_OFFSET);
        V0_CSC_IODC.bits.cscodc2 = pstCscCoef->csc_out_dc2;
        V0_CSC_IODC.bits.cscidc2 = pstCscCoef->csc_in_dc2;
        PQ_HAL_RegWrite(((HI_U32) & (pstVDPReg->V0_CSC_IODC.u32) + 3 * VDP_VID_OFFSET), V0_CSC_IODC.u32);
    }
    else
    {
        HI_ERR_PQ("[%d]Not Vo/V1/v2/v3/v4/VP CSC!\n", enChan);
...
HI_S32 PQ_HAL_GetWbcPointSel(HI_VOID)
{
    S_VDP_REGS_TYPE *pstVDPReg = HI_NULL;
    HI_S32 s32Sel = 0;

    pstVDPReg = PQ_HAL_GetVdpReg();
    s32Sel = pstVDPReg->WBC_DHD0_CTRL.bits.wbc_point_sel;
