...
{
    WBC_POINT_AFTER_CSC  = 0,   /*00：回写点在VP内的CSC后，数据格式为YUV444 */
    WBC_POINT_AFTER_ZME,        /*01：回写点在V0 ZME后面，数据格式为YUV422 */
    WBC_POINT_BEFORE_ZME,       /*10：回写点在V0 ZME前面，数据格式为YUV420或YUV422 */
