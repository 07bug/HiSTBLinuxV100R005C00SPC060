...
HI_S32 PQ_HAL_GetIFmdStatInfo(PQ_IFMD_CALC_S *pstIfmdCalcInfo, IFMD_TotalHardPara *pIfmdTotalHardPara)
{
    ...
    PQ_CHECK_NULL_PTR_RE_FAIL(pstIfmdCalcInfo->pstIfmdHardOutReg);
    ...
    PQ_SAFE_MEMCPY((HI_U32 *) & (pIfmdTotalHardPara->stMadRtlStatPara.u32MotionHist[0]), \
                   (HI_U32 *) & (pstIfmdCalcInfo->pstIfmdHardOutReg->IGLB_MTN_BIN0), sizeof(pIfmdTotalHardPara->stMadRtlStatPara.u32MotionHist));
