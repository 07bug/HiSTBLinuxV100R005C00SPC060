...
HI_S32 PQ_HAL_GetMotionHistReg(MOTION_INPUT_S *pstMotionInput, MotionHist_S *pstMotionHist)
{
    ...
    PQ_SAFE_MEMCPY((HI_U32 *) & (pstMotionHist->MOTION_HIST[0]), (HI_U32 *) & (pstVpssVirReg->VPSS_DIEGLBMTNBIN[0]), sizeof(pstMotionHist->MOTION_HIST));
...
HI_S32 PQ_HAL_GetInterlaceMotionEn(HI_U32 u32HandleNo, HI_BOOL *bIglbEn)
{
    return HI_SUCCESS;
}
