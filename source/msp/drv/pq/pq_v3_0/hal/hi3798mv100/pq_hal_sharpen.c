...
static HI_S32 PQ_HAL_SetSharpStr(HI_U32 u32HandleNo, HI_S32 s32ShpStr, PQ_SHARP_GAIN_S *pstSharpGain)
{
    ...
    /* VHD */
    pstVpssVirReg->VPSS_VHD_LTI_CTRL.bits.lgain_ratio = ((pstSharpGain->u32HD_Lgain_ratio) * s32ShpStr + 64) / 128;
    pstVpssVirReg->VPSS_VHD_CTI_CTRL.bits.cgain_ratio = ((pstSharpGain->u32HD_Cgain_ratio) * s32ShpStr + 64) / 128;
