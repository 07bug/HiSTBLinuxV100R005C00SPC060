...
HI_S32 PQ_HAL_SetCscDcCoef(HAL_DISP_LAYER_E enChan, CSC_DCCOEF_S *pstCscCoef)
{
    ...
    V0_CSC_IDC.bits.cscidc0  = pstCscCoef->csc_in_dc2;
    ...
    V0_CSC_ODC.bits.cscodc0 = pstCscCoef->csc_out_dc2;
    ...
    V0_CSC_IODC.bits.cscodc2 = pstCscCoef->csc_out_dc0;
    V0_CSC_IODC.bits.cscidc2 = pstCscCoef->csc_in_dc0;
