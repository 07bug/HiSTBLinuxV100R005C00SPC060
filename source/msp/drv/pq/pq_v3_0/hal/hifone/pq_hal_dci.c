...
HI_S32 PQ_HAL_DCIInit(HI_VOID)
{
    ...
    PQ_SAFE_MEMSET((HI_U8 *)sg_stDciBuf.u32StartVirAddr, 0, DCI_BUFFER);
...
HI_S32 PQ_HAL_SetDCILut(DCI_LUT_S *pstDciLut)
{
    ...
    PQ_SAFE_MEMCPY((HI_U8 *)sg_stDciBuf.u32StartVirAddr, au32DCIConvertTbl, sizeof(au32DCIConvertTbl));
