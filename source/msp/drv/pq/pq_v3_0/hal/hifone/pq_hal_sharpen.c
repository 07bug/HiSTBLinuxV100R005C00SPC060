...
HI_S32 PQ_HAL_SetHSharpStrReg(HI_U32 u32HandleNo, HI_S32 s32ShpStr, PQ_HSHARP_GAIN_S *pstHSharpGain)
{
    ...
    pstVpssVirReg->VPSS_HSPCFG3.bits.hsp_hf0_gainpos = (HI_S32)(((pstHSharpGain->s32H0GainPos) * u32GainPosH0 + 64) / 128);
    pstVpssVirReg->VPSS_HSPCFG3.bits.hsp_hf0_gainneg = (HI_S32)(((pstHSharpGain->s32H0GainNeg) * u32GainNegH0 + 64) / 128);
    pstVpssVirReg->VPSS_HSPCFG7.bits.hsp_hf1_gainpos = (HI_S32)(((pstHSharpGain->s32H1GainPos) * u32GainPosH1 + 64) / 128);
    pstVpssVirReg->VPSS_HSPCFG7.bits.hsp_hf1_gainneg = (HI_S32)(((pstHSharpGain->s32H1GainNeg) * u32GainNegH1 + 64) / 128);
