...
HI_S32 PQ_MNG_DCILUTInit(PQ_PARAM_S *pstPqParam, HI_BOOL bDefault)
{
    ...
    PQ_HAL_SetDCIlevel(VDP_LAYER_VP0, sg_u32DCILevelGain[PQ_SOURCE_MODE_HD][DCI_GLOBAL_GAIN_0], \
...
HI_S32 PQ_MNG_InitDCI(PQ_PARAM_S *pstPqParam, HI_BOOL bDefault)
{
    ...
    s32Ret = PQ_MNG_InitPhyList(u32ID, REG_TYPE_VDP, PQ_SOURCE_MODE_HD, PQ_OUTPUT_MODE_HD, PQ_BIN_MODULE_DCI);
    if (HI_SUCCESS != s32Ret)
    {
