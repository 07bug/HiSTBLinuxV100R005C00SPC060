                                   ...
                                   HI_U32 *pu32HspNegGainH1, HI_U8 u8InMode, HI_U8 u8OutMode)
{
    ...
    PQ_CHECK_NULL_PTR_RE_FAIL(pu32HspPosGainH0);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu32HspNegGainH0);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu32HspPosGainH1);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu32HspNegGainH1);
...
static HI_S32 PQ_MNG_HSharpInit(HI_U32 u32Data)
{
    ...
    s32Ret = PQ_MNG_InitPhyList(u32Data, REG_TYPE_VPSS, PQ_SOURCE_MODE_NO, PQ_OUTPUT_MODE_NO, PQ_BIN_MODULE_SHARPEN);
