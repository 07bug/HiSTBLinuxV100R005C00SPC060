...
static HI_U32 sg_u32Gain1[PQ_SOURCE_MODE_BUTT][PQ_OUTPUT_MODE_BUTT] =
{
    {256, 256, 256}, /* PQ_SOURCE_MODE_NO  */
    {256, 256, 256}, /* PQ_SOURCE_MODE_SD  */
    {256, 256, 256}, /* PQ_SOURCE_MODE_HD  */
    {256, 256, 256}, /* PQ_SOURCE_MODE_UHD */
};

#if defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100)
static HI_U32 sg_u32Gain2[PQ_SOURCE_MODE_BUTT][PQ_OUTPUT_MODE_BUTT] =
{
    {304, 304, 304}, /* PQ_SOURCE_MODE_NO  */
    {304, 304, 304}, /* PQ_SOURCE_MODE_SD  */
    {304, 304, 304}, /* PQ_SOURCE_MODE_HD  */
    {304, 304, 304}, /* PQ_SOURCE_MODE_UHD */
};
#endif
...
static HI_U32 sg_u32Gain2[PQ_SOURCE_MODE_BUTT][PQ_OUTPUT_MODE_BUTT] =
{
    {128, 128, 128}, /* PQ_SOURCE_MODE_NO  */
    {128, 128, 128}, /* PQ_SOURCE_MODE_SD  */
    {128, 128, 128}, /* PQ_SOURCE_MODE_HD  */
    {128, 128, 128}, /* PQ_SOURCE_MODE_UHD */
};
#endif
...
static HI_S32 PQ_MNG_FindSharpenGainRatio(HI_U32 ppu32Gain[][4], HI_U32 u32RegAddr, HI_U8 u8GainLsb, HI_U8 u8GainMsb)
{
    ...
    for (i = 0; i < u32ListNum; i++)
    {
        ...
        if ((PQ_SOURCE_MODE_UHD < u8SourceMode) || (PQ_OUTPUT_MODE_UHD < u8OutputMode))
        {
            continue;
        }
...
#if defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100)
    s32Ret = PQ_MNG_InitPhyList(u32Data, REG_TYPE_VPSS, PQ_SOURCE_MODE_HD, PQ_OUTPUT_MODE_HD, PQ_BIN_MODULE_SHARPEN);
#endif
#if defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420)
    s32Ret = PQ_MNG_InitPhyList(u32Data, REG_TYPE_VDP, PQ_SOURCE_MODE_HD, PQ_OUTPUT_MODE_HD, PQ_BIN_MODULE_SHARPEN);
#endif
...
HI_S32 PQ_MNG_SetSharpenStr(HI_S32 s32ShpStr, HI_U32 u32SourceMode, HI_U32 u32OutputMode)
{
    ...
    if ((PQ_SOURCE_MODE_UHD < u32SourceMode) || (PQ_OUTPUT_MODE_UHD < u32OutputMode))
    {
