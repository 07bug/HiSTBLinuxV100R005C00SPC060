...
{
    HI_S32 s32Ret = HI_SUCCESS;
    HI_PQ_SR_DEMO_E enSRMode;

    enSRMode = *(HI_PQ_SR_DEMO_E *)arg;
    s32Ret = DRV_PQ_SetSRMode(enSRMode);
...
{
    HI_S32 s32Ret = HI_SUCCESS;
    HI_PQ_SR_DEMO_E *penSRMode;

    penSRMode = (HI_PQ_SR_DEMO_E *)arg;

    s32Ret = DRV_PQ_GetSRMode(penSRMode);
...
static HI_S32 u32PQIoctl_G_VP_REMOTE_BRIGHTNESS(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;
...
static HI_S32 u32PQIoctl_S_GFXHDROFFSET_PARAM(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;
    ...
    s32Ret = DRV_PQ_SetGfxHdrOffsetPara(pstAttr);


    return s32Ret;
}

static HI_S32 u32PQIoctl_S_MCDI_SPLIT_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_U32 u32SplitMode;

    u32SplitMode = *(HI_U32 *)arg;
    DRV_PQ_SetMcdiSplitMode(u32SplitMode);
...
static HI_S32 u32PQIoctl_S_HDR_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_PARA_MODE_S *pstMode;
    pstMode = (HI_PQ_HDR_PARA_MODE_S *)arg;
    s32Ret = PQ_MNG_Tool_SetHDRParaMode(pstMode);

    return s32Ret;
}

static HI_S32 u32PQIoctl_G_HDR_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_PARA_MODE_S *pstMode;
    pstMode = (HI_PQ_HDR_PARA_MODE_S *)arg;
    s32Ret = PQ_MNG_Tool_GetHDRParaMode(pstMode);

    return s32Ret;
}

static HI_S32 u32PQIoctl_S_HDR_TMAP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_TMAP_S *pstAttr;
    pstAttr = (HI_PQ_HDR_TMAP_S *)arg;
    s32Ret = PQ_MNG_Tool_SetHdrTMap(pstAttr);
    return s32Ret;
}

static HI_S32 u32PQIoctl_G_HDR_TMAP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_TMAP_S *pstAttr;
    pstAttr = (HI_PQ_HDR_TMAP_S *)arg;
    s32Ret = PQ_MNG_Tool_GetHdrTMap(pstAttr);
...
static HI_S32 u32PQIoctl_S_HDR_SMAP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_SMAP_S *pstAttr;
    pstAttr = (HI_PQ_HDR_SMAP_S *)arg;
    s32Ret = PQ_MNG_Tool_SetHdrSMap(pstAttr);

    return s32Ret;
}

static HI_S32 u32PQIoctl_G_HDR_SMAP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_SMAP_S *pstAttr;
    pstAttr = (HI_PQ_HDR_SMAP_S *)arg;
    s32Ret = PQ_MNG_Tool_GetHdrSMap(pstAttr);
...
static HI_S32 u32PQIoctl_S_GFXHDR_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_GFXHDR_MODE_S *pstMode;
    pstMode = (HI_PQ_GFXHDR_MODE_S *)arg;
    s32Ret = PQ_MNG_SetGfxHdrModeByTool(pstMode);

    return s32Ret;
}

static HI_S32 u32PQIoctl_G_GFXHDR_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_GFXHDR_MODE_S *pstMode;
    pstMode = (HI_PQ_GFXHDR_MODE_S *)arg;
    s32Ret = PQ_MNG_GetGfxHdrModeByTool(pstMode);

    return s32Ret;
}

static HI_S32 u32PQIoctl_S_GFXHDR_TMAP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_GFXHDR_TMAP_S *pstAttr;
    pstAttr = (HI_PQ_GFXHDR_TMAP_S *)arg;
    s32Ret = PQ_MNG_SetGfxHdrTmapByTool(pstAttr);
    return s32Ret;
}

static HI_S32 u32PQIoctl_G_GFXHDR_TMAP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_GFXHDR_TMAP_S *pstAttr;
    pstAttr = (HI_PQ_GFXHDR_TMAP_S *)arg;
    s32Ret = PQ_MNG_GetGfxHdrTmapByTool(pstAttr);

    return s32Ret;
}


static HI_S32 u32PQIoctl_S_GFXHDR_STEP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_GFXHDR_STEP_S *pstAttr;
    pstAttr = (HI_PQ_GFXHDR_STEP_S *)arg;
    s32Ret = PQ_MNG_SetGfxHdrStepByTool(pstAttr);
    return s32Ret;
}

static HI_S32 u32PQIoctl_G_GFXHDR_STEP(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_GFXHDR_STEP_S *pstAttr;
    pstAttr = (HI_PQ_GFXHDR_STEP_S *)arg;
    s32Ret = PQ_MNG_GetGfxHdrStepByTool(pstAttr);
...
static HI_S32 u32PQIoctl_S_HDR_ACM_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_ACM_MODE_S *pstMode;
    pstMode = (HI_PQ_HDR_ACM_MODE_S *)arg;
    s32Ret = PQ_MNG_Tool_SetHdrAcmMode(pstMode);

    return s32Ret;
}

static HI_S32 u32PQIoctl_G_HDR_ACM_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_ACM_MODE_S *pstMode;
    pstMode = (HI_PQ_HDR_ACM_MODE_S *)arg;
    s32Ret = PQ_MNG_Tool_GetHdrAcmMode(pstMode);

    return s32Ret;
}

static HI_S32 u32PQIoctl_S_HDR_ACM_REGCFG(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_ACM_REGCFG_S *pstAttr;
    pstAttr = (HI_PQ_HDR_ACM_REGCFG_S *)arg;
    s32Ret = PQ_MNG_Tool_SetHdrAcmRegCfg(pstAttr);
    return s32Ret;
}

static HI_S32 u32PQIoctl_G_HDR_ACM_REGCFG(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_ACM_REGCFG_S *pstAttr;
    pstAttr = (HI_PQ_HDR_ACM_REGCFG_S *)arg;
    s32Ret = PQ_MNG_Tool_GetHdrAcmRegCfg(pstAttr);
...
#ifdef PQ_ALG_ACC
#if defined(PQ_ACC_27_SUPPORT)
static HI_S32 u32PQIoctl_S_HDR_DYN_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_DYN_TM_TUNING_S *pstMode;
    pstMode = (HI_PQ_HDR_DYN_TM_TUNING_S *)arg;
    s32Ret = PQ_MNG_Tool_SetHdrDynCfg(pstMode);

    return s32Ret;
}

static HI_S32 u32PQIoctl_G_HDR_DYN_MODE(struct inode *inode, struct file *filp, HI_VOID *arg)
{
    HI_S32 s32Ret = HI_SUCCESS;

    HI_PQ_HDR_DYN_TM_TUNING_S *pstMode;
    pstMode = (HI_PQ_HDR_DYN_TM_TUNING_S *)arg;
    s32Ret = PQ_MNG_Tool_GetHdrDynCfg(pstMode);
...
PQ_IOCTRL_CMD_FUN_S stPQIoctrlCmdFunction[] =
{
    ...
    {HIIOC_PQ_G_VP_REMOTE_BRIGHTNESS,   u32PQIoctl_G_VP_REMOTE_BRIGHTNESS},
    ...
    {HIIOC_PQ_S_MCDI_SPLIT_MODE,    u32PQIoctl_S_MCDI_SPLIT_MODE},
    ...
    {HIIOC_PQ_S_GfxHDROFFSET_PARAM, u32PQIoctl_S_GFXHDROFFSET_PARAM},
#if defined(CHIP_TYPE_hi3798cv200)
#ifdef PQ_ALG_TNR
...
#if defined(PQ_HDR_TM_64_SUPPORT)
    {HIIOC_PQ_S_HDR_PARA_MODE,   u32PQIoctl_S_HDR_MODE },
    {HIIOC_PQ_G_HDR_PARA_MODE,   u32PQIoctl_G_HDR_MODE },
    {HIIOC_PQ_S_HDR_TMAP,        u32PQIoctl_S_HDR_TMAP },
    {HIIOC_PQ_G_HDR_TMAP,        u32PQIoctl_G_HDR_TMAP },
#endif

#if defined(PQ_HDR_SM_64_SUPPORT)
    {HIIOC_PQ_S_HDR_SMAP,        u32PQIoctl_S_HDR_SMAP },
    {HIIOC_PQ_G_HDR_SMAP,        u32PQIoctl_G_HDR_SMAP },
#endif
#endif

#ifdef PQ_ALG_GFXHDR
#if defined(PQ_HDR_GFX_TM_SUPPORT)
    {HIIOC_PQ_S_GFXHDR_MODE,     u32PQIoctl_S_GFXHDR_MODE},
    {HIIOC_PQ_G_GFXHDR_MODE,     u32PQIoctl_G_GFXHDR_MODE},
    {HIIOC_PQ_S_GFXHDR_TMAP,     u32PQIoctl_S_GFXHDR_TMAP},
    {HIIOC_PQ_G_GFXHDR_TMAP,     u32PQIoctl_G_GFXHDR_TMAP},
    {HIIOC_PQ_S_GFXHDR_STEP,     u32PQIoctl_S_GFXHDR_STEP},
    {HIIOC_PQ_G_GFXHDR_STEP,     u32PQIoctl_G_GFXHDR_STEP},
#endif
#endif

#ifdef PQ_ALG_LCACM
#if defined(PQ_HDR_ACM_SUPPORT)
    {HIIOC_PQ_S_HDR_ACM_MODE,   u32PQIoctl_S_HDR_ACM_MODE },
    {HIIOC_PQ_G_HDR_ACM_MODE,   u32PQIoctl_G_HDR_ACM_MODE },
    {HIIOC_PQ_S_HDR_ACM_REGCFG, u32PQIoctl_S_HDR_ACM_REGCFG},
    {HIIOC_PQ_G_HDR_ACM_REGCFG, u32PQIoctl_G_HDR_ACM_REGCFG},
#endif
#endif

#ifdef PQ_ALG_ACC
#if defined(PQ_ACC_27_SUPPORT)
    {HIIOC_PQ_S_HDR_DYN_MODE,   u32PQIoctl_S_HDR_DYN_MODE },
    {HIIOC_PQ_G_HDR_DYN_MODE,   u32PQIoctl_G_HDR_DYN_MODE },
#endif
#endif
