...
HI_S32 PQ_HAL_SetDBBlkNumberCfg(HI_U32 u32HandleNo, DB_PARAM_S *pstDBPara)
{
    ...
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBPara);
    pstVpssReg = PQ_HAL_GetVpssReg(u32HandleNo);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstVpssReg);

    pstVpssReg->VPSS_SNR_CTRL.bits.dbm_out_mode              = pstDBPara->u16DbmOutMode;

    pstVpssReg->VPSS_CTRL.bits.blk_det_en                   = pstDBPara->DetSizeEn;
    pstVpssReg->VPSS_SNR_CTRL.bits.det_hy_en                 = pstDBPara->hyEn;
...
HI_S32 PQ_HAL_SetDBStrengh(HI_U32 u32HandleNo, HI_U32 u32Strength)
{
    ...
    pstVpssReg->VPSS_DB_RATIO.bits.db_global_db_strenth_lum = u32Strength;
...
HI_S32 PQ_HAL_SetDBApiReg(HI_U32 u32HandleNo, DB_API_REG_S *pstApiPara)
{
    ...
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDbRegs);

    PQ_CHECK_NULL_PTR_RE_FAIL(pstDbRegs->u8DirStrGainLut);
    ...
    pstVpssVirReg->VPSS_SNR_CTRL.bits.db_lum_hor_en               = pstApiPara->stDbRegs.u8DBLumHorTrue;
    ...
    pstVpssVirReg->VPSS_DB_BORD_FLAG32.bits.vpss_db_bord_flag_32   = pstApiPara->vpss_db_bord_flag[32];
    pstVpssVirReg->VPSS_DB_BORD_FLAG33.bits.vpss_db_bord_flag_33   = pstApiPara->vpss_db_bord_flag[33];
    pstVpssVirReg->VPSS_DB_BORD_FLAG34.bits.vpss_db_bord_flag_34   = pstApiPara->vpss_db_bord_flag[34];
    pstVpssVirReg->VPSS_DB_BORD_FLAG35.bits.vpss_db_bord_flag_35   = pstApiPara->vpss_db_bord_flag[35];
    pstVpssVirReg->VPSS_DB_BORD_FLAG36.bits.vpss_db_bord_flag_36   = pstApiPara->vpss_db_bord_flag[36];
    pstVpssVirReg->VPSS_DB_BORD_FLAG37.bits.vpss_db_bord_flag_37   = pstApiPara->vpss_db_bord_flag[37];
    pstVpssVirReg->VPSS_DB_BORD_FLAG38.bits.vpss_db_bord_flag_38   = pstApiPara->vpss_db_bord_flag[38];
    pstVpssVirReg->VPSS_DB_BORD_FLAG39.bits.vpss_db_bord_flag_39   = pstApiPara->vpss_db_bord_flag[39];
    pstVpssVirReg->VPSS_DB_BORD_FLAG40.bits.vpss_db_bord_flag_40   = pstApiPara->vpss_db_bord_flag[40];
    pstVpssVirReg->VPSS_DB_BORD_FLAG41.bits.vpss_db_bord_flag_41   = pstApiPara->vpss_db_bord_flag[41];
    pstVpssVirReg->VPSS_DB_BORD_FLAG42.bits.vpss_db_bord_flag_42   = pstApiPara->vpss_db_bord_flag[42];
    pstVpssVirReg->VPSS_DB_BORD_FLAG43.bits.vpss_db_bord_flag_43   = pstApiPara->vpss_db_bord_flag[43];
    pstVpssVirReg->VPSS_DB_BORD_FLAG44.bits.vpss_db_bord_flag_44   = pstApiPara->vpss_db_bord_flag[44];
    pstVpssVirReg->VPSS_DB_BORD_FLAG45.bits.vpss_db_bord_flag_45   = pstApiPara->vpss_db_bord_flag[45];
    pstVpssVirReg->VPSS_DB_BORD_FLAG46.bits.vpss_db_bord_flag_46   = pstApiPara->vpss_db_bord_flag[46];
    pstVpssVirReg->VPSS_DB_BORD_FLAG47.bits.vpss_db_bord_flag_47   = pstApiPara->vpss_db_bord_flag[47];
    pstVpssVirReg->VPSS_DB_BORD_FLAG48.bits.vpss_db_bord_flag_48   = pstApiPara->vpss_db_bord_flag[48];
    pstVpssVirReg->VPSS_DB_BORD_FLAG49.bits.vpss_db_bord_flag_49   = pstApiPara->vpss_db_bord_flag[49];
    pstVpssVirReg->VPSS_DB_BORD_FLAG50.bits.vpss_db_bord_flag_50   = pstApiPara->vpss_db_bord_flag[50];
    pstVpssVirReg->VPSS_DB_BORD_FLAG51.bits.vpss_db_bord_flag_51   = pstApiPara->vpss_db_bord_flag[51];
    pstVpssVirReg->VPSS_DB_BORD_FLAG52.bits.vpss_db_bord_flag_52   = pstApiPara->vpss_db_bord_flag[52];
    pstVpssVirReg->VPSS_DB_BORD_FLAG53.bits.vpss_db_bord_flag_53   = pstApiPara->vpss_db_bord_flag[53];
    pstVpssVirReg->VPSS_DB_BORD_FLAG54.bits.vpss_db_bord_flag_54   = pstApiPara->vpss_db_bord_flag[54];
    pstVpssVirReg->VPSS_DB_BORD_FLAG55.bits.vpss_db_bord_flag_55   = pstApiPara->vpss_db_bord_flag[55];
    pstVpssVirReg->VPSS_DB_BORD_FLAG56.bits.vpss_db_bord_flag_56   = pstApiPara->vpss_db_bord_flag[56];
    pstVpssVirReg->VPSS_DB_BORD_FLAG57.bits.vpss_db_bord_flag_57   = pstApiPara->vpss_db_bord_flag[57];
    pstVpssVirReg->VPSS_DB_BORD_FLAG58.bits.vpss_db_bord_flag_58   = pstApiPara->vpss_db_bord_flag[58];
    pstVpssVirReg->VPSS_DB_BORD_FLAG59.bits.vpss_db_bord_flag_59   = pstApiPara->vpss_db_bord_flag[59];
    pstVpssVirReg->VPSS_DB_BORD_FLAG60.bits.vpss_db_bord_flag_60   = pstApiPara->vpss_db_bord_flag[60];
    pstVpssVirReg->VPSS_DB_BORD_FLAG61.bits.vpss_db_bord_flag_61   = pstApiPara->vpss_db_bord_flag[61];
    pstVpssVirReg->VPSS_DB_BORD_FLAG62.bits.vpss_db_bord_flag_62   = pstApiPara->vpss_db_bord_flag[62];
    pstVpssVirReg->VPSS_DB_BORD_FLAG63.bits.vpss_db_bord_flag_63   = pstApiPara->vpss_db_bord_flag[63];
                            ...
                            HI_S32 *pDet_hy_en, HI_S32 *pDet_hc_en, HI_S32 *pDet_vy_en)
{
    ...
    *pDet_hy_en   = pstVpssReg->VPSS_SNR_CTRL.bits.det_hy_en;
...
/* Set DB Enable Ctrl by modify dbm_out_mode */
HI_S32 PQ_HAL_SetDBDbmOutMode(HI_U32 u32Data, HI_BOOL bOnOff)
{
    S_CAS_REGS_TYPE *pstVpssReg = HI_NULL;
    ...
    /* to solve pq demo db enable control ; 通过控制其他寄存器来开关DB使能 */
    if (HI_TRUE == bOnOff)
    {
        pstVpssReg->VPSS_SNR_CTRL.bits.dbm_out_mode = 6;
    }
    else
    {
        pstVpssReg->VPSS_SNR_CTRL.bits.dbm_out_mode = 0;
    }
    return HI_SUCCESS;
}
...
HI_S32 PQ_HAL_EnableDB(HI_U32 u32Data, HI_BOOL bOnOff)
{
    ...
    pstVpssReg->VPSS_SNR_CTRL.bits.db_en = bOnOff;

    PQ_HAL_SetDBDbmOutMode(u32Data, bOnOff);
...
HI_S32 PQ_HAL_SetDbmDemoMode(HI_U32 u32Data, DBM_DEMO_MODE_E enMode)
{
    ...
    pstVpssReg = PQ_HAL_GetVpssReg(u32Data);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstVpssReg);
    pstVpssReg->VPSS_SNR_CTRL.bits.dbm_demo_mode = enMode;
