...
typedef struct tagMCNR_TIMING_PARAM
{
    ...
    HI_S32 Reg_ME_DiscardSMVXEn;
    HI_S32 Reg_ME_DiscardSMVYEn;
    HI_S32 Reg_ME_SMVXThd;
    HI_S32 Reg_ME_SMVYThd;
    ...
    HI_S32 Reg_MC_YMotionStrLUT[128];
    HI_S32 Reg_MC_CMotionStrLUT[128];
    HI_S32 Reg_TF_YBlendingAlphaLUT[32];
    HI_S32 Reg_TF_CBlendingAlphaLUT[32];
} MCNR_TIMING_PARAM;

typedef struct tagSNR_OUTPUT_REG
{
    HI_S32  MotionAlpha;
    HI_S32  SceneChange;
} SNR_OUTPUT_REG;
