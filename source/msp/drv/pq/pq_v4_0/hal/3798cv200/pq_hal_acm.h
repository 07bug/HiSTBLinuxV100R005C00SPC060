...
/* ACM Convert */
#define LUT0_PIXEL_NUM 528
#define LUT1_PIXEL_NUM 424
#define LUT2_PIXEL_NUM 456
#define LUT3_PIXEL_NUM 360
#define LUT4_PIXEL_NUM 528
#define LUT5_PIXEL_NUM 424
#define LUT6_PIXEL_NUM 456
#define LUT7_PIXEL_NUM 360
...
{
    LLLONG_S LUT4_LUT0_CONF[264];
    LLLONG_S LUT5_LUT1_CONF[212];
    LLLONG_S LUT6_LUT2_CONF[228];
    LLLONG_S LUT7_LUT3_CONF[180];
} ACM_CONVERT_TABLE;
/*------------- ACM Convert End ---------*/
...
HI_S32  PQ_HAL_GetACMDemoPos(PQ_HAL_LAYER_VP_E u32VId, HI_U32 *pu32XPos);
