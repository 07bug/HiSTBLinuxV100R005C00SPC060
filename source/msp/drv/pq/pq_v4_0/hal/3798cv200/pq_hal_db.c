...
static HI_S32 DB_SetParamToReg(VPSS_REG_S *pstVpssReg, DB_PARAM_S *pstDBValue)
{
    ...
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBValue->pu8Lum_hor_delta_lut);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBValue->pu8Lum_ver_delta_lut);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBValue->pu8Chr_hor_delta_lut);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBValue->pu8Lum_h_str_fade_lut);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBValue->pu8Lum_v_str_fade_lut);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBValue->pu8Chr_h_str_fade_lut);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstDBValue->pu8Dir_str_gain_lut);
...
HI_S32 PQ_HAL_SetDBApiReg(HI_U32 u32HandleNo, DB_API_REG_S *pstApiPara)
{
    ...
    if (REG_TYPE_VPSS == PQ_COMM_GetAlgTypeID(HI_PQ_MODULE_DB))
    {
        ...
        //VPSS_DB_CTRL
        pstVpssVirReg->VPSS_DB_CTRL.bits.db_lum_ver_en          = pstDbRegs->u8DBLumVerTrue;//modify by sdk 2015.7.21
        pstVpssVirReg->VPSS_DB_CTRL.bits.db_lum_hor_en          = pstDbRegs->u8DBLumHorTrue;//modify by sdk 2015.7.21
        ...
        pstVpssVirReg->VPSS_DB_THR0.bits.db_grad_sub_ratio = pstDbRegs->u8DBGradSubRatio;//modify by sdk 2015.7.21
    ...
    {
        g_pstIPSelVdpAlg->V0_DB_CTRL.bits.db_lum_ver_en          = pstDbRegs->u8DBLumVerTrue;//modify by sdk 2015.7.21
        g_pstIPSelVdpAlg->V0_DB_CTRL.bits.db_lum_hor_en          = pstDbRegs->u8DBLumHorTrue;//modify by sdk 2015.7.21
...
{
    VPSS_REG_S *pstVpssVirReg = HI_NULL;
    PQ_CHECK_NULL_PTR_RE_FAIL(pbDbEn);
