...
{
#if 0
    HI_U32 MOTION_NUM0;            //output of logic, 32bit unsigned    //没有初始化, 是否需要和逻辑交互?  逻辑提供统计信息
    HI_U32 MOTION_NUM1;            //output of logic, 32bit unsigned    //没有初始化
    HI_U32 MOTION_NUM2;            //output of logic, 32bit unsigned    //没有初始化
    HI_U32 MOTION_NUM3;            //output of logic, 32bit unsigned    //没有初始化
    HI_U32 MOTION_NUM4;            //output of logic, 32bit unsigned    //没有初始化

    HI_U32 MOTION_SUM0;            //output of logic, 32bit unsigned    //没有初始化
    HI_U32 MOTION_SUM1;            //output of logic, 32bit unsigned    //没有初始化
    HI_U32 MOTION_SUM2;            //output of logic, 32bit unsigned    //没有初始化
    HI_U32 MOTION_SUM3;            //output of logic, 32bit unsigned    //没有初始化
    HI_U32 MOTION_SUM4;            //output of logic, 32bit unsigned    //没有初始化//同前面Motion
#endif
...
#endif
#if 0
    /* calculate the motion gain based on global motion in the sofeware */
    HI_U32  u32GlobalMotionEn;
    HI_U32  u32GlobalMotionThd[6];    /* 8-bit unsigned:it will be multiplied by 4 when 10-bit processing bitdepth */
    HI_S32  u32GlobalMotionSlope[4];  /* 6-bit unsigned(3,3) */
    HI_U16  u16MaxGlobalMotionRatio;  /* 8-bit unsigned(2,6) */
    HI_U16  u16MinGlobalMotionRatio;  /* 8-bit unsigned(2,6) */

    /* For Alg Debug */
    HI_U32 u32LumForceMotionEn; /* force luma motion to max value */
    HI_U32 u32ChmForceMotionEn; /* force chroma motion to max value */
    HI_U32 u32ForceDeiroutput;

    HI_U32 u32PrintDirEn;
    HI_U32 u32IsPrintDirNum;
    HI_U32 u32PrintDirNum;
#endif
} DEI_PARAMETER_S;
