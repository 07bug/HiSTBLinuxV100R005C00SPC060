...
typedef enum hiHAL_FMD_PQ_MCDI_SPLIT_MODE_E
{
    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_0 = 0, /* Mcdi Split Mode */
    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_1 = 1, /* Mcdi Split Mode */
    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_2 = 2, /* Mcdi Split Mode */
    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_3 = 3, /* Mcdi Split Mode */
    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_4 = 4, /* Mcdi Split Mode */
    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_5 = 5, /* Mcdi Split Mode */

    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_BUTT
} HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_E;
...
typedef struct hi_PQ_REG_IFMD_CALC_S
{
    ...
    HI_HAL_FMD_PQ_MCDI_SPLIT_MODE_E enSplitMode; /*Mcdei 是否使用拆分模式，将FHD拆分为多个SD帧处理*/
