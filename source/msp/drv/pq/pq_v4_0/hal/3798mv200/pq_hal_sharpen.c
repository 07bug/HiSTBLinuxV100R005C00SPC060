...
HI_S32 PQ_HAL_SetSharpDetecEn(HI_U32 u32Data, HI_BOOL bOnOff)
{
    ...
    pVdpReg = PQ_HAL_GetVdpReg();
    SPENABLE.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->SPENABLE.u32)) + u32Data * PQ_VID_OFFSET));
    SPENABLE.bits.detec_en = bOnOff;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->SPENABLE.u32)) + u32Data * PQ_VID_OFFSET), SPENABLE.u32);
