...
static PQ_PHY_REG_S sg_stPhyRegDefault[PHY_REG_MAX] =
{
    ...
    {0x1080,       8,      13,     0,      0,      HI_PQ_MODULE_DEI,       3},     //motion_adjust_coring
    ...
    /*VPSS_DIEKMAG1*/
    {0x10c8,       24,     28,     1,      0,      HI_PQ_MODULE_DEI,       31},    //khoredge
    {0x10c8,       19,     23,     1,      0,      HI_PQ_MODULE_DEI,       2},     //kmagv_2
    {0x10c8,       14,     18,     1,      0,      HI_PQ_MODULE_DEI,       8},     //kmagv_1
    {0x10c8,       7,      13,     1,      0,      HI_PQ_MODULE_DEI,       31},    //kmagh_2
    {0x10c8,       0,      6,      1,      0,      HI_PQ_MODULE_DEI,       31},    //kmagh_1
    /*VPSS_DIEKMAG2*/
    {0x10cc,       24,     26,     1,      0,      HI_PQ_MODULE_DEI,       4},     //gain_framemotion
    {0x10cc,       14,     23,     1,      0,      HI_PQ_MODULE_DEI,     240},    //motion_limt_2
    {0x10cc,       4,      13,     1,      0,      HI_PQ_MODULE_DEI,     240},    //motion_limt_1
    {0x10cc,       3,      3,      1,      0,      HI_PQ_MODULE_DEI,       0},     //frame_mag_en
    {0x10cc,       0,      2,      1,      0,      HI_PQ_MODULE_DEI,       2},     //gain_horedge
    {0x10c8,       24,     28,     2,      0,      HI_PQ_MODULE_DEI,       31},    //khoredge
    {0x10c8,       19,     23,     2,      0,      HI_PQ_MODULE_DEI,       3},     //kmagv_2
    {0x10c8,       14,     18,     2,      0,      HI_PQ_MODULE_DEI,       12},     //kmagv_1
    {0x10c8,       7,      13,     2,      0,      HI_PQ_MODULE_DEI,       31},    //kmagh_2
    {0x10c8,       0,      6,      2,      0,      HI_PQ_MODULE_DEI,       31},    //kmagh_1
    {0x10cc,       24,     26,     2,      0,      HI_PQ_MODULE_DEI,       4},     //gain_framemotion
    {0x10cc,       14,     23,     2,      0,      HI_PQ_MODULE_DEI,     240},    //motion_limt_2
    {0x10cc,       4,      13,     2,      0,      HI_PQ_MODULE_DEI,     240},    //motion_limt_1
    {0x10cc,       3,      3,      2,      0,      HI_PQ_MODULE_DEI,       1},     //frame_mag_en
    {0x10cc,       0,      2,      2,      0,      HI_PQ_MODULE_DEI,       4},     //gain_horedge
    ...
    {0x1118,        4,      8,      0,      0,      HI_PQ_MODULE_DEI,       8},     //th_sad_rgls
    ...
    /*VPSS_MCDI_MC5*/
    {0x1188,        18,     29,     0,      0,      HI_PQ_MODULE_DEI,       480},     //r0_mc
    ...
    {0x621c,    10,      19,        1,      0,      HI_PQ_MODULE_SHARPNESS, 768},     //edge_gain
    ...
    {0x6224,     8,      15,        1,      0,      HI_PQ_MODULE_SHARPNESS,  0},     //peak_under_thr
    {0x6224,     0,       7,        1,      0,      HI_PQ_MODULE_SHARPNESS,  0},     //peak_over_thr
    /*SPGAINPOS*/
    ...
    {0x621c,    10,      19,        1,      3,      HI_PQ_MODULE_SHARPNESS, 768},     //edge_gain
    {0x621c,     0,       9,        1,      3,      HI_PQ_MODULE_SHARPNESS, 456},     //peak_gain
    /************************************* ZME DS *****************************************/
    /* SHOOTCTRL_HL */
