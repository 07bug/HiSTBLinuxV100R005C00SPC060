...
HI_S32 PQ_HAL_SetDBBlkNumberCfg(HI_U32 u32HandleNo, DB_PARAM_S *pstDBPara)
{
    ...
    pstVpssReg->VPSS_DB_CTRL.bits.dbm_out_mode              = pstDBPara->dbm_out_mode;
...
HI_S32 PQ_HAL_SetDBDbmOutMode(HI_U32 u32Data, HI_BOOL bOnOff)
{
    ...
    /*if (HI_TRUE == bOnOff)
    {
        pstVpssReg->VPSS_DB_CTRL.bits.dbm_out_mode = 4;
    }
    else
    {
        pstVpssReg->VPSS_DB_CTRL.bits.dbm_out_mode = 0;
    }*/
