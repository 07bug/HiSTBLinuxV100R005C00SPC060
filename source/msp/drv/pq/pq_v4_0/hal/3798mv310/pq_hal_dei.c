...
HI_S32 PQ_HAL_GetInterlaceMotionEn(HI_U32 u32HandleNo, HI_BOOL *bIgbmEn)
{
    ...
    *bIgbmEn = pstVpssVirReg->VPSS_CTRL.bits.igbm_en & 0x1;
...
HI_S32 PQ_HAL_SetDeiStreamId2(HI_U32 u32HandleNo)
{
    VPSS_REG_S *pstVpssVirReg = NULL;
    pstVpssVirReg = PQ_HAL_GetVpssReg(u32HandleNo);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstVpssVirReg);

    pstVpssVirReg->VPSS_DIEKMAG2.bits.frame_mag_en = 1;
    pstVpssVirReg->VPSS_DIEHISMODE.bits.rec_mode_fld_motion_step_0 = 1;
    pstVpssVirReg->VPSS_DIEHISMODE.bits.rec_mode_fld_motion_step_1 = 1;
...
HI_S32 PQ_HAL_SetSoftReg(HI_U32 u32HandleNo, HI_Mc_DeiParam_S *pstMcParm, HI_DEI_Variable_S *pstDeiVar)
{
    ...
    pstVpssVirReg->VPSS_DIEFUSION0.bits.k_y_mcbld = pstMcParm->nK_MCBLD_Y;
    pstVpssVirReg->VPSS_DIEFUSION0.bits.k_c_mcw   = pstMcParm->nK_MCW_C;
