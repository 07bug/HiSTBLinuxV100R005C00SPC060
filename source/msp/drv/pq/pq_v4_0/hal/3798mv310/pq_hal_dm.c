...
HI_S32 PQ_HAL_SetDmDirStrLutReg(HI_U32 u32HandleNo, HI_U8 *pu8DirStrLut)
{
    VPSS_REG_S *pstVpssVirReg = HI_NULL;

    PQ_CHECK_NULL_PTR_RE_FAIL(pu8DirStrLut);
    pstVpssVirReg = PQ_HAL_GetVpssReg(u32HandleNo);
    PQ_CHECK_NULL_PTR_RE_FAIL(pstVpssVirReg);

    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p0 =  pu8DirStrLut[0];
    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p1 =  pu8DirStrLut[1];
    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p2 =  pu8DirStrLut[2];
    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p3 =  pu8DirStrLut[3];
    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p4 =  pu8DirStrLut[4];

    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p5 =  pu8DirStrLut[5];
    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p6 =  pu8DirStrLut[6];
    pstVpssVirReg->VPSS_DM_LUT3.bits.dm_dir_str_lut_p7 =  pu8DirStrLut[7];

    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p8  =  pu8DirStrLut[8];
    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p9  =  pu8DirStrLut[9];
    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p10 =  pu8DirStrLut[10];
    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p11 =  pu8DirStrLut[11];
    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p12 =  pu8DirStrLut[12];
    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p13 =  pu8DirStrLut[13];
    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p14 =  pu8DirStrLut[14];
    pstVpssVirReg->VPSS_DM_LUT4.bits.dm_dir_str_lut_p15 =  pu8DirStrLut[15];
