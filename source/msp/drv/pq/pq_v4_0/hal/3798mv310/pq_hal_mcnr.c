...
HI_S32 PQ_HAL_UpdateTnrSoftReg(HI_U32 u32HandleNo, MCNR_TIMING_PARAM *pstMcApiParam)
{
...

    {
        ...
        pstVpssVirReg->VPSS_TNR_MAME_STD_GAIN.bits.std_pnl_core = pstMcApiParam->Reg_ME_Std_Pnl_Core;
        pstVpssVirReg->VPSS_TNR_MAME_STD_GAIN.bits.std_pnl_gain = pstMcApiParam->Reg_ME_Std_Pnl_Gain;
        pstVpssVirReg->VPSS_TNR_MAME_CTRL.bits.discardsmvxen = pstMcApiParam->Reg_ME_DiscardSMVXEn;
        pstVpssVirReg->VPSS_TNR_MAME_CTRL.bits.discardsmvyen = pstMcApiParam->Reg_ME_DiscardSMVYEn;
        pstVpssVirReg->VPSS_TNR_MAME_CTRL.bits.smvxthd = pstMcApiParam->Reg_ME_SMVXThd;
        pstVpssVirReg->VPSS_TNR_MAME_CTRL.bits.smvythd                    = pstMcApiParam->Reg_ME_SMVYThd;
...
HI_S32 PQ_HAL_UpdateSnrSoftReg(HI_U32 u32HandleNo, SNR_OUTPUT_REG *pstSnrParam)
{
    ...
    pstVpssVirReg->VPSS_SNR_SCHANGE.bits.scenechange_info  = pstSnrParam->SceneChange;
