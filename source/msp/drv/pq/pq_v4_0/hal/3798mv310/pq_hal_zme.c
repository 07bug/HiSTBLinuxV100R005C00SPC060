...
HI_U32 PQ_HAL_WbcDhdZmeCoefAddrH(ALG_VZME_COEF_ADDR_S *pstCoefAddr, HI_U32 u32Ratio)
{
    ...
    if      (u32TmpRatio > 4096 )
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrHLHC8T6T_1;
    }
    else if (u32TmpRatio == 4096)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrHLHC8T6T_E1;
    }
    else if (u32TmpRatio >= 3072)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrHLHC8T6T_075;
    }
    else if (u32TmpRatio >= 2048)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrHLHC8T6T_05;
    }
    else if (u32TmpRatio >= 1365)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrHLHC8T6T_033;
    }
    else if (u32TmpRatio >= 1024)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrHLHC8T6T_025;
    }
    else
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrHLHC8T6T_0;
    }
...
HI_U32 PQ_HAL_WbcDhdZmeCoefAddrV(ALG_VZME_COEF_ADDR_S *pstCoefAddr, HI_U32 u32Ratio)
{
    ...
    if      (u32TmpRatio > 4096 )
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrVLVC8T4T_1;
    }
    else if (u32TmpRatio == 4096)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrVLVC8T4T_E1;
    }
    else if (u32TmpRatio >= 3072)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrVLVC8T4T_075;
    }
    else if (u32TmpRatio >= 2048)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrVLVC8T4T_05;
    }
    else if (u32TmpRatio >= 1365)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrVLVC8T4T_033;
    }
    else if (u32TmpRatio >= 1024)
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrVLVC8T4T_025;
    }
    else
    {
        u32CoefAddr = pstCoefAddr->u32ZmeCoefAddrVLVC8T4T_0;
    }
...
//load hor coef for vdp wbcdhd , right data is low location in ddr
static HI_U32 VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_RATIO_E enCoefRatio, PQ_HAL_WBC_DHD_ZME_COEF_TYPE_E enCoefType, VZME_TAP_E enZmeTap, HI_U8 *pu8Addr)
{
    HI_U32 u32Tap = 8;
    HI_S16 s16TableTmp[u32Tap * 17];
    HI_U32 u32TableTmpSize = u32Tap * 2 * 17;
    const HI_S16 *ps16L;
    HI_S16 *ps16Dst;
    HI_U32 i;

    ps16L   = g_pWbcDhdZmeReduceCoef[enCoefRatio][enCoefType];
    ps16Dst = s16TableTmp;

    /*load vertical zme(luma and chroma) coef*/
    for (i = 0; i < u32Tap * 17; i += 1)
    {
        *ps16Dst++ = *(ps16L)++;
    }
...
static HI_U32 VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_RATIO_E enCoefRatio,
                                  PQ_HAL_WBC_DHD_ZME_COEF_TYPE_E enCoefType, VZME_TAP_E enZmeTap, HI_U8 *pu8Addr)
{
    ...
    {
        //*ps16Dst++ = *(ps16L);//++;
        *ps16Dst++ = *(ps16L + (i / u32Tap + 1) * u32Tap - (i % u32Tap) - 1); //++;
    }
    memcpy(pu8Addr, s16TableTmp, u32TableTmpSize);
    return HI_SUCCESS;
}
...
HI_VOID PQ_HAL_VdpLoadCoef(ALG_VZME_MEM_S *pstVZmeCoefMem)
{
    ...
    // for 98mv300 wbcdhd zme 8tap coef(actual is 6644)
    /***********************************************************/
    //H_L6:Luma-Hor-4T32P
    u32NumSizeLuma = 16 * 17; /*(4x18) / 12 * 16 */
    VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_1, PQ_HAL_WBC_DHD_ZME_COEF_8T32P_H, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrHLHC8T6T_1 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;
    VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_E1, PQ_HAL_WBC_DHD_ZME_COEF_8T32P_H, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrHLHC8T6T_E1 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_075, PQ_HAL_WBC_DHD_ZME_COEF_8T32P_H, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrHLHC8T6T_075 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_05, PQ_HAL_WBC_DHD_ZME_COEF_8T32P_H, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrHLHC8T6T_05 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_033, PQ_HAL_WBC_DHD_ZME_COEF_8T32P_H, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrHLHC8T6T_033 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_025, PQ_HAL_WBC_DHD_ZME_COEF_8T32P_H, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrHLHC8T6T_025 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefH(PQ_HAL_ZME_COEF_0, PQ_HAL_WBC_DHD_ZME_COEF_8T32P_H, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrHLHC8T6T_0 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    //H_L4:Luma-Hor-4T32P
    //u32NumSizeLuma = 96; /*(4x18) / 12 * 16 */
    VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_1, PQ_HAL_WBC_DHD_ZME_COEF_6T32P_V, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrVLVC8T4T_1 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_E1, PQ_HAL_WBC_DHD_ZME_COEF_6T32P_V, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrVLVC8T4T_E1 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_075, PQ_HAL_WBC_DHD_ZME_COEF_6T32P_V, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrVLVC8T4T_075 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_05, PQ_HAL_WBC_DHD_ZME_COEF_6T32P_V, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrVLVC8T4T_05 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_033, PQ_HAL_WBC_DHD_ZME_COEF_6T32P_V, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrVLVC8T4T_033 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_025, PQ_HAL_WBC_DHD_ZME_COEF_6T32P_V, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrVLVC8T4T_025 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;

    VZmeLoadWbcdhdCoefV(PQ_HAL_ZME_COEF_0, PQ_HAL_WBC_DHD_ZME_COEF_6T32P_V, VZME_TAP_8T32P, pu8CurAddr);
    pstAddrTmp->u32ZmeCoefAddrVLVC8T4T_0 = u32PhyAddr;
    u32PhyAddr  += u32NumSizeLuma;
    pu8CurAddr  += u32NumSizeLuma;
    return;
}
...
/*******************************WBC ZME START***************************************/
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHorLoffset(HI_U32 s32PhaseL)
{
...
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHorCoffset(HI_U32 s32PhaseC)
{
...
static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVerLoffset(HI_U32 s32PhaseL)
{
...
static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVerCoffset(HI_U32 s32PhaseC)
{
    U_WBC_DHD0_ZME_VOFFSET WBC_DHD0_ZME_VOFFSET;
...
static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVblumaOffset(HI_U32 s32PhaseL)
{
    U_WBC_DHD0_ZME_VBOFFSET WBC_DHD0_ZME_VBOFFSET;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VBOFFSET.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&pVdpReg->WBC_DHD0_ZME_VBOFFSET.u32)));
    WBC_DHD0_ZME_VBOFFSET.bits.vbluma_offset = s32PhaseL;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VBOFFSET.u32))), WBC_DHD0_ZME_VBOFFSET.u32);

    return ;
}


static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVbchromaOffset(HI_U32 s32PhaseC)
{
    U_WBC_DHD0_ZME_VBOFFSET WBC_DHD0_ZME_VBOFFSET;
...
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHorRatio(HI_U32 u32Ratio)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))));
    WBC_DHD0_ZME_HSP.bits.hratio = u32Ratio;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))), WBC_DHD0_ZME_HSP.u32);

    return;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVerRatio(HI_U32 u32Ratio)
{
    U_WBC_DHD0_ZME_VSR WBC_DHD0_ZME_VSR;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VSR.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSR.u32))));
    WBC_DHD0_ZME_VSR.bits.vratio = u32Ratio;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSR.u32))), WBC_DHD0_ZME_VSR.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_HZME_SetOutWidth(HI_U32 u32OutWidth)
{
    U_WBC_DHD0_ZME_HINFO WBC_DHD0_ZME_HINFO;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HINFO.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HINFO.u32))));
    WBC_DHD0_ZME_HINFO.bits.out_width = u32OutWidth;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HINFO.u32))), WBC_DHD0_ZME_HINFO.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetOutHeight(HI_U32 u32OutHeight)
{
    U_WBC_DHD0_ZME_VINFO WBC_DHD0_ZME_VINFO;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VINFO.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VINFO.u32))));
    WBC_DHD0_ZME_VINFO.bits.out_height = u32OutHeight;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VINFO.u32))), WBC_DHD0_ZME_VINFO.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHlmscEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;
...
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHchmscEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;
...
static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVlmscEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))));
    WBC_DHD0_ZME_VSP.bits.vlmsc_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))), WBC_DHD0_ZME_VSP.u32);
    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVchmscEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;
...
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHlfirEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))));
    WBC_DHD0_ZME_HSP.bits.hlfir_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))), WBC_DHD0_ZME_HSP.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHchfirEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))));
    WBC_DHD0_ZME_HSP.bits.hchfir_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))), WBC_DHD0_ZME_HSP.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVlfirEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))));
    WBC_DHD0_ZME_VSP.bits.vlfir_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))), WBC_DHD0_ZME_VSP.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetVchfirEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))));
    WBC_DHD0_ZME_VSP.bits.vchfir_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))), WBC_DHD0_ZME_VSP.u32);
...
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHlmidEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))));
    WBC_DHD0_ZME_HSP.bits.hlmid_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))), WBC_DHD0_ZME_HSP.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_HZME_SetHchmidEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))));
    WBC_DHD0_ZME_HSP.bits.hchmid_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))), WBC_DHD0_ZME_HSP.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetHlmidEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))));
    WBC_DHD0_ZME_VSP.bits.vlmid_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))), WBC_DHD0_ZME_VSP.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetHchmidEn(HI_U32 u32bEnable)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_VSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))));
    WBC_DHD0_ZME_VSP.bits.vchmid_en = u32bEnable;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_VSP.u32))), WBC_DHD0_ZME_VSP.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_SetZmeHfirOrder(HI_U32 u32HfirOrder)
{
    U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;
    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HSP.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32))));
...
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetCoefAddr( HI_U32 u32Addr)
{
    U_PARA_ADDR_VHD_CHN11 PARA_ADDR_VHD_CHN11;

    pVdpReg = PQ_HAL_GetVdpReg();
    PARA_ADDR_VHD_CHN11.bits.para_addr_vhd_chn11 = u32Addr;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->PARA_ADDR_VHD_CHN11.u32))), PARA_ADDR_VHD_CHN11.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetCoefAddr( HI_U32 u32Addr)
{
    U_PARA_ADDR_VHD_CHN12 PARA_ADDR_VHD_CHN12;

    pVdpReg = PQ_HAL_GetVdpReg();
    PARA_ADDR_VHD_CHN12.bits.para_addr_vhd_chn12 = u32Addr;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->PARA_ADDR_VHD_CHN12.u32))), PARA_ADDR_VHD_CHN12.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_HZME_SetParaUpd(HI_VOID)
{
    ...
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->PARA_UP_VHD.u32))), PARA_UP_VHD.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetParaUpd( HI_VOID)
{
    U_PARA_UP_VHD PARA_UP_VHD;
...
static HI_VOID PQ_HAL_WBC_DHD_HZME_SetZmeOutFmt(HI_U32 zme_out_fmt)
{
    U_WBC_DHD0_ZME_HINFO WBC_DHD0_ZME_HINFO;

    pVdpReg = PQ_HAL_GetVdpReg();
    WBC_DHD0_ZME_HINFO.u32 = PQ_HAL_RegRead((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HINFO.u32))));
    WBC_DHD0_ZME_HINFO.bits.out_fmt = zme_out_fmt;
    PQ_HAL_RegWrite((HI_U32 *)((HI_ULONG)(&(pVdpReg->WBC_DHD0_ZME_HINFO.u32))), WBC_DHD0_ZME_HINFO.u32);

    return ;
}

static HI_VOID PQ_HAL_WBC_DHD_VZME_SetZmeOutFmt(HI_U32 zme_out_fmt)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;
...
static HI_VOID PQ_HAL_WBC_DHD_VZME_SetZmeInFmt(HI_U32 zme_in_fmt)
{
    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;
...
static HI_VOID PQ_HAL_WBC_DHD_VZME_SetOutFld(HI_U32 out_fld)
{
    U_WBC_DHD0_ZME_VINFO WBC_DHD0_ZME_VINFO;
...
static HI_VOID PQ_HAL_WBC_DHD_VZME_SetOutPro(HI_U32 out_pro)
{
    U_WBC_DHD0_ZME_VINFO WBC_DHD0_ZME_VINFO;
