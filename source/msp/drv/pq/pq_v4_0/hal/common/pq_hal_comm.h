...
#define PQ_VPSS_WBCREG_SIZE           ((sizeof(S_STT_REGS_TYPE) + 15) & 0xFFFFFFF0)
...
typedef enum hiPQ_PRN_TYPE_E
{
    ...
    PQ_PRN_VPSSCSC  = 0x2000000,   /*VPSS CSC 算法调试信息打印*/
    PQ_PRN_VPSSGAMMA = 0x4000000, /*VPSS GAMMA 算法调试信息打印*/
    PQ_PRN_VDP4KSNR = 0x8000000,  /*VDP 4K SNR 算法调试信息打印*/
    PQ_PRN_HDR      = 0x10000000,   /*HDR 算法调试信息打印*/
    PQ_PRN_GFXHDR   = 0x20000000,   /*GFXHDR 算法调试信息打印*/
...
extern PQ_MMZ_BUF_S     g_stSharpCfgBuff;
#endif
