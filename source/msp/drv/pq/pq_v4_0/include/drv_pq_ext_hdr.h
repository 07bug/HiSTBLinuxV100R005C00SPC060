...
#define PQ_GFXHDR_DEGMM_SEG_SIZE       4
/*#define PQ_GFXHDR_DEGMM_LUT_SIZE      64*/

#define PQ_GFXHDR_TMAP_SEG_SIZE        4
#define PQ_GFXHDR_TMAP_LUT_SIZE       32

#define PQ_GFXHDR_GMM_SEG_SIZE         8
#define PQ_GFXHDR_GMM_LUT_SIZE        64
...
/* Hdr Layer ID */
typedef enum hiPQ_XDR_LAYER_ID_E
{
    HI_PQ_XDR_LAYER_ID_0    = 0, /* HDR LAYER ID 0 */
    HI_PQ_XDR_LAYER_ID_1    = 1, /* HDR LAYER ID 1 */

    HI_PQ_XDR_LAYER_ID_BUTT
} HI_PQ_XDR_LAYER_ID_E;

typedef struct hiPQ_HDR_LAYER_REGION_S
{
    HI_PQ_XDR_LAYER_ID_E  enPqXdrLayerId;   /* layer 0 : v0, layer 1 : v1 */
    HI_U32  u32WindowNum;                   /* window num : 1,vo, >1:multi, 0:invaild */
} HI_PQ_XDR_LAYER_REGION_S;
...
typedef struct hiPQ_XDR_FRZME_INFO_S
{
    HI_PQ_XDR_LAYER_REGION_S            stLayerRegionInfo;
...
} HI_PQ_XDR_FRAME_INFO;

typedef struct hiPQ_GFXHDR_INFO_S
{
    HI_DRV_VIDEO_FRAME_TYPE_E           enSrcFrameType;
    HI_PQ_DISP_OUT_TYPE_E               enDispType;         /* SDR/HDR10/... */
    HI_DRV_COLOR_SPACE_E                enInCS;             /* input color */
    HI_DRV_COLOR_SPACE_E                enOutCS;            /* output color */
} HI_PQ_GFXHDR_HDR_INFO;
...
typedef struct hiPQ_HDR_TMAP
{
    ...
    HI_U32 u32ScaleMixAlpha ;               /* 310 */
    HI_U32 u32MixAlpha ;                    /* 310 */
    ...
    HI_U32  au32StepSM[PQ_SMAP_SEG_SIZE];    /* U5.0  [0,21]*/
    HI_U32  au32PosSM[PQ_SMAP_SEG_SIZE];     /* U21.0 [0,2097151]*/
    HI_U32  au32NumSM[PQ_SMAP_SEG_SIZE];     /* U6.0  [0,63]*/
...
typedef struct hiPQ_HDR_CFG
{
    ...
    HI_BOOL bV0HdrEn        ;         /* 96add vdm bypass or not */
    HI_BOOL bV1HdrEn        ;         /* 96add vdm bypass or not */
...
typedef struct hiPQ_GFXHDR_DEGMM
{
    HI_U32  au32Step[PQ_GFXHDR_DEGMM_SEG_SIZE];    /* U4.0  [0,15] */
    HI_U32  au32Pos[PQ_GFXHDR_DEGMM_SEG_SIZE];     /* U12.0  [0,4095] */
    HI_U32  au32Num[PQ_GFXHDR_DEGMM_SEG_SIZE];     /* U6.0  [0,63] */
    //HI_U32  pu32LUT[PQ_GFXHDR_DEGMM_LUT_SIZE] ;    /* U21.0 [0,2097151]   Size:PQ_DEGMM_LUT_SIZE */
} PQ_GFXHDR_DEGMM;

typedef struct hiPQ_GFXHDR_TMAP
{
    HI_U16 u16ScaleLumaCal ;                /* U4.0  [0,15]*/
    HI_U16 au16M3LumaCal[3] ;               /* U1.15 [0, 65535]*/
    HI_U32 u32ClipMinTM ;                   /* U21.0 [0,2097151]*/
    ...
    HI_U16  u16ScaleCoefTM ;                /* U4.0  [0,15]*/
    HI_U32  au32StepTM[PQ_GFXHDR_TMAP_SEG_SIZE];   /* U5.0  [0,21]*/
    HI_U32  au32NumTM[PQ_GFXHDR_TMAP_SEG_SIZE];    /* U6.0  [0,63]*/
    HI_U32  au32PosTM[PQ_GFXHDR_TMAP_SEG_SIZE];    /* U21.0 [0,2097151]*/
    HI_U32  pu32LUTTM[PQ_GFXHDR_TMAP_LUT_SIZE];    /* U16.0 [0,65535]  */
} PQ_GFXHDR_TMAP;

typedef struct hiPQ_GFXHDR_GMAP
{
    HI_U16 u16ScaleGMAP;                    /* U4.0  [0,15] */
    HI_S16 as16M33GMAP[3][3];               /* S1.14 [-2^15, 2^15-1] = [-32768, 32767]  */
    HI_U32 u32ClipMinGMAP;                  /* U21.0 [0,2097151] */
...
typedef struct hiPQ_GFXHDR_GMM
{
    HI_U32  au32Step[PQ_GFXHDR_GMM_SEG_SIZE];      /* U5.0  [0,21] */
    HI_U32  au32Pos[PQ_GFXHDR_GMM_SEG_SIZE];       /* U21.0 [0,2097151] */
    HI_U32  au32Num[PQ_GFXHDR_GMM_SEG_SIZE];       /* U6.0  [0,63] */
    HI_U32  pu32LUT[PQ_GFXHDR_GMM_LUT_SIZE] ;      /* U12.0 [0,4095]   Size:PQ_GMM_LUT_SIZE */
} PQ_GFXHDR_GMM;

typedef struct hiPQ_GFXHDR_R2Y
{
    HI_U16 u16ScaleR2Y ;                  /*U4.0  [0,15] */
    HI_S16 as16M33R2Y[3][3];              /* S1.14 [-32768, 32767] */
    HI_S16 as16DcInR2Y[3] ;               /* S10.0  [-1024, 1023] */
    HI_S16 as16DcOutR2Y[3] ;              /* S10.0  [-1024,1023] */
    HI_U16 u16ClipMinR2Y ;                /* U10.0  [0,1023] */
    HI_U16 u16ClipMaxR2Y;                 /* U10.0  [0,1023] */
} PQ_GFXHDR_R2Y;

typedef struct hiPQ_GFXHDR_CFG
{
    /**** Enable  ****/
    HI_BOOL bHdrEn        ;         /*Gdm bypass or not */
    HI_BOOL bDegammaEn      ;         /*DeGamma enable*/
    HI_BOOL bGMapEn         ;         /*GamutMapping enable*/
    HI_BOOL bTMapEn         ;         /*ToneMapping enable*/
    HI_BOOL bGammaEn        ;         /*Gamma enable*/
    ...
    /***** Coef *****/
    PQ_GFXHDR_DEGMM stDeGmm    ;         /* DeGamma */
    PQ_GFXHDR_TMAP  stTMAP     ;         /* ToneMapping */
    PQ_GFXHDR_GMAP  stGMAP     ;         /* GamutMapping */
    PQ_GFXHDR_GMM   stGmm      ;         /* Gamma */
    PQ_GFXHDR_R2Y   stR2Y      ;         /* RGB2YUV */
} HI_PQ_GFXHDR_CFG;
