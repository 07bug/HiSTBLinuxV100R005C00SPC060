...
HI_S32 PQ_MNG_ALG_GetMcDeiParam(MOTION_INPUT_S *pstMotionInput)
{
    ...
    nK_FR_MCW = MIN2(16, MAX2(0, sg_stPQDEIInfo.s32FRCountMC - 8) * 48 / 8);
    ...
    sg_stPQDEIInfo.s32FRCountMC = (sg_stPQDEIInfo.s32FRCountMC == 31) ? sg_stPQDEIInfo.s32FRCountMC : (sg_stPQDEIInfo.s32FRCountMC + 1);
