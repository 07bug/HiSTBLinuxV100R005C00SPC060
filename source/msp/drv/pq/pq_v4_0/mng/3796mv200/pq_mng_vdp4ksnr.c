...
HI_S32 PQ_MNG_InitVdp4KSnr(PQ_PARAM_S *pstPqParam, HI_BOOL bParaUseTableDefault)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    PQ_TABLE_InitPhyList(u32HandleNo, HI_PQ_MODULE_VDP4KSNR, PQ_SOURCE_MODE_UHD, PQ_OUTPUT_MODE_NO);
