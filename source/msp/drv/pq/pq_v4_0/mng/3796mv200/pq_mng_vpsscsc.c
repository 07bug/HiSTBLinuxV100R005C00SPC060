...
HI_S32 PQ_MNG_GetVpssColorTemp(HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    PQ_CHECK_NULL_PTR_RE_FAIL(pstTemperature);


    pstTemperature->u32Red   = sg_stVpssColorTemp.u32Red;
    pstTemperature->u32Green = sg_stVpssColorTemp.u32Green;
    pstTemperature->u32Blue  = sg_stVpssColorTemp.u32Blue;

    return HI_SUCCESS;
}

HI_S32  PQ_MNG_SetVpssColorTemp(HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    sg_stVpssColorTemp.u32Red   = pstTemperature->u32Red;
    sg_stVpssColorTemp.u32Green = pstTemperature->u32Green;
    sg_stVpssColorTemp.u32Blue  = pstTemperature->u32Blue;
