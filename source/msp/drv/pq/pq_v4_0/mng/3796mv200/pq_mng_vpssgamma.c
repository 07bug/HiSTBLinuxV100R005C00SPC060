...
static HI_U16 sg_VpssGammaClutY[HI_DRV_PQ_VIDEOPHONE_MODE_BUTT][HI_PQ_VPSSGAMA_LUT_SIZE] =
{
    {
...
static HI_U16 sg_VpssGammaClutU[HI_DRV_PQ_VIDEOPHONE_MODE_BUTT][HI_PQ_VPSSGAMA_LUT_SIZE] =
{
    {
        0,   8,   16,  24,  32,  40,  48,  56,  64,  72,  80,  88,  96,  104, 112, 120,
        128, 136, 144, 152, 160, 168, 176, 184, 192, 200, 208, 216, 224, 232, 240, 248, 255
...
static HI_U16 sg_VpssGammaClutV[HI_DRV_PQ_VIDEOPHONE_MODE_BUTT][HI_PQ_VPSSGAMA_LUT_SIZE] =
{
    {
        0,   8,   16,  24,  32,  40,  48,  56,  64,  72,  80,  88,  96,  104, 112, 120,
        128, 136, 144, 152, 160, 168, 176, 184, 192, 200, 208, 216, 224, 232, 240, 248, 255
...
static HI_S32 pq_mng_GetVpssGammaModeCoef(HI_DRV_PQ_VP_MODE_E enPqVPImageMode, HAL_PQ_VPSSGAMMA_COEF_S *pstVpssGammaCoef)
{
    ...
    memcpy(pstVpssGammaCoef->u32aGammaLutY, sg_VpssGammaClutY[enPqVPImageMode], sizeof(pstVpssGammaCoef->u32aGammaLutY));
    memcpy(pstVpssGammaCoef->u32aGammaLutU, sg_VpssGammaClutU[enPqVPImageMode], sizeof(pstVpssGammaCoef->u32aGammaLutU));
    memcpy(pstVpssGammaCoef->u32aGammaLutV, sg_VpssGammaClutV[enPqVPImageMode], sizeof(pstVpssGammaCoef->u32aGammaLutV));
