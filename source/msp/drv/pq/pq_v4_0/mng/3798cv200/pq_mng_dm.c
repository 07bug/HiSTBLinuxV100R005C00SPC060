...
HI_S32 PQ_MNG_DMCalcConfigCfg(HI_PQ_DB_CALC_INFO_S *pstDmCalcInfo)
{
    ...
    PQ_HAL_SetRegDmDirStrGainLut(pstDmCalcInfo->u32HandleNo, g_DmDirStrGainLut);
    PQ_HAL_SetRegDmDirStrLut(pstDmCalcInfo->u32HandleNo, g_DmDirStrLut);
    PQ_HAL_SetRegDmSwWhtLut(pstDmCalcInfo->u32HandleNo, g_DmSwWhtLut);
