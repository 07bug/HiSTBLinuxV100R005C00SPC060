...
static HI_S32 PQ_MNG_GZmeLoadCoefH(PQ_GZME_COEF_RATIO_E enCoefRatio, HI_U8 *pu8Addr)
{
    ...
    /* Luma */
    u32TableTmpSize = PQ_MNG_GZmeTransCoefAlign(g_pPQGfxZmeCoef[enCoefRatio][PQ_GZME_COEF_8T8P_LH], (HI_S16)(8 * 8), s16TableTmp);
    ...
    /* Chroma */
    u32TableTmpSize = PQ_MNG_GZmeTransCoefAlign(g_pPQGfxZmeCoef[enCoefRatio][PQ_GZME_COEF_8T8P_CH], (HI_S16)(8 * 8), s16TableTmp);
