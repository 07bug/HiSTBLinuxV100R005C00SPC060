...
static HI_S32 PQ_MNG_GZmeTransCoefAlign(const HI_S16 *ps16Coef, HI_S16 s16CoefNumber, HI_S16 *pBitCoef)
{
    HI_U32 i;
...
static HI_S32 PQ_MNG_GDtiTransCoefVert(const HI_S16 *ps16LtiCoef, const HI_S16 *ps16CtiCoef,
...
static HI_S32 PQ_MNG_GDtiTransCoefHor(const HI_S16 *ps16LtiCoef, const HI_S16 *ps16CtiCoef,
                                      PQ_GZME_COEF_BITARRAY_S *pBitCoef)
{
    HI_U32 i, u32Cnt, u32Tmp;
...
static HI_S32 PQ_MNG_GZmeLoadCoefH(PQ_GZME_COEF_RATIO_E enCoefRatio, HI_U8 *pu8Addr)
{
    ...
    u32TableTmpSize = PQ_MNG_GZmeTransCoefAlign(g_pPQGfxZmeReduceCoef[enCoefRatio][PQ_GZME_COEF_8T8P_LH], (HI_S16)(8 * 8), s16TableTmp);
    ...
    /* Chroma */
    u32TableTmpSize = PQ_MNG_GZmeTransCoefAlign(g_pPQGfxZmeReduceCoef[enCoefRatio][PQ_GZME_COEF_8T8P_CH], (HI_S16)(8 * 8), s16TableTmp);
...
static HI_S32 PQ_MNG_GZmeLoadCoefV(PQ_GZME_COEF_RATIO_E enCoefRatio, HI_U8 *pu8Addr)
{
    ...
    PQ_CHECK_NULL_PTR_RE_FAIL(pu8Addr);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu8Addr + u32TableTmpSize * 2);

    memcpy(pu8Addr, s16TableTmp, u32TableTmpSize * 2);
...
static HI_S32 PQ_MNG_GTinyZmeLoadCoefV(PQ_GZME_COEF_RATIO_E enCoefRatio, HI_U8 *pu8Addr)
{
    ...
    PQ_CHECK_OVER_RANGE_RE_FAIL(enCoefRatio, PQ_GZME_COEF_RATIO_BUTT);
...
* others:       : NA
***************************************************************************************/
static HI_S32 PQ_MNG_GZmeLoadSDCoefH(PQ_GZME_COEF_RATIO_E enCoefRatio, HI_U8 *pu8Addr)
{
    HI_S16 s16TableTmp[8 * 8];
    HI_U32 u32TableTmpSize;
    PQ_GZME_COEF_BITARRAY_S stArray; /* for DTI coefficient */
    ...
    memset(s16TableTmp, 0, sizeof(s16TableTmp));
    /* Luma */
    u32TableTmpSize = PQ_MNG_GZmeTransCoefAlign(g_pPQGfxSDZmeCoef[enCoefRatio][PQ_GZME_COEF_8T8P_LH], (HI_S16)(8 * 8), s16TableTmp);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu8Addr);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu8Addr + u32TableTmpSize);
    ...
    /* Chroma */
    u32TableTmpSize = PQ_MNG_GZmeTransCoefAlign(g_pPQGfxSDZmeCoef[enCoefRatio][PQ_GZME_COEF_8T8P_CH], (HI_S16)(8 * 8), s16TableTmp);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu8Addr);
    PQ_CHECK_NULL_PTR_RE_FAIL(pu8Addr + u32TableTmpSize);
...
static HI_VOID PQ_MNG_GZmeLoadCoefHV(PQ_GZME_MEM_S *pstGZmeCoefMem)
{
    ...
    HI_U32 u32NumSizeH = 48;
    HI_U32 u32NumSizeV = 96;
    HI_U32 u32NumSizeSdH = 48;
    HI_U32 u32NumSizeSdV = 96;
     ...
     **/
    u32NumSize = 256 + u32NumSizeH; /** 256 + (2*8*2/12+1)*16 **/
     ...
     **/
    u32NumSize = 256 + u32NumSizeV; /** 256+(2*16*2/12+1)*16 **/
    ...
    /**
     ** GFX1 or WBC2; added by sdk
     ** 8 tap 8 phase for horizontal
     **/
    u32NumSize = 256 + u32NumSizeSdH;
