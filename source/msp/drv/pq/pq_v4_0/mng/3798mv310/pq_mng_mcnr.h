...
typedef struct hiMCNR_INPUT_INFO
{
    ...
    HI_S32 Cfg_MD_YMotionGain;
    HI_S32 Cfg_MD_YMotionCore;

    HI_S32 Cfg_MD_CMotionGain;
    HI_S32 Cfg_MD_CMotionCore;
...
typedef struct hiMCNR_TIMING_INFO
{
    ...
    HI_S32 Inf_ME_preNonrgmeLevel[4];//double
    HI_S32 Inf_ME_NonrgmeLevel;
    HI_S32 Inf_ME_preSaltusLevel[3];    //double

    HI_S32 Inf_ME_SaltusLevel;
    HI_S32 Inf_ME_SaltusFlag;
    HI_S32 Inf_ME_HMVCnt[40];
    HI_S32 Inf_ME_VMVCnt[40];
    HI_S32 Inf_ME_AsistGlobalMotion1;
    HI_S32 Inf_ME_AsistGlobalMotion2;
    HI_S32 Inf_ND_preGM[10];
    HI_S32 Inf_SCD_DarknessLevel;
    HI_S32 Inf_SCD_SCLevel;
