...
HI_S32 PQ_MNG_InitArtDS(PQ_PARAM_S *pstPqParam, HI_BOOL bParaUseTableDefault)
{
    ...
    s32Ret = PQ_TABLE_InitPhyList(u32ID, HI_PQ_MODULE_ARTDS, PQ_SOURCE_MODE_HD, PQ_OUTPUT_MODE_HD);
