...
static COLOR_SPACE_S      sg_stCSCMode[HI_PQ_CSC_TYPE_BUUT] =
{
...
static HI_PQ_VDP_CSC_S   sg_stCscModeStat[HI_PQ_CSC_TYPE_BUUT] =
{
    {HI_FALSE, HI_PQ_CSC_YUV2YUV_601_709},//V0
    {HI_FALSE, HI_PQ_CSC_YUV2YUV_601_709},//V1
    {HI_FALSE, HI_PQ_CSC_BUTT           },//V2
    {HI_FALSE, HI_PQ_CSC_BUTT           },//V3
    {HI_FALSE, HI_PQ_CSC_BUTT           },//V4
    {HI_FALSE, HI_PQ_CSC_RGB2RGB        },//GP0
    {HI_FALSE, HI_PQ_CSC_BUTT           },//GP1
    {HI_FALSE, HI_PQ_CSC_BUTT           } //Default
};

static const HI_S32 SIN_TABLE[61] =
{
...
static const HI_U32 COS_TABLE[61] =
{
...
HI_PQ_CSC_COEF_S CSCTable_NtscSDYCbCr_to_HDYCbCr =
{
    1024, -88, -204,
    0,   1032,  114,
    0,     60,  964
...
HI_PQ_CSC_COEF_S CSCTable_PalSDYCbCr_to_HDYCbCr =
{
    1024, -116, -192,
    0,    1028,  104,
    0,      88, 1100
...
HI_PQ_CSC_COEF_S CSCTable_240MHDYCbCr_to_HDYCbCr =
{
    1024,  0,   0,
    0,  1016,   0,
    0,     1, 948
...
HI_PQ_CSC_COEF_S CSCTable_FccSDYCbCr_to_HDYCbCr =
{
    1024,   0,   0,
    56,  1148,  -4,
    36,   -12, 1148
...
HI_PQ_CSC_COEF_S CSCTable_XvYCCSDYCbCr_to_HDYCbCr =
{
    1024, -118, -213,
    0,    1043,  117,
    0,      77, 1050
...
HI_PQ_CSC_COEF_S CSCTable_HDYCbCr_to_XvYCCSDYCbCr =
{
    1024, 102,  196,
    0,   1014, -113,
    0,    -74, 1007
...
HI_PQ_CSC_COEF_S CSCTable_FccSDYCbCr_to_XvYCCSDYCbCr =
{
    1036, 112,  292,
    52,  1140, -176,
    28,   -96, 1444
...
HI_PQ_CSC_COEF_S CSCTable_PalSDYCbCr_to_XvYCCSDYCbCr =
{
    1024,  0,   28,
    0,  1004,  -20,
    0,     4, 1072
...
HI_PQ_CSC_COEF_S CSCTable_NtscSDYCbCr_to_XvYCCSDYCbCr =
{
    1024,  24,  -8,
    0,   1016,   4,
    0,    -20, 940
...
HI_PQ_CSC_COEF_S CSCTable_240MHDYCbCr_to_XvYCCSDYCbCr =
{
    1024, 104,  180,
    0,   1004, -104,
    0,    -68,  932
...
/* identity matrix */
HI_PQ_CSC_COEF_S CSCTable_Identity_YCbCr_to_YCbCr =
{
    1024,  0,    0,
    0,  1024,    0,
    0,     0, 1024
...
**************************************************/
/* RGB -> YUV709 (i.e. SD) */
HI_PQ_CSC_COEF_S CSCTable_RGB_to_HDYCbCr =
{
    188,   629,  63,
    -103, -347, 450,
    450,  -409, -41
...
HI_PQ_CSC_COEF_S CSCTable_RGB_to_HDYCbCr_Full =
{
    218,   732,  74,
    -118, -394, 512,
    512,  -465, -47
...
/* RGB -> YUV601 (i.e. SD) */
HI_PQ_CSC_COEF_S CSCTable_RGB_to_XvYCCSDYCbCr =
{
    264,   516, 100,
    -152, -298, 450,
    450,  -377, -73
...
HI_PQ_CSC_COEF_S CSCTable_RGB_to_XvYCCSDYCbCr_Full =
{
    306,   601, 117,
    -173, -339, 512,
    512,  -429, -83
...
**************************************************/
/* BT.709 (i.e. HD) -> RGB */
HI_PQ_CSC_COEF_S CSCTable_HDYCbCr_to_RGB =
{
    1192,    0, 1836,
    1192, -218, -547,
    1192, 2166,    0
...
HI_PQ_CSC_COEF_S CSCTable_HDYCbCr_to_RGB_Full =
{
    1024,    0, 1613,
    1024, -191, -479,
    1024, 1901,    0
...
HI_PQ_CSC_COEF_S CSCTable_XvYCCSDYCbCr_to_RGB =
{
    1192,    0, 1634,
    1192, -400, -833,
    1192, 2066,    0
...
HI_PQ_CSC_COEF_S CSCTable_XvYCCSDYCbCr_to_RGB_Full =
{
    1024,    0, 1436,
    1024, -352, -731,
    1024, 1815,    0
...
**************************************************/
/* identity matrix */
HI_PQ_CSC_COEF_S CSCTable_Identity_RGB_to_RGB =
{
    1024,  0,    0,
    0,  1024,    0,
    0,     0, 1024
...
static HI_PQ_CSC_COEF_S *CSC_YCbCr_MatrixTbl[OPTM_CS_BUTT][2] =
{
    /* OPTM_CS_eUnknown = 0 */
    {
...
static HI_PQ_CSC_COEF_S *CSC_YCbCr_to_RGBPrim_MatrixTbl[][9] =
{
    /* LIMIT */
    {
...
static HI_PQ_CSC_COEF_S *CSC_RGBPrim_to_YCbCr_MatrixTbl[][2] =
{
    /* LIMIT */
    {
...
/* Set CSC Tran Mode:
   ...
   */
static HI_S32 PQ_MNG_GetCSCModeCoef(HI_PQ_CSC_MODE_E enCscMode, HI_PQ_CSC_COEF_S *pstCscCoef, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    ...
    if (enCscMode == HI_PQ_CSC_RGB2YUV_601) /* RGB -> YCbCr_601 L */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_601) /* YCbCr_601 L -> RGB */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_709) /* RGB -> YCbCr_709 L */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_709) /* YCbCr_709 L -> RGB */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(1192);
        pstCscCoef->csc_coef01 = (HI_S32)(0);
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2YUV_709_601) /* YCbCr_709 L -> YCbCr_601 L */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2YUV_601_709) /* YCbCr_601 L -> YCbCr_709 L */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(1024);
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2YUV) /* YCbCr L -> YCbCr L */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_601_FULL) /* YCbCr_601 F -> RGB */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(1024);
        pstCscCoef->csc_coef01 = (HI_S32)(0);
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_709_FULL) /* YCbCr_709 F -> RGB */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(1024);
        pstCscCoef->csc_coef01 = (HI_S32)(0);
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_601_FULL) /* RGB -> YCbCr_601 F */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_709_FULL) /* RGB -> YCbCr_709 F */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2RGB) /* RGB -> RGB */
    {
        pstCscCoef->csc_coef00 = 1024;
        pstCscCoef->csc_coef01 = 0;
        pstCscCoef->csc_coef02 = 0;
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_709_2020) /* RGB_709 -> RGB_2020 */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_2020_2020_L) /* RGB_2020 -> YCbCr_2020 L */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_2020_2020_L) /* YCbCr_2020 L -> RGB_2020 */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(1192);
        pstCscCoef->csc_coef01 = (HI_S32)(0);
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_2020_709) /* RGB_2020 -> RGB_709 */
    {
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_601_2020) /* RGB_601 -> RGB_2020 */ /* same to RGB_709 -> RGB_2020 */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(642);
        pstCscCoef->csc_coef01 = (HI_S32)(337);
        pstCscCoef->csc_coef02 = (HI_S32)(44);
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_2020_601) /* RGB_2020 -> RGB_601 */ /* same to RGB_2020 -> RGB_709 */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(1700);
        pstCscCoef->csc_coef01 = (HI_S32)(-602);
        pstCscCoef->csc_coef02 = (HI_S32)(-75);
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2YUV_2020_601_L_L) /* YCbCr_2020 L -> YCbCr_601 L */ /* same to YCbCr_709 L -> YCbCr_601 L */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(1024);
        pstCscCoef->csc_coef01 = (HI_S32)(102);
        pstCscCoef->csc_coef02 = (HI_S32)(196);
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_2020_601_L) /* RGB_2020 -> YCbCr_601 L */ /* same to RGB -> YCbCr_601 L */
    {
        pstCscCoef->csc_coef00 = (HI_S32)(264);
        pstCscCoef->csc_coef01 = (HI_S32)(516);
        pstCscCoef->csc_coef02 = (HI_S32)(100);
...
static HI_VOID PQ_MNG_CalCSCCoefTprtRGBtoRGB(HI_U32 Contrast, HI_U32 Saturation, HI_U32 Hue,
        HI_U32 Kr, HI_U32 Kg, HI_U32 Kb, HI_PQ_CSC_COEF_S *pCSCTable, HI_PQ_CSC_COEF_S *pDstCSCTable)
{
...
/* 计算色彩空间转换系数
   ...
   */
static HI_VOID PQ_MNG_CalCTemperatureMat(HI_U32 Kr, HI_U32 Kg, HI_U32 Kb, HI_PQ_CSC_COEF_S *pCSCTable, HI_PQ_CSC_COEF_S *pDstCSCTable)
{
    HI_S32 rGain;
    HI_S32 gGain;
    HI_S32 bGain;
...
static HI_VOID PQ_MNG_CalcCscDcCoef(CSC_PARA_S *pstCSCParameter, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
...
/* 10 bit precision */
static HI_S32 PQ_MNG_CalcCSCCoef(CSC_PARA_S *pstCSCParameter, HI_PQ_CSC_COEF_S *pstCSCCoef)
{
    HI_PQ_CSC_COEF_S *pCSCMatrix = HI_NULL;
    HI_PQ_CSC_COEF_S stCSCMatrix;

    PQ_CHECK_NULL_PTR_RE_FAIL(pstCSCParameter);
    ...
    if (pstCSCParameter->u16InputColorSpace == OPTM_CS_eRGB) /* input RGB color space */
    {
        if (pstCSCParameter->u16OutputColorSpace == OPTM_CS_eRGB) /* RGB -> RGB */
        {
            ...
            PQ_CHECK_NULL_PTR_RE_FAIL(pCSCMatrix);
...
/* 设置CSC参数 */
static HI_S32 PQ_MNG_SetCSCPictureParam(HI_PQ_CSC_TYPE_E enCscTpyeId, HI_PQ_CSC_COEF_S *pstCscCoef, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    ...
    if (enCscTpyeId >= HI_PQ_CSC_TYPE_BUUT)
    {
    ...
    if ((HI_PQ_CSC_TUNING_V0 == enCscTpyeId) || (HI_PQ_CSC_TUNING_V1 == enCscTpyeId))
    {
        ...
        stV0CSCParameter.bFullRange          = sg_stCSCMode[HI_PQ_CSC_TUNING_V0].bFullRange;
        stV0CSCParameter.u16InputColorSpace  = sg_stCSCMode[HI_PQ_CSC_TUNING_V0].u16InputColorSpace;
        stV0CSCParameter.u16OutputColorSpace = sg_stCSCMode[HI_PQ_CSC_TUNING_V0].u16OutputColorSpace;
        ...
        stV1CSCParameter.bFullRange          = sg_stCSCMode[HI_PQ_CSC_TUNING_V1].bFullRange;
        stV1CSCParameter.u16InputColorSpace  = sg_stCSCMode[HI_PQ_CSC_TUNING_V1].u16InputColorSpace;
        stV1CSCParameter.u16OutputColorSpace = sg_stCSCMode[HI_PQ_CSC_TUNING_V1].u16OutputColorSpace;
    ...
    else if ((HI_PQ_CSC_TUNING_V3 == enCscTpyeId) || (HI_PQ_CSC_TUNING_V4 == enCscTpyeId))
    {
        ...
        stV3CSCParameter.bFullRange          = sg_stCSCMode[HI_PQ_CSC_TUNING_V3].bFullRange;
        stV3CSCParameter.u16InputColorSpace  = sg_stCSCMode[HI_PQ_CSC_TUNING_V3].u16InputColorSpace;
        stV3CSCParameter.u16OutputColorSpace = sg_stCSCMode[HI_PQ_CSC_TUNING_V3].u16OutputColorSpace;
        ...
        stV4CSCParameter.bFullRange          = sg_stCSCMode[HI_PQ_CSC_TUNING_V4].bFullRange;
        stV4CSCParameter.u16InputColorSpace  = sg_stCSCMode[HI_PQ_CSC_TUNING_V4].u16InputColorSpace;
        stV4CSCParameter.u16OutputColorSpace = sg_stCSCMode[HI_PQ_CSC_TUNING_V4].u16OutputColorSpace;
...
static HI_S32 PQ_MNG_SetCSCMode(HI_PQ_CSC_TYPE_E enCscTypeId, HI_PQ_CSC_MODE_E enCscMode)
{
    if (enCscTypeId >= HI_PQ_CSC_TYPE_BUUT)
    {
        HI_ERR_PQ("Error, Select Wrong CSC ID!\n");
        return HI_FAILURE;
    }

    if (enCscMode == HI_PQ_CSC_YUV2RGB_709)
    {
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_601)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eRGB;
    ...
    else if ((enCscMode == HI_PQ_CSC_YUV2YUV_709_601) || (enCscMode == HI_PQ_CSC_YUV2YUV_709_F_601_L))
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eItu_R_BT_709;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eXvYCC_601;
    }
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_709_FULL)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eItu_R_BT_709;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eRGB;
    }
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_601_FULL)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eXvYCC_601;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eRGB;
    }
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_601_FULL)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eRGB;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eXvYCC_601;
    }
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_709_FULL)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eRGB;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eItu_R_BT_709;
    }
#if 0
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_709_2020)
    {
    ...
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_2020_2020_L)
    {
    ...
    else if (enCscMode == HI_PQ_CSC_YUV2RGB_2020_2020_L)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eItu_BT_2020;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eRGB_2020;
    }
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_2020_709)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eRGB_2020;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eRGB_709;
    }
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_601_2020)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eXvYCC_601;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eRGB_2020;
    }
    else if (enCscMode == HI_PQ_CSC_RGB2RGB_2020_601)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eRGB_2020;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eRGB_601;
    }
    else if (enCscMode == HI_PQ_CSC_YUV2YUV_2020_601_L_L)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eItu_BT_2020;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eXvYCC_601;
    }
    else if (enCscMode == HI_PQ_CSC_RGB2YUV_2020_601_L)
    {
        sg_stCSCMode[enCscTypeId].u16InputColorSpace  = OPTM_CS_eRGB_2020;
        sg_stCSCMode[enCscTypeId].u16OutputColorSpace = OPTM_CS_eXvYCC_601;
    }
    ...
    if (enCscMode >= HI_PQ_CSC_YUV2RGB_601_FULL && enCscMode <= HI_PQ_CSC_YUV2YUV_709_F_601_L)
    {
...
HI_S32 PQ_MNG_GetCscCoef(HI_PQ_CSC_CRTL_S *pstCscCtrl, HI_PQ_CSC_MODE_E enCscMode, HI_PQ_CSC_COEF_S *pstCscCoef, HI_PQ_CSC_DCCOEF_S *pstCscDcCoef)
{
    ...
    {
        PQ_MNG_GetCSCModeCoef(enCscMode, pstCscCoef, pstCscDcCoef);
    }
    else
    {
        ...
        else if (HI_TRUE == pstCscCtrl->bCSCEn) /* reload picture setting for DTV request */
        {
            ...
            PQ_MNG_SetCSCPictureParam(enCscTypeId, pstCscCoef, pstCscDcCoef);
        }
        else
        {
            PQ_MNG_GetCSCModeCoef(enCscMode, pstCscCoef, pstCscDcCoef);
...
HI_S32 PQ_MNG_GetColorTemp(HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    PQ_CHECK_NULL_PTR_RE_FAIL(pstTemperature);


    pstTemperature->u32Red   = sg_stColorTemp.u32Red;
    pstTemperature->u32Green = sg_stColorTemp.u32Green;
    pstTemperature->u32Blue  = sg_stColorTemp.u32Blue;

    return HI_SUCCESS;
}

HI_S32  PQ_MNG_SetColorTemp(HI_PQ_COLORTEMPERATURE_S *pstTemperature)
{
    sg_stColorTemp.u32Red   = pstTemperature->u32Red;
    sg_stColorTemp.u32Green = pstTemperature->u32Green;
    sg_stColorTemp.u32Blue  = pstTemperature->u32Blue;
