...
const HI_S32 PQ_GFX_SIN_TABLE[PQ_GFX_TABLE_MAX] =
{
...
const HI_U32 PQ_GFX_COS_TABLE[PQ_GFX_TABLE_MAX] =
{
...
static HI_VOID PQ_MNG_CalcCscCoef_RGBtoRGB(PQ_GFX_CSC_TUNING_S *pstGfxCscTuning, const PQ_GFX_CSC_COEF_S *pMatrixOri, PQ_GFX_CSC_COEF_S *pMatrixDst)
{
    ...
    s32ContrstAdj = ((2 * s32ContrstAdj) / 4) + 100;
    s32SatAdj     = (HI_S32)(pstGfxCscTuning->u32Satur) - 50;
    s32SatAdj     = ((2 * s32SatAdj) / 4) + 100;
...
HI_VOID PQ_MNG_CalcCscMatrix(PQ_GFX_CSC_MODE_S *pstGfxCscMode, PQ_GFX_CSC_COEF_S *pstGfxCscCoef, HI_BOOL bIsBGRIn)
{
    ...
    if ((pstGfxCscMode == HI_NULL) || (pstGfxCscCoef == HI_NULL))
    {
        return;
    }
...
#elif defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450) || defined(CHIP_TYPE_hi3798mv310)
...
HI_S32 PQ_MNG_RegisterGfxCSC()
{
    ...
    s32Ret = PQ_COMM_AlgRegister(HI_PQ_MODULE_GFXCSC, REG_TYPE_ALL, PQ_BIN_ADAPT_SINGLE, "gfx csc", HI_NULL, &stGfxCSCFuncs);
