...
HI_S32 PQ_MNG_InitSnr(PQ_PARAM_S *pstPqParam, HI_BOOL bParaUseTableDefault)
{
    ...
    PQ_TABLE_InitPhyList(u32HandleNo, HI_PQ_MODULE_SNR, PQ_SOURCE_MODE_SD, PQ_OUTPUT_MODE_NO);
#endif

#if defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv300) || defined(CHIP_TYPE_hi3798mv310) ||defined(CHIP_TYPE_hi3796mv200) || defined(CHIP_TYPE_hi3716mv450)
...
HI_S32 PQ_MNG_SetSnrEn(HI_BOOL bOnOff)
{
    ...
    {
        PQ_HAL_EnableSNR(u32Vid, bOnOff);
    }
...
HI_S32 PQ_MNG_SetSnrMeanRatio(HI_PQ_SNR_MEAN_RATIO_S *pstMeanRatio)
{
    ...
    PQ_CHECK_NULL_PTR_RE_FAIL(pstMeanRatio);
...
HI_S32 PQ_MNG_GetSnrMeanRatio(HI_PQ_SNR_MEAN_RATIO_S *pstMeanRatio)
{
    ...
    s32Ret = PQ_HAL_GetSnrMeanRatio(PQ_VDP_LAYER_VID0, (PQ_HAL_SNR_MEAN_RATIO_S *)pstMeanRatio);
...
HI_S32  PQ_MNG_SetVdpSnrParaUpd (HI_U32 u32Data)
{
    ...
    s32Ret = PQ_HAL_SetVdpSnrParaUpd(u32VId);
...
HI_S32 PQ_MNG_InitVdpSnr(HI_VOID)
{
    ...
    s32Ret = PQ_HAL_InitVdpSnr();
    s32Ret |= PQ_HAL_SetVdpSnrEnable(u32VId, HI_TRUE);
