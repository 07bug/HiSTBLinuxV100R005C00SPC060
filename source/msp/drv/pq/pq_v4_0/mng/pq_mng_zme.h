...
typedef struct
{
    ...
    HI_U32  u32HandleNo;
    HI_PQ_SCENEMODE_E enSceneMode; /* vpss zme contain vidiophone or normal scane */
} ALG_VZME_DRV_PARA_S;

typedef struct hiALG_VIDEO_ZME_S
{
    HI_BOOL bZmeInitFlag     ;
    HI_BOOL bVdpZmeInitFlag  ;
    HI_BOOL bVpssZmeInitFlag ;
