...
#define PQ_ZME_SIZE_UNUSED_CODE 0
...
const HI_S16 ceof4Tap_3M_a15 [18][4] =
{
    {17,    28,    17,     2},
    {17,    27,    18,     2},
    {16,    27,    18,     3},
...
const HI_S16 ceof6Tap_2M_a15_vdp [18][8] =
{
    {0,  6 , 15 , 21 ,  15 ,  6  , 1, 0},
    {0,  6 , 15 , 19 ,  16 ,  7  , 1, 0},
    {0,  6 , 15 , 19 ,  16 ,  7  , 1, 0},
...
const HI_S16 ceof6Tap_3M_a15_vdp [18][8] =
{
    {0,  2,  17 , 28, 17 ,  2 , -2 , 0},
    {0,  2,  17 , 27, 18 ,  2 , -2 , 0},
    {0,  1,  16 , 28, 18 ,  3 , -2 , 0},
...
const HI_S16 ceof5Tap_1M_a15_vdp [18][6] =
{
    {0,  12 , 17 , 18 , 12 , 5},
    {0,  11 , 18 , 18 , 12 , 5},
    {0,  11 , 18 , 18 , 12 , 5},
...
const HI_S16 ceof5Tap_2M_a15_vdp [18][6] =
{
    {0, 10 ,  22 , 20 , 10,  2},
    {0, 10 ,  20 , 21 , 11,  2},
    {0, 10 ,  20 , 20 , 11,  3},
...
const HI_S16 ceof5Tap_3M_a15_vdp [18][6] =
{
    { 0, 8 , 24 ,  25 ,  8 ,  -1 },
    { 0, 7 , 24 ,  26 ,  8 ,  -1 },
    { 0, 7 , 24 ,  25 ,  9 ,  -1 },
...
const HI_S16 coef6Tap_66M_a15 [18][8] =
{
    {   0,   -4,    7,   56,    7,   -4,    2,   0},
    {   0,   -4,    6,   56,    9,   -5,    2,   0},
    {   0,   -3,    4,   55,   11,   -5,    2,   0},
...
const HI_S16 ceof6Tap_6M_a25_vdp_new[18][8] =  //0403
{
    { 0,  -4,   10,   52,   10,   -4,    0 , 0},
    { 0,  -4,    8,   52,   11,   -4,    1 , 0},
    { 0,  -4,    7,   52,   13,   -5,    1 , 0},
...
const HI_S16 ceof6Tap_2M_a18_vdp [18][8] =
{
    {0,  7 ,  15,   19,    15,    7,     1,   0},
    {0,  7 ,  15,   18,    15,    8,     1,   0},
    {0,  7 ,  14,   18,    15,    8,     2,   0},
...
const HI_S16 ceof5Tap_15M_a20_vdp [18][6] =
{
    {0,  12,    17,    17,    12,     6},
    {0,  12,    17,    17,    12,     6},
    {0,  12,    17,    17,    12,     6},
...
const HI_S16 ceof4Tap_65M_a15 [18][4] =
{
    {    2,   61,   2,    -1},
    {    0,   62,   4,    -2},
    {   -1,   62,   6,    -3},
...
const HI_S16 ceof4Tap_2M_a15 [18][4] =
{
    {17,    23,    17,     7},
    {17,    23,    17,     7},
    {16,    22,    18,     8},
...
const HI_S16 *g_pVZmeReduceCoef[PQ_HAL_ZME_COEF_RATIO_BUTT][PQ_HAL_ZME_VDP_COEF_TYPE_BUTT] =
{
    ...
    { &ceof6Tap_6M_a25_vdp[0][0], &ceof5Tap_5M_a20_vdp[0][0],  &ceof4Tap_65M_a15[0][0], &ceof4Tap_5M_a15[0][0], &coef6Tap_66M_a20[0][0], &ceof4Tap_5M_a15[0][0] }, //>1
    ...
    { &coef6Tap_66M_a15[0][0],  &coef5Tap_66M_a20_vdp[0][0],   &ceof4Tap_5M_a15[0][0], &ceof4Tap_5M_a15[0][0], &ceof6Tap_6M_a25[0][0],  &ceof4Tap_5M_a15[0][0] }, //>=0.75
    { &ceof6Tap_35M_a18_vdp[0][0], &ceof5Tap_4M_a20_vdp[0][0],  &ceof4Tap_2M_a15[0][0], &ceof4Tap_2M_a15[0][0], &ceof6Tap_5M_a25[0][0],  &ceof4Tap_5M_a15[0][0] }, //>=0.5
    { &ceof6Tap_2M_a18_vdp[0][0], &ceof5Tap_15M_a20_vdp[0][0],  &ceof4Tap_2M_a15[0][0], &ceof4Tap_2M_a15[0][0], &ceof6Tap_4M_a20[0][0],  &ceof4Tap_4M_a15[0][0] }, //>=0.33
...
/* HL8 VL6(Real HL6 VL5) HC4 VC4 /32Phase/6bit */
const HI_S16 *g_pVZmeReduceCoef_new68[PQ_HAL_ZME_COEF_RATIO_BUTT][PQ_HAL_ZME_VDP_COEF_TYPE_BUTT] =
{
    //Logic: VZME_COEF_8T32P_LH        VZME_COEF_6T32P_LV          VZME_COEF_4T32P_CH      VZME_COEF_4T32P_CV      VZME_COEF_6T32P_LH       VZME_COEF_4T32P_LV
    //Ture : VZME_COEF_6T32P_LH        VZME_COEF_5T32P_LV          VZME_COEF_4T32P_CH      VZME_COEF_4T32P_CV      VZME_COEF_6T32P_LH       VZME_COEF_4T32P_LV
    { &ceof6Tap_6M_a25_vdp_new[0][0], &ceof5Tap_5M_a20_vdp[0][0],  &ceof4Tap_65M_a15[0][0], &ceof4Tap_5M_a15[0][0], &coef6Tap_66M_a20[0][0], &ceof4Tap_5M_a15[0][0] }, //>1
    { &ceof6Tap_cubic_vdp[0][0],   &ceof5Tap_675M_a20_vdp[0][0], &ceof4Tap_cubic[0][0],  &ceof4Tap_cubic[0][0],  &ceof6Tap_cubic[0][0],   &ceof4Tap_cubic[0][0]  }, //==1
    { &coef6Tap_66M_a15[0][0],  &coef5Tap_66M_a20_vdp[0][0],   &ceof4Tap_5M_a15[0][0], &ceof4Tap_5M_a15[0][0], &ceof6Tap_6M_a25[0][0],  &ceof4Tap_5M_a15[0][0] }, //>=0.75
    { &ceof6Tap_35M_a18_vdp[0][0], &ceof5Tap_4M_a20_vdp[0][0],  &ceof4Tap_2M_a15[0][0], &ceof4Tap_2M_a15[0][0], &ceof6Tap_5M_a25[0][0],  &ceof4Tap_5M_a15[0][0] }, //>=0.5
    { &ceof6Tap_2M_a18_vdp[0][0], &ceof5Tap_15M_a20_vdp[0][0],  &ceof4Tap_2M_a15[0][0], &ceof4Tap_2M_a15[0][0], &ceof6Tap_4M_a20[0][0],  &ceof4Tap_4M_a15[0][0] }, //>=0.33
...
const HI_S16 *g_pVFrostZmeReduceCoef[PQ_HAL_ZME_COEF_RATIO_BUTT][PQ_HAL_FROST_ZME_VDP_COEF_TYPE_BUTT][PQ_HAL_FROST_LEVEL_BUTT - 1] =
{
    ...
    { {&ceof6Tap_3M_a15_vdp[0][0],   &ceof6Tap_2M_a15_vdp[0][0], &ceof6Tap_1M_a15_vdp[0][0]}, {&ceof5Tap_3M_a15_vdp[0][0],  &ceof5Tap_2M_a15_vdp[0][0],  &ceof5Tap_1M_a15_vdp[0][0] } }, //>1
    { {&ceof6Tap_3M_a15_vdp[0][0],   &ceof6Tap_2M_a15_vdp[0][0],   &ceof6Tap_1M_a15_vdp[0][0]  }, {&ceof5Tap_3M_a15_vdp[0][0], &ceof5Tap_2M_a15_vdp[0][0], &ceof5Tap_1M_a15_vdp[0][0]} }, //==1
    { {&ceof6Tap_3M_a15_vdp[0][0],  &ceof6Tap_2M_a15_vdp[0][0],  &ceof6Tap_1M_a15_vdp[0][0] }, {&ceof5Tap_3M_a15_vdp[0][0],   &ceof5Tap_2M_a15_vdp[0][0],   &ceof5Tap_1M_a15_vdp[0][0]  } }, //>=0.75
    { {&ceof6Tap_2M_a15_vdp[0][0],  &ceof6Tap_1M_a15_vdp[0][0],  &ceof6Tap_1M_a15_vdp[0][0] }, {&ceof5Tap_2M_a15_vdp[0][0],   &ceof5Tap_1M_a15_vdp[0][0],   &ceof5Tap_1M_a15_vdp[0][0]  } }, //>=0.5
    { {&ceof6Tap_2M_a15_vdp[0][0],  &ceof6Tap_1M_a15_vdp[0][0],  &ceof6Tap_1M_a15_vdp[0][0] }, {&ceof5Tap_2M_a15_vdp[0][0],   &ceof5Tap_1M_a15_vdp[0][0],   &ceof5Tap_1M_a15_vdp[0][0]  } }, //>=0.33
    { {&ceof6Tap_2M_a15_vdp[0][0], &ceof6Tap_1M_a15_vdp[0][0], &ceof6Tap_1M_a15_vdp[0][0]}, {&ceof5Tap_2M_a15_vdp[0][0],  &ceof5Tap_1M_a15_vdp[0][0],  &ceof5Tap_1M_a15_vdp[0][0] } }, //>=0.25
    { {&ceof6Tap_2M_a15_vdp[0][0], &ceof6Tap_1M_a15_vdp[0][0], &ceof6Tap_1M_a15_vdp[0][0]}, {&ceof5Tap_2M_a15_vdp[0][0],  &ceof5Tap_1M_a15_vdp[0][0],  &ceof5Tap_1M_a15_vdp[0][0] } }  //else
};
...
//for 98mv300 vdp wbcdhd
//576P->720P
static HI_S16 coef6Tap_66M_a20_vdpwbcdhd [18][8] =
{
    {  -4,    7,   56,    7,   -4,    2, 0, 0},
    {  -4,    6,   56,    9,   -5,    2, 0, 0},
    {  -3,    4,   55,   11,   -5,    2, 0, 0},
...
static HI_S16 ceof6Tap_6M_a25_vdpwbcdhd [18][8] =
{
    { -4,    9,   53,    9,   -4,    1, 0, 0},
    { -4,    8,   52,   11,   -4,    1, 0, 0},
    { -4,    7,   52,   13,   -5,    1, 0, 0},
...
static HI_S16 ceof6Tap_5M_a25_vdpwbcdhd [18][8] =
{
    { -4,   13,   46,   13,   -4,    0, 0, 0},
    { -4,   12,   46,   14,   -4,    0, 0, 0},
    { -4,   11,   45,   16,   -4,    0, 0, 0},
...
//4K->720p ver
static HI_S16 ceof6Tap_4M_a20_vdpwbcdhd [18][8] =
{
    {  -2,   15,   39,   15,   -2,   -1, 0, 0},
    {  -3,   15,   38,   17,   -2,   -1, 0, 0},
    {  -3,   14,   38,   18,   -2,   -1, 0, 0},
...
static HI_S16 ceof6Tap_35M_a18_vdpwbcdhd [18][8] =
{
    { -1,   17,   33,   17,   -1,   -1, 0, 0},
    { -1,   16,   33,   17,    0,   -1, 0, 0},
    { -1,   15,   33,   18,    0,   -1, 0, 0},
...
static HI_S16 ceof6Tap_cubic_vdpwbcdhd [18][8] =
{
    {0,    0,   63,    0,    0,    0, 0, 0},
    {0,   -1,   63,    2,    0,    0, 0, 0},
    {1,   -3,   63,    4,   -1,    0, 0, 0},
...
static HI_S16 ceof4Tap_5M_a15_vdpwbcdhd [18][8] =
{
    { 0, 0, 0, 0, 12,   44,   12,   -4},
    { 0, 0, 0, 0, 11,   44,   13,   -4},
    { 0, 0, 0, 0, 10,   44,   15,   -5},
...
static HI_S16 ceof4Tap_4M_a15_vdpwbcdhd [18][8] =
{
    { 0, 0, 0, 0,  15,   36,   15,   -2},
    { 0, 0, 0, 0,  14,   36,   16,   -2},
    { 0, 0, 0, 0,  13,   36,   17,   -2},
...
static HI_S16 ceof4Tap_cubic_vdpwbcdhd [18][8] =
{
    { 0, 0, 0, 0,   0,   63,    0,    0},
    { 0, 0, 0, 0,  -2,   63,    3,    0},
    { 0, 0, 0, 0,  -4,   63,    5,    0},
...
const HI_S16 *g_pWbcDhdZmeReduceCoef[PQ_HAL_ZME_COEF_RATIO_BUTT][PQ_HAL_WBC_DHD_ZME_COEF_TYPE_BUTT] =
{
    //Logic: VZME_COEF_8T_Wbcdhd_32P_LH        VZME_COEF_8T_Wbcdhd_32P_LV
    //Ture : VZME_COEF_6T_Wbcdhd_32P_LH        VZME_COEF_4T_Wbcdhd_32P_LV
    { &coef6Tap_66M_a20_vdpwbcdhd[0][0], &ceof4Tap_5M_a15_vdpwbcdhd[0][0],  }, //>1
    { &ceof6Tap_cubic_vdpwbcdhd[0][0]  , &ceof4Tap_cubic_vdpwbcdhd[0][0] ,  }, //==1
    { &ceof6Tap_6M_a25_vdpwbcdhd[0][0] , &ceof4Tap_5M_a15_vdpwbcdhd[0][0],  }, //>=0.75
    { &ceof6Tap_5M_a25_vdpwbcdhd[0][0] , &ceof4Tap_5M_a15_vdpwbcdhd[0][0],  }, //>=0.5
    { &ceof6Tap_4M_a20_vdpwbcdhd[0][0] , &ceof4Tap_4M_a15_vdpwbcdhd[0][0],  }, //>=0.33
    { &ceof6Tap_35M_a18_vdpwbcdhd[0][0], &ceof4Tap_4M_a15_vdpwbcdhd[0][0],  }, //>=0.25
    { &ceof6Tap_35M_a18_vdpwbcdhd[0][0], &ceof4Tap_4M_a15_vdpwbcdhd[0][0],  }  //else
};
#endif
...
const HI_S16 *g_pVZmeCoef[PQ_HAL_ZME_COEF_RATIO_BUTT][VZME_COEF_TYPE_BUTT] =
{
    ...
    { &s16ZmeCoef_8T32P_2M_a05[0][0], &s16ZmeCoef_6T32P_2M_a05[0][0], &s16ZmeCoef_4T32P_4M_a15[0][0], &s16ZmeCoef_4T32P_4M_a15[0][0], &s16ZmeCoef_4T32P_4M_a15[0][0], &s16ZmeCoef_8T32P_2M_a05[0][0],   &s16ZmeCoef_6T32P_2M_a05[0][0],  &s16coef5tap_cubic_3M[0][0], &s16coef3tap_cubic_4M[0][0], &s16ZmeCoef_8T2P_Lanc3[0][0], &s16ZmeCoef_6T2P_6M_a25[0][0]},/* >=0.25 */
    { &s16ZmeCoef_8T32P_1_5M_a05[0][0], &s16ZmeCoef_6T32P_1_5M_a05[0][0], &s16ZmeCoef_4T32P_4M_a15[0][0], &s16ZmeCoef_4T32P_4M_a15[0][0], &s16ZmeCoef_4T32P_4M_a15[0][0], &s16ZmeCoef_8T32P_1_5M_a05[0][0], &s16ZmeCoef_6T32P_1_5M_a05[0][0], &s16coef5tap_cubic_3M[0][0], &s16coef3tap_cubic_4M[0][0], &s16ZmeCoef_8T2P_Lanc3[0][0], &s16ZmeCoef_6T2P_6M_a25[0][0]}, /* else   */
};
