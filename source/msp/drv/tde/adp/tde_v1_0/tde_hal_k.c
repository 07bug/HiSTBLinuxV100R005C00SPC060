...
#define TDE_QUICKCOPY_CHECK(u32Capability)\
    do{\
        ...
        {\
            TDE_ERROR("It deos not support QuickCopy\n");\
...
{
    TDE_CHECK_EQUAL_RETURN_VALUE(0, u32BaseAddr, HI_FAILURE);
...
HI_U32 TdeHalCtlIntStats(HI_VOID)
{
    ...
    /* clear all status */
    TDE_WRITE_REG(s_pu32BaseVirAddr, TDE_INT, (Value));
...
HI_VOID TdeHalSetClock(HI_BOOL bEnable)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(g_pstRegCrg);
...
{
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pstHWNode);
...
HI_VOID TdeHalFreeNodeBuf(TDE_HWNode_S *pstHWNode)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pBuf);
    TDE_FREE(pBuf);
...
HI_VOID TdeHalNodeInitChildNd(TDE_HWNode_S *pHWNode, HI_U32 u32TDE_CLIP_START, HI_U32 u32TDE_CLIP_STOP)
{
    ...
    TDE_INS_U unIns;
    TDE_2D_RSZ_U unRsz;
    HI_BOOL bClipOut = HI_FALSE;

    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pHWNode);
...
HI_S32 TdeHalNodeExecute(HI_U32 u32NodePhyAddr, HI_U64 u64Update, HI_BOOL bAqUseBuff)
{
    ...
    if (TdeHalCtlIsIdleSafely())
    {
        ...
        if (HI_TRUE ==  bAqUseBuff)
        {
            ...
            TDE_INFO("Aq Ctrl use comp list mode\n");
        }
        else
        {
            unAqCtrl.stBits.u32AqOperMode = TDE_AQ_CTRL_COMP_LINE;
            TDE_INFO("Aq Ctrl use comp node line mode\n");
        }
...
HI_VOID TdeHalNodeSetSrc1(TDE_HWNode_S *pHWNode, TDE_DRV_SURFACE_S *pDrvSurface)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pHWNode);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pDrvSurface);
...
HI_VOID TdeHalNodeSetSrcMbY(TDE_HWNode_S *pHWNode, TDE_DRV_SURFACE_S *pDrvMbY, TDE_DRV_MB_OPT_MODE_E enMbOpt)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pHWNode);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pDrvMbY);
...
HI_VOID TdeHalNodeSetSrcMbCbCr(TDE_HWNode_S *pHWNode, TDE_DRV_SURFACE_S *pDrvMbCbCr, TDE_DRV_MB_OPT_MODE_E enMbOpt)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pHWNode);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pDrvMbCbCr);
                                ...
                                TDE_DRV_ALU_MODE_E enAlu, TDE_DRV_COLORFILL_S *pstColorFill)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    ...
    switch (enMode)
    {
        ...
        {
            TDE_CHECK_NULLPOINTER_RETURN_VALUE(pstColorFill, HI_FAILURE);
            TDE_QUICKFill_CHECK(u32Capability);
            TDE_FILL_DATA_BY_FMT(pHWNode->u32TDE_S1_FILL, pstColorFill->u32FillData, pstColorFill->enDrvColorFmt);
        ...
        {
            TDE_CHECK_NULLPOINTER_RETURN_VALUE(pstColorFill, HI_FAILURE);
            TDE_FILL_DATA_BY_FMT(pHWNode->u32TDE_S2_FILL, pstColorFill->u32FillData, pstColorFill->enDrvColorFmt);
...
HI_S32 TdeHalNodeSetRop(TDE_HWNode_S *pHWNode, TDE2_ROP_CODE_E enRgbRop, TDE2_ROP_CODE_E enAlphaRop)
{
    ...
    {
        TDE_WARNING("It deos not support Rop\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
HI_S32 TdeHalNodeSetBlend(TDE_HWNode_S *pHWNode, TDE2_BLEND_OPT_S *pstBlendOpt)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pstBlendOpt, HI_FAILURE);

    TdeHalGetCapability(&u32Capability);

    if (!(u32Capability & ALPHABLEND))
    {
        TDE_WARNING("It deos not support Blend\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
HI_S32 TdeHalNodeSetColorize(TDE_HWNode_S *pHWNode, HI_U32 u32Colorize)
{
    ...
    {
        TDE_WARNING("It deos not support Colorize\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
HI_S32 TdeHalNodeSetClutOpt(TDE_HWNode_S *pHWNode, TDE_DRV_CLUT_CMD_S *pClutCmd, HI_BOOL bReload)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pClutCmd, HI_FAILURE);

    TdeHalGetCapability(&u32Capability);

    if (!(u32Capability & CLUT))
    {
        TDE_WARNING("It deos not support Clut\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    unIns.u32All = pHWNode->u32TDE_INS;
...
{
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pHWNode);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pColorKey);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(unAluMode);
                             ...
                             TDE_DRV_COLORKEY_CMD_S *pColorKey)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pColorKey, HI_FAILURE);

    TdeHalGetCapability(&u32Capability);

    if (!(u32Capability & COLORKEY))
    {
        TDE_WARNING("It deos not support ColorKey\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }

    unIns.u32All = pHWNode->u32TDE_INS;
    unIns.stBits.u32ColorKey = 1;
    unAluMode.u32All = pHWNode->u32TDE_ALU;
...
HI_S32 TdeHalNodeSetClipping(TDE_HWNode_S *pHWNode, TDE_DRV_CLIP_CMD_S *pClip)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pClip, HI_FAILURE);

    TdeHalGetCapability(&u32Capability);

    if (!(u32Capability & CLIP))
    {
        TDE_WARNING("It deos not support Clip\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
    ...
    unClipPos.u32All = 0; /*reset for next set*/
...
HI_S32 TdeHalNodeSetFlicker(TDE_HWNode_S *pHWNode, TDE_DRV_FLICKER_CMD_S *pFlicker)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pFlicker, HI_FAILURE);

    TdeHalGetCapability(&u32Capability);

    if (!(u32Capability & DEFLICKER))
    {
        TDE_WARNING("It deos not support Deflicker\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
HI_S32 TdeHalNodeSetResize(TDE_HWNode_S *pHWNode, TDE_FILTER_OPT *pstFilterOpt, TDE_NODE_SUBM_TYPE_E enNodeType)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pstFilterOpt, HI_FAILURE);

    TdeHalGetCapability(&u32Capability);
    if (!(u32Capability & RESIZE))
    {
        TDE_WARNING("It deos not support Resize\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
HI_S32 TdeHalNodeSetColorConvert(TDE_HWNode_S *pHWNode, TDE_DRV_CONV_MODE_CMD_S *pConv)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pHWNode, HI_FAILURE);
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pConv, HI_FAILURE);

    TdeHalGetCapability(&u32Capability);
    if (!(u32Capability & CSCCOVERT))
    {
        TDE_WARNING("It deos not support CSCCovert\n");
        return HI_ERR_TDE_UNSUPPORTED_OPERATION;
    }
...
HI_VOID TdeHalNodeAddChild(TDE_HWNode_S *pHWNode, TDE_CHILD_INFO *pChildInfo)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pHWNode);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pChildInfo);
...
HI_VOID TdeHalNodeSetMbMode(TDE_HWNode_S *pHWNode, TDE_DRV_MB_CMD_S *pMbCmd)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pHWNode);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pMbCmd);
...
HI_S32 TdeHalNodeSetCsc(TDE_HWNode_S *pHWNode, TDE2_CSC_OPT_S stCscOpt)
{
    ...
    if (unIns.stBits.u32IcsConv)
    {
        ...
        else
        {
            ...
            TDE_CHECK_EQUAL_RETURN_VALUE(0, pHWNode->u32TDE_ICSC_ADDR, HI_ERR_TDE_NO_MEM);
    ...
    if (unIns.stBits.u32OcsConv)
    {
        ...
        else
        {
            ...
            TDE_CHECK_EQUAL_RETURN_VALUE(0, pHWNode->u32TDE_OCSC_ADDR, HI_ERR_TDE_NO_MEM);
...
#define OrgHfCoef Tde8x32Coef
    ...
    if (HI_NULL == pHfCoef)
    {
        TDE_ERROR("Alloc horizontal coef failed!\n");
        return HI_FAILURE;
    }
    ...
    if (HI_NULL == pVfCoef)
    {
        TDE_ERROR("Alloc vertical coef failed\n");
        TDE_FREE(pHfCoef);
        return HI_FAILURE;
    }
    ...
    if (0 == s_stParaTable.u32HfCoefAddr)
    {
        TDE_FREE(pHfCoef);
        TDE_FREE(pVfCoef);
        TDE_ERROR("Alloc u32HfCoefAddr failed!\n");
        return HI_FAILURE;
    }
    ...
    if (0 == s_stParaTable.u32VfCoefAddr)
    {
        TDE_FREE(pHfCoef);
        TDE_FREE(pVfCoef);
        TDE_ERROR("Alloc u32VfCoefAddr failed!\n");
        return HI_FAILURE;
    }
    ...
    if (HI_NULL == pRgb2YuvCsc)
    {
        TDE_FREE(pHfCoef);
        TDE_FREE(pVfCoef);
        TDE_ERROR("Alloc csc coef failed!\n");
        return HI_FAILURE;
    }
    ...
    if (0 == s_u32Rgb2YuvCoefAddr)
    {
        TDE_ERROR("Alloc s_u32Rgb2YuvCoefAddr failed\n");
        TDE_FREE(pHfCoef);
        TDE_FREE(pVfCoef);
        TDE_FREE(pRgb2YuvCsc);
        TDE_FREE(pYuv2RgbCsc);
        return HI_FAILURE;
    }
    ...
    if (0 == s_u32Yuv2RgbCoefAddr)
    {
        TDE_ERROR("Alloc s_u32Yuv2RgbCoefAddr failed\n");
        TDE_FREE(pHfCoef);
        TDE_FREE(pVfCoef);
        TDE_FREE(pRgb2YuvCsc);
        TDE_FREE(pYuv2RgbCsc);
...
{
    return ((TDE_DRV_COLOR_FMT_CLUT2 == enFmt) ? 2 : -1);
}
STATIC HI_S32  TdeHalGetbppByFmt4(TDE_DRV_COLOR_FMT_E enFmt)
{
    return ((TDE_DRV_COLOR_FMT_CLUT4 == enFmt) ? 4 : -1);
}
...
STATIC HI_S32 TdeHalGetbppByFmt(TDE_DRV_COLOR_FMT_E enFmt)
{
    ...
    BppDepth = TdeHalGetbppByFmt16(enFmt);
    if (16 == BppDepth)
    {
        return 16;
    }
    BppDepth = TdeHalGetbppByFmt24(enFmt);
    if (24 == BppDepth)
    {
        return 24;
    }
    BppDepth = TdeHalGetbppByFmt32(enFmt);
    if (32 == BppDepth)
    {
        return 32;
    }
    BppDepth = TdeHalGetbppByFmt1(enFmt);
    if (1 == BppDepth)
    {
        return 1;
    }
    BppDepth = TdeHalGetbppByFmt2(enFmt);
    if (2 == BppDepth)
    {
        return 2;
    }
    BppDepth = TdeHalGetbppByFmt4(enFmt);
    if (4 == BppDepth)
    {
        return 4;
    }
    BppDepth = TdeHalGetbppByFmt8(enFmt);
    if (8 == BppDepth)
    {
        return 8;
    }
...
{
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pDeflicerLevel, HI_FAILURE);
...
{
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pu8ThresholdValue, HI_FAILURE);
...
{
    TDE_CHECK_NULLPOINTER_RETURN_VALUE(pbEnAlphaThreshold, HI_FAILURE);
...
HI_VOID TdeHalNodePrintInfo(struct seq_file *p, HI_U32 *pu32CurNode)
{
    ...
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(p);
    TDE_CHECK_NULLPOINTER_RETURN_NOVALUE(pu32CurNode);
