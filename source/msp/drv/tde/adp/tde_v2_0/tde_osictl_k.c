...
typedef struct hiTDE_SLICE_DATA_S
{
    ...
    //change
    //HI_U32 hoffset_pix ;//??????????ò???′??÷

    HI_U32 hlmsc_en;//????áá?è??·?ê1?ü?￡
    HI_U32 hchmsc_en;//????é??è??·?ê1?ü?￡
    HI_U32 hratio;//(u,4,20)
    HI_S32 hor_loffset;//????áá?è??????ò?￡?(s,8,20)??ê??￡21??±íê??￡3?ê??à??
    HI_S32 hor_coffset;//????é??è??????ò?￡?(s,8,20)??ê??￡21??±íê??￡
    HI_U32 zme_ow ;
    HI_U32 zme_iw;
    HI_U32 hpzme_en;//?????¤??·?ê1?ü
    HI_U32 hpzme_mode;//?????¤??·?3éμ??￡ê?
    HI_U32 hpzme_width;//?¤??·?ê?3?μ?í????í?è
