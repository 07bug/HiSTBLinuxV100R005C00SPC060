...
#ifdef HI_TEE_SUPPORT
extern HI_S32 HI_DRV_VDEC_AllocBuf(BUFMNG_INST_CONFIG_S *pstConfig, VDEC_BUFFER_S* pstVDECAllocBuf);
extern HI_S32 HI_DRV_VDEC_ReleaseBuf(VDEC_BUFFER_S* pstVDECBuf);
#endif
...
static HI_VOID BUFMNG_DestroyBuffer(HI_BOOL bTvp, VDEC_BUFFER_S* pstVDECAllocBuf)
{
    ...
    {
    #ifdef HI_TEE_SUPPORT
        HI_DRV_VDEC_ReleaseBuf(pstVDECAllocBuf);
    #else
                                 ...
                                 VDEC_BUFFER_S* pstVDECAllocBuf)
{
...
#endif
    {
        ...
        {
        #ifdef HI_TEE_SUPPORT
            s32Ret = HI_DRV_VDEC_AllocBuf(pstConfig, pstVDECAllocBuf);
        #else
...
HI_S32 BUFMNG_Destroy(HI_HANDLE hBuf)
{
    ...
    if (BUFMNG_ALLOC_INNER == pstInst->enAllocType)
    {
...
#endif
        {
            ...
            {
            #ifdef HI_TEE_SUPPORT
                HI_DRV_VDEC_ReleaseBuf(&stVDECBuf);
            #else
