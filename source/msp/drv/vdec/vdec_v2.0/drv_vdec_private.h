...
/* VDEC VERSION */
#define VDEC_VERSION                (2018070300)
...
typedef struct tagVDEC_CHAN_STATINFO_S
{
    ...
    HI_U32 u32VdecToVpssFrameOK;
    HI_U32 u32FrameType[2];
    HI_U32 u32DiscardFrmNum;
...
typedef struct tagVFMW_REPORT_FRAME_BUFFER_INFO_S
{
    ...
    UINT32  u32AllocFrmStartTime;
    UINT32  u32AllocFrmEndTime;
...
typedef struct tagVDEC_CHANNEL_S
{
    ...
    HI_U32                          u32FrameSize;//sdk
    HI_U32                          u32RefFrameNum; //sdk
    ...
    HI_BOOL isInitAlready;
    HI_BOOL bWakeUpVfmw;
    HI_BOOL bWakeUpVpss;
    HI_UNF_AVPLAY_SCENE_MODE_E enSceneMode;
