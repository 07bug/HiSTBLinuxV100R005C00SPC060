...
HI_VOID VENC_HAL_ReadReg_Smmu( VeduEfl_EncPara_S* EncHandle )
{
    ...
    pEncPara->intns_tlbinvalid_stat   = pAllReg->SMMU_INTSTAT_NS.bits.intns_tlbinvalid_stat;
...
HI_VOID VENC_HAL_ReadReg( VeduEfl_EncPara_S* EncHandle )
{
    ...
    pEncPara->VencPbitOverflow = pAllReg->VEDU_INTSTAT.bits.VencPbitOverflow;
...
HI_VOID VENC_HAL_CfgReg( VeduEfl_EncPara_S* EncHandle )
{
    ...
    pAllReg->VEDU_PTS2 = pEncPara->ExtFlag;
    pAllReg->VEDU_PTS3 = (pEncPara->ExtFlag) ? pEncPara->stImage_OMX.data_len : 0;
