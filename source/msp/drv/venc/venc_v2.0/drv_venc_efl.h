...
typedef struct
{
    ...
    HI_BOOL QuickEncode;
    HI_BOOL OMXChn;
    HI_BOOL IFrmInsertBySaveStrm;

    /* stream buffer parameter */
    VENC_BUFFER_S StreamMMZBuf;
    VENC_BUFFER_S WpRpMMZBuf;
    VENC_BUFFER_S OmxOutputBuf[OMX_OUTPUT_PORT_BUFFER_MAX];
    ...
    HI_BOOL bstImageValid;
    HI_BOOL bFirstSlcForLowDly;
   ...
   /* register of low power work mode */
    ...
    HI_S32 RcDbgPrint;
    HI_U32 u32StrmBufExtLen;
    HI_U32 idr_pic_id;

    VENC_DRV_FRMRATETYPE_E InputFrmRateTypeDefault;
    VENC_DRV_FRMRATETYPE_E InputFrmRateTypeConfig;
} VeduEfl_EncPara_S;
