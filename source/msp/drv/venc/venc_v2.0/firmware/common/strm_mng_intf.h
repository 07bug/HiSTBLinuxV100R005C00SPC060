...
typedef struct hiVENC_STRM_FUN_PTR_S
{
    ...
    HI_S32  (*pfun_STRM_Create)(HI_HANDLE hHandle, STRMMNG_INST_CONFIG_S *pstConfig);
    ...
    HI_U32  (*pfun_STRM_GetBitBufSize)(HI_HANDLE hHandle, HI_U32 StrmBufSize, HI_U32 SlcSplitEn, HI_U32 LumaSize, HI_U32 *pExtLen);
    HI_S32  (*pfun_STRM_AllocStreamBuf)(HI_HANDLE hHandle, VENC_BUFFER_S *pStreamMMZBuf, STRMMNG_ALLOC_INFO_S *pAllocInfo);
