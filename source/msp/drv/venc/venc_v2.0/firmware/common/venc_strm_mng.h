...
typedef struct
{
    ...
    HI_U32 u32Pts1Ms;
    HI_U32 ExtFlag;                    /*just for omx flag*/
    HI_U32 ExtFillLen;                 /*just for omx Yuv buffer fillLen*/
    HI_BOOL bFrameEnd;
} STRMMNG_BUF_S;
...
typedef struct
{
    ...
    #endif
    HI_BOOL  IFrmInsertBySaveStream;

    HI_U32 StrmBufExtLen;
} STRMMNG_STREAM_INFO_S;

HI_S32 STRM_Init(HI_VOID);
HI_S32 STRM_DeInit(HI_VOID);
HI_S32 STRM_Create(HI_U32 hHandle, STRMMNG_STREAM_INFO_S *pstStreamInfo);
