...
static VOID DRV_VENC_PDT_OpenHardware(VOID)
{
    ...
    unTmpValue.bits.venc_clk_sel  = VENC_CLK_SEL_270;
    g_pstRegCrg->PERI_CRG35.u32 = unTmpValue.u32;
}
...
{
    g_venc_hal_fun_ptr.pfun_HAL_ClearInt      = DRV_VENC_HAL_V400R004C02_ClrInt;
    g_venc_hal_fun_ptr.pfun_HAL_DisableInt    = DRV_VENC_HAL_V400R004C02_DisableInt;
    g_venc_hal_fun_ptr.pfun_HAL_ReadReg       = DRV_VENC_HAL_V400R004C02_ReadReg;
    g_venc_hal_fun_ptr.pfun_HAL_ReadSmmuReg   = DRV_VENC_HAL_V400R004C02_ReadReg_Smmu;
    g_venc_hal_fun_ptr.pfun_HAL_CfgReg        = DRV_VENC_HAL_V400R004C02_CfgReg;

    g_venc_hal_fun_ptr.pfun_HAL_Init          = DRV_VENC_HAL_V400R004C02_Init;
    g_venc_hal_fun_ptr.pfun_HAL_Deinit        = DRV_VENC_HAL_V400R004C02_Deinit;
...
SINT32 DRV_VENC_PDT_V400R004C02_Init(VOID)
{
