...
typedef enum hiVDEC_CID_E
{
    ...
    VDEC_CID_ALLOC_MEM_TO_CHANNEL,   /* sdk */
#ifndef Hi3716MV410
    VDEC_CID_SET_MORE_GAP_ENABLE = 60, /* 60. bvt set enable more gap */
#else
    VDEC_CID_ALLOC_PMV_TO_DECODER,
...
typedef enum
{
    ...
    EVNT_NEED_ARRANGE,//sdk
    EVNT_UNSUPPORT_SPEC,//sdk
    EVNT_FAKE_FRAME,
#ifdef Hi3716MV410
...
typedef struct
{
    ...
    /* for CC, valid when IsRegistered=1 */              //sdk
    SINT8    IsRegistered;
...
typedef struct
{
    ...
    /* BEGIN: Added by sdk, for hevc */
    UINT32      left_offset;
    UINT32      right_offset;
    UINT32      top_offset;
    UINT32      bottom_offset;
    /* END: Added by sdk, for hevc */
...
typedef struct hiSTREAM_PACKET_S
{
    ...
    UINT8       is_not_last_packet_flag;  //add by sdk, 2012.11.09
    UINT8       is_stream_end_flag;        //add by sdk, 2012.12.10
    UINT8       is_extern_eop_flag;      // add by sdk, 2015.07.02	
    UINT32      DispEnableFlag;
    UINT32      DispFrameDistance;
    UINT32      DistanceBeforeFirstFrame;
    UINT32      GopNum;
...
/*For dynamic frame store param sdk*/
...
typedef struct
{
    ...
    UINT32 u32DynamicFrameStoreAllocEn; //sdk
    SINT32 s32DelayTime;//sdk
    SINT32 s32ExtraFrameStoreNum;//sdk
    UINT32 u32SelfAdaptionDFS;//sdk
    UINT32 u32CfgFrameNum;//sdk
    UINT32 u32NeedMMZ;//sdk
    UINT32 u32MaxMemUse;//sdk
