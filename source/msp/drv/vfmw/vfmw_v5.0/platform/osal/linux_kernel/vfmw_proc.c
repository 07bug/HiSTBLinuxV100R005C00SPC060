...
extern VBOOL g_SegBypassEnable;
...
SINT32 vfmw_read_proc_info(struct seq_file *p, VOID *v)
{
    ...
    seq_printf(p, "%-40s :%d\n",   "SegBypassEnable",             g_SegBypassEnable);
    seq_printf(p, "\n");
...
SINT32 vfmw_read_proc_help(struct seq_file *p, VOID *v)
{
    ...
    seq_printf(p, "echo [arg1] [arg2] > /proc/vfmw/info\n");
    seq_printf(p, "\n");
    seq_printf(p, "---------------------------------------------------------------\n");
    ...
    seq_printf(p, "set uvmos_enable                0x9       (chan_id<<24)|uvmos_enable\n");
...
SINT32 vfmw_read_proc_scd(struct seq_file *p, VOID *v)
{
    ...
    seq_printf(p, "%-40s :%d\n",      "Is seg bypass",     pInst->IsSegBypass);
