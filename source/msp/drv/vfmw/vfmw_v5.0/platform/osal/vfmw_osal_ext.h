...
typedef VOID   (*FN_OSAL_KernelMunMapMMZ)(MEM_RECORD_S *pMemRec);
...
typedef SINT32 (*FN_OSAL_Get_MMzAddrFromSmmu)(UADDR *pMMZPhyAddr, UADDR SmmuPhyAddr, SINT32 Size);
...
typedef struct Vfmw_Osal_Func_Ptr
{
    ...
    FN_OSAL_Get_MMzAddrFromSmmu pfun_Osal_GetMMZAddrFromSmmu;
} Vfmw_Osal_Func_Ptr;
