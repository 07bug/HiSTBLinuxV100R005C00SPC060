...
#define VFMW_EPB_REMOVAL
#ifdef VFMW_EPB_REMOVAL
#define EPB_MAX_PIC_HEADER_SIZE        (512)
#endif
...
/* For EPB removal in picture header */
#ifdef VFMW_EPB_REMOVAL
    UINT8 aucTmpStrBuf[EPB_MAX_PIC_HEADER_SIZE];
#endif /* VFMW_EPB_REMOVAL */
