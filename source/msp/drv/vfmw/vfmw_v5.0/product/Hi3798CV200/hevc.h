...
#define HEVC_GOP_LEN                         (100)    //the max length of gop for wrapping around
...
typedef struct
{
    UINT32  g_SigLastScan[HEVC_MAX_CU_DEPTH][HEVC_MAX_CU_SIZE *HEVC_MAX_CU_SIZE];
...
typedef struct
{
    ...
    UINT32 PrevLumaBitDepth;
    UINT32 PrevChromaBitDepth;
...
VOID   HEVC_Sei_Get_Dpb_Output_Time(HEVC_CTX_S *pHevcCtx, HEVC_VUI_PARAM_SET_S *pVui);
...
#endif
SINT32 HEVCDEC_AllocHevcGlbMem(VOID);
VOID HEVCDEC_ReleaseHevcGlbMem(VOID);
#ifdef __cplusplus
}
#endif
