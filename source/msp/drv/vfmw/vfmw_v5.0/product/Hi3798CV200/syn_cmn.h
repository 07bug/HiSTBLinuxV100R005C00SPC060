...
typedef struct hiSYNTAX_EXTRA_DATA_S
{
    ...
    SINT32     s32SedOnlyEnable;                    /*SED帧内低延时使能标志*/
    SINT32     s32UVMOSEnable;                     /*UVMOS使能标志*/
    SINT32     s32ScdMmuEn;
    SINT32     s32VdhMmuEn;
    ...
    SINT32     s32IsResizeHaveOldFrm; //变分辨率的时候，旧分辨率还没有被后级取走
    SINT32     s32firstIdecodedflag;   //add for o5, 0:begin decode;1:out put a frame;2:stop decode
} SYNTAX_EXTRA_DATA_S;
