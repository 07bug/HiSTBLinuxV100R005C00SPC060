...
SINT32 IsNewpicSeg(SINT32 ChanId, SINT32 *pNewPicDetector, VID_STD_E VidStd, STREAM_SEG_S *pStreamSeg);
...
#endif
SINT32 IsPtsRewind(SINT32 ChanID, UINT64 CurrentPts, UINT64 MinPts);
SINT32 MetadataMapToSec(SINT32 ChanID, UADDR PhyAddr, UINT8 **VirAddr,UINT32 Length);
SINT32 MetadataUnMapToSec(SINT32 ChanID, UINT8 *VirAddr);
#endif
