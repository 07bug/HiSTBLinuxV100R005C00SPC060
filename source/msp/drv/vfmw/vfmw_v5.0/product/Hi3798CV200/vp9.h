...
#define VP9_NOTDEC             -2
#define VP9_FRAME_NOT_ALLOCATE  0
#define VP9_FRAME_ALLOCATED     1
...
#else
typedef Vp9_Prob Vp9_CoeffProbsModel[VP9_REF_TYPES][VP9_COEF_BANDS + 2][VP9_PREV_COEF_CONTEXTS + 2][UNCONSTRAINED_NODES + 1]; //[6][6][3] -> [8][8][4]
#endif
...
typedef struct
{
    Vp9_Prob sign[2];
    Vp9_Prob joints[MV_JOINTS - 1];
    Vp9_Prob classes[2][VP9_MV_CLASSES - 1];
    Vp9_Prob class0[2][VP9_CLASS0_SIZE - 1];
    Vp9_Prob bits[2][VP9_MV_OFFSET_BITS];
    Vp9_Prob class0_fp[2][VP9_CLASS0_SIZE][4 - 1];
    Vp9_Prob fp[2][4 - 1];
...
typedef struct
{
    VP9_VFMW_NMV_COMPONENT_S comps;
} VP9_NMV_CONTEXT_S;
#endif
...
{
    Vp9_CoeffProbsModel coef_probs[TX_SIZES][VP9_BLOCK_TYPES];
    Vp9_Prob y_mode_prob[BLOCK_SIZE_GROUPS][INTRA_MODES - 1 + 7]; //[4][9] -> [4][16], D0-D15
    Vp9_Prob uv_mode_prob[INTRA_MODES][INTRA_MODES - 1 + 7]; //[10][9] -> [10][16], D16-D53
    Vp9_Prob reserved1[2 * 16];
    Vp9_Prob partition_prob_one[NUM_PARTITION_CONTEXTS][PARTITION_TYPES - 1]; //[16][3], D0-D11
    Vp9_Prob mbskip_probs[MBSKIP_CONTEXTS]; //[3], D12[0]-D12[2]
    VP9_VFMW_TX_PROBS_S tx_probs; //[2][1]+[2][2]+[3][2], D12[3]-D15[2]
    Vp9_Prob intra_inter_prob[INTRA_INTER_CONTEXTS]; //[4], D15[3]-D16[2]
    Vp9_Prob comp_inter_prob[COMP_INTER_CONTEXTS]; //[5], D16[3]-D17[3]
    Vp9_Prob comp_ref_prob[REF_CONTEXTS]; //[5], D18[0]-D19[0]
    Vp9_Prob single_ref_prob[REF_CONTEXTS][2]; //[5][2], D19[1]-D21[2]
    Vp9_Prob inter_mode_probs[INTER_MODE_CONTEXTS][INTER_MODES - 1]; //[7][3], D21[3]-D26[3]
    Vp9_Prob switchable_interp_prob[SWITCHABLE_FILTERS + 1][SWITCHABLE_FILTERS - 1]; //[4][2], D27-D28
    VP9_NMV_CONTEXT_S nmvc;
    Vp9_Prob reserved2[7];
    Vp9_Prob tree_probs[SEG_TREE_PROBS];
    Vp9_Prob reserved3[1];
    Vp9_Prob pred_probs[PREDICTION_PROBS];
    Vp9_Prob reserved4[57];
    Vp9_Prob partition_prob[VP9_NUM_FRAME_TYPES][NUM_PARTITION_CONTEXTS][PARTITION_TYPES - 1];
} VP9_FRAME_CONTEXT_S;//sizeof()=2KB
#endif
