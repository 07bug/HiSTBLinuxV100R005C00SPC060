...
ASM_CFLAGS += -DCHIP_TYPE_hi3798mv310
endif
...
OPEN_SRC := $(VFMW_BASE)/platform/osal/linux_kernel/vfmw_linux_kernel_osal.S $(VFMW_BASE)/platform/osal/linux_kernel/vfmw_linux_kernel_proc.S  $(VFMW_BASE)/platform/osal/sos_kernel/vfmw_sos_kernel_osal.S 
...
OPEN_SRC += $(VFMW_BASE)/module/vmm/vmm_command_intf.S $(VFMW_BASE)/module/vmm/vmm_core.S $(VFMW_BASE)/module/vmm/vmm_list_common.S $(VFMW_BASE)/module/vmm/vmm_memlist_manager.S $(VFMW_BASE)/module/vmm/vmm_memory_ops.S $(VFMW_BASE)/module/vmm/vmm_msglist_manager.S $(VFMW_BASE)/module/vmm/vmm_osal.S
...
asm: $(ASM_SRC)
	...
	cp $(VFMW_BASE)/core/driver/$(VDH_DIR)/vdm_hal_api.h    $(VFMW_DIR)/product/$(PRODUCT_DIR)/

	mv $(VFMW_DIR)/product/$(PRODUCT_DIR)/product.S ${DST_DIR}/
