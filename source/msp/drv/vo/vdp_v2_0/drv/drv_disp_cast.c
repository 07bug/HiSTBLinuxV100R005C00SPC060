                       ...
                       DISP_CAST_S** cast_ptr)
{
    ...
    stCB1.eCallBackPrior = HI_DRV_DISP_CALLBACK_PRIORTY_HIGH;
    ...
    stCB2.eCallBackPrior = HI_DRV_DISP_CALLBACK_PRIORTY_HIGH;
    if (pstCfg->bLowDelay)
    {
...
HI_VOID DISP_CastCB_GenarateFrame(HI_VOID *cast_ptr, const HI_DRV_DISP_CALLBACK_INFO_S *pstInfo)
{
    ...
    if (pstInfo->eEventType == HI_DRV_DISP_C_VT_INT)
    {
        ...
        if (pstCast->stDispInfo.u32RefreshRate)
        {
        ...
        pstCast->stAttr.stFrameDemo.u32Pts    = pstCast->stAttr.stFrameDemo.u32Pts;
