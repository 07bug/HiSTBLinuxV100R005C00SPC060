...
#endif
#endif /* __cplusplus */
static HI_S32 DRV_MCVN_SetDateMcvn(HI_DRV_DISP_FMT_E enFmt, HI_DRV_DISP_MACROVISION_E enMcvn);
                                ...
                                HI_DRV_DISP_FMT_E enFmt)
{
    ...
    if ((HI_DRV_DISP_MACROVISION_TYPE0 > enMode )
        || (HI_DRV_DISP_MACROVISION_TYPE3  < enMode))
    {
