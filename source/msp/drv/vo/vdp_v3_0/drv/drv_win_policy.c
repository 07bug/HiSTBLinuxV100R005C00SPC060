...
{    
    ...
    {		
        if (!bSrCapability)
        {
            ...
            {
                if (0 == stExpectVpssOutputSize.s32Height || 0 == stExpectVpssOutputSize.s32Width)
                {
...
{   
    ...
    if (0 == u32InputMultiple || 0 == u32OutputMultiple)
    {
        WIN_ERROR("Denominator may be zero !\n");
        return HI_FAILURE;
    }
	...
	{
        if (0 == stSdOutputRectSize.s32Height)
        {
            WIN_ERROR("Denominator may be zero !\n");
            return HI_FAILURE;
        }
	...
	{
        if (0 == stSdOutputRectSize.s32Width)
        {
            WIN_ERROR("Denominator may be zero !\n");
            return HI_FAILURE;
        }
