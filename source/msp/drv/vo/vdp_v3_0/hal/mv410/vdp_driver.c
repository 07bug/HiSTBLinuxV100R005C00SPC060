...
HI_VOID  VDP_DRIVER_SetVirtualAddr(S_VDP_REGS_TYPE *pstvirAddr)
{
    pVdpReg = (S_VDP_REGS_TYPE *)pstvirAddr;
}
...
HI_VOID  VDP_DRIVER_Initial()
{
    ...
    VDP_SetRdOutStd(VDP_MASTER0, 0, 15);
    VDP_SetRdOutStd(VDP_MASTER0, 1, 15);
    VDP_SetWrOutStd(VDP_MASTER0, 0, 15);
...
HI_VOID  VDP_VID_SetUnpackDrawEnable   (HI_U32 u32Data, HI_U32 u32Enable )
{
    volatile    U_V0_CTRL  V0_CTRL;
    ...
    if(u32Data >= VID_MAX)
    {
        HI_PRINT("Error,VID_SetUnpackDrawEnable() Select Wrong Video Layer ID\n");
        return ;
    }

    V0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET));
    V0_CTRL.bits.unpack_draw_en= u32Enable ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET), V0_CTRL.u32);
    ...
    if(u32Enable == 1)
    {
        ...
        V0_CPOS.bits.src_xfpos = 0;//(V0_CPOS.bits.src_xfpos+1)/4*2-1;
        V0_CPOS.bits.src_xlpos = (V0_CPOS.bits.src_xlpos+1)/4*2-1;
...
//    U_V0_16REGIONENL V0_16REGIONENL;
    ...
    //mv410 del v4
    if(u32Data == VDP_LAYER_VID4)
    {
        HI_PRINT("Warning! MV410 has no VID4 Layer\n");
        return;
    }
...
HI_VOID VDP_VID_SetUpdMode (HI_U32 u32Data, HI_U32 u32Mode)
{
    volatile    U_V0_CTRL  V0_CTRL;

    if(u32Data >= VID_MAX)
    {
        HI_PRINT("Error,VDP_VID_SetUpdMode() Select Wrong Graph Layer ID\n");
        return ;
    }

    /* V0 layer register update mode */
    V0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_CTRL.u32)+ u32Data * GFX_OFFSET));
    V0_CTRL.bits.upd_mode = u32Mode;
    VDP_RegWrite((HI_U32)(&(pVdpReg->V0_CTRL.u32)+ u32Data * GFX_OFFSET), V0_CTRL.u32);
}

HI_VOID VDP_VID_SetZmeMemMode (HI_U32 u32Data, HI_U32 u32Mode)
{
    volatile    U_V0_CTRL  V0_CTRL;

    if(u32Data >= VID_MAX)
    {
        HI_PRINT("Error,VDP_VID_SetZmeMemMode() Select Wrong Graph Layer ID\n");
        return ;
    }

    /* V0 layer register update mode */
    V0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_CTRL.u32)+ u32Data * GFX_OFFSET));
    V0_CTRL.bits.zme_mem_mode = u32Mode;
    VDP_RegWrite((HI_U32)(&(pVdpReg->V0_CTRL.u32)+ u32Data * GFX_OFFSET), V0_CTRL.u32);
}
...
{
    volatile    U_V0_MUTE_BK    V0_MUTE_BK;
...
{
    volatile    U_V0_TILE_STRIDE V0_TILE_STRIDE;

    if(u32Data != VDP_LAYER_VID0)
    {
        HI_PRINT("Error, VDP_VID_SetTileStride() Select Wrong Video Layer ID\n");
        return ;
    }

    V0_TILE_STRIDE.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_TILE_STRIDE.u32) + u32Data * VID_OFFSET));
    V0_TILE_STRIDE.bits.tile_stride = u32LStr;
    V0_TILE_STRIDE.bits.tile_cstride = u32CStr;
    VDP_RegWrite((HI_U32)(&(pVdpReg->V0_TILE_STRIDE.u32) + u32Data * VID_OFFSET), V0_TILE_STRIDE.u32);
...
{
    volatile    U_V0_TILE_LOFFSET V0_TILE_LOFFSET;
    volatile    U_V0_TILE_COFFSET V0_TILE_COFFSET;

    if(u32Data >= VID_MAX)
    {
        HI_PRINT("Error,VDP_VID_SetSrcCropReso() Select Wrong Video Layer ID\n");
        return ;
    }
...
//#if VID_DRAW_EN
    ...
    V0_DRAWMODE.bits.c_draw_mode = u32ModeChroma;
...
{
    volatile    U_V0_DCMP_CTRL V0_DCMP_CTRL;
...
{
    volatile    U_VP0_DCICTRL VP0_DCICTRL;
...
HI_VOID VDP_VP_SetDciDbgPos(HI_U32 u32Data, HI_U32 u32DciDbgPos)
{
    volatile    U_VP0_DCICTRL VP0_DCICTRL;

    if(u32Data >= VP_MAX)
    {
        HI_PRINT("Error,VDP_VP_SetDciDbgPos() Select Wrong VP ID\n");
        return ;
    }

    VP0_DCICTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->VP0_DCICTRL.u32)+ u32Data * VP_OFFSET));
    VP0_DCICTRL.bits.dci_dbg_pos = u32DciDbgPos ;
    VDP_RegWrite((HI_U32)(&(pVdpReg->VP0_DCICTRL.u32)+ u32Data * VP_OFFSET), VP0_DCICTRL.u32);
...
{
	volatile    U_VP0_DCIHPOS VP0_DCIHPOS;
	volatile    U_VP0_DCIVPOS VP0_DCIVPOS;
...
{
    volatile    U_VP0_DCIHISBLD VP0_DCIHISBLD;
...
{
    volatile    U_VP0_DCIHISOFT VP0_DCIHISOFT ;
...
{
    volatile    U_VP0_DCIHISCOR VP0_DCIHISCOR;
...
{
    volatile    U_VP0_DCIMERBLD VP0_DCIMERBLD;
...
{
    volatile    U_VP0_DCIADJWGT VP0_DCIADJWGT;
...
{
    volatile    U_VP0_DCICLIP0 VP0_DCICLIP0;
    volatile    U_VP0_DCICLIP1 VP0_DCICLIP1;
    volatile    U_VP0_DCICLIP2 VP0_DCICLIP2;
...
{
    volatile    U_VP0_DCIGLBGAIN VP0_DCIGLBGAIN;
...
{
    volatile    U_VP0_DCIPOSTHR0 VP0_DCIPOSTHR0;
    volatile    U_VP0_DCIPOSTHR1 VP0_DCIPOSTHR1;

    volatile    U_VP0_DCIPOSGAIN0 VP0_DCIPOSGAIN0;
    volatile    U_VP0_DCIPOSGAIN1 VP0_DCIPOSGAIN1;

    volatile    U_VP0_DCIPOSSLP0 VP0_DCIPOSSLP0;
    volatile    U_VP0_DCIPOSSLP1 VP0_DCIPOSSLP1;
    volatile    U_VP0_DCIPOSSLP2 VP0_DCIPOSSLP2;
...
{
    volatile    U_VP0_DCINEGTHR0 VP0_DCINEGTHR0;
    volatile    U_VP0_DCINEGTHR1 VP0_DCINEGTHR1;

    volatile    U_VP0_DCINEGGAIN0 VP0_DCINEGGAIN0;
    volatile    U_VP0_DCINEGGAIN1 VP0_DCINEGGAIN1;

    volatile    U_VP0_DCINEGSLP0 VP0_DCINEGSLP0;
    volatile    U_VP0_DCINEGSLP1 VP0_DCINEGSLP1;
    volatile    U_VP0_DCINEGSLP2 VP0_DCINEGSLP2;
...
{
    volatile    U_VP0_DCIADJSW0 VP0_DCIADJSW0 ;
    volatile    U_VP0_DCIADJSW1 VP0_DCIADJSW1 ;
    volatile    U_VP0_DCIADJSW2 VP0_DCIADJSW2 ;
    volatile    U_VP0_DCIADJSW3 VP0_DCIADJSW3 ;
    volatile    U_VP0_DCIADJSW4 VP0_DCIADJSW4 ;
    volatile    U_VP0_DCIADJSW5 VP0_DCIADJSW5 ;
    volatile    U_VP0_DCIADJSW6 VP0_DCIADJSW6 ;
    volatile    U_VP0_DCIADJSW7 VP0_DCIADJSW7 ;
    volatile    U_VP0_DCIADJSW8 VP0_DCIADJSW8 ;
    volatile    U_VP0_DCIADJSW9 VP0_DCIADJSW9 ;
    volatile    U_VP0_DCIADJSW10 VP0_DCIADJSW10 ;
...
{
    volatile    U_VP0_DCI_CAD VP0_DCI_CAD;
...
HI_VOID  VDP_VP_SetMuteBkg(HI_U32 u32Data, VDP_BKG_S stVpMuteBkg)
{
    volatile    U_VP0_MUTE_BK VP0_MUTE_BK;
    ...
    VP0_MUTE_BK.bits.mute_y  = stVpMuteBkg.u32BkgY;
    VP0_MUTE_BK.bits.mute_cb = stVpMuteBkg.u32BkgU;
    VP0_MUTE_BK.bits.mute_cr = stVpMuteBkg.u32BkgV;
...
HI_VOID  VDP_VP0_SetParaUpd       (HI_U32 u32Data, VDP_DISP_COEFMODE_E  enMode)
{
    ...
    if(enMode == VDP_DISP_COEFMODE_DCI)
    {
...
HI_VOID VDP_VID_SetDataWidth    (HI_U32 u32Data, HI_U32 u32idatawth)
{
    return ;
}
...
//    }
    ...
    {
        HI_PRINT("Error,VDP_SetRdMultiIdEnable() Select Wrong Master!\n");
    }
...
HI_VOID VDP_DISP_SetDataSel  (HI_U32 u32hd_id, VDP_DISP_INTF_E enIntf, HI_U32 u32DataSel)
{
	...
	if(enIntf == VDP_DISP_INTF_HDMI)
	{
		DHD0_DATA_SEL.bits.hdmi_data_sel = u32DataSel;
	}
	//else if(enIntf == VDP_DISP_INTF_LCD)
	//{
	//	DHD0_DATA_SEL.bits.lcd_data_sel = u32DataSel;
	//}
	else if(enIntf == VDP_DISP_INTF_VGA)
	{
		DHD0_DATA_SEL.bits.vga_data_sel = u32DataSel;
	}
	else if(enIntf == VDP_DISP_INTF_DATE)
	{
		DHD0_DATA_SEL.bits.date_data_sel = u32DataSel;
	}
...
HI_VOID VDP_GFX_SetSrcxPos   (HI_U32 u32Data, HI_U32 u32SrcX)
{
    volatile    U_G0_SFPOS G0_SFPOS;

   if(u32Data >= GFX_MAX)
   {
       HI_PRINT("Error,VDP_GFX_SetSrcxPos() Select Wrong Video Layer ID\n");
       return ;
   }

   G0_SFPOS.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->G0_SFPOS.u32)+ u32Data * GFX_OFFSET));
   G0_SFPOS.bits.src_xfpos = u32SrcX;
...
HI_VOID VDP_GP_SetZmePhase   (HI_U32 u32Data, VDP_ZME_MODE_E enMode, HI_S32 s32Phase)
{
    ...
    {
        GP0_ZME_HLOFFSET.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->GP0_ZME_HLOFFSET.u32) + u32Data * GP_OFFSET));
        GP0_ZME_HLOFFSET.bits.hor_loffset = s32Phase;
        VDP_RegWrite((HI_U32)(&(pVdpReg->GP0_ZME_HLOFFSET.u32) + u32Data * GP_OFFSET), GP0_ZME_HLOFFSET.u32);
    }

    if((enMode == VDP_ZME_MODE_HORC) || (enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
    {
        GP0_ZME_HCOFFSET.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->GP0_ZME_HCOFFSET.u32) + u32Data * GP_OFFSET));
        GP0_ZME_HCOFFSET.bits.hor_coffset = s32Phase;
        VDP_RegWrite((HI_U32)(&(pVdpReg->GP0_ZME_HCOFFSET.u32) + u32Data * GP_OFFSET), GP0_ZME_HCOFFSET.u32);
    }
...
HI_VOID  VDP_GP_SetTiEnable(HI_U32 u32Data, HI_U32 u32Md,HI_U32 u32Data1)
{
    ...
    if((u32Md == VDP_TI_MODE_LUM)||(u32Md == VDP_TI_MODE_ALL))
    {
        ...
        GP0_ZME_LTICTRL.bits.lti_en = 0;//u32Data1; //mv410 no lti/cti
    ...
    if((u32Md == VDP_TI_MODE_CHM)||(u32Md == VDP_TI_MODE_ALL))
    {
        ...
        GP0_ZME_CTICTRL.bits.cti_en = 0;//u32Data1; //mv410 no lti/cti
...
//WBC_DHD0_BEGIN
//-------------------------------------------------------------------
HI_VOID VDP_WBC_SetConnection  (HI_U32 u32LayerId, VDP_LAYER_CONN_E u32WbcVpConnect)
{
    ...
    WBC_DHD0_CTRL.bits.wbc_point_sel = u32WbcVpConnect;
    VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)), WBC_DHD0_CTRL.u32);
}


//add  v3 zme who to use
HI_VOID VDP_WBC_SetZmeUse  (VDP_LAYER_WBC_E enLayer, VDP_WBC_ZME_USE_E stZmeUseBy)
{
    volatile    U_WBC_DHD0_CTRL    WBC_DHD0_CTRL;
    ...
    {
        WBC_DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)));
        WBC_DHD0_CTRL.bits.v3_zme_sel =  stZmeUseBy;
        VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)), WBC_DHD0_CTRL.u32);
    }
}
//--------------------------------------------
...
{
    volatile    U_WBC_DHD0_HCDS WBC_DHD0_HCDS;
    if(enLayer == VDP_LAYER_WBC_HD0)
    {
...
{
    volatile    U_WBC_DHD0_HCDS_COEF0 WBC_DHD0_HCDS_COEF0;
    volatile    U_WBC_DHD0_HCDS_COEF1 WBC_DHD0_HCDS_COEF1;
...
HI_VOID VDP_hdate_SetVideoFmt(HI_U32 u32VideoFmt)
{
...
HI_VOID  VDP_WBC_SetLayerAddr   (VDP_LAYER_WBC_E enLayer, HI_U32 u32LAddr,HI_U32 u32CAddr,HI_U32 u32LStr, HI_U32 u32CStr)
{
    ...
    if (enLayer == VDP_LAYER_WBC_HD0)
    {
		//HI_PRINT("VDP_WBC_SetLayerAddr:---:%x, %x,%x,%x!\n", u32LAddr, u32CAddr,
			//	u32LStr,
			//	u32CStr);
...
HI_VOID  VDP_WBC_SetLayerReso     (VDP_LAYER_WBC_E enLayer, VDP_DISP_RECT_S  stRect)
{
   ...
   // volatile U_WBC_GP0_IRESO WBC_GP0_IRESO;//mask by sdk
    ...
    {
       // mask by sdk WBC_GP0_IRESO.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_GP0_IRESO.u32)));
       // mask by sdk WBC_GP0_IRESO.bits.iw = stRect.u32IWth - 1;
       // mask by sdk WBC_GP0_IRESO.bits.ih = stRect.u32IHgt - 1;
       // mask by sdk VDP_RegWrite((HI_U32)(&(pVdpReg->WBC_GP0_IRESO.u32)), WBC_GP0_IRESO.u32);
...
//    U_WBC_DHD0_VCCOEFAD WBC_DHD0_VCCOEFAD;
    ...
    {
        HI_PRINT("Warning,VDP_VID_SetZmeEnable() Select Wrong Video Layer ID\n");
        return ;
    }
    ...
    if( enLayer == VDP_LAYER_WBC_HD0)
    {
        ...
        {
            V0_HLCOEFAD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_HLCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_HLCOEFAD.bits.coef_addr = u32Addr;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_HLCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_HLCOEFAD.u32);

            V0_HCCOEFAD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_HCCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_HCCOEFAD.bits.coef_addr = (u32Addr +ADDR_OFFSET) & 0xfffffff0;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_HCCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_HCCOEFAD.u32);

        }
        else if(u32Mode == VDP_VID_PARA_ZME_VER)
        {
            V0_VLCOEFAD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_VLCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_VLCOEFAD.bits.coef_addr = u32Addr;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_VLCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_VLCOEFAD.u32);

            V0_VCCOEFAD.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_VCCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_VCCOEFAD.bits.coef_addr = (u32Addr + ADDR_OFFSET)  & 0xfffffff0;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_VCCOEFAD.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_VCCOEFAD.u32);
...
HI_VOID  VDP_WBC_SetParaUpd (VDP_LAYER_WBC_E enLayer, VDP_WBC_PARA_E enMode)
{
    ...
    V0_PARAUP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_PARAUP.u32) + VDP_LAYER_VID3 * VID_OFFSET));
...
//    WBC_DHD0_PARAUP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_PARAUP.u32)));
    ...
    if( enLayer == VDP_LAYER_WBC_HD0)
    {
        ...
        {
            HI_PRINT("error,VDP_WBC_SetParaUpd() select wrong mode!\n");
        }

    VDP_RegWrite((HI_U32)(&(pVdpReg->V0_PARAUP.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_PARAUP.u32);
#if 0
        if(enMode == VDP_WBC_PARA_ZME_HOR)
        {
...
//    U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;
    ...
    if(enLayer == VDP_LAYER_WBC_HD0 )
    {
        ...
        if((enMode == VDP_ZME_MODE_HORL)||(enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
        {
            V0_HSP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_HSP.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_HSP.bits.hlmsc_en = u32bEnable;
            V0_HSP.bits.hlfir_en = 1;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_HSP.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_HSP.u32);
        }
        ...
        {
            V0_HSP.u32 = VDP_RegRead(&(pVdpReg->V0_HSP.u32));
//             V0_HSP.bits.non_lnr_en = u32bEnable;
            VDP_RegWrite(&(pVdpReg->V0_HSP.u32), V0_HSP.u32);
        }
        if((enMode == VDP_ZME_MODE_VERL)||(enMode == VDP_ZME_MODE_VER)||(enMode == VDP_ZME_MODE_ALL))
        {
            V0_VSP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_VSP.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_VSP.bits.vlmsc_en = u32bEnable;
            V0_VSP.bits.vlfir_en = 1;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_VSP.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_VSP.u32);
        }
    ...
    else if(enLayer == VDP_LAYER_WBC_GP0)
    {
        if((enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
        {
            ...
            //add because of Prj Hi3719MV100 .. begin
            GP0_ZME_HSP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->GP0_ZME_HSP.u32) + WBC_GP0_SEL * GP_OFFSET));
            GP0_ZME_HSP.bits.hfir_order = 0;
            VDP_RegWrite((HI_U32)(&(pVdpReg->GP0_ZME_HSP.u32) + WBC_GP0_SEL * GP_OFFSET), GP0_ZME_HSP.u32);
            //add because of Prj Hi3719MV100 .. end
...
//     U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;
//     U_WBC_DHD0_ZME_VSP WBC_DHD0_ZME_VSP;
    U_V0_HSP WBC_DHD0_ZME_HSP;
    U_V0_VSP WBC_DHD0_ZME_VSP;
    U_GP0_ZME_HSP      GP0_ZME_HSP;
    U_GP0_ZME_VSP      GP0_ZME_VSP;
    U_WBC_DHD0_CTRL    WBC_DHD0_CTRL;
    WBC_DHD0_CTRL.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_CTRL.u32)));
    ...
    if(enLayer == VDP_LAYER_WBC_HD0 )
    {
        if((enMode == VDP_ZME_MODE_HORL)||(enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
        {
            WBC_DHD0_ZME_HSP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_HSP.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            WBC_DHD0_ZME_HSP.bits.hlmid_en = bEnable;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_HSP.u32) + VDP_LAYER_VID3 * VID_OFFSET), WBC_DHD0_ZME_HSP.u32);
        }
        ...
        if((enMode == VDP_ZME_MODE_VERL)||(enMode == VDP_ZME_MODE_VER)||(enMode == VDP_ZME_MODE_ALL))
        {
            WBC_DHD0_ZME_VSP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_VSP.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            WBC_DHD0_ZME_VSP.bits.vlmid_en = bEnable;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_VSP.u32) + VDP_LAYER_VID3 * VID_OFFSET), WBC_DHD0_ZME_VSP.u32);
        }
...
//     U_WBC_DHD0_ZME_HSP WBC_DHD0_ZME_HSP;
    ...
    {
        V0_HSP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_HSP.u32) + VDP_LAYER_VID3 * VID_OFFSET));
        V0_HSP.bits.hfir_order = VDP_ZME_ORDER_HV;//fixed hv order
        VDP_RegWrite((HI_U32)(&(pVdpReg->V0_HSP.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_HSP.u32);
#if 0
        WBC_DHD0_ZME_HSP.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->WBC_DHD0_ZME_HSP.u32)));
...
//     U_WBC_DHD0_ZME_VSR WBC_DHD0_ZME_VSR;
    ...
    if(enLayer == VDP_LAYER_WBC_HD0 )
    {
        V0_VSR.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_VSR.u32) + VDP_LAYER_VID3 * VID_OFFSET));
        V0_VSR.bits.vratio = u32Ratio;
        VDP_RegWrite((HI_U32)(&(pVdpReg->V0_VSR.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_VSR.u32);
#if 0
...
//     U_WBC_DHD0_ZME_VBOFFSET  WBC_DHD0_ZME_VBOFFSET;
    ...
    if(enLayer == VDP_LAYER_WBC_HD0)
    {
        ...
        if((enMode == VDP_ZME_MODE_HORL) || (enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
        {
            V0_HLOFFSET.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_HLOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_HLOFFSET.bits.hor_loffset = s32Phase;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_HLOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_HLOFFSET.u32);
        }

        if((enMode == VDP_ZME_MODE_HORC) || (enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
        {
            V0_HCOFFSET.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_HCOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_HCOFFSET.bits.hor_coffset = s32Phase;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_HCOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_HCOFFSET.u32);
        }

        if((enMode == VDP_ZME_MODE_VERL)||(enMode == VDP_ZME_MODE_VER)||(enMode == VDP_ZME_MODE_ALL))
        {
            V0_VOFFSET.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_VOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_VOFFSET.bits.vluma_offset = s32Phase;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_VOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_VOFFSET.u32);
        }
        ...
        {
            V0_VBOFFSET.u32 = VDP_RegRead((HI_U32)(&(pVdpReg->V0_VBOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET));
            V0_VBOFFSET.bits.vbluma_offset = s32Phase;
            VDP_RegWrite((HI_U32)(&(pVdpReg->V0_VBOFFSET.u32) + VDP_LAYER_VID3 * VID_OFFSET), V0_VBOFFSET.u32);
        }
...
HI_VOID VDP_VO_SetPdChopper(HI_U32 u32Data)
{
    volatile    U_VO_CABLE_CTRL  VO_CABLE_CTRL;
    VO_CABLE_CTRL.u32 = VDP_RegRead((HI_U32)&(pVdpReg->VO_CABLE_CTRL.u32));
    VO_CABLE_CTRL.bits.pdchopper = u32Data;
    VDP_RegWrite((HI_U32)&(pVdpReg->VO_CABLE_CTRL.u32), VO_CABLE_CTRL.u32);
}

HI_VOID VDP_VO_SetCableCtrl(HI_U32 u32DacSel,HI_U32 u32Data)
{
    volatile    U_VO_CABLE_CTRL  VO_CABLE_CTRL;
    ...
    if(u32DacSel == 0)
    {
    VO_CABLE_CTRL.bits.cable_ctrl0= u32Data;
    }
    else if(u32DacSel == 1)
    {
    VO_CABLE_CTRL.bits.cable_ctrl1= u32Data;
    }
    else if(u32DacSel == 2)
    {
    VO_CABLE_CTRL.bits.cable_ctrl2= u32Data;
    }
    else if(u32DacSel == 3)
    {
    VO_CABLE_CTRL.bits.cable_ctrl3= u32Data;
    }
...
HI_VOID VDP_DATE_SetHTiming(HI_U32 u32Chan, HI_U32 *pu32SrcCoef)
{
    ...
    VDP_RegWrite((HI_U32)&(pVdpReg->DATE_COEFF24.u32), *pu32SrcCoef++);
    VDP_RegWrite((HI_U32)&(pVdpReg->DATE_COEFF61.u32), *pu32SrcCoef++);
    VDP_RegWrite((HI_U32)&(pVdpReg->DATE_COEFF66.u32), *pu32SrcCoef++);
    VDP_RegWrite((HI_U32)&(pVdpReg->DATE_COEFF67.u32), *pu32SrcCoef++);
    VDP_RegWrite((HI_U32)&(pVdpReg->DATE_COEFF68.u32), *pu32SrcCoef++);
    VDP_RegWrite((HI_U32)&(pVdpReg->DATE_COEFF69.u32), *pu32SrcCoef++);
    VDP_RegWrite((HI_U32)&(pVdpReg->DATE_COEFF70.u32), *pu32SrcCoef++);

	VDP_RegWrite((HI_U32)(&(pVdpReg->DATE_COEFF84.u32) + 6), *pu32SrcCoef++);
	VDP_RegWrite((HI_U32)(&(pVdpReg->DATE_COEFF84.u32) + 7), *pu32SrcCoef++);
}

HI_U32 u32SDDATESrcHTimingCoef[][10]=
{
    /* NTSC  HTiming*/
    {0xf12c00 ,  0x1 ,  0xf ,   0x35a ,  0x40 ,  0x14,0x2ca, 0x80001b, 0x10000e5},
   /* PAL  HTiming*/
    ...
    if (DISP_VENC_HDATE0 == eDate)
    {
        ...
        switch(enFmt)
        {
            ...
            case HI_DRV_DISP_FMT_720P_59_94:
                ...
                VDP_RegWrite((HI_U32)(&(pVdpReg->HDATE_POLA_CTRL.u32)), 0x01ul);
                break;
        ...
        // some sony46 TV can not accept 576P50 siganl correctly
        {
...
HI_VOID VDP_VDAC_ResetCRG(HI_VOID)
{
    ...
    PERI_CRG71TMP.bits.vdac_1_clk_pctrl = 0;
    PERI_CRG71TMP.bits.vdac_2_clk_pctrl = 0;
    PERI_CRG71TMP.bits.vdac_3_clk_pctrl = 0;
...
HI_VOID VDP_VBI_TtxEnableInt(HI_VOID)
{
...
HI_VOID VDP_VBI_TtxSetPackOff(HI_U32 PackOff)
{
...
HI_VOID VDP_VBI_TtxPiorityHighest(HI_BOOL Highest)
{
    U_DATE_COEFF10   TtxConfig;
...
HI_VOID VDP_VBI_SetTtxFullPage(HI_BOOL Flag)
{
    U_DATE_COEFF10   TtxConfig;
...
HI_VOID VDP_VBI_VbiFilterEnable(HI_BOOL VbiFilterEnable)
{
	U_DATE_COEFF0		DATE_COEFF0;
...
HI_VOID VDP_VBI_TtxIntClear(HI_VOID)
{
...
HI_VOID VDP_VBI_TtxDisableInt(HI_VOID)
{
    U_DATE_ISRMASK DATE_ISRMASK;
...
HI_VOID VDP_VBI_CCSetSeq(HI_BOOL CCSeq)
{
...
HI_VOID VDP_VBI_WSSConfig(HI_BOOL WssEnable, HI_U16 WssData)
{
...
HI_VOID VDP_VBI_CCLineConfig(HI_BOOL TopEnable, HI_BOOL BottomEnable, HI_U16 TopLine, HI_U16 BottomLine)
{
...
HI_VOID VDP_VBI_TtxSetSeq(HI_BOOL TtxSeq)
{
	U_DATE_COEFF0   DATE_COEFF0;
...
HI_VOID VDP_VBI_TtxLineEnable(HI_U32 WhichRow, HI_U32 WhichExtRow)
{
...
HI_VOID VDP_VBI_TtxSetAddr(HI_U32 StartAddr, HI_U32 EndAddr)
{
...
HI_VOID VDP_VBI_TtxSetReady(HI_VOID)
{
    U_DATE_COEFF10   TtxConfig;
...
HI_VOID VDP_VBI_TtxSetMode(HI_U32 TtxMode)
{
    U_DATE_COEFF10 TtxConfig;
...
HI_VOID VDP_VBI_CCDataConfig(HI_U16 TopData, HI_U16 BottomData)
{
...
HI_BOOL VDP_VBI_IntStatus(HI_VOID)
{
