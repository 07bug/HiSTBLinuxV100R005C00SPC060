                                       ...
                                       CBB_PIX_FORMAT_E enLayerFmt)
{
    ...
    if ((enLayerFmt == CBB_VID_IFMT_SP_420)
        ...
        || (enLayerFmt == CBB_VID_IFMT_SP_444)
        || (enLayerFmt == CBB_VID_IFMT_RGB_888)
        || (enLayerFmt == CBB_VID_IFMT_ARGB_8888))
    {
