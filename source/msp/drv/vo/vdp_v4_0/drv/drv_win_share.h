...
typedef struct tagWIN_SHARE_XDR_LIB_STATUS_S
{
    HI_BOOL bExistHdr10Lib;
    HI_BOOL bExistHlgLib;
    HI_BOOL bExistSlfLib;
    HI_BOOL bExistDolbyLib;
    HI_BOOL bExistJTPLib;
}WIN_SHARE_XDR_LIB_STATUS_S;
