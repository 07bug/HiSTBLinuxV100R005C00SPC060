...
#define  WIN_CMD_ARGS_SIZE  8


/* display ID */
typedef enum hiDRV_WIN_CMD_E
{
    DRV_WIN_CMD_NOTHING = 0,
    DRV_WIN_CMD_FREEZE,
    DRV_WIN_CMD_PAUSE,
    DRV_WIN_CMD_RESET,
    DRV_WIN_CMD_BUTT
...
typedef struct hiWIN_CMD_PARA_S
{
    DRV_WIN_CMD_E enWinCMD;
    HI_U32 u32Args[WIN_CMD_ARGS_SIZE];
}WIN_CMD_PARA_S;

typedef struct hiWIN_QUEUE_NODE_S
{
    WIN_CMD_PARA_S stWinCMDPara;
    DISP_OSAL_LIST stNode;
}WIN_QUEUE_NODE_S;
