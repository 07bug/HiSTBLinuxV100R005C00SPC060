...
static DISP_FMT_CFG_S s_stDispFormatParam[] =
{
    ...
    {   {1,  1,   2,  2160,  82,  8,  3840, 384, 176,       1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /*  3840x2160@60Hz@594.000MHz  */
...
HI_VOID Chip_Specific_SetSyncInv(HI_U32 u32hd_id, VDP_DISP_INTF_E enIntf, VDP_DISP_SYNCINV_S enInv)
{
    ...
    /*just a temporary modify, there exist some problems in  the horizonal phrase
     * which hardwarers can not explain.
    */
    if ((VDP_DISP_INTF_HDDATE == enIntf)
        || (VDP_DISP_INTF_SDDATE == enIntf))
    {
        enInv.u32HsInv = 1;
    }
