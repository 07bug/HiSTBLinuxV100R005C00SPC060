...
HI_VOID VDP_OpenClkAndInitCrgConfig(HI_VOID)
{
    ...
    unTmpValue.bits.vo_hd_cken       = 1;/* default config 0x01 open hd*/
    unTmpValue.bits.vo_hdate_cken    = 1;
    unTmpValue.bits.vdac_ch0_cken    = 1; /* open  clk  2017/2/27*/
    ...
    unTmpValue.bits.vdac_ch0_clk_sel = 1; /* open hd clk  2017/2/27*/
