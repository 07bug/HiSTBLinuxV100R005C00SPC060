...
typedef enum
{
    VDP_COEF_BUF_NO_USE      = 0  ,
    VDP_COEF_BUF_IN_GAMMA      ,
    ...
    VDP_COEF_BUF_TCHDR_C          ,
    VDP_COEF_BUF_TCHDR_P          ,
    VDP_COEF_BUF_TCHDR_S          ,
    VDP_COEF_BUF_TCHDR_I          ,
    VDP_COEF_BUF_TCHDR_D          ,
...
typedef struct hiVDP_REG_ADDR_S
{
    VDP_MMZ_BUFFER_S        stBufBaseAddr   ;
    HI_U32                  u32size         ;
