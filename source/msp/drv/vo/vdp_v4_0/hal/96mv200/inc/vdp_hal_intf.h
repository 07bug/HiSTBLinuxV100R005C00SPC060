...
typedef enum tagCBB_VID_IFMT_E
{
    ...
    CBB_VID_IFMT_RGB_888     = 0xc,
    CBB_VID_IFMT_ARGB_8888   = 0xd,
...
#define PIXCEL_FMT_TRANSFER(a) ({\
        VDP_CLR_SPACE_E b = 0;\
        switch(a)\
        {\
            case CBB_VID_IFMT_SP_400:\
            {\
                b             = VDP_VID_IFMT_SP_400; \
                break;\
            }\
