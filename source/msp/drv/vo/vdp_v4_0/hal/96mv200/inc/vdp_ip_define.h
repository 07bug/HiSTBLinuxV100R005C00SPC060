...
typedef enum tagVDP_DISP_INTF_E
{
    ...
    VDP_DISP_INTF_YPBPR = 6,
    VDP_DISP_INTF_BUTT   = 7,
} VDP_DISP_INTF_E;
...
typedef enum tagVDP_LP_PARA_MODE_E
{
    VDP_LP_PARA_MODE_ZERO,
    VDP_LP_PARA_MODE_NZERO,
    VDP_LP_PARA_MODE_INTERVAL,
    VDP_LP_PARA_MODE_NINTERVAL,
    VDP_LP_PARA_MODE_VLD1,
    VDP_LP_PARA_MODE_NVLD1,
    VDP_LP_PARA_MODE_NVLD2,
    VDP_LP_PARA_MODE_RAND,
    VDP_LP_PARA_MODE_CFG,
    VDP_LP_PARA_MODE_BUTT
} VDP_LP_PARA_MODE_E;

typedef struct tagVDP_LP_PARA_S
{
    HI_U32  lp_para_00;
    HI_U32  lp_para_01;
    HI_U32  lp_para_02;
