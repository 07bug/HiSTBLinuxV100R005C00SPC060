...
HI_S32 VDP_DRV_CoefBufAddrDistribute(VDP_COEF_ADDR_S *stVdpCoefBufAddr)
{
    ...
    stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_C6_V0]  = stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_ZME_TMP] + COEF_SIZE_ZME_TMP - u32CoefAlign;
    stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_C6_V1]  = stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_C6_V0] + COEF_SIZE_C6_V0 - u32CoefAlign;
    stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_C6_VP0] = stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_C6_V1] + COEF_SIZE_C6_V1 - u32CoefAlign;
    stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_WBC_ZMEH]  = stVdpCoefBufAddr->pu8CoefVirAddr[VDP_COEF_BUF_C6_VP0] + COEF_SIZE_C6_VP0 - u32CoefAlign;
    ...
    stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_C6_V0]  = stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_ZME_TMP] + COEF_SIZE_ZME_TMP  - u32CoefAlign;


    stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_C6_V1]  = stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_C6_V0] + COEF_SIZE_C6_V0 - u32CoefAlign;
    stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_C6_VP0] = stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_C6_V1] + COEF_SIZE_C6_V1 - u32CoefAlign;

    stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_WBC_ZMEH]  = stVdpCoefBufAddr->u32CoefPhyAddr[VDP_COEF_BUF_C6_VP0] + COEF_SIZE_C6_VP0 - u32CoefAlign;
