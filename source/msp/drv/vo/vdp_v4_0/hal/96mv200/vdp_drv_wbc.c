...
HI_S32 VDP_DRV_SetWbcZme(HI_U32 u32LayerId, VDP_DRV_WBC_ZME_INFO_S *pstZmeInfo)
{
    ...
    VDP_WBC_SetFirEnable           (u32LayerId, VDP_ZME_MODE_HORL, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirHL);
    VDP_WBC_SetFirEnable           (u32LayerId, VDP_ZME_MODE_HORC, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirHC);
    VDP_WBC_SetFirEnable           (u32LayerId, VDP_ZME_MODE_VERL, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirVL);
    VDP_WBC_SetFirEnable           (u32LayerId, VDP_ZME_MODE_VERC, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirVC);

    VDP_WBC_SetMidEnable           (u32LayerId, VDP_ZME_MODE_HOR,  pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeMedH);
    VDP_WBC_SetMidEnable           (u32LayerId, VDP_ZME_MODE_VER,  pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeMedV);
    ...
    VDP_WBC_SetZmePhase            ((VDP_LAYER_WBC_E)u32LayerId, VDP_ZME_MODE_HORL, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetHL);
    VDP_WBC_SetZmePhase            ((VDP_LAYER_WBC_E)u32LayerId, VDP_ZME_MODE_HORC, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetHC);
    VDP_WBC_SetZmePhase            ((VDP_LAYER_WBC_E)u32LayerId, VDP_ZME_MODE_VERL, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVL);
    VDP_WBC_SetZmePhase            ((VDP_LAYER_WBC_E)u32LayerId, VDP_ZME_MODE_VERC, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVC);
    VDP_WBC_SetZmePhase            ((VDP_LAYER_WBC_E)u32LayerId, VDP_ZME_MODE_VERBL, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVLBtm);
    VDP_WBC_SetZmePhase            ((VDP_LAYER_WBC_E)u32LayerId, VDP_ZME_MODE_VERBC, pstZmeInfo->stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVCBtm);

    if ((0 == u32Ration)
        || (0 == pstZmeInfo->stOutRect.u32Wth)
...
HI_S32 VDP_DRV_SetWbcLayer(HI_U32 u32LayerId, VDP_LAYER_WBC_INFO_S *pstInfo)
{
    ...
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirHL = pstInfo->bZmeFirHL;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirHC = pstInfo->bZmeFirHC;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirVL = pstInfo->bZmeFirVL;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirVC = pstInfo->bZmeFirVC;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeMedH  = pstInfo->bZmeMedH;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeMedV  = pstInfo->bZmeMedV;


    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetHL    = pstInfo->s32ZmeOffsetHL;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetHC    = pstInfo->s32ZmeOffsetHC;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVL    = pstInfo->s32ZmeOffsetVL;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVC    = pstInfo->s32ZmeOffsetVC;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVLBtm = pstInfo->s32ZmeOffsetVLBtm;
    stZmeInfo.stZmeDrvPara.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].stZmeOffset.s32ZmeOffsetVCBtm = pstInfo->s32ZmeOffsetVCBtm;
