...
HI_S32 scale_frequency_distance(HI_S32 frequency_distance[3][3], HI_S32 V_RES);
HI_S32 scale_symbols(HI_S32 symbol_scale_control, HI_S32 symbol_size, HI_S32 spacing_horz, HI_S32 spacing_vert, HI_S32 symbols_xpos, HI_S32 symbols_ypos, HI_S32 symbols_cols, HI_S32 symbols_rows, HI_S32 H_RES, HI_S32 V_RES);
...
#if  VDP_HDR_EN
HI_VOID VDP_FUNC_HdrComposerMdsParse(VDP_FIXPT_MAIN_CFG_S *comp_cfg, const char *file_metadata, HI_U32 frm_cnt);
HI_VOID VDP_FUNC_SetComposerMode(VDP_HDR_COMPOSER_CFG_E ComposerMode, VDP_FIXPT_MAIN_CFG_S *comp_cfg);
