...
HI_VOID VDP_DATE_SetSrcCoef(DISP_VENC_E eDate, HI_U32 *pu32Src13)
{
    ...
    else if (DISP_VENC_SDATE0 == eDate)
    {
        ...
        VDP_RegWrite((HI_ULONG) & (pVdpReg->DATE_COEFF56.u32), *pu32Src13tmp++);
        VDP_RegWrite((HI_ULONG) & (pVdpReg->DATE_COEFF57.u32), *pu32Src13tmp++);
        VDP_RegWrite((HI_ULONG) & (pVdpReg->DATE_COEFF58.u32), *pu32Src13tmp++);
        VDP_RegWrite((HI_ULONG) & (pVdpReg->DATE_COEFF59.u32), *pu32Src13tmp++);
    }
}
