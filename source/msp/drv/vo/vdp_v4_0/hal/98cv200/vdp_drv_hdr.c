...
extern HI_U32 gu32SdrToHdr10_PQ300[64];
extern HI_U32 gu32SdrTodolby_PQ600[64];
extern HI_U32 gu32SdrTodolby_PQ1000[64];
extern HI_U32 gu32Hdr10Todolby_PQ1000[64];

HI_S32 VDP_DRV_SetHdrMode(VDP_HDR_CFG_S *stHdrCfg, VDP_FIXPT_MAIN_CFG_S *pstCompCfg, DmKsFxp_t *pstDmKs)
{
    ...
    VDP_RECT_S stOutReso = {0}  ;
    VDP_RECT_S stVidReso = {0} ;
    VDP_RECT_S stDispReso = {0}  ;
    ...
    HI_BOOL bIsReduceZme = HI_FALSE;
    static VDP_DRV_ZME_INFO_S  stZmeInfo;
    if (HI_NULL == stHdrCfg || HI_NULL == pstCompCfg || HI_NULL == pstDmKs)
    {
    ...
    //DOVI YUV OUTPUT
    //----------------------------------------------------------------------
    if (stHdrCfg->enHdrMode >= VDP_HDR_CFG_MODE_BUTT)
    {
        VDP_PRINT("enHdrMode arange Error !!! \n");
        return HI_FAILURE;
    }
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_BC_IN_HDR10_OUT_CERT)
    {
        edr_ds_en            = 1;
        cvm_sel              = 1;
        edr_en               = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_BC_IN_HDR10_OUT)
    {
        edr_ds_en            = 0;
        cvm_sel              = 1;
        edr_en               = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_DOVI_NBC_IN_HDR10_OUT_CERT || stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_HDR10_OUT_CERT)
    {
        edr_ds_en            = 1;
        cvm_sel              = 1;
        edr_en               = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_HDR10_IN_HDR10_OUT_CERT || stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_HDR10_OUT_CERT)
    {
        bl_en                = 0;
        //el_en                = 0;
        composer_en          = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_HDR10_OUT)
    {
        bl_en                = 0;
        composer_en          = 0;
        cvm_sel              = 1;
    ...
    else if (stHdrCfg->enHdrMode ==  VDP_HDR_V2P3_SDR_IN_HDR10_OUT)
    {
        bl_en                = 0;
        composer_en          = 0;
        cvm_sel              = 0;
    ...
    else if (stHdrCfg->enHdrMode ==  VDP_HDR_V2P3_SDR_IN_HDR10_OUT_CERT)
    {
        bl_en                = 0;
        composer_en          = 0;
        cvm_sel    = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_DOVI_NBC_IN_HDR10_OUT || stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_HDR10_OUT)
    {
        edr_ds_en            = 0;
        cvm_sel              = 1;
        edr_en               = 1;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_BC_IN_SDR_OUT_CERT)
    {
        bl_en                = 1;//???
        edr_ds_en            = 1;
        edr_md_en            = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_BC_IN_SDR_OUT)
    {
        bl_en                = 1;//???
        edr_ds_en            = 0;
        edr_md_en            = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_SDR_OUT)
    {
        bl_en                = 1;//???
        edr_ds_en            = 0;
        edr_md_en            = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_SDR_OUT_CERT)
    {
        bl_en                = 1;//???
        edr_ds_en            = 1;
        edr_md_en            = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_HDR10_IN_SDR_OUT || stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_SDR_OUT)
    {
        bl_en                = 0;
        //el_en                = 0;
        composer_en          = 0;
    ...
    //----------------------------------------------------------------------
    else if (stHdrCfg->enHdrMode == VDP_HDR_HDR10_IN_SDR_OUT_CERT || stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_SDR_OUT_CERT)
    {
        bl_en                = 0;
        //el_en                = 0;
        composer_en          = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_DOLBY_OUT)
    {
        bl_en                = 0;
        composer_en          = 0;
        edr_md_en            = 1;
        edr_ds_en            = 1;
        cvm_sel              = 1;//gfx tonemapping ,video no use.
        cvm2_lms2ipt_en      = 1;
    }
    ...
    //IPT OUTPUT
    //----------------------------------------------------------------------
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_SDR_IN_DOLBY_OUT)
    {
        bl_en                = 0;
        composer_en          = 0;
        cvm_sel              = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_BC_IN_DOVI_IPT_OUT)
    {
        bl_en                = 1;//???
        //el_en                = 1;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_DOVI_IPT_OUT)
    {
        bl_en                = 1;//???
        //el_en                = 1;
    ...
    if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_SDR_IN_DOLBY_OUT)
    {
        //VDP_DRV_SetGdmgammaCoef(gu32SdrToHdr10_PQ300);
        VDP_DRV_SetGdmgammaCoef(gu32SdrTodolby_PQ600);//dolby
        //VDP_DRV_SetGdmgammaCoef(gu32SdrTodolby_PQ1000);//hdr10
    }
    else if (stHdrCfg->enHdrMode   == VDP_HDR_V2P3_SDR_IN_HDR10_OUT
             ||   stHdrCfg->enHdrMode   == VDP_HDR_V2P3_SDR_IN_HDR10_OUT_CERT
            )
    {
        VDP_DRV_SetGdmgammaCoef(gu32SdrTodolby_PQ1000);
    }
    //else if(stHdrCfg->enHdrMode   == VDP_HDR_V2P3_HDR10_IN_DOLBY_OUT)
    //{
    //    VDP_DRV_SetGdmgammaCoef(gu32Hdr10Todolby_PQ1000);
    // }
    else
    {
    ...
    //----------------------------------------------------------------------
    {
        ...
        if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_SDR_IN_HDR10_OUT)
        {
            VDP_DRV_SetGdmSdrToHdr10();

        }
        else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_SDR_IN_DOLBY_OUT )
        {
            VDP_DRV_SetGdmSdrToDolbyOut();
    ...
    //BL setting
    //----------------------------------------------------------------------
    VDP_VID_SetLayerEnable             (VDP_LAYER_VID0, !stHdrCfg->bMuteEn);
    ...
    if ((3840 <= stHdrCfg->stFmtResolution.u32Wth)
        && (2160 == stHdrCfg->stFmtResolution.u32Hgt)
        && (1920 < stHdrCfg->stVidReso.u32Wth)
        && (1080 < stHdrCfg->stVidReso.u32Hgt))
    {
        bIsReduceZme = HI_TRUE;
        VDP_VID_SetVtapReduce  (VDP_LAYER_VID0, HI_TRUE);
    }
    else
    {
        bIsReduceZme = HI_FALSE;
...
#if 1
    stZmeInfo.stInRect    = stHdrCfg->stVidReso;
    stZmeInfo.stOutRect   = stOutReso;
    stZmeInfo.stZme2InRect   = stOutReso;
    stZmeInfo.enInFmt     = stHdrCfg->enVdpBlVidIFmt;
    stZmeInfo.enReadMode  = VDP_RMODE_INTERFACE;
    stZmeInfo.enDispMode  = VDP_DISP_MODE_2D;
    stZmeInfo.enDrawMode  = stHdrCfg->enDrawMode;//VDP_DRAW_MODE_1;

    stZmeInfo.stFmtResolution.u32Wth = stHdrCfg->stFmtResolution.u32Wth;
    stZmeInfo.stFmtResolution.u32Hgt = stHdrCfg->stFmtResolution.u32Hgt;

    VDP_VID_SetDrawMode(VDP_LAYER_VID0, stHdrCfg->enDrawMode, stHdrCfg->enDrawMode);
    memcpy(&stZmeInfo.stZmeDrvPara, &stHdrCfg->stZmeDrvPara,  sizeof(VDP_VZME_DRV_PARA_S));
...
#else
    VDP_DRV_GetVidZmeStrategy(&stZmeInfo, &enRationHL, HI_PQ_ZME_COEF_TYPE_LH, stZmeInfo.enInFmt);
    VDP_DRV_GetVidZmeStrategy(&stZmeInfo, &enRationHC, HI_PQ_ZME_COEF_TYPE_CH, stZmeInfo.enInFmt);
    VDP_DRV_GetVidZmeStrategy(&stZmeInfo, &enRationVL, HI_PQ_ZME_COEF_TYPE_LV, stZmeInfo.enInFmt);
    VDP_DRV_GetVidZmeStrategy(&stZmeInfo, &enRationVC, HI_PQ_ZME_COEF_TYPE_CV, stZmeInfo.enInFmt);
#endif
    ...
    if (HI_NULL == gstVdpCoefBufAddr.pu8CoefVirAddr[VDP_COEF_BUF_ZMEH]
    ...
    if (HI_TRUE == bIsReduceZme)
    {
        DRV_PQ_GetVdpZmeCoef(enRationVL, HI_PQ_ZME_COEF_TYPE_LV, HI_PQ_ZME_TAP_5T32P, (HI_S16 *)(gstVdpCoefBufAddr.pu8CoefVirAddr[VDP_COEF_BUF_ZME_TMP]));
        ...
        DRV_PQ_GetVdpZmeCoef(enRationVC, HI_PQ_ZME_COEF_TYPE_CV, HI_PQ_ZME_TAP_3T32P, (HI_S16 *)(gstVdpCoefBufAddr.pu8CoefVirAddr[VDP_COEF_BUF_ZME_TMP]));
    ...
    VDP_VID_Set16RegionSmmuLumBypass (VDP_LAYER_VID0, 1, !stHdrCfg->bSmmuEn);
    VDP_VID_Set16RegionSmmuChromBypass (VDP_LAYER_VID0, 1, !stHdrCfg->bSmmuEn);
    ...
    if ((stHdrCfg->stVidReso.u32Wth != stOutReso.u32Wth) || (stHdrCfg->stVidReso.u32Hgt != stOutReso.u32Hgt))
    {
        ...
        VDP_VID_SetZmeHorRatio         (VDP_LAYER_VID0, (stHdrCfg->stVidReso.u32Wth / 2 * ZME_HPREC) / stOutReso.u32Wth * 2);
    ...
    VDP_VP_SetLayerGalpha          (VDP_LAYER_VP0, stHdrCfg->u32AllAlpha);
    ...
    if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_HDR10_OUT_CERT)
    {
        csc_offset[0] = 0;
        csc_offset[1] = 0;
        csc_offset[2] = 0;
        ...
        csc_offset[0] = pstDmKs->ksIMap.v3Yuv2RgbOffInRgb[0] * 4;
        csc_offset[1] = pstDmKs->ksIMap.v3Yuv2RgbOffInRgb[1] * 4;
        csc_offset[2] = pstDmKs->ksIMap.v3Yuv2RgbOffInRgb[2] * 4;

        VDP_HDR_SetVDmInBits                 ( 1 );//14bit
        VDP_VID_SetComposeElUpsampleMax      ( 16383 );
        VDP_VID_SetComposeElUpsampleMin      ( 0 );
        VDP_HDR_SetVDmImapYuv2rgbOutDc0      ( csc_offset );
        VDP_HDR_SetVDmImapRange              ( pstDmKs->ksIMap.eotfParam.range * 4 );

    }
    if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_HDR10_OUT
        || stHdrCfg->enHdrMode == VDP_HDR_V2P3_SDR_IN_HDR10_OUT
        || stHdrCfg->enHdrMode == VDP_HDR_V2P3_SDR_IN_HDR10_OUT_CERT)
    {
        csc_offset[0] = 0;
        csc_offset[1] = 0;
        ...
        //for FPGA test
        //----------------------------------------------------------------------
        csc_offset[0] = pstDmKs->ksOMap.v3Rgb2YuvOff[0] * 1;
        csc_offset[1] = pstDmKs->ksOMap.v3Rgb2YuvOff[1] * 1;
        csc_offset[2] = pstDmKs->ksOMap.v3Rgb2YuvOff[2] * 1;

        VDP_HDR_SetVCvmOmapRgb2yuvOutDc      ( csc_offset );
        VDP_HDR_SetCvmOutBits                ( 2 );
    }

    if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_BC_IN_HDR10_OUT)
    {
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_HDR10_OUT)
    {
        ...
        csc_offset[2] = 0;
        VDP_HDR_SetVDmImapYuv2rgbOutDc0      ( csc_offset );
        VDP_HDR_SetVDmImapYuv2rgbscale2p     ( 12 ) ;//shift = scale2p - 4
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_SDR_OUT || stHdrCfg->enHdrMode == VDP_HDR_V2P3_HDR10_IN_SDR_OUT_CERT)
    {
        csc_offset[0] = pstDmKs->ksIMap.v3Yuv2RgbOffInRgb[0] * 4;
        csc_offset[1] = pstDmKs->ksIMap.v3Yuv2RgbOffInRgb[1] * 4;
        csc_offset[2] = pstDmKs->ksIMap.v3Yuv2RgbOffInRgb[2] * 4;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_HDR10_OUT_CERT)
    {
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_DOVI_BC_IN_SDR_OUT)
    {
        ...
        VDP_HDR_SetVCvmImapLms2iptOutDc      ( csc_offset );
             ...
             || (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_BC_IN_SDR_OUT)
             || (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_SDR_OUT)
             || (stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_SDR_OUT_CERT)
            )
    {
        csc_offset[0] = 0;
        csc_offset[1] = 0;
    ...
    else if (stHdrCfg->enHdrMode == VDP_HDR_V2P3_SDR_IN_DOLBY_OUT)
    {
        ...
        VDP_HDR_SetCvmOutBits                ( 2 );
             ...
             ||  stHdrCfg->enHdrMode == VDP_HDR_V2P3_DOVI_NBC_IN_DOVI_IPT_OUT)
    {
        csc_offset[0] = 0;
        csc_offset[1] = 0;
        csc_offset[2] = 0;
...
HI_VOID VDP_DRV_SetGdmSdrToDolbyOut(HI_VOID)
{
    ...
    g_rgb2yuv_en = 1;//stCfg -> g_rgb2yuv_en;
    {
        ...
        g_imap_rgb2lms[0][0] = 9989; ;
        g_imap_rgb2lms[0][1] = 20686; ;
        g_imap_rgb2lms[0][2] = 2091; ;
        g_imap_rgb2lms[1][0] = 5103; ;
        g_imap_rgb2lms[1][1] = 24333; ;
        g_imap_rgb2lms[1][2] = 3329; ;
        g_imap_rgb2lms[2][0] = 865; ;
        g_imap_rgb2lms[2][1] = 4358; ;
        g_imap_rgb2lms[2][2] = 27543; ;
        g_imap_rgb2lmsscale2p = 15;
        g_imap_rgb2lmsmin = 0;
        g_imap_rgb2lmsmax = 26214400;
        g_imap_rgb2lms_out_dc[0] = 0;
        g_imap_rgb2lms_out_dc[1] = 0;
        g_imap_rgb2lms_out_dc[2] = 0;


        VDP_HDR_SetGCvmLms2IptMin(0);
        VDP_HDR_SetGCvmLms2IptMax(32767);

        g_omap_rgb2yuv[0][0] = 1638;
        g_omap_rgb2yuv[0][1] = 1638;
        g_omap_rgb2yuv[0][2] = 819;
        g_omap_rgb2yuv[1][0] = 18248;
        g_omap_rgb2yuv[1][1] = -19870;
        g_omap_rgb2yuv[1][2] = 1622;
        g_omap_rgb2yuv[2][0] = 3300;
        g_omap_rgb2yuv[2][1] = 1463;
        g_omap_rgb2yuv[2][2] = -4763;
        g_omap_rgb2yuvscale2p = 12;
        g_omap_rgb2yuv_out_dc[0] = 0;
        g_omap_rgb2yuv_out_dc[1] = 0;
        g_omap_rgb2yuv_out_dc[2] = 0;
    }
