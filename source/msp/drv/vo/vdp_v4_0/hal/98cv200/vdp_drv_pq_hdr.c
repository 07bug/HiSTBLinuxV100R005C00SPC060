...
#endif
#if 1 //20160105
HI_U32  gu32SdrToHdr10_PQ300 [64] =
{
    0    ,
    6921 ,
    8898 ,
...
HI_U32 gu32Hdr10Todolby_PQ1000 [64] =
{
    496  ,
    8258 ,
    10422,
...
HI_U32 gu32SdrTodolby_PQ1000 [64] =
{
    595  ,
    7798 ,
    9869 ,
...
HI_U32 gu32SdrTodolby_PQ600 [64] =
{
    397  ,
    7594 ,
    9659 ,
...
HI_S32 VDP_DRV_SetDmCvmCoef(HI_S16 *ptmLutI, HI_S16 *ptmLutS, HI_S16 *psmLutI, HI_S16 *psmLutS)
{
    ...
    if (HI_NULL == ptmLutI
        ...
        || HI_NULL == addr)
    {
        VDP_PRINT("PTR of VDP_DRV_SetDmCvmCoef is HI_NULL  please check it !!! \n");
        return HI_FAILURE;
    }
...
HI_VOID VDP_DRV_SetDmDegammaCoef (DmKsFxp_t *pKs)
{
    ...
    if (HI_NULL == input_addr
        || HI_NULL == output_addr)
    {
        VDP_PRINT("PTR of VDP_DRV_SetDmDegammaCoef is HI_NULL  please check it !!! \n");
        return ;
    }
...
HI_VOID VDP_DRV_SetDmgammaCoef(DmKsFxp_t *pKs)
{
    ...
    if (HI_NULL == input_addr
        || HI_NULL == output_addr)
    {
        VDP_PRINT("PTR of VDP_DRV_SetDmgammaCoef is HI_NULL  please check it !!! \n");
        return ;
    }
...
#endif
    if (HI_NULL == addr
        || HI_NULL == u32GdmGammaCoef)
    {
        VDP_PRINT("PTR of VDP_DRV_SetGdmgammaCoef is HI_NULL  please check it !!! \n");
        return ;
    }
...
#endif
    if (HI_NULL == addr
        || HI_NULL == u32GdmDeGammaCoef)
    {
        VDP_PRINT("PTR of VDP_DRV_SetGdmDegammaCoef is HI_NULL  please check it !!! \n");
        return ;
    }
