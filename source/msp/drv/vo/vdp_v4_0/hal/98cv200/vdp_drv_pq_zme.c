...
const HI_S16 coefficient8_cubic[18][8] = {{ 0,  0, 0, 511,   0,   0,  0,  0}, { -1,  3, -12, 511,  14, -4,  1,  0},
    ...
    { -4, 18, -69, 348, 265, -59, 16, -3}, { -4, 18, -67, 329, 286, -63, 16, -3}, { -3, 17, -65, 307, 307, -65, 17, -3}, {0, 0, 0, 0, 0, 0, 0, 0}
};//normalized ok
...
const HI_S16 coefficient8_lanczos2_8tap[18][8] = {{ -16, 0, 145, 254, 145, 0, -16, 0}, { -16, -2, 140, 253, 151, 3, -17, 0},
    ...
    { -6, -21, 69, 230, 215, 50, -22, -3}, { -5, -21, 65, 226, 219, 55, -22, -5}, { -5, -21, 60, 222, 222, 60, -21, -5}, {0, 0, 0, 0, 0, 0, 0, 0}
};//normalized ok
...
const HI_S16 coefficient6_cubic[18][6] = {{0, 0, 511, 0, 0, 0}, {3, -12, 511, 13, -3, 0}, {6, -22, 507, 28, -7, 0},
    ...
    {13, -66, 328, 286, -61, 12}, {13, -63, 306, 306, -63, 13}, {0, 0, 0, 0, 0, 0}
};//normalized ok
#endif
...
const HI_S16 coefficient8_3M_a19[18][8] = {{ -18, 18, 144, 226, 144, 19, -17, -4}, { -17, 16, 139, 226, 148, 21, -17, -4},
    ...
    { -13, -9, 83, 210, 198, 66, -13, -10}, { -12, -10, 79, 207, 201, 70, -12, -11}, { -12, -11, 74, 205, 205, 74, -11, -12}, {0, 0, 0, 0, 0, 0, 0, 0}
};//normalized ok
//1.944M
...
const HI_S16 coefficient6_6M_a25[18][6] = {{ -34, 78, 415, 78, -34, 9}, { -32, 66, 415, 90, -36, 9},
    ...
    { -1, -36, 322, 269, -46, 4}, {0, -39, 309, 283, -44, 3}, {2, -42, 296, 296, -42, 2}, {0, 0, 0, 0, 0, 0}
};//normalized ok
#endif
/*
...
const HI_S16 coefficient6_5M_a25[18][6] = {{ -31, 104, 362, 104, -31, 4}, { -30, 94, 362, 114, -32, 4},
    ...
    { -11, -4, 295, 257, -19, -6}, { -10, -8, 286, 267, -16, -7}, { -9, -12, 277, 277, -12, -9}, {0, 0, 0, 0, 0, 0}
};//normalized ok
//3.216M
const HI_S16 coefficient6_4M_a20[18][6] = {{ -20, 130, 297, 130, -20, -5}, { -21, 122, 298, 138, -19, -6},
    ...
    { -21, 37, 261, 236, 17, -18}, { -21, 32, 255, 242, 22, -18}, { -20, 27, 249, 249, 27, -20}, {0, 0, 0, 0, 0, 0}
};//normalized ok
//2.16M
...
{
#if  0
    //VOU_ZOOM_TAP_8LH,           VOU_ZOOM_TAP_6LV,           VOU_ZOOM_TAP_4CH,         VOU_ZOOM_TAP_4CV,   VOU_ZOOM_TAP_2CV,
    {&coefficient_lanczos3[0][0], &coefficient6_6M_a25[0][0],  &coefficient4_5M_a15[0][0],  &coefficient4_5M_a15[0][0], &coefficient2_6M_1_3[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0]}, //>1
    {&coefficient8_cubic[0][0], &coefficient6_cubic[0][0], &coefficient4_cubic[0][0], &coefficient4_cubic[0][0],  &coefficient2_cubic[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0]},  //==1
    {&coefficient8_lanczos2_8tap[0][0], &coefficient6_5M_a25[0][0], &coefficient4_5M_a15[0][0], &coefficient4_5M_a15[0][0], &coefficient2_5M[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0]},//>=0.75
    {&coefficient8_lanczos2_8tap[0][0], &coefficient6_4M_a20[0][0], &coefficient4_5M_a15[0][0], &coefficient4_5M_a15[0][0], &coefficient2_5M_1_0[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0]}, //>=0.5
    {&coefficient8_3M_a19[0][0], &coefficient6_3M_a15[0][0], &coefficient4_4M_a15[0][0], &coefficient4_4M_a15[0][0], &coefficient2_4M_0_1[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0]},           //>=0.33
    {&coefficient8_3M_a19[0][0], &coefficient6_3M_a15[0][0], &coefficient4_4M_a15[0][0], &coefficient4_4M_a15[0][0], &coefficient2_4M_0_1[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0]},           //>=0.25
    {&coefficient8_3M_a19[0][0], &coefficient6_3M_a15[0][0], &coefficient4_4M_a15[0][0], &coefficient4_4M_a15[0][0], &coefficient2_4M_0_1[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0], &s32Coeff_guass2_6M_2_5[0][0]}           //else
#endif
...
HI_S32 VDP_GetVdpZmeCoef(HI_PQ_ZME_COEF_RATIO_E enCoefRatio, HI_PQ_ZME_COEF_TYPE_E enCoefType, HI_PQ_ZME_TAP_E enZmeTap, HI_S16 *ps16Coef)
{
    if ( enCoefType == HI_PQ_ZME_COEF_TYPE_LH)
    {
        ...
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_8LH], sizeof(HI_S16) * 8 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_075)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_8LH], sizeof(HI_S16) * 8 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_05)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_8LH], sizeof(HI_S16) * 8 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_033)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_8LH], sizeof(HI_S16) * 8 * 18);

        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_025)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_8LH], sizeof(HI_S16) * 8 * 18);
    ...
    else if (enCoefType == HI_PQ_ZME_COEF_TYPE_LV)
    {
        ...
        if (HI_PQ_ZME_TAP_5T32P == enZmeTap)
        {

            if (enCoefRatio == HI_PQ_ZME_COEF_1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_1][VDP_ZOOM_TAP_5LV], sizeof(HI_S16) * 5 * 18);

            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_E1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_5LV], sizeof(HI_S16) * 5 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_075)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_5LV], sizeof(HI_S16) * 5 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_05)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_5LV], sizeof(HI_S16) * 5 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_033)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_5LV], sizeof(HI_S16) * 5 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_025)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_5LV], sizeof(HI_S16) * 5 * 18);
            }
        }
        else
        {
            if (enCoefRatio == HI_PQ_ZME_COEF_1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_1][VDP_ZOOM_TAP_6LV], sizeof(HI_S16) * 6 * 18);

            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_E1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_6LV], sizeof(HI_S16) * 6 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_075)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_6LV], sizeof(HI_S16) * 6 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_05)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_6LV], sizeof(HI_S16) * 6 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_033)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_6LV], sizeof(HI_S16) * 6 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_025)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_6LV], sizeof(HI_S16) * 6 * 18);
            }
        }
    ...
    else if (enCoefType == HI_PQ_ZME_COEF_TYPE_CH)
    {
        if (enCoefRatio == HI_PQ_ZME_COEF_1)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_1][VDP_ZOOM_TAP_4CH], sizeof(HI_S16) * 4 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_E1)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_4CH], sizeof(HI_S16) * 4 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_075)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_4CH], sizeof(HI_S16) * 4 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_05)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_4CH], sizeof(HI_S16) * 4 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_033)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_4CH], sizeof(HI_S16) * 4 * 18);
        }
        else if (enCoefRatio == HI_PQ_ZME_COEF_025)
        {
            memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_4CH], sizeof(HI_S16) * 4 * 18);
        }

    }
    else if (enCoefType == HI_PQ_ZME_COEF_TYPE_CV)
    {
        if (HI_PQ_ZME_TAP_3T32P == enZmeTap)
        {
            if (enCoefRatio == HI_PQ_ZME_COEF_1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_1][VDP_ZOOM_TAP_3CV], sizeof(HI_S16) * 3 * 18);

            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_E1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_3CV], sizeof(HI_S16) * 3 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_075)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_3CV], sizeof(HI_S16) * 3 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_05)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_3CV], sizeof(HI_S16) * 3 * 18);

            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_033)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_3CV], sizeof(HI_S16) * 3 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_025)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_3CV], sizeof(HI_S16) * 3 * 18);
            }
        }
        else
        {
            ...
            if (enCoefRatio == HI_PQ_ZME_COEF_1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_1][VDP_ZOOM_TAP_4CV], sizeof(HI_S16) * 4 * 18);

            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_E1)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_4CV], sizeof(HI_S16) * 4 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_075)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_4CV], sizeof(HI_S16) * 4 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_05)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_4CV], sizeof(HI_S16) * 4 * 18);

            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_033)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_4CV], sizeof(HI_S16) * 4 * 18);
            }
            else if (enCoefRatio == HI_PQ_ZME_COEF_025)
            {
                memcpy((HI_VOID *)ps16Coef, (HI_VOID *)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_4CV], sizeof(HI_S16) * 4 * 18);
            }
        }
    }
...
HI_VOID DRV_PQ_SetVdpZmeCoef(VDP_ZOOM_TAP_E enVdpZoomTap, HI_PQ_ZME_COEF_TYPE_E enCoefType, HI_U8  *VirAddr, HI_U8 *ps32Coef)
{
    ...
    HI_S16 s16VlCoef[18][6] ;
    HI_S16 s16VcCoef[18][4] ;
    HI_S16 *ps16CoefTmp = (HI_S16 *)ps32Coef;
    HI_U32 i = 0;
    HI_U32 j = 0;
    HI_S16 S16ValueTmpForReduceTap = 0;
    pCurAddr = VirAddr;
    //ps32Coef = (HI_S32 *)VirAddrTmp;
    memset((HI_VOID * )s16VlCoef, 0, sizeof(s16VlCoef));
    memset((HI_VOID * )s16VcCoef, 0, sizeof(s16VcCoef));
    ...
    {
        if (VDP_ZOOM_TAP_5LV == enVdpZoomTap)
        {
            ...
            for (j = 0; j < 18; j++)
            {
                for (i = 0; i < 6; i++)
                {
                    ...
                    {
                        S16ValueTmpForReduceTap = *ps16CoefTmp;
                        ps16CoefTmp ++;
                        s16VlCoef[j][i] =  S16ValueTmpForReduceTap ;
            ...
            DRV_VDP_LoadZoomCoefVH((HI_U8 *)s16VlCoef, VDP_ZOOM_TAP_6LV, pCurAddr);
    ...
    else if (enCoefType == HI_PQ_ZME_COEF_TYPE_CV)
    {
        ...
        if (VDP_ZOOM_TAP_3CV == enVdpZoomTap)
        {
            ...
            for (j = 0; j < 18; j++)
            {
                for (i = 0; i < 4; i++)
                {
                    ...
                    else
                    {
                        S16ValueTmpForReduceTap = *ps16CoefTmp;
                        ps16CoefTmp ++;
                        s16VcCoef[j][i] =  S16ValueTmpForReduceTap ;
                    }
            ...
            DRV_VDP_LoadZoomCoefVC((HI_U8 *)s16VcCoef, VDP_ZOOM_TAP_4CV, pCurAddr);
