...
HI_BOOL Internal_GetVidZmeOutFormatBasedOnP2IState(HI_U32 u32LayerNO, HI_BOOL bP2IOpen)
{
...
HI_S32 CBB_Video_SetLayerParam(CBB_LAYER_CFG_INFO_S *pLayerCfgBasePara, CBB_CFG_EXT_S *pVDPCfgExtPara)
{
    ...
    if (!pLayerCfgBasePara->bMuteEn && pLayerCfgBasePara->bRegionEn)
    {
            ...
            || (pLayerCfgBasePara->u32LayerNO == VDP_LAYER_VID1))
        {
            ...
            {
                stVidInfo.stZme2InRect.u32Wth  =    pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInWidth;
                stVidInfo.stZme2InRect.u32Hgt  =    pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME2].u32FrmInHeight;
            }
            else
            {
        ...
        stVidInfo.stZmeDrvPara.bZmeFirHL   = pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirHL;
        stVidInfo.stZmeDrvPara.bZmeFirHC   = pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirHC;
        stVidInfo.stZmeDrvPara.bZmeFirVL   = pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirVL;
        stVidInfo.stZmeDrvPara.bZmeFirVC   = pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeFirVC;
        stVidInfo.stZmeDrvPara.bZmeMedH    = pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeMedH;
        stVidInfo.stZmeDrvPara.bZmeMedV    = pstZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].bZmeMedV;
        stVidInfo.stZmeDrvPara.bZmeDefault = pstZmeOut.stStrategyLayerId.bZmeDefault;

        stVidInfo.stZmeDrvPara.bZmeFrmFmtIn  = pstZmeOut.stStrategyLayerId.bReadFmtIn;
        stVidInfo.stZmeDrvPara.bZmeFrmFmtOut = Internal_GetVidZmeOutFormatBasedOnP2IState(pLayerCfgBasePara->u32LayerNO, HI_TRUE);
            ...
            || (pLayerCfgBasePara->u32LayerNO ==  VDP_LAYER_VID1))
        {
            ...
            stVidInfo.stZmeDrvPara.bZmeBFOut       = !bBtm;
            stVidInfo.stZmeDrvPara.bZmeBFIn        = !bBtm;
        }
        else
        {
            stVidInfo.stZmeDrvPara.bZmeBFOut       = HI_FALSE;
            stVidInfo.stZmeDrvPara.bZmeBFIn        = pstZmeOut.stStrategyLayerId.bReadBFIn;
        }
    ...
    {
        stVidInfo.stZmeDrvPara.bZmeFrmFmtIn     = HI_TRUE;
        stVidInfo.stZmeDrvPara.bZmeFrmFmtOut   = HI_TRUE;
        stVidInfo.stZmeDrvPara.bZmeBFOut        = HI_FALSE;
        stVidInfo.stZmeDrvPara.bZmeBFIn         = HI_FALSE;
        stVidInfo.stZme2InRect.u32Wth  =    0;
        stVidInfo.stZme2InRect.u32Hgt  =    0;
...
HI_S32 CBB_Video_SetWbcParam(CBB_WBC_CFG_INFO_S *pLayerCfgBasePara, CBB_CFG_EXT_S *pVDPCfgExtPara)
{
    ...
    if (pLayerCfgBasePara->enWBC == DRV_VDP_WBC_WIN)
    {
        if (pLayerCfgBasePara->bWbcEnable == HI_TRUE)
        {
            ...
            stWbcInfo.bZmeFrmFmtIn  = unionZmeOut.stStrategyWbcVp.stZmeFmt.bInFmt;
            stWbcInfo.bZmeFrmFmtOut = unionZmeOut.stStrategyWbcVp.stZmeFmt.bOutFmt;
...
#if 0
            VDP_PRINT("----Wbc Config:%d,%d,%d,%d,%d!\n", unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmInWidth,
                      unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmInHeight,
                      unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmOutWidth,
                      unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmOutHeight,
                      unionZmeOut.stStrategyWbcVp.enVpPoint);

            VDP_PRINT("Wbc Strategy:%d,%d,%d,%d!\n", unionZmeOut.stStrategyWbcVp.bReadFmtIn,
                      unionZmeOut.stStrategyWbcVp.stZmeFmt.bOutFmt,
                      bBtm,
