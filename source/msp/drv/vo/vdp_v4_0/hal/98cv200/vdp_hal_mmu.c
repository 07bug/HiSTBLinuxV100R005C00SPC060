...
HI_VOID VDP_SMMU_SetIntsTlbinvalidMsk(HI_U32 u32Msk)
{
    ...
    SMMU_INTMASK_S.bits.ints_tlbinvalid_msk = u32Msk;
...
HI_VOID VDP_SMMU_SetIntsTlbinvalidClr(HI_U32 u32Clear)
{
    ...
    SMMU_INTCLR_S.bits.ints_tlbinvalid_clr = u32Clear;
...
HI_VOID VDP_SMMU_SetIntnsTlbinvalidMsk(HI_U32 u32Msk)
{
    ...
    SMMU_INTMASK_NS.bits.intns_tlbinvalid_msk = u32Msk;
...
HI_VOID VDP_SMMU_SetIntnsTlbinvalidClr(HI_U32 u32Clear)
{
    ...
    SMMU_INTCLR_NS.bits.intns_tlbinvalid_clr = u32Clear;
...
HI_VOID VDP_SMMU_SetErrRdAddr(HI_U32 u32Addr)
{
    ...
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->SMMU_ERR_RDADDR.u32)), u32Addr);
...
HI_VOID VDP_SMMU_SetErrWrAddr(HI_U32 u32Addr)
{
    ...
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->SMMU_ERR_WRADDR.u32)), u32Addr);
...
HI_BOOL VDP_SMMU_GetIntsTlbinvalidSta(HI_VOID)
{
    ...
    return SMMU_INTSTAT_S.bits.ints_tlbinvalid_stat;
}
