...
#if (!defined CHIP_TYPE_hi3798mv300) && (!defined HI_VDP_VER_YDJC)

//#ifndef CHIP_TYPE_hi3798mv300
...
static DISP_FMT_CFG_S s_stDispFormatParam[] =
{
    ...
    {   {0,   0,   0,   240,  18,  4,   720, 119, 19,     240,  19,  4, 62 /*124*/, 3,  310, 0, 1,  1},/* 480I(NTSC) */
        DISP_CLOCK_SOURCE_SD0,
        {0x12000000, 0x0001048}, // 1080i50
        {HI_DRV_DISP_FMT_NTSC,    DISP_STEREO_NONE, HI_TRUE,  {0, 0, 720, 480} , {0, 0, 720, 480} , {4, 3},  5994, HI_DRV_CS_BT601_YUV_LIMITED},
    },
#else
    ...
    {   {1,   1,   2,   600,  27,  1,   800, 216, 40,       1,   1,  1,    128, 4, 1, 0,  0,  0}, /* 800*600@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11000000, 0x00030a0}, /* 800*600@60Hz */
        {HI_DRV_DISP_FMT_VESA_800X600_60,    DISP_STEREO_NONE, HI_FALSE,  {0, 0, 800, 600} ,  {0, 0, 800, 600}, {16, 9},  6000, HI_DRV_CS_BT709_RGB_FULL}
    },
    // 16
    {   {1,   1,   2,   768,  35,  3,  1024, 296, 24,      1,   1,  1,    136, 6, 1,  0,  1,  1}, /* 1024x768@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11000000, 0x0003082}, /* 1024x768@60Hz */
    ...
    {   {1,   1,   2,   720,  25,  5,  1280, 260, 110,  1,     1,   1,  40, 5,  1, 0,  0,  0}, /* 1280x720@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /* 1280x720@60Hz */
    ...
    {   {1,   1,   2,   800,  28,  3,  1280, 328, 72,  1,     1,   1,      128, 6, 1, 0,  0,  0}, /* 1280x800@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11000000, 0x00030a7}, /* 1280x800@60Hz */
    ...
    {   {1,   1,   2,  1024,  41,  1,  1280, 360, 48,  1,     1,   1,     112, 3, 1,  0,  0,  0}, /* 1280x1024@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001048}, /* 1280x1024@60Hz */
    ...
    {   {1,   1,   2,   768,  24,  3,  1360, 368, 64,  1,     1,   1,    112, 6,  1,  0,  0,  0}, /* 1360x768@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11000000, 0x000030ab}, /* 1360x768@60Hz */
    ...
    {   {1,   1,   2,   768,  27,  3,  1366, 356, 70,  1,     1,   1,      143, 3, 1, 0,  0,  0}, /* 1366x768@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11000000, 0x000030ab}, /* 1366X768@60Hz */
    ...
    {   {1,   1,   2,  1050,  36,  3,  1400, 376, 88,  1,     1,   1,    144, 4,  1,  0,  0,  0}, /* 1400x1050@60Hz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11C042C0, 0x00003079}, /* 1400x1050@60Hz */
    ...
    // 24
    {   {1,   1,   2,   900,  31,  3,  1440, 384, 80,    1,   1,  1,    152, 6,   1,  0,  1,  0}, /* 1440x900@60Hz_RB@106.5MHz */
        DISP_CLOCK_SOURCE_HD0,
        {0x1181B320, 0x0000306a}, /* 1440x900@60Hz_RB@88.75MHz */
        {HI_DRV_DISP_FMT_VESA_1440X900_60,    DISP_STEREO_NONE, HI_FALSE,  {0, 0, 1440, 900} ,  {0, 0, 1440, 900}, {16, 9},  6000, HI_DRV_CS_BT709_RGB_FULL}
    },

    // 23
    {   {1,   1,   2,   900,  23,  3,  1440, 112, 48,     1,   1,  1,    32, 6,   1, 0,  0,  1}, /* 1440x900@60Hz@88.75MHz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11557300, 0x00002076},/* 1440x900@60Hz@106.5MHz */
    ...
    {   {1,   1,   2,   900,  23,  3,  1600, 112, 48,    1,   1,  1,    32, 5,   1,  0,  0,  0}, /* 1600x900@60Hz_RB@97.750 MHz  */
        DISP_CLOCK_SOURCE_HD0,
        {0x11557300, 0x00002082}, /* 1600x900@60Hz_RB@97.750 MHz  */
    ...
    {   {1,   1,   2,   1200, 49,  1, 1600, 496, 64,       1,   1,  1,     192, 3, 1, 0,  0,  0}, /* 1600*12000@60Hz@162.000 MHz  */
        DISP_CLOCK_SOURCE_HD0,
        {0x11000000, 0x00001036}, /* 1600*12000@60Hz@162.000 MHz  */
    ...
    {   {1,   1,   2,  1050,  36,  3,  1680, 456, 104,  1,     1,   1,   176, 6,   1,  0,  0,  0}, /* 1680x1050@60Hz@119.000 MHz  */
        DISP_CLOCK_SOURCE_HD0,
        {0x11400e70, 0x00003092}, /* 1680x1050@60Hz@119.000 MHz  */
    ...
    {   {1,   1,   2,  1050,  36,  3,  1680, 456, 104,  1,     1,   1,   176, 6,   1,  0,  0,  0}, /* 1680x1050@60Hz@119.000 MHz  */
        DISP_CLOCK_SOURCE_HD0,
        {0x11557300, 0x0000204f}, /* 1680x1050@60Hz@119.000 MHz  */
    ...
    {   {1,   1,   2,  1080,  41,  4,  1920, 192, 88,  1,     1,   1,       44, 5, 1, 0,  0,  0}, /* 1920x1080@60Hz@148.500 MHz  */
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /* 1920x1080@60Hz@148.500 MHz  */
    ...
    // 30
    {   {1,   1,   2,  1200,  42,  3,  1920, 536, 136,  1,     1,   1,      200, 6, 1,  0,  1,  0}, /* 1920x1200@60Hz@154.000 MHz */
        DISP_CLOCK_SOURCE_HD0,
        {0x114002B8, 0x000030C1}, /* 1920x1200@60Hz@154.000 MHz */
    ...
    {   {1,     1,         2,  1440,  59,      1,  1920,       552,      128,        1,             1,         1,        208,           3,      1,  0,     0,  0}, /*  1920x1440@60Hz 234MHz */
        DISP_CLOCK_SOURCE_HD0,
        {0x11000000, 0x0003075}, /*  1920x1440@60Hz 234MHz */
    ...
    // 32
    {   {1,   1,   2,  1152,  30,  3,  2048, 112, 48,  1,     1,   1,     32, 5,  1,  0,  0,  1}, /* 2048X1152@60Hz@156.750 MHz  */
        DISP_CLOCK_SOURCE_HD0,
        {0x11800000, 0x00002068}, /* 2048X1152@60Hz@156.750 MHz  */
    ...
    // 33       /*not support*/
    {
        ...
        DISP_CLOCK_SOURCE_HD0,
        {0x11D978D5, 0x00003078}, /*  2560x1440@60Hz@241.5MHz RB */
    ...
    // 34       /*not support*/
    {   {1,     1,         2,  1600,  43,      3,  2560,       112,       48,          1,             1,         1,           32,            6,   1,  0,     0,  1}, /*  2560x1600@60Hz@268.5MHz RB */

        DISP_CLOCK_SOURCE_HD0,
        {0x11401640, 0x00003086}, /*  2560x1600@60Hz@268.5MHz RB */
    ...
    {   {1,     1,   2,  2160,  82,  8,  3840, 384, 1056,      1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /*  3840x2160@50Hz@594.000MHz  */
    ...
    {   {1,  1,   2,  2160,  82,  8,  3840, 384, 176,       1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12e6ae6a, 0x001062}, /*  3840x2160@60Hz@594.000MHz  */
        {HI_DRV_DISP_FMT_3840X2160_60, DISP_STEREO_NONE, HI_FALSE, {0, 0, 3840, 2160}, {0, 0, 3840, 2160}, {16, 9}, 5994, HI_DRV_CS_BT709_YUV_LIMITED}
    },
    ...
    {   {1,  1,   2,  2160,  82,  8,  4096, 384, 1020,       1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /*  4096x2160@24Hz@297.000MHz  */
    ...
    {   {1,  1,   2,  2160,  82,  8,  4096, 216, 968,        1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /*  4096x2160@25Hz@297.000MHz  */
    ...
    {   {1,   1,   2,  2160,  82,  8,  4096, 216, 88,       1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /*  4096x2160@30Hz@297.000MHz  */
        {HI_DRV_DISP_FMT_4096X2160_30, DISP_STEREO_NONE, HI_FALSE, {0, 0, 4096, 2160}, {0, 0, 4096, 2160}, {16, 9}, 3000, HI_DRV_CS_BT709_YUV_LIMITED}
    },
    //49 4096x2160@50Hz,
    {   {1,  1,   2,  2160,  82,  8,  4096, 216, 968,        1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12000000, 0x0001063}, /*  4096x2160@50Hz@594.000MHz  */
        {HI_DRV_DISP_FMT_4096X2160_50, DISP_STEREO_NONE, HI_FALSE, {0, 0, 4096, 2160}, {0, 0, 4096, 2160}, {16, 9}, 5000, HI_DRV_CS_BT709_YUV_LIMITED}
    },
    //50 4096x2160@60Hz,
    {   {1,  1,   2,  2160,  82,  8,  4096, 216, 88,         1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x12e6ae6a, 0x001062}, /*  4096x2160@60Hz@594.000MHz  */
        {HI_DRV_DISP_FMT_4096X2160_60, DISP_STEREO_NONE, HI_FALSE, {0, 0, 4096, 2160}, {0, 0, 4096, 2160}, {16, 9}, 5994, HI_DRV_CS_BT709_YUV_LIMITED}
    },
...
static DISP_FMT_CFG_S s_stDispFormatParam[] =
{
    ...
    {   {1,   1,   2,  1080,  41,  4,  1920, 192, 88,      1,   1,  1,     44, 5, 1,  0,  0,  0}, /* 1080P@60Hz */
        //{0x14000000, 0x02002063}, // 1080P60/50
        DISP_CLOCK_SOURCE_HD0,
        {0x11800000, 0x00001031}, // 1080P60/50
        {HI_DRV_DISP_FMT_1080P_60, DISP_STEREO_NONE, HI_FALSE, {0, 0, 1920, 1080}, {0, 0, 1920, 1080}, {16, 9}, 6000, HI_DRV_CS_BT709_YUV_LIMITED}
    },
    // 1 HI_UNF_ENC_FMT_1080P_60,
    {   {1,   1,   2,  1080,  41,  4,  1920, 192, 88,      1,   1,  1,     44, 5, 1,  0,  0,  0}, /* 1080P@60Hz */
    ...
    {   {1,   0,   2,   540,  20,  2,  1920, 192, 88,  540, 21,  2,    44,  5, 908,   0,  0,  0}, /* 1080I@60Hz */
        //   {0x24000000, 0x02002063}, // 1080i50
        DISP_CLOCK_SOURCE_HD0,
        {0x1174bc6a, 0x00001031}, // 1080P60/50
        {HI_DRV_DISP_FMT_1080i_60, DISP_STEREO_NONE, HI_TRUE, {0, 0, 1920, 1080}, {0, 0, 1920, 1080}, {16, 9}, 6000, HI_DRV_CS_BT709_YUV_LIMITED}
    },
    // 7 HI_UNF_ENC_FMT_1080i_50
    {   {1,   0,   2,   540,  20,  2,  1920, 192, 528,  540,  21,  2,   44, 5, 1128,  0,  0,  0}, /* 1080I@50Hz */
    ...
    {   {1,  1,   2,  2160,  82,  8,  3840, 384, 176,       1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x11800000, 0x00001031}, /*  3840x2160@60Hz@594.000MHz  */
    ...
    {   {1,  1,   2,  2160,  82,  8,  4096, 216, 88,         1,   1,  1,    88, 10, 1, 0,  0,  0},
        DISP_CLOCK_SOURCE_HD0,
        {0x11800000, 0x00001031}, /*  4096x2160@60Hz@594.000MHz  */
...
HI_S32 Chip_Specific_SetWbc3DInfo(DISP_WBC_E eWbc, HI_DISP_DISPLAY_INFO_S *pstDispInfo, HI_RECT_S *in)
{
    ...
    if ((HI_NULL == pstDispInfo) || (HI_NULL == in))
    {
        ...
        HI_U32 *pu32HsyncPolarityInvert)
{
    ...
    *pu32VsyncPolarityInvert = *pu32VsyncPolarityInvert;
    *pu32HsyncPolarityInvert = *pu32HsyncPolarityInvert;
    return ;
}
...
/*****************************************************************************
 Prototype    : DISP_TimingFixSpreadSpectrum
 Description  : Config the external and internal PLL divider, to fix spread spectrum issue.
 Input        : pu32PixClk      - Pixel clock(Hz)
 Output       : u32FixPixelDiv  - PIXEL_CLK according the table.
...
{
    HI_U32 u32VdpClkDiv = 0;
    HI_U32 u32ClkHdDiv = 0;
    U_PERI_CRG211 PERI_CRG211;

    /* Sort external and internal divider according configtable */
    if (21250000 <= u32PixClk && u32PixClk <= 50000000)
    {
        *pu32FixPixelDiv = 16;
        u32ClkHdDiv      = 0;
        u32VdpClkDiv     = 0x7;
    }
    else if (50000000 < u32PixClk && u32PixClk <= 100000000)
    {
        *pu32FixPixelDiv = 8;
        u32ClkHdDiv      = 0;
        u32VdpClkDiv     = 0x3;
    }
    else if (100000000 < u32PixClk && u32PixClk <= 200000000)
    {
        *pu32FixPixelDiv = 4;
        u32ClkHdDiv      = 0;
        u32VdpClkDiv     = 0x1;
    }
    else if (200000000 < u32PixClk && u32PixClk <= 340000000)
    {
        *pu32FixPixelDiv = 2;
        u32ClkHdDiv      = 0x2;
        u32VdpClkDiv     = 0x1;
    }
    else if (340000000 < u32PixClk && u32PixClk <= 600000000)
    {
        *pu32FixPixelDiv = 1;
        u32ClkHdDiv      = 0x2;
        u32VdpClkDiv     = 0x0;
    ...
    {
        DISP_ERROR("u32PixClk out of range (12.25M~600M)!!\n");
        return HI_FAILURE;
    }

    /* Config external divider */
    PERI_CRG211.u32 = g_pstRegCrg->PERI_CRG211.u32;
    PERI_CRG211.bits.vdp_clk_div = u32VdpClkDiv;
    g_pstRegCrg->PERI_CRG211.u32 = PERI_CRG211.u32;

    /* Config internal divider */
    (HI_VOID)VDP_DISP_SelectChanClkDiv(HI_DRV_DISPLAY_1, u32ClkHdDiv);
...
{
    VDP_SelectClk(VDP_CLK_MODE_333MHZ);
    return;
}
...
/*****************************************************************************
 Prototype    : DISP_UpdateCustomFormatParam
 Description  : Update custom format param to array s_stDispFormatParam
 Input        : pstTiming   - Timing param
                pstRegPara  - Two reg param
 Output       : None
 Return Value : HI_SUCCESS-success; others-error code
*****************************************************************************/
HI_S32 DISP_UpdateCustomFormatParam(const HI_DRV_DISP_TIMING_S *pstTiming, const REG_PARA_S* pstRegPara)
{
    s_stDispFormatParam[0].stTiming.bSynm       = 1;
    s_stDispFormatParam[0].stTiming.bIop        = 1;
    s_stDispFormatParam[0].stTiming.u32Intfb    = 2;
    s_stDispFormatParam[0].stTiming.u32Vact     = pstTiming->u32VACT;
    s_stDispFormatParam[0].stTiming.u32Vbb      = pstTiming->u32VBB;
    s_stDispFormatParam[0].stTiming.u32Vfb      = pstTiming->u32VFB;
    s_stDispFormatParam[0].stTiming.u32Hact     = pstTiming->u32HACT;
    s_stDispFormatParam[0].stTiming.u32Hbb      = pstTiming->u32HBB;
    s_stDispFormatParam[0].stTiming.u32Hfb      = pstTiming->u32HFB;
    s_stDispFormatParam[0].stTiming.u32Bvact    = 1;
    s_stDispFormatParam[0].stTiming.u32Bvbb     = 1;
    s_stDispFormatParam[0].stTiming.u32Bvfb     = 1;
    s_stDispFormatParam[0].stTiming.u32Hpw      = pstTiming->u32HPW;
    s_stDispFormatParam[0].stTiming.u32Vpw      = pstTiming->u32VPW;
    s_stDispFormatParam[0].stTiming.u32Hmid     = 1;
    s_stDispFormatParam[0].stTiming.bIdv        = pstTiming->bIDV;
    s_stDispFormatParam[0].stTiming.bIhs        = pstTiming->bIHS;
    s_stDispFormatParam[0].stTiming.bIvs        = pstTiming->bIVS;
    s_stDispFormatParam[0].enPllIndex           = DISP_CLOCK_SOURCE_HD0;

    s_stDispFormatParam[0].u32Pll[0]            = pstRegPara->u32ClkPara0;
    s_stDispFormatParam[0].u32Pll[1]            = pstRegPara->u32ClkPara1;

    s_stDispFormatParam[0].stInfo.eFmt          = HI_DRV_DISP_FMT_CUSTOM;
    s_stDispFormatParam[0].stInfo.eDispMode     = DISP_STEREO_NONE;
    s_stDispFormatParam[0].stInfo.bInterlace    = pstTiming->bInterlace;
    s_stDispFormatParam[0].stInfo.stOrgRect.s32X        = 0;
    s_stDispFormatParam[0].stInfo.stOrgRect.s32Y        = 0;
    s_stDispFormatParam[0].stInfo.stOrgRect.s32Width    = pstTiming->u32HACT;
    s_stDispFormatParam[0].stInfo.stOrgRect.s32Height   = pstTiming->u32VACT;
    s_stDispFormatParam[0].stInfo.stRefRect.s32X        = 0;
    s_stDispFormatParam[0].stInfo.stRefRect.s32Y        = 0;
    s_stDispFormatParam[0].stInfo.stRefRect.s32Width    = pstTiming->u32HACT;
    s_stDispFormatParam[0].stInfo.stRefRect.s32Height   = pstTiming->u32VACT;
    s_stDispFormatParam[0].stInfo.stAR.u32ARw   = 16;
    s_stDispFormatParam[0].stInfo.stAR.u32ARh   = 9;
    s_stDispFormatParam[0].stInfo.u32RefreshRate= pstTiming->u32VertFreq / 10;
    s_stDispFormatParam[0].stInfo.enColorSpace  = HI_DRV_CS_BT709_RGB_FULL;
