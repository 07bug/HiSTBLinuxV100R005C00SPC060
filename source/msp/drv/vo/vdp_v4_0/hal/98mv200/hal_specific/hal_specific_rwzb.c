...
/*VDAC_DEFAULT_VALUE*/
const HI_U32 g_u32VdacGain[MAX_SONCHIPNUMBER_SUPPORT] = {0x800003b0/*98mv200*/, 0x80000380/*98mv300*/};
#else
/*VDAC_DEFAULT_VALUE*/
const HI_U32 g_u32VdacGain[MAX_SONCHIPNUMBER_SUPPORT] = {0x800000a0/*98mv200*/, 0x80000060/*98mv300*/};
#endif
...
{
    HI_U32 u32TinyAdjustGainValue = 0, u32GainValue = 0;
    ...
    if ((HI_CHIP_TYPE_HI3798M != enChipType)
        || ((HI_CHIP_VERSION_V300 != enChipVersion)
            && (HI_CHIP_VERSION_V200 != enChipVersion)))
    {
        DISP_ERROR("invalid chip type:%d,%d\n", enChipType, enChipVersion);
        return;
    }

    if (HI_CHIP_VERSION_V200 == enChipVersion)
    {
        u32GainValue = g_u32VdacGain[0];
    }
    else
    {
        u32GainValue = g_u32VdacGain[1];
    }
...
HI_VOID VDP_VDAC_SetCvbsAndYpbprDriveMode(HI_VOID)
{
        ...
        && (HI_CHIP_VERSION_V300 == enChipVersion))
    {
        ...
        VO_DAC_CTRL1.bits.dac_mode = bYpbprCvbsSame;
