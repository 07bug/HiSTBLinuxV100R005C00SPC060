...
HI_S32  Internal_SelectTnrLocation(HI_PQ_ALGIP_SEL_E   enAlgIPSel)
{
        ...
        VDP_LAYER_VID_INFO_S *pstVidInfo)
{
    ...
    if (!pLayerCfgBasePara->bMuteEn && pLayerCfgBasePara->bRegionEn)
    {
        ...
        stZmeIn.stLayerStrategy.u32FmtIn   = pLayerCfgBasePara->stFrame.eSrcFmt;
        stZmeIn.stLayerStrategy.u32FrmWIn  = pLayerCfgBasePara->stCropRect.s32Width;
        stZmeIn.stLayerStrategy.u32FrmHIn  = pLayerCfgBasePara->stCropRect.s32Height;
        ...
        stZmeIn.stLayerStrategy.stHDCPAttestFactor.bHDCPScene = pLayerCfgBasePara->bHdcpDegradePQ;
        stZmeIn.stLayerStrategy.stHDCPAttestFactor.u32IntermedWidth = pLayerCfgBasePara->stHdcpIntermediateRect.s32Width;
        stZmeIn.stLayerStrategy.stHDCPAttestFactor.u32IntermedHeight = pLayerCfgBasePara->stHdcpIntermediateRect.s32Height;

        stZmeIn.stLayerStrategy.u32FrmWOut = pLayerCfgBasePara->stVideoRect.s32Width;
        stZmeIn.stLayerStrategy.u32FrmHOut = pLayerCfgBasePara->stVideoRect.s32Height;
            ...
            || (pLayerCfgBasePara->u32LayerNO == VDP_LAYER_VID1))
        {
            ...
            if (HI_SUCCESS != (s32Ret = DRV_PQ_GetVdpZmeStrategy ((HI_PQ_ZME_LAYER_E)pLayerCfgBasePara->u32LayerNO, &stZmeIn, &stZmeOut)))
            {
                return s32Ret;
            }

            if (stZmeOut.stStrategyLayerId.eVScalerMode >= VDP_DRAW_MODE_BUTT)
            {
                DISP_ERROR("eVScalerMode out of range.\n");
                return HI_FAILURE;
            }
            ...
            else
            {
                ...
                pstVidInfo->stZme2InRect.u32Wth  =  stZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].u32FrmOutWidth;
                pstVidInfo->stZme2InRect.u32Hgt  =  stZmeOut.stStrategyLayerId.stZmeFmt[HI_PQ_V0_ZME_NODE_ZME1].u32FrmOutHeight;
            }
        ...
        pstVidInfo->pstZmeDrvPara.bZmeFirHL = stZmeOut.stStrategyLayerId.bZmeFirHL;
        pstVidInfo->pstZmeDrvPara.bZmeFirHC = stZmeOut.stStrategyLayerId.bZmeFirHC;
        pstVidInfo->pstZmeDrvPara.bZmeFirVL = stZmeOut.stStrategyLayerId.bZmeFirVL;
        pstVidInfo->pstZmeDrvPara.bZmeFirVC = stZmeOut.stStrategyLayerId.bZmeFirVC;
        ...
        pstVidInfo->pstZmeDrvPara.bZmeMedH  = stZmeOut.stStrategyLayerId.bZmeMedH;
        pstVidInfo->pstZmeDrvPara.bZmeMedV  = stZmeOut.stStrategyLayerId.bZmeMedV;
        pstVidInfo->pstZmeDrvPara.bZmeDefault   = stZmeOut.stStrategyLayerId.bZmeDefault;
        ...
        pstVidInfo->bHzmeEn = stZmeOut.stStrategyLayerId.stPreZmeConfig.bPreZme;
        pstVidInfo->enHzmeMode = stZmeOut.stStrategyLayerId.stPreZmeConfig.bPreZmeFir ? VDP_HZME_MODE_FIR : VDP_HZME_MODE_COPY;
        ...
        pstVidInfo->pstZmeDrvPara.bZmeFrmFmtIn  = stZmeOut.stStrategyLayerId.bReadFmtIn;
        ...
        else
        {
            ...
            pstVidInfo->pstZmeDrvPara.bZmeBFIn      = stZmeOut.stStrategyLayerId.bReadBFIn;
        }
...
HI_S32 CBB_Video_SetLayerParam(CBB_LAYER_CFG_INFO_S *pLayerCfgBasePara, CBB_CFG_EXT_S *pVDPCfgExtPara)
{
    ...
    if (stVidInfo.bRegionEn == HI_TRUE)
    {
        ...
        stVidInfo.stMixvColor.u32BkgA  = 0xff;
        stVidInfo.stMixvColor.u32BkgY  = pLayerCfgBasePara->stMixvColor.u32YorRValue;
        stVidInfo.stMixvColor.u32BkgU  = pLayerCfgBasePara->stMixvColor.u32UorGValue;
        stVidInfo.stMixvColor.u32BkgV  = pLayerCfgBasePara->stMixvColor.u32VorBValue;
...
HI_S32 CBB_Video_SetWbcParam(CBB_WBC_CFG_INFO_S *pLayerCfgBasePara, CBB_CFG_EXT_S *pVDPCfgExtPara)
{
    ...
    if (pLayerCfgBasePara->enWBC == DRV_VDP_WBC_WIN)
    {
        if (pLayerCfgBasePara->bWbcEnable == HI_TRUE)
        {
            ...
            unionZmeIn.stWbcStrategy.stLayerInfo[1].bZmeBFIn    = 1 - bBtm;
            unionZmeIn.stWbcStrategy.stLayerInfo[1].bZmeBFOut   = 1 - bBtm;
            ...
            stWbcInfo.bZmeFirHL   = unionZmeOut.stStrategyWbcVp.stZmeFmt.bZmeFirHL;
            stWbcInfo.bZmeFirHC   = unionZmeOut.stStrategyWbcVp.stZmeFmt.bZmeFirHC;

            stWbcInfo.bZmeFirVL   = unionZmeOut.stStrategyWbcVp.stZmeFmt.bZmeFirVL;
            stWbcInfo.bZmeFirVC   = unionZmeOut.stStrategyWbcVp.stZmeFmt.bZmeFirVC;

            stWbcInfo.bZmeMedH   = unionZmeOut.stStrategyWbcVp.stZmeFmt.bZmeMedH;
            stWbcInfo.bZmeMedV   = unionZmeOut.stStrategyWbcVp.stZmeFmt.bZmeMedV;
            ...
            stWbcInfo.enWbcVpConnPoint   = (unionZmeOut.stStrategyWbcVp.enVpPoint == HI_PQ_WBC_VP_POINT_VP) ? VDP_LAYER_CONN_VPACSC : VDP_LAYER_CONN_VIDBZME;
            stWbcInfo.enInFmt =  (unionZmeOut.stStrategyWbcVp.stZmeFmt.u32PixInFmt == 0) ? VDP_VID_IFMT_SP_422 : VDP_VID_IFMT_SP_420;
            stWbcInfo.bP2iEn   = unionZmeOut.stStrategyWbcVp.bOpenP2I;

            stWbcInfo.stInRect.u32Wth = unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmInWidth;
            stWbcInfo.stInRect.u32Hgt = unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmInHeight;

            stWbcInfo.stOutRect.u32Wth = unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmOutWidth;
            stWbcInfo.stOutRect.u32Hgt = unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmOutHeight;
            stWbcInfo.s32ZmeOffsetHL = unionZmeOut.stStrategyWbcVp.stZmeFmt.stZmeOffset.s32ZmeOffsetHL;
            stWbcInfo.s32ZmeOffsetHC = unionZmeOut.stStrategyWbcVp.stZmeFmt.stZmeOffset.s32ZmeOffsetHC;
            stWbcInfo.s32ZmeOffsetVL = unionZmeOut.stStrategyWbcVp.stZmeFmt.stZmeOffset.s32ZmeOffsetVL;
            stWbcInfo.s32ZmeOffsetVC = unionZmeOut.stStrategyWbcVp.stZmeFmt.stZmeOffset.s32ZmeOffsetVC;
            stWbcInfo.s32ZmeOffsetVLBtm = unionZmeOut.stStrategyWbcVp.stZmeFmt.stZmeOffset.s32ZmeOffsetVLBtm;
            stWbcInfo.s32ZmeOffsetVCBtm = unionZmeOut.stStrategyWbcVp.stZmeFmt.stZmeOffset.s32ZmeOffsetVCBtm;
#if 0
            ...
            stWbcInfo.enOutFmt  = (unionZmeOut.stStrategyWbcVp.stZmeFmt.u32PixOutFmt == 0) ? VDP_WBC_OFMT_SP422 : VDP_WBC_OFMT_SP420;
            stWbcInfo.enWbcVpConnPoint = (unionZmeOut.stStrategyWbcVp.enVpPoint == HI_PQ_WBC_VP_POINT_VP) ? VDP_LAYER_CONN_VPACSC : VDP_LAYER_CONN_VIDBZME;
                              ...
                              CBB_WBC_POLICY_S *pWbcPolicy)
{
    ...
    if (pLayerCfgBasePara->enWBC  == DRV_VDP_WBC_WIN)
    {
        ...
        pWbcPolicy->bWbcOutputFieldMode = unionZmeOut.stStrategyWbcVp.stZmeFmt.bOutFmt ? HI_FALSE : HI_TRUE;

        enWbcVpConnPoint = (unionZmeOut.stStrategyWbcVp.enVpPoint == HI_PQ_WBC_VP_POINT_VP) ? VDP_LAYER_CONN_VPACSC : VDP_LAYER_CONN_VIDBZME;
        ...
        if (enWbcVpConnPoint == VDP_LAYER_CONN_VPACSC)
        {
            ...
            pWbcPolicy->stSdFinaleDispRect.s32Width = unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmOutWidth;
            pWbcPolicy->stSdFinaleDispRect.s32Height = unionZmeOut.stStrategyWbcVp.stZmeFmt.u32FrmOutHeight;
...
HI_S32 CBB_Resource_AllocateCoefMem(HI_VOID)
{
...
HI_VOID CBB_Resource_FreeCoefMem(HI_VOID)
{
#ifdef  VDP_PQ_STRATEGY
