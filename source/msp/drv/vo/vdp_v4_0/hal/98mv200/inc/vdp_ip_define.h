...
typedef enum
{
    VDP_LAYER_C6_VID0      = 0x0,
    VDP_LAYER_C6_VID1      = 0x1,
    VDP_LAYER_C6_VP0       = 0x2,
    VDP_LAYER_C6_BUTT
} VDP_LAYER_C6_E;
//add VID_NXG LayerID
typedef enum
...
typedef enum tagVDP_VID_IFMT_E
{
    ...
    VDP_VID_IFMT_RGB_888     = 0xc,
    VDP_VID_IFMT_ARGB_8888   = 0xd,
...
typedef enum tagVDP_C6_MODE_E
{
    VDP_C6_TYP = 0,
    VDP_C6_4K_SMALL_SYMBOLS ,
    VDP_C6_MAXIMUM_COVERAGE ,
    VDP_C6_NORM ,
    VDP_C6_RAND_MULTIPLY_THRESHOLD , //all settings rand but :watermark is on, multiply is 100, threshold value use default value
    VDP_C6_RAND_THRESHOLD ,    //all seetings rand but :watermark is on, threshold value use default value
    VDP_C6_RAND ,              //all seetings rand include watermark on or not
    VDP_C6_MAX  ,
    VDP_C6_MIN  ,
    VDP_C6_BUTT
} VDP_C6_MODE_E;
