...
HI_VOID VDP_HDATE_ResetFmt( HI_DRV_DISP_FMT_E enFmt)
{
    ...
    switch (enFmt)
    {
        ...
        case HI_DRV_DISP_FMT_1080P_59_94:
            ...
            VDP_DATE_SetSrcCoef(DISP_VENC_HDATE0, VDP_Get_HDateSrc13Coef(DISP_DATE_SRC_COEF_INDEX_1080P));
            break;
        ...
        case HI_DRV_DISP_FMT_1080i_59_94:
            ...
            VDP_DATE_SetSrcCoef(DISP_VENC_HDATE0, VDP_Get_HDateSrc13Coef(DISP_DATE_SRC_COEF_INDEX_1080I));
            VDP_RegWrite(((HI_ULONG) & (pVdpReg->HDATE_POLA_CTRL.u32)), 0x05ul);
            break;
        ...
        case HI_DRV_DISP_FMT_720P_59_94:
            ...
            VDP_DATE_SetSrcCoef(DISP_VENC_HDATE0, VDP_Get_HDateSrc13Coef(DISP_DATE_SRC_COEF_INDEX_720P));
            VDP_RegWrite(((HI_ULONG) & (pVdpReg->HDATE_POLA_CTRL.u32)), 0x01ul);
            break;

        case HI_DRV_DISP_FMT_576P_50:
            HDATE_VIDEO_FORMAT.u32 = 0x000000a1;
            VDP_DATE_SetSrcCoef(DISP_VENC_HDATE0, VDP_Get_HDateSrc13Coef(DISP_DATE_SRC_COEF_INDEX_576P));
            VDP_RegWrite(((HI_ULONG) & (pVdpReg->HDATE_POLA_CTRL.u32)), 0x01ul);
            break;
        ...
        case HI_DRV_DISP_FMT_480P_60:
            ...
            VDP_DATE_SetSrcCoef(DISP_VENC_HDATE0, VDP_Get_HDateSrc13Coef(DISP_DATE_SRC_COEF_INDEX_480P));
            break;
        ...
        default :
            HDATE_VIDEO_FORMAT.u32 = 0x000000a2;
            VDP_DATE_SetSrcCoef(DISP_VENC_HDATE0, VDP_Get_HDateSrc13Coef(DISP_DATE_SRC_COEF_INDEX_DEFAULT));
...
HI_VOID VDP_SDATE_ResetFmt(HI_DRV_DISP_FMT_E enFmt)
{
    U_DATE_COEFF0 DATE_COEFF0;
    ...
    VDP_DATE_SetSrcCoef(DISP_VENC_SDATE0, VDP_Get_SDateSrcCoef(0));
...
HI_VOID VDP_DATE_ResetFmt(DISP_VENC_E eDate, HI_DRV_DISP_FMT_E enFmt)
{
    ...
    if (DISP_VENC_HDATE0 == eDate)
    {
        VDP_HDATE_ResetFmt(enFmt);
    }
    else if (DISP_VENC_SDATE0 == eDate)
    {
        VDP_SDATE_ResetFmt(enFmt);
    }
}
...
HI_VOID SDATE_HDATE_VBI_GetCgmsTypeAEn(DISP_VENC_E enChanel, HI_BOOL *bEnTypeA)
{
...
HI_VOID SDATE_HDATE_VBI_GetCgmsTypeA(DISP_VENC_E enChanel, HI_U32 *u32Data)
{
    ...
    if (enChanel == DISP_VENC_HDATE0)
    {
        ...
        *u32Data = HDATE_CGMSA_DATA.bits.cgmsa_data;
        //      pVdpReg->HDATE_CGMSA_DATA.u32 = HDATE_CGMSA_DATA.u32;
    }
    else if (enChanel == DISP_VENC_SDATE0)
    {
        DATE_COEFF13.u32 = pVdpReg->DATE_COEFF13.u32;
        *u32Data = DATE_COEFF13.bits.cg_f1data;
        //      pVdpReg->DATE_COEFF13.u32 = DATE_COEFF13.u32;
...
HI_VOID SDATE_HDATE_VBI_GetWssEn(DISP_VENC_E enChanel, HI_BOOL *bEnWss)
{
    ...
    else if (enChanel == DISP_VENC_SDATE0)
    {
        ...
        *bEnWss = DATE_COEFF15.bits.wss_en;
...
HI_VOID SDATE_HDATE_VBI_GetWssData(DISP_VENC_E enChanel, HI_U32 *u32Data)
{
    U_DATE_COEFF15 DATE_COEFF15;
    ...
    {
        DATE_COEFF15.u32 = pVdpReg->DATE_COEFF15.u32;
        *u32Data = DATE_COEFF15.bits.wss_data ;
        //      pVdpReg->DATE_COEFF15.u32 = DATE_COEFF15.u32;
    }
...
HI_S32  SDATE_MVCN_DATE_GetMcvn(HI_U32 *pu32Value)
{

    //VDP_MVCN_DATE_GetMcvn
    HI_INFO_DISP("DATE_COEFF2-6= %x %x %x %x %x \n",
                 pVdpReg->DATE_COEFF2.u32,
                 pVdpReg->DATE_COEFF3.u32,
                 pVdpReg->DATE_COEFF4.u32,
                 pVdpReg->DATE_COEFF5.u32,
                 pVdpReg->DATE_COEFF6.u32);
    pu32Value[0] = pVdpReg->DATE_COEFF2.u32;
    pu32Value[1] = pVdpReg->DATE_COEFF3.u32;
    pu32Value[2] = pVdpReg->DATE_COEFF4.u32;
    pu32Value[3] = pVdpReg->DATE_COEFF5.u32;
    pu32Value[4] = pVdpReg->DATE_COEFF6.u32;
