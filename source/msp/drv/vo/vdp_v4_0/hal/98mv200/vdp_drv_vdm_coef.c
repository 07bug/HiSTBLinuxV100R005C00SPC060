...
/************* DeGamma Luts **************/
HI_U32 au32DeGmmLut_PQSdr7092bt2020[64] =                      /*U20.0 [0,1048575] */
{
    0      ,
    11     ,
    62     ,
...
HI_U32 au32DeGmmLut_Gmm24_Sdr2Hdr10[64] =                               //U20.0 [0,1048575]
{
    // Gamma2.4
    0      ,
    9      ,
...
HI_U32 u32DePQLut[64] =                              //U20.0 [0,1048575]
{
    0      ,
    1      ,
    2      ,
...
HI_U32 au32TMLut_SDRtoHDR1000[64] =                   //U1.15 [0,65535]
{
    10820,
    10820,
    5410 ,
...
/******************* Gmm-8 Lut Params *************************/
/* Gamma Curve */
HI_U32 au32GmmLut_Gmm[64] =              /* U12.0 [0,4095] */
{
    0   ,
    0   ,
    1   ,
...
// PQ-1000 Curve
HI_U32 au32GmmLut_PQ1000[64] =              //U12.0 [0,4095]
{
    0   ,
    108 ,
    151 ,
...
HI_VOID Vdp_Drv_SetVdmCoef_gmm(HIHDR_SCENE_MODE_E  enHiHdrMode, HI_PQ_HDR_CFG   *HiHdrCfg)
{
    ...
    {
        VDP_PRINT("gamma Coef : VdmSceneMode == HIHDR_SDR_IN_HDR10_OUT\n");

        p_coef_array[0]    = (HI_S32 *)au32GmmLut_PQ1000     ;
    }
    else if (enHiHdrMode == HIHDR_709_IN_BT2020_OUT)
    {
        VDP_PRINT("gamma Coef : VdmSceneMode == HIHDR_709_IN_BT2020_OUT\n");

        p_coef_array[0]    = (HI_S32 *)au32GmmLut_Gmm     ;
    }
...
#else
    pu32LutTmp = (HI_S32 *)HiHdrCfg->stGmm.pu32LUT;

    if (HI_NULL == pu32LutTmp)
    {
        VDP_PRINT("HiHdrCfg->stGmm.pu32LUT is NULL!\n");
        return;
    }
...
HI_VOID Vdp_Drv_SetVdmCoef_Degmm(HIHDR_SCENE_MODE_E  enHiHdrMode, HI_PQ_HDR_CFG  *HiHdrCfg)
{
    ...
    {
        VDP_PRINT("DeGamma Coef : VdmSceneMode == HIHDR_709_IN_BT2020_OUT\n");

        p_coef_array[0]    = (HI_S32 *)au32DeGmmLut_PQSdr7092bt2020     ;
...
#else
    pu32LutTmp = (HI_S32 *)HiHdrCfg->stDeGmm.pu32LUT;

    if (HI_NULL == pu32LutTmp)
    {
        VDP_PRINT("pstHiHdrCfg stDeGmm is NULL!\n");
        return;
    }
...
HI_VOID Vdp_Drv_SetVdmCoef_Tmapping(HIHDR_SCENE_MODE_E  enHiHdrMode, HI_PQ_HDR_CFG  *HiHdrCfg)
{
    ...
    {
        VDP_PRINT("DeGamma Coef : VdmSceneMode == HIHDR_SDR_IN_HDR10_OUT\n");

        p_coef_array[0]    = (HI_S32 *)au32TMLut_SDRtoHDR1000     ;
    }
    else
    {
        VDP_PRINT("DeGamma Coef : VdmSceneMode == Default !\n");
...
#else
    pu32LutTmp = (HI_S32 *)HiHdrCfg->stTMAP.pu32LUTTM;

    if (HI_NULL == pu32LutTmp)
    {
        VDP_PRINT("pstHiHdrCfg stTMAP is NULL!\n");
        return;
    }
