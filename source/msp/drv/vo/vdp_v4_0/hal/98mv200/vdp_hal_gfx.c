...
HI_VOID  VDP_GFX_SetLayerReso     (HI_U32 u32Data, VDP_DISP_RECT_S  stRect)
{
    ...
    if (u32Data >= GFX_MAX)
    {
        VDP_PRINT("Error,VDP_GFX_SetLayerReso() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID VDP_GFX_SetReqMacCtrl(HI_U32 u32Data, HI_U32 u32ReqMacCtrl)
{
    ...
    if (u32Data >= GFX_MAX)
    {
        VDP_PRINT("Error,VDP_GFX_SetReqMacCtrl() Select Wrong Video Layer ID\n");
        return ;
    }
...
HI_VOID  VDP_GP_SetLayerReso (HI_U32 u32Data, VDP_DISP_RECT_S  stRect)
{
    ...
    if (u32Data >= GP_MAX)
    {
        VDP_PRINT("Error,VDP_GP_SetLayerReso() Select Wrong GP Layer ID\n");
        return ;
    }
    /*video position */
...
HI_VOID VDP_GP_SetCoefReadEnable(HI_U32 u32Id, HI_U32 u32Para)
{
    ...
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->GP0_PARARD.u32) + u32Id ), u32WrData);
}

HI_VOID VDP_GP_SetCoefReadDisable(HI_U32 u32Id, HI_U32 u32Para)
{

    VDP_RegWrite(((HI_ULONG) & (pVdpReg->GP0_PARARD.u32) + u32Id ), 0);
}
