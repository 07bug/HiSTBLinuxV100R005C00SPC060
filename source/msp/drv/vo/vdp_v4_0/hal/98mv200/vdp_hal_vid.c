...
HI_VOID  VDP_VID_SetReqMacCtrl    (HI_U32 u32Data, HI_U32 u32ReqMacCtrl )
{
    ...
    if (u32Data >= VID_MAX)
    {
        VDP_PRINT("Error,VDP_VID_SetReqMacCtrl() Select Wrong Video Layer ID\n");
        return ;
    }
    V0_PRERD.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->V0_PRERD.u32) + u32Data * VID_OFFSET));
...
HI_VOID  VDP_VID_SetCscDcCoef   (HI_U32 u32Data, HI_PQ_CSC_DCCOEF_S pstCscCoef)
{
...
HI_VOID   VDP_VID_SetCscCoef(HI_U32 u32Data, HI_PQ_CSC_COEF_S stCscCoef)
{
...
{
    HI_PQ_CSC_COEF_S    st_csc_coef;
    HI_PQ_CSC_DCCOEF_S st_csc_dc_coef;
    ...
    //    V0_CSC_IDC.u32 = VDP_RegRead((&(pVdpReg->V0_CSC_IDC.u32) + u32Data * VID_OFFSET ));
    //    V0_CSC_IDC.bits.csc_mode = enCscMode;
    //    VDP_RegWrite((&(pVdpReg->V0_CSC_IDC.u32) + u32Data * VID_OFFSET ), V0_CSC_IDC.u32);
    //}
...
HI_VOID VDP_VID_SetDispMode(HI_U32 u32Data, VDP_DISP_MODE_E enDispMode)
{
    ...
    //
    //V0_CTRL.u32 = VDP_RegRead((&(pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET));
    //V0_CTRL.bits.disp_mode = enDispMode;
    //VDP_RegWrite((&(pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET), V0_CTRL.u32);
...
HI_BOOL VDP_VID_CheckRegionState(HI_U32 u32Data)
{
    ...
    {
        V0_P0CTRL.u32   =   VDP_RegRead((HI_ULONG) & (pVdpReg->V0_P0CTRL.u32) + u32Data * VID_OFFSET + u32Num * REGION_OFFSET);
        if (V0_P0CTRL.bits.region_en == HI_TRUE)
...
HI_VOID  VDP_VID_SetCvfirVCoef(HI_U32 u32Data,  VDP_VID_CVFIR_VCOEF_S stCvfirVCoef)
{
    ...
    if (u32Data == VDP_LAYER_VID1)
    {
        st_v0_vcoef4.bits.vccoef00 = stCvfirVCoef.cvfir_vccoef00;
        st_v0_vcoef4.bits.vccoef01 = stCvfirVCoef.cvfir_vccoef01;
        st_v0_vcoef4.bits.vccoef02 = stCvfirVCoef.cvfir_vccoef02;
        st_v0_vcoef5.bits.vccoef03 = stCvfirVCoef.cvfir_vccoef03;
        st_v0_vcoef5.bits.vccoef10 = stCvfirVCoef.cvfir_vccoef10;
        st_v0_vcoef5.bits.vccoef11 = stCvfirVCoef.cvfir_vccoef11;
        st_v0_vcoef6.bits.vccoef12 = stCvfirVCoef.cvfir_vccoef12;
        st_v0_vcoef6.bits.vccoef13 = stCvfirVCoef.cvfir_vccoef13;

        VDP_RegWrite(((HI_ULONG) & (pVdpReg->V0_VCOEF0.u32) + VID_OFFSET), st_v0_vcoef0.u32 );
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->V0_VCOEF1.u32) + VID_OFFSET), st_v0_vcoef1.u32 );
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->V0_VCOEF3.u32) + VID_OFFSET), st_v0_vcoef3.u32 );
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->V0_VCOEF4.u32) + VID_OFFSET), st_v0_vcoef4.u32 );
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->V0_VCOEF5.u32) + VID_OFFSET), st_v0_vcoef5.u32 );
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->V0_VCOEF6.u32) + VID_OFFSET), st_v0_vcoef6.u32 );
    }
    return ;
}
...
//    if(u32Mode == VDP_VID_PARA_ZME_HOR)
//    {
//        V0_HLCOEFAD.u32 = VDP_RegRead((&(pVdpReg->V0_HLCOEFAD.u32) + VID_ZME_OFFSET));
//        V0_HLCOEFAD.bits.coef_addr = u32Addr;
//        VDP_RegWrite((&(pVdpReg->V0_HLCOEFAD.u32) + VID_ZME_OFFSET), V0_HLCOEFAD.u32);
//
//        V0_HCCOEFAD.u32 = VDP_RegRead((&(pVdpReg->V0_HCCOEFAD.u32) + VID_ZME_OFFSET));
//        V0_HCCOEFAD.bits.coef_addr = (u32Addr +ADDR_OFFSET) & 0xfffffff0;
//        VDP_RegWrite((&(pVdpReg->V0_HCCOEFAD.u32) + VID_ZME_OFFSET), V0_HCCOEFAD.u32);
//
//    }
//    else if(u32Mode == VDP_VID_PARA_ZME_VER)
//    {
//        V0_VLCOEFAD.u32 = VDP_RegRead((&(pVdpReg->V0_VLCOEFAD.u32) + VID_ZME_OFFSET));
//        V0_VLCOEFAD.bits.coef_addr = u32Addr;
//        VDP_RegWrite((&(pVdpReg->V0_VLCOEFAD.u32) + VID_ZME_OFFSET), V0_VLCOEFAD.u32);
//
//        V0_VCCOEFAD.u32 = VDP_RegRead((&(pVdpReg->V0_VCCOEFAD.u32) + VID_ZME_OFFSET));
//        V0_VCCOEFAD.bits.coef_addr = (u32Addr + ADDR_OFFSET)  & 0xfffffff0;
//        VDP_RegWrite((&(pVdpReg->V0_VCCOEFAD.u32) + VID_ZME_OFFSET), V0_VCCOEFAD.u32);
//
//
//    }
//    else
...
HI_VOID  VDP_VP0_SetParaUpd       (HI_U32 u32Data, VDP_VP_PARA_E  enMode)
{
    ...
    U_V0_DWM_SYB_PARAUP V0_DWM_SYB_PARAUP ;
    if (enMode == VDP_VP_PARA_C6)
    {
        V0_DWM_SYB_PARAUP.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->V0_DWM_SYB_PARAUP.u32) + 2 * VID_C6_OFFSET));
    }
    else
    {
    ...
    if (enMode == VDP_VP_PARA_C6)
    {
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->V0_DWM_SYB_PARAUP.u32) + 2 * VID_C6_OFFSET), V0_DWM_SYB_PARAUP.u32);
    }
    else
    {
...
HI_VOID VDP_VID_SetESBC1CFG(HI_U32 u32Data, HI_U32 check1_deadzone, HI_U32 check1_autodz_gain, HI_U32 check1_gain, HI_U32 chech1_dir_diff_gain)
{
    ...
    //ES_BC1_CFG.bits.check1_deadzone      = check1_deadzone <<2 ;
...
HI_VOID VDP_VID_SetESBC2CFG(HI_U32 u32Data, HI_U32 check2_deadzone, HI_U32 check2_autodz_gain, HI_U32 check2_gain)
{
    ...
    //ES_BC2_CFG.bits.check2_deadzone      = check2_deadzone <<2 ;
...
HI_VOID VDP_VID_SetESVerMinStrength(HI_U32 u32Data, HI_S32 ver_min_strength)
{
    ...
    //ES_VER_MIN_STRENGTH.bits.ver_min_strength   = ver_min_strength <<2 ;
...
HI_VOID VDP_VID_SetESEdgeThd(HI_U32 u32Data, HI_U32 edge_thd[4])
{
    ...
    //ES_EDGE_THD.bits.edge_thd_0   = edge_thd[0] <<2  ;
...
HI_VOID  VDP_VID_SetTestPatternEnable    (HI_U32 u32Data, HI_U32 u32Enable )
{
    ...
    if (u32Data >= VID_MAX)
    {
        VDP_PRINT("Error,VID_SetTestPatternEnable() Select Wrong Video Layer ID\n");
        return ;
    }


    V0_CTRL.u32 = VDP_RegRead( ((HI_ULONG) & (pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET));
    V0_CTRL.bits.test_pattern_en = u32Enable ;
    VDP_RegWrite( ((HI_ULONG) & (pVdpReg->V0_CTRL.u32) + u32Data * VID_OFFSET), V0_CTRL.u32);
...
{
    U_V0_TEST_PAT_CFG0 V0_TEST_PAT_CFG0;

    if (u32Data >= VID_MAX)
    {
        VDP_PRINT("Error,VDP_VID_SetTestPatternMode() Select Wrong Video Layer ID\n");
        return ;
    }

    V0_TEST_PAT_CFG0.u32 = VDP_RegRead( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG0.u32) + u32Data * VID_OFFSET));
    V0_TEST_PAT_CFG0.bits.tp_mode = u32Mode ;
    VDP_RegWrite( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG0.u32) + u32Data * VID_OFFSET), V0_TEST_PAT_CFG0.u32);
...
HI_VOID  VDP_VID_SetTestPatternLWidth    (HI_U32 u32Data, HI_U32 u32Width )
{
    ...
    V0_TEST_PAT_CFG0.u32 = VDP_RegRead( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG0.u32) + u32Data * VID_OFFSET));
    V0_TEST_PAT_CFG0.bits.tp_line_w = u32Width ;
    VDP_RegWrite( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG0.u32) + u32Data * VID_OFFSET), V0_TEST_PAT_CFG0.u32);
...
HI_VOID  VDP_VID_SetTestPatternSpeed    (HI_U32 u32Data, HI_U32 u32Speed )
{
    ...
    V0_TEST_PAT_CFG0.u32 = VDP_RegRead( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG0.u32) + u32Data * VID_OFFSET));
    V0_TEST_PAT_CFG0.bits.tp_speed = u32Speed ;
    VDP_RegWrite( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG0.u32) + u32Data * VID_OFFSET), V0_TEST_PAT_CFG0.u32);
...
{
    U_V0_TEST_PAT_CFG1 V0_TEST_PAT_CFG1;
    ...
    V0_TEST_PAT_CFG1.u32 = VDP_RegRead( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG1.u32) + u32Data * VID_OFFSET));
    V0_TEST_PAT_CFG1.bits.tp_seed = u32Seed ;
    VDP_RegWrite( ((HI_ULONG) & (pVdpReg->V0_TEST_PAT_CFG1.u32) + u32Data * VID_OFFSET), V0_TEST_PAT_CFG1.u32);
...
//  if(u32Data >= VID_MAX)
//  {
//      VDP_PRINT("Error, VDP_VID_SetHpzmeHpzmeMidEn Select Wrong Layer ID\n");
//  }
//
//  V0_HPZME.u32 = VDP_RegRead( (&(pVdpReg->V0_HPZME.u32) + u32Data * VID_OFFSET));
//  V0_HPZME.bits.hpzme_mid_en = hpzme_mid_en;
//  VDP_RegWrite( (&(pVdpReg->V0_HPZME.u32) + u32Data * VID_OFFSET),V0_HPZME.u32);
//
//  return ;
//}
