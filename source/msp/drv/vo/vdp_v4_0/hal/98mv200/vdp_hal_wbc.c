...
HI_VOID  VDP_WBC_SetRegUpAuto (VDP_LAYER_WBC_E enLayer, HI_U32 mm, VDP_CHN_E enChn)
{
    ...
    DHD0_CTRL.u32 = VDP_RegRead((HI_ULONG) & (pVdpReg->DHD0_CTRL.u32) + enChn * CHN_OFFSET);
    DHD0_STATE.u32 = VDP_RegRead((HI_ULONG) & (pVdpReg->DHD0_STATE.u32) + enChn * CHN_OFFSET);
    if (DHD0_CTRL.bits.iop == 0)
    {
        ...
        if (mm % 2 == 1)
        {
            ...
            {
                VDP_PRINT("Wready to regup  top filed wbcdhd !!!\n");
                DHD0_STATE.u32 = VDP_RegRead((HI_ULONG) & (pVdpReg->DHD0_STATE.u32) + enChn * CHN_OFFSET);
            }
        }
        else if (mm % 2 == 0)
        {
            ...
            {
                VDP_PRINT("Wready to regup  bottum filed wbcdhd !!!\n");
                DHD0_STATE.u32 = VDP_RegRead((HI_ULONG) & (pVdpReg->DHD0_STATE.u32) + enChn * CHN_OFFSET);
            }
        }
    ...
    else if (enLayer == VDP_LAYER_WBC_GP0)
    {
        ...
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_GP0_UPD.u32)), WBC_GP0_UPD.u32);
    ...
    else if (enLayer == VDP_LAYER_WBC_G0)
    {
        ...
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_G0_UPD.u32)), WBC_G0_UPD.u32);
    ...
    {
        WBC_G0_UPD.bits.regup = 0x1;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_G0_UPD.u32) + WBC_OFFSET), WBC_G0_UPD.u32);
...
HI_VOID VDP_WBC_SetCmpEnable( VDP_LAYER_WBC_E enLayer, HI_U32 bEnable)
{
    ...
    {
        WBC_G0_CMP.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_G0_CMP.u32) + (enLayer - VDP_LAYER_WBC_G0) * WBC_OFFSET));
        WBC_G0_CMP.bits.cmp_en = bEnable;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_G0_CMP.u32) + (enLayer - VDP_LAYER_WBC_G0) * WBC_OFFSET), WBC_G0_CMP.u32);
    }
    else if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CTRL.u32)));
        WBC_FI_CTRL.bits.cmp_en = bEnable;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CTRL.u32)), WBC_FI_CTRL.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpEnable() select wrong layer id\n");
    }
...
HI_VOID VDP_WBC_SetCmpDrr( VDP_LAYER_WBC_E enLayer, HI_U32 u32CmpDrr)
{
    ...
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpDrr() select wrong layer id\n");
    }
...
HI_VOID VDP_WBC_SetLossy( VDP_LAYER_WBC_E enLayer, HI_U32 bEnable)
{
    ...
    {
        VDP_PRINT("Error,VDP_WBC_SetLossy() select wrong layer id\n");
    }
...
HI_VOID VDP_WBC_SetOffSet( VDP_LAYER_WBC_E enLayer, HI_U32 u32Offset)
{
    ...
    {
        WBC_G0_OFFSET.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_G0_OFFSET.u32) + (enLayer - VDP_LAYER_WBC_G0) * WBC_OFFSET));
        WBC_G0_OFFSET.bits.wbcoffset = u32Offset;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_G0_OFFSET.u32) + (enLayer - VDP_LAYER_WBC_G0) * WBC_OFFSET), WBC_G0_OFFSET.u32);

    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetOffSet() select wrong layer id\n");
    }
}
...
HI_VOID VDP_WBC_SetLowdlyTestEnable(VDP_LAYER_WBC_E enLayer, HI_U32 u32Enable)
{
    ...
    {
        VDP_PRINT("Error,VDP_WBC_SetLowdlyTestEnable() select wrong layer id\n");
    }
}
...
HI_VOID VDP_WBC_VtthdMode(VDP_LAYER_WBC_E enLayer, HI_U32 u32wbc_vtthd_mode)
{
    ...
    {
        WBC_GP0_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_GP0_CTRL.u32) + enLayer * WBC_OFFSET));
        WBC_GP0_CTRL.bits.wbc_vtthd_mode =  u32wbc_vtthd_mode;
        VDP_RegWrite((((HI_ULONG) & (pVdpReg->WBC_GP0_CTRL.u32)) + enLayer * WBC_OFFSET), WBC_GP0_CTRL.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_VtthdMode() select wrong layer id\n");
    }
...
HI_VOID VDP_WBC_SetOflEnable(HI_U32 bEnable)
{
    ...
    WBC_OFL_EN.u32 = (VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_OFL_EN.u32))) & 0xefffffff);
...
HI_VOID VDP_WBC_SetOflMixerReso(VDP_RECT_S stRect)
{
    ...
    WBC_OFL_RESO.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_OFL_RESO.u32)));
    WBC_OFL_RESO.bits.w = stRect.u32Wth - 1;
    WBC_OFL_RESO.bits.h = stRect.u32Hgt - 1;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_OFL_RESO.u32)), WBC_OFL_RESO.u32);
}
...
HI_VOID  VDP_WBC_SetVideoPos     ( VDP_LAYER_WBC_E enLayer, VDP_RECT_S  stRect)
{
    ...
    /*video position */
    WBC_DHD0_VFPOS.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_VFPOS.u32) + enLayer * WBC_OFFSET));
    WBC_DHD0_VFPOS.bits.video_xfpos = stRect.u32X;
    WBC_DHD0_VFPOS.bits.video_yfpos = stRect.u32Y;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_VFPOS.u32) + enLayer * WBC_OFFSET), WBC_DHD0_VFPOS.u32);

    WBC_DHD0_VLPOS.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_VLPOS.u32) + enLayer * WBC_OFFSET));
    WBC_DHD0_VLPOS.bits.video_xlpos = stRect.u32X + stRect.u32Wth - 1;
    WBC_DHD0_VLPOS.bits.video_ylpos = stRect.u32Y + stRect.u32Hgt - 1;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_VLPOS.u32) + enLayer * WBC_OFFSET), WBC_DHD0_VLPOS.u32);
    return ;
}
...
HI_VOID  VDP_WBC_SetDispPos     ( VDP_LAYER_WBC_E enLayer, VDP_RECT_S  stRect)
{
    ...
    /*video position */
    WBC_DHD0_DFPOS.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_DFPOS.u32) + enLayer * WBC_OFFSET));
    WBC_DHD0_DFPOS.bits.disp_xfpos = stRect.u32X;
    WBC_DHD0_DFPOS.bits.disp_yfpos = stRect.u32Y;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_DFPOS.u32) + enLayer * WBC_OFFSET), WBC_DHD0_DFPOS.u32);

    WBC_DHD0_DLPOS.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_DLPOS.u32) + enLayer * WBC_OFFSET));
    WBC_DHD0_DLPOS.bits.disp_xlpos = stRect.u32X + stRect.u32Wth - 1;
    WBC_DHD0_DLPOS.bits.disp_ylpos = stRect.u32Y + stRect.u32Hgt - 1;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_DLPOS.u32) + enLayer * WBC_OFFSET), WBC_DHD0_DLPOS.u32);
    return ;
}
...
{
    U_WBC_VIDEO_BK WBC_VIDEO_BK;

    WBC_VIDEO_BK.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_VIDEO_BK.u32) + enLayer * WBC_OFFSET));
    WBC_VIDEO_BK.bits.vbk_y  = stBkg.u32BkgY;
    WBC_VIDEO_BK.bits.vbk_cb = stBkg.u32BkgU;
    WBC_VIDEO_BK.bits.vbk_cr = stBkg.u32BkgV;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_VIDEO_BK.u32) + enLayer * WBC_OFFSET), WBC_VIDEO_BK.u32);
...
{
    U_WBC_MIXV_BK WBC_MIXV_BK;

    WBC_MIXV_BK.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_MIXV_BK.u32) + enLayer * WBC_OFFSET));
    WBC_MIXV_BK.bits.mix_y  = stBkg.u32BkgY;
    WBC_MIXV_BK.bits.mix_cb = stBkg.u32BkgU;
    WBC_MIXV_BK.bits.mix_cr = stBkg.u32BkgV;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_MIXV_BK.u32) + enLayer * WBC_OFFSET), WBC_MIXV_BK.u32);
...
HI_VOID VDP_WBC_SetMuteEnable     ( VDP_LAYER_WBC_E enLayer, HI_U32 bEnable)
{
    ...
    WBC_DHD0_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_CTRL.u32) + enLayer * WBC_OFFSET));
    WBC_DHD0_CTRL.bits.mute_en = bEnable;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_CTRL.u32) + enLayer * WBC_OFFSET), WBC_DHD0_CTRL.u32);
...
{
    U_WBC_MUTE_BK WBC_MUTE_BK;

    WBC_MUTE_BK.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_MUTE_BK.u32) + enLayer * WBC_OFFSET));
    WBC_MUTE_BK.bits.mute_y  = stMuteBkg.u32MuteBkgY;
    WBC_MUTE_BK.bits.mute_cb = stMuteBkg.u32MuteBkgU;
    WBC_MUTE_BK.bits.mute_cr = stMuteBkg.u32MuteBkgV;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_MUTE_BK.u32) + enLayer * WBC_OFFSET), WBC_MUTE_BK.u32);
...
HI_VOID VDP_WBC_SetSpd(VDP_LAYER_WBC_E enLayer, HI_U32 u32ReqSpd)
{
    ...
    if (enLayer == VDP_LAYER_WBC_GP0)
    {
        ...
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_GP0_CTRL.u32)), WBC_GP0_CTRL.u32);
    }
    else
    {
        WBC_DHD0_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_CTRL.u32) + enLayer * WBC_OFFSET));
...
{
    U_WBC_DHD0_WLEN_SEL WBC_DHD0_WLEN_SEL;

    WBC_DHD0_WLEN_SEL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_WLEN_SEL.u32) + enLayer * WBC_OFFSET));
    WBC_DHD0_WLEN_SEL.bits.wlen_sel = stWlen;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_WLEN_SEL.u32) + enLayer * WBC_OFFSET), WBC_DHD0_WLEN_SEL.u32);
}
...
HI_VOID VDP_WBC_SetBmp_Thd( VDP_LAYER_WBC_E enLayer, HI_U32 u32wbc_bmp_thd)
{
    ...
    WBC_BMP_THD.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_BMP_THD.u32) ));
    WBC_BMP_THD.bits.wbc_bmp_thd = u32wbc_bmp_thd;
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_BMP_THD.u32) ), WBC_BMP_THD.u32);
}
...
HI_VOID VDP_WBC_SetCscMode( VDP_LAYER_WBC_E enLayer, VDP_CSC_MODE_E enCscMode)
{
    ...
    //    WBC_DHD0_CSCIDC.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->WBC_DHD0_CSCIDC.u32)));
    //    WBC_DHD0_CSCIDC.bits.csc_mode = enCscMode;
    //    VDP_RegWrite(((HI_ULONG)&(pVdpReg->WBC_DHD0_CSCIDC.u32)), WBC_DHD0_CSCIDC.u32);
    //}
    //else if(enLayer == VDP_LAYER_WBC_GP0)
    {
        //csc config mode
        ...
        if (enLayer == VDP_LAYER_WBC_HD0 || enLayer == VDP_LAYER_WBC_VP0 || enLayer == VDP_LAYER_WBC_FI)
        {
            ...
            {
#if  EDA_TEST
                st_csc_dc_coef.csc_in_dc0  = sGetRandEx(-255, 255) * u32DcPre;
                st_csc_dc_coef.csc_in_dc1  = sGetRandEx(-255, 255) * u32DcPre;
                st_csc_dc_coef.csc_in_dc2  = sGetRandEx(-255, 255) * u32DcPre;

                st_csc_dc_coef.csc_out_dc0 = sGetRandEx(-255, 255) * u32DcPre;
                st_csc_dc_coef.csc_out_dc1 = sGetRandEx(-255, 255) * u32DcPre;
                st_csc_dc_coef.csc_out_dc2 = sGetRandEx(-255, 255) * u32DcPre;
                st_csc_coef.csc_coef00     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);
                st_csc_coef.csc_coef01     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);
                st_csc_coef.csc_coef02     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);

                st_csc_coef.csc_coef10     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);
                st_csc_coef.csc_coef11     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);
                st_csc_coef.csc_coef12     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);

                st_csc_coef.csc_coef20     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);
                st_csc_coef.csc_coef21     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);
                st_csc_coef.csc_coef22     = (HI_S32)(sGetRandEx(-31, 31) * u32Pre);
#endif
            }
            else
            {
...
HI_VOID VDP_WBC_SetConnection(HI_U32 u32LayerId, HI_U32 u32Data )
{
    ...
    {
        VDP_PRINT("Error, VDP_WBC_SetConnection() select wrong dhd layer id\n");
        return ;

    }

    WBC_DHD_LOCATE.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD_LOCATE.u32)) + u32LayerId * WBC_OFFSET);
    WBC_DHD_LOCATE.bits.wbc_dhd_locate = (HI_U32) u32Data;
    VDP_RegWrite((((HI_ULONG) & (pVdpReg->WBC_DHD_LOCATE.u32)) + u32LayerId * WBC_OFFSET), WBC_DHD_LOCATE.u32);

    //U_WBC_CORRESP  WBC_CORRESP;

    //WBC_CORRESP.u32 = VDP_RegRead(((HI_ULONG)&(pVdpReg->WBC_CORRESP.u32)));
    //WBC_CORRESP.bits.wbc_corresp = u32Data;
    //VDP_RegWrite(((HI_ULONG)&(pVdpReg->WBC_CORRESP.u32)), WBC_CORRESP.u32);
...
HI_VOID VDP_WBC_SetCoefReadEnable(HI_U32 u32Id, HI_U32 u32Para)
{
    ...
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_PARARD.u32) + u32Id * 4), u32WrData);
}

HI_VOID VDP_WBC_SetCoefReadDisable(HI_U32 u32Id, HI_U32 u32Para)
{

    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_PARARD.u32) + u32Id * 4), 0);
}
...
HI_VOID VDP_WBC_SetCmpMb(VDP_LAYER_WBC_E enLayer, HI_U32 u32MbBits)
{
    ...
    {
        WBC_FI_CMP_MB.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_MB.u32)));
        WBC_FI_CMP_MB.bits.mb_bits = u32MbBits;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_MB.u32)), WBC_FI_CMP_MB.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpMb() Select a Wrong layer!\n");
    }
}
...
HI_VOID VDP_WBC_SetCmpMaxMin(VDP_LAYER_WBC_E enLayer, HI_U32 u32MinBitsCnt, HI_U32 u32MaxBitsCnt)
{
    ...
    if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_MAX_MIN.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_MAX_MIN.u32)));
        WBC_FI_CMP_MAX_MIN.bits.min_bits_cnt = u32MinBitsCnt;
        WBC_FI_CMP_MAX_MIN.bits.max_bits_cnt = u32MaxBitsCnt;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_MAX_MIN.u32)), WBC_FI_CMP_MAX_MIN.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpMaxMin() Select a Wrong layer!\n");
    }
}
HI_VOID VDP_WBC_SetCmpAdjThr(VDP_LAYER_WBC_E enLayer, HI_U32 u32AdjSadThr, HI_U32 u32AdjSadBitThr, HI_U32 u32AdjSpecBitThr)
{
    ...
    if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_ADJ_THR.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_ADJ_THR.u32)));
        ...
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_ADJ_THR.u32)), WBC_FI_CMP_ADJ_THR.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpAdjThr() Select a Wrong layer!\n");
    }
}
HI_VOID VDP_WBC_SetCmpBigGrad(VDP_LAYER_WBC_E enLayer, HI_U32 u32BigGradThr, HI_U32 u32BigGradNumThr)
{
    ...
    if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_BIG_GRAD.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_BIG_GRAD.u32)));
        WBC_FI_CMP_BIG_GRAD.bits.big_grad_thr = u32BigGradThr;
        WBC_FI_CMP_BIG_GRAD.bits.big_grad_num_thr = u32BigGradNumThr;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_BIG_GRAD.u32)), WBC_FI_CMP_BIG_GRAD.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpBigGrad() Select a Wrong layer!\n");
    }
}
...
HI_VOID VDP_WBC_SetCmpBlk(VDP_LAYER_WBC_E enLayer, HI_U32 u32SmthThr, HI_U32 u32BlkCompThr)
{
    ...
    if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_BLK.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_BLK.u32)));
        WBC_FI_CMP_BLK.bits.smth_thr = u32SmthThr;
        WBC_FI_CMP_BLK.bits.blk_comp_thr = u32BlkCompThr;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_BLK.u32)), WBC_FI_CMP_BLK.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpBlk() Select a Wrong layer!\n");
    }
}
...
HI_VOID VDP_WBC_SetCmpGraphic(VDP_LAYER_WBC_E enLayer, HI_U32 u32GrcEn, HI_U32 u32VideoSadThr)
{
    ...
    if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_GRAPHIC_JUDGE.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_GRAPHIC_JUDGE.u32)));
        WBC_FI_CMP_GRAPHIC_JUDGE.bits.graphic_en = u32GrcEn;
        WBC_FI_CMP_GRAPHIC_JUDGE.bits.video_sad_thr = u32VideoSadThr;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_GRAPHIC_JUDGE.u32)), WBC_FI_CMP_GRAPHIC_JUDGE.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpGraphic() Select a Wrong layer!\n");
    }
}
...
HI_VOID VDP_WBC_SetCmpRateCtrl(VDP_LAYER_WBC_E enLayer, HI_U32 u32MaxTrow, HI_U32 u32SmthGain, HI_U32 u32SadBitNgain)
{
    ...
    if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_RC.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_RC.u32)));
        ...
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_RC.u32)), WBC_FI_CMP_RC.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpRateCtrl() Select a Wrong layer!\n");
    }
}
...
HI_VOID VDP_WBC_SetCmpFrameSize(VDP_LAYER_WBC_E enLayer, HI_U32 u32FrameSize)
{
    ...
    if (enLayer == VDP_LAYER_WBC_FI)
    {
        WBC_FI_CMP_FRAME_SIZE.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_FRAME_SIZE.u32)));
        WBC_FI_CMP_FRAME_SIZE.bits.frame_size = u32FrameSize;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CMP_FRAME_SIZE.u32)), WBC_FI_CMP_FRAME_SIZE.u32);
    }
    else
    {
        VDP_PRINT("Error,VDP_WBC_SetCmpFrameSize() Select a Wrong layer!\n");
    }
}
...
HI_VOID VDP_WBC_SetMasterSel  (VDP_LAYER_WBC_E enVdpLayerWbc, VDP_MASTER_E enVdpMaster)
{
    ...
    WBC_ME_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_ME_CTRL.u32)));
    WBC_FI_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_FI_CTRL.u32)));
    WBC_BMP_CTRL.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_BMP_CTRL.u32)));


    if (enVdpMaster == VDP_MASTER0)
    {

        if (enVdpLayerWbc == VDP_LAYER_WBC_HD0 || enVdpLayerWbc == VDP_LAYER_WBC_VP0)
        {
            WBC_DHD0_CTRL.bits.ofl_master    = 0;
            VOMASTERSEL.bits.wbc0_master_sel = 0;
        }
        else if (enVdpLayerWbc == VDP_LAYER_WBC_GP0)
        {
            VOMASTERSEL.bits.wbc1_master_sel = 0;
        }
        else if (enVdpLayerWbc == VDP_LAYER_WBC_G0)
        {
            VOMASTERSEL.bits.wbc2_master_sel = 0;
        }
        else if (enVdpLayerWbc == VDP_LAYER_WBC_G4)
        {
            VOMASTERSEL.bits.wbc3_master_sel = 0;
        }
        else if (enVdpLayerWbc == VDP_LAYER_WBC_ME)
        {
            WBC_ME_CTRL.bits.ofl_master    = 0;
            VOMASTERSEL.bits.wbc4_master_sel = 0;
        }
        else if (enVdpLayerWbc == VDP_LAYER_WBC_FI)
        {
            WBC_FI_CTRL.bits.ofl_master    = 0;
            VOMASTERSEL.bits.wbc5_master_sel = 0;
        }
        else if (enVdpLayerWbc == VDP_LAYER_WBC_BMP)
        {
        ...
        {
            VDP_PRINT("Error! VDP_WBC_SetM0AndM1Sel() Select Wrong layer ID\n");
        }
    }
    else if (enVdpMaster == VDP_MASTER1)
    {
        if (enVdpLayerWbc == VDP_LAYER_WBC_HD0 || enVdpLayerWbc == VDP_LAYER_WBC_VP0)
        {
            WBC_DHD0_CTRL.bits.ofl_master    = 0;
    ...
    else if (enVdpMaster == VDP_MASTER2)
    {
        if (enVdpLayerWbc == VDP_LAYER_WBC_HD0 || enVdpLayerWbc == VDP_LAYER_WBC_VP0)
        {
    ...
    else if (enVdpMaster == VDP_MASTER3)
    {
        if (enVdpLayerWbc == VDP_LAYER_WBC_HD0 || enVdpLayerWbc == VDP_LAYER_WBC_VP0)
        {
            WBC_DHD0_CTRL.bits.ofl_master    = 1;
    ...
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_CTRL.u32)), WBC_DHD0_CTRL.u32);
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_ME_CTRL.u32)), WBC_ME_CTRL.u32);
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_BMP_CTRL.u32)), WBC_BMP_CTRL.u32);
    VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_FI_CTRL.u32)), WBC_FI_CTRL.u32);
...
HI_VOID VDP_WBC_SetFlipEnable(HI_U32 u32LayerId, HI_U32 u32Enable)
{
    ...
    {
        VDP_PRINT("Error,VDP_WBC_SetFlipEnable() Select a Wrong layer!\n");
    }
...
HI_VOID VDP_WBC_SetDhdFlip(HI_U32 u32LayerId, HI_U32 u32Data )
{
    ...
    if (u32LayerId != VDP_LAYER_WBC_HD0)
    {
        VDP_PRINT("Error, VDP_WBC_SetDhdFlip() select wrong dhd layer id\n");
        return ;
...
HI_VOID VDP_WBC_SetGpFlip(HI_U32 u32LayerId, HI_U32 u32Data )
{
    ...
    {
        VDP_PRINT("Error, VDP_WBC_SetGpFlip() select wrong dhd layer id\n");
        return ;
...
{
    U_WBC_DHD0_DEBUG WBC_DHD0_DEBUG;

    if ( enLayer == VDP_LAYER_WBC_VP0)
    {
        WBC_DHD0_DEBUG.u32 = VDP_RegRead(((HI_ULONG) & (pVdpReg->WBC_DHD0_DEBUG.u32) + enLayer * WBC_OFFSET));
        WBC_DHD0_DEBUG.bits.fmt_sel = u32FmtSel;
        VDP_RegWrite(((HI_ULONG) & (pVdpReg->WBC_DHD0_DEBUG.u32) + enLayer * WBC_OFFSET), WBC_DHD0_DEBUG.u32);
    }
    else
    {
        VDP_PRINT("Error, VDP_WBC_SetBtDebug () select wrong dhd layer id\n");
        return ;
    }
}
