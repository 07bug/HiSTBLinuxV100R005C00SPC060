...
#define  VO_DAC_CTRL1_DAC_OTP_REG 0x4080


#ifdef HI_VO_VDAC_LC_CIRCUIT
/*VDAC_DEFAULT_VALUE*/
const HI_U32 g_u32VdacGain[MAX_SONCHIPNUMBER_SUPPORT] = {0x80000370/*98mv310*/, 0x80000380/*98mv300*/};
#else
/*VDAC_DEFAULT_VALUE*/
const HI_U32 g_u32VdacGain[MAX_SONCHIPNUMBER_SUPPORT] = {0x80000060/*98mv310*/, 0x80000060/*98mv300*/};
#endif
