...
#define VDP_ANALOG_CTRL_ADDR     0xf8000f20
...
HI_VOID VDP_MVCN_GetMcvnEnable(HI_BOOL* bEnable);//get
...
HI_VOID SDATE_HDATE_VBI_GetCgmsTypeAEn(DISP_VENC_E enChanel,HI_BOOL* bEnTypeA);//get
HI_VOID SDATE_HDATE_VBI_SetCgmsTypeA(DISP_VENC_E enChanel,HI_U32 u32Data);
HI_VOID SDATE_HDATE_VBI_GetCgmsTypeA(DISP_VENC_E enChanel,HI_U32* u32Data);//get
HI_VOID SDATE_HDATE_VBI_SetWssData(DISP_VENC_E enChanel,HI_U32 u32Data);
HI_VOID SDATE_HDATE_VBI_GetWssData(DISP_VENC_E enChanel,HI_U32* u32Data);//get
HI_VOID SDATE_HDATE_VBI_SetWssEn(DISP_VENC_E enChanel,HI_BOOL bEnWss);
HI_VOID SDATE_HDATE_VBI_GetWssEn(DISP_VENC_E enChanel,HI_BOOL* bEnWss);//get
HI_S32 SDATE_MVCN_DATE_SetMcvn(HI_U32 *pu32Value);
HI_S32 SDATE_MVCN_DATE_GetMcvn(HI_U32 *pu32Value);//get
