...
HI_VOID VDP_GP_SetZmeCkGtEn           (HI_U32 u32Data, HI_U32 ck_gt_en);//new add
HI_VOID VDP_GP_SetZmeCoefAddr         (HI_U32 u32Data, HI_U32 u32Mode, HI_U32 u32Addr);
HI_VOID VDP_GP0_SetZmeCoefAddr        (HI_U32 u32Addr);
HI_VOID VDP_GP_SetParaRd              (HI_U32 u32Data, VDP_GP_PARA_E enMode); //nouse
...
HI_VOID VDP_GP_SetLayerEnable          (HI_U32 u32Data, HI_U32 u32bEnable );//new add
HI_VOID VDP_GP_SetUpdMode              (HI_U32 u32Data, HI_U32  u32Rgup);//new add
...
HI_VOID VDP_GP_SetWcgCoef              (HI_U32 u32Data, VDP_WCG_COEF_S stWcgCoef);
