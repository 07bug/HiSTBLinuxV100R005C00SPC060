...
HI_VOID VDP_HDR_SetVCvmImapLms2iptOutDc   (HI_S32  * v_omap_lms2ipt_out_dc);
...
HI_VOID VDP_HDR_SetGcvmCoefParaup (HI_VOID                         );
HI_VOID VDP_HDR_SetGCvmSslutRdEn  ( HI_U32 vcvm_sslut_rd_en );
HI_VOID VDP_HDR_SetGCvmTslutRdEn  ( HI_U32 vcvm_tslut_rd_en );
HI_VOID VDP_HDR_SetGCvmSilutRdEn  ( HI_U32 vcvm_silut_rd_en );
HI_VOID VDP_HDR_SetGCvmTilutRdEn  ( HI_U32 vcvm_tilut_rd_en );
HI_VOID VDP_HDR_SetGCvmCoefAddr   ( HI_U32 gcvm_coef_addr   );

HI_VOID VDP_HDR_SetGCvmImapLms2iptOutDc   ( HI_S32  * g_omap_lms2ipt_out_dc ) ;
