...
#define GP_OFFSET      0x200
#define MIX_OFFSET     0x1000
#define CHN_OFFSET     0x200
#define INTF_OFFSET    0x400
...
#define REGION_FDR_OFFSET  0x30
#define VID_HFIR_OFFSET    0xD00
#define VID_ZME_OFFSET     0x200
