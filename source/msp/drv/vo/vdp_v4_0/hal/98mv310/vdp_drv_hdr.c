...
HI_S32 VDP_DRV_GetHdrCfg(XDP_DOLBY_CFG_MODE_E  enSceneMode, rpu_ext_config_fixpt_main_t *pstCompCfg, DmKsFxp_t *pstDmKs, XDP_HDR_CTRL_S *pstXdpHdrCtrl)
{
...
HI_S32 VDP_DRV_SetVid1Zme(HI_U32 u32LayerId, XDP_LAYER_VID_INFO_S *pstInfoOut)
{
    ...
    else
    {
        ...
        VDP_VID_SetZmeVerRatio         (VDP_LAYER_VID1, (pstInfoOut->stXdpSrcCfg.stElSrcRect.u32Hgt / 2 * ZME_HPREC) / pstInfoOut->stXdpPositionCfg.stVideoRect.u32Hgt * 2);
    }
...
HI_S32 XDP_DRV_SetHdrCbmBkg(XDP_LAYER_VID_INFO_S *pstInfoOut)
{

    /* set the mixv background color under RGB colorspace.NOTE:mixv is immediate register. */
    VDP_CBM_SetMixerBkg(VDP_CBM_MIX0, pstInfoOut->stXdpBkgCfg.stCbm0Color);
...
HI_S32 VDP_DRV_SetHdrMode(XDP_LAYER_VID_INFO_S  *stXdpHdrCfgIn, rpu_ext_config_fixpt_main_t *pstCompCfg, DmKsFxp_t *pstDmKs)
{

    XDP_HDR_CTRL_S stXdpHdrCtrl;
