                                  ...
                                  VDP_VID_ZOOM_BITARRAY_S *pBitCoef)
{
    ...
    for (i = 0; i < u32Cnt; i++)
    {
        ...
        s32Tmp = DRV_VDP_BitValue(*ps32Coef++);
        pBitCoef->stBit[i].bits_32 = s32Tmp;
        pBitCoef->stBit[i].bits_38 = (s32Tmp >> 2);

        pBitCoef->stBit[i].bits_4 = DRV_VDP_BitValue(*ps32Coef++);
        pBitCoef->stBit[i].bits_5 = DRV_VDP_BitValue(*ps32Coef++);

        s32Tmp = DRV_VDP_BitValue(*ps32Coef++);
        pBitCoef->stBit[i].bits_64 = s32Tmp;
        pBitCoef->stBit[i].bits_66 = s32Tmp >> 4;

        pBitCoef->stBit[i].bits_7 = DRV_VDP_BitValue(*ps32Coef++);
        pBitCoef->stBit[i].bits_8 = DRV_VDP_BitValue(*ps32Coef++);

        s32Tmp = DRV_VDP_BitValue(*ps32Coef++);
        pBitCoef->stBit[i].bits_96 = s32Tmp;
        pBitCoef->stBit[i].bits_94 = s32Tmp >> 6;
