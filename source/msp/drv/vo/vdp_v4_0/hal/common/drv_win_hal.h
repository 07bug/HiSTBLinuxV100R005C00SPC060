...
#define HI_WIN_OUT_RECT_I_X_ALIGN      (2)
#define HI_WIN_OUT_RECT_I_WIDTH_ALIGN  (2)
#define HI_WIN_OUT_RECT_I_Y_ALIGN      (2)
#define HI_WIN_OUT_RECT_I_HEIGHT_ALIGN (2)


#define HI_WIN_OUT_RECT_X_ALIGN      (2)
#define HI_WIN_OUT_RECT_WIDTH_ALIGN  (2)
#define HI_WIN_OUT_RECT_Y_ALIGN      (2)
#define HI_WIN_OUT_RECT_HEIGHT_ALIGN (2)

#define HI_WIN_OUT_RECT_X_SD_ALIGN      (2)
#define HI_WIN_OUT_RECT_WIDTH_SD_ALIGN  (2)
#define HI_WIN_OUT_RECT_Y_SD_ALIGN      (2)
#define HI_WIN_OUT_RECT_HEIGHT_SD_ALIGN (2)

#else

#define HI_WIN_OUT_RECT_I_X_ALIGN      (4)
#define HI_WIN_OUT_RECT_I_WIDTH_ALIGN  (4)
#define HI_WIN_OUT_RECT_I_Y_ALIGN      (4)
#define HI_WIN_OUT_RECT_I_HEIGHT_ALIGN (4)


#define HI_WIN_OUT_RECT_X_ALIGN      (2)
#define HI_WIN_OUT_RECT_WIDTH_ALIGN  (2)
#define HI_WIN_OUT_RECT_Y_ALIGN      (4)
#define HI_WIN_OUT_RECT_HEIGHT_ALIGN (4)

#define HI_WIN_OUT_RECT_X_SD_ALIGN      (8)
#define HI_WIN_OUT_RECT_WIDTH_SD_ALIGN  (8)
#define HI_WIN_OUT_RECT_Y_SD_ALIGN      (8)
#define HI_WIN_OUT_RECT_HEIGHT_SD_ALIGN (8)

#endif

#define HI_WIN_OUT_RECT_X_3D_ALIGN      (4)
#define HI_WIN_OUT_RECT_WIDTH_3D_ALIGN  (4)
#define HI_WIN_OUT_RECT_Y_3D_ALIGN      (4)
#define HI_WIN_OUT_RECT_HEIGHT_3D_ALIGN (4)

#define HI_WIN_IN_RECT_X_ALIGN      (2)
#define HI_WIN_IN_RECT_WIDTH_ALIGN  (2)
#define HI_WIN_IN_RECT_Y_ALIGN      (4)
#define HI_WIN_IN_RECT_HEIGHT_ALIGN (4)

#define HI_WIN_IN_RECT_X_3D_ALIGN       (4)
#define HI_WIN_IN_RECT_WIDTH_3D_ALIGN   (4)
#define HI_WIN_IN_RECT_Y_3D_ALIGN       (4)
#define HI_WIN_IN_RECT_HEIGHT_3D_ALIGN  (4)
...
#define BITWIDTH_8BIT   8
#define BITWIDTH_10BIT  10
#define BITWIDTH_12BIT  12
...
typedef struct tagVIDEO_LAYER_FUNCTIONG_S
{
    ...
    HI_S32 (*PF_SetSdLayerCfg)(HI_U32 u32Layer, HI_VOID *pstWinInfo);
