#ifndef __VPSS_HAL_3716MV410_H__
#define __VPSS_HAL_3716MV410_H__
#include"hi_type.h"
...
#define VPSS_REG_SIZE    ((sizeof(VPSS_REG_S) + 15) & 0xFFFFFFF0) //16bytes align
...
typedef struct hiVPSS_HAL_INFO_S
{
    ...
    /*VPSS V2_0*/
    VPSS_HAL_FRAME_S        stInRefInfo[3];       //参考帧信息
