...
HI_S32 VPSS_REG_ReSetCRG(HI_U32 u32Type)
{
    ...
    PERI_CRG60.bits.vpss_clk_sel = 3;
...
HI_S32 VPSS_REG_SetAddr(HI_U32 u32AppAddr, VPSS_REG_ADDR_E eType, HI_U32 u32Addr)
{
    ...
    switch (eType)
    {
            ...
            //      break;
        case REG_VPSS_TNR_ADDR:
            VPSS_REG_RegWrite((volatile HI_U32 *) & (pstReg->VPSS_TNR_ADDR), u32Addr);
            break;

        case REG_VPSS_TNR_CLUT_ADDR:
            VPSS_REG_RegWrite((volatile HI_U32 *) & (pstReg->VPSS_TNR_CLUT_ADDR), u32Addr);
            break;

        case REG_VPSS_DBM_ADDR:
            VPSS_REG_RegWrite((volatile HI_U32 *) & (pstReg->VPSS_DBM_ADDR), u32Addr);
            break;
...
HI_S32 VPSS_REG_SetCurPackage(HI_U32 u32AppAddr, HI_U32 u32CurPackage422)
{
    ...
    VPSS_CUR_CTRL.bits.cur_package422 = u32CurPackage422;
...
HI_S32 VPSS_REG_SetRefPackage(HI_U32 u32AppAddr, HI_U32 u32RefPackage422)
{
    ...
    VPSS_REF_CTRL.bits.ref_package422 = u32RefPackage422;
...
HI_S32 VPSS_REG_SetFr0VC1_Profile(HI_U32 u32AppAddr, HI_U32 u32vc1profile)
{
    ...
    VPSS_VC1_CTRL0.bits.fr0_vc1_profile = u32vc1profile;
...
HI_S32 VPSS_REG_SetFr0VC1_RangedFrm(HI_U32 u32AppAddr, HI_U32 u32vc1rangedfrm)
{
    ...
    VPSS_VC1_CTRL0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL0.u32));
    VPSS_VC1_CTRL0.bits.fr0_vc1_rangedfrm = u32vc1rangedfrm;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL0.u32), VPSS_VC1_CTRL0.u32);
...
HI_S32 VPSS_REG_SetFr0VC1_MapyFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapyflg)
{
    ...
    VPSS_VC1_CTRL0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL0.u32));
    VPSS_VC1_CTRL0.bits.fr0_vc1_mapyflg = u32vc1mapyflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL0.u32), VPSS_VC1_CTRL0.u32);
...
HI_S32 VPSS_REG_SetFr0VC1_MapcFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapcflg)
{
    ...
    VPSS_VC1_CTRL0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL0.u32));
    VPSS_VC1_CTRL0.bits.fr0_vc1_mapcflg = u32vc1mapcflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL0.u32), VPSS_VC1_CTRL0.u32);
...
HI_S32 VPSS_REG_SetFr0VC1_Mapy(HI_U32 u32AppAddr, HI_U32 u32vc1mapy)
{
    ...
    VPSS_VC1_CTRL0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL0.u32));
    VPSS_VC1_CTRL0.bits.fr0_vc1_mapy = u32vc1mapy;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL0.u32), VPSS_VC1_CTRL0.u32);

    return HI_SUCCESS;
} //lzx

HI_S32 VPSS_REG_SetFr0VC1_Mapc(HI_U32 u32AppAddr, HI_U32 u32vc1mapc)
{
    U_VPSS_VC1_CTRL0 VPSS_VC1_CTRL0;
    ...
    VPSS_VC1_CTRL0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL0.u32));
    VPSS_VC1_CTRL0.bits.fr0_vc1_mapc = u32vc1mapc;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL0.u32), VPSS_VC1_CTRL0.u32);
...
HI_S32 VPSS_REG_SetFr0VC1Enable(HI_U32 u32AppAddr, HI_BOOL bVc1Enable)
{
    ...
    VPSS_VC1_CTRL0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL0.u32));
    VPSS_VC1_CTRL0.bits.fr0_vc1_en = bVc1Enable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL0.u32), VPSS_VC1_CTRL0.u32);
...
HI_S32 VPSS_REG_SetFr1VC1_Profile(HI_U32 u32AppAddr, HI_U32 u32vc1profile)
{
    ...
    VPSS_VC1_CTRL1.bits.fr1_vc1_profile = u32vc1profile;
...
HI_S32 VPSS_REG_SetFr1VC1_RangedFrm(HI_U32 u32AppAddr, HI_U32 u32vc1rangedfrm)
{
    ...
    VPSS_VC1_CTRL1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL1.u32));
    VPSS_VC1_CTRL1.bits.fr1_vc1_rangedfrm = u32vc1rangedfrm;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL1.u32), VPSS_VC1_CTRL1.u32);
...
HI_S32 VPSS_REG_SetFr1VC1_MapyFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapyflg)
{
    ...
    VPSS_VC1_CTRL1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL1.u32));
    VPSS_VC1_CTRL1.bits.fr1_vc1_mapyflg = u32vc1mapyflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL1.u32), VPSS_VC1_CTRL1.u32);
...
HI_S32 VPSS_REG_SetFr1VC1_MapcFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapcflg)
{
    ...
    VPSS_VC1_CTRL1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL1.u32));
    VPSS_VC1_CTRL1.bits.fr1_vc1_mapcflg = u32vc1mapcflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL1.u32), VPSS_VC1_CTRL1.u32);
...
HI_S32 VPSS_REG_SetFr1VC1_Mapy(HI_U32 u32AppAddr, HI_U32 u32vc1mapy)
{
    ...
    VPSS_VC1_CTRL1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL1.u32));
    VPSS_VC1_CTRL1.bits.fr1_vc1_mapy = u32vc1mapy;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL1.u32), VPSS_VC1_CTRL1.u32);

    return HI_SUCCESS;
} //lzx

HI_S32 VPSS_REG_SetFr1VC1_Mapc(HI_U32 u32AppAddr, HI_U32 u32vc1mapc)
{
    U_VPSS_VC1_CTRL1 VPSS_VC1_CTRL1;
    ...
    VPSS_VC1_CTRL1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL1.u32));
    VPSS_VC1_CTRL1.bits.fr1_vc1_mapc = u32vc1mapc;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL1.u32), VPSS_VC1_CTRL1.u32);
...
HI_S32 VPSS_REG_SetFr1VC1Enable(HI_U32 u32AppAddr, HI_BOOL bVc1Enable)
{
    ...
    VPSS_VC1_CTRL1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL1.u32));
    VPSS_VC1_CTRL1.bits.fr1_vc1_en = bVc1Enable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL1.u32), VPSS_VC1_CTRL1.u32);
...
HI_S32 VPSS_REG_SetFr2VC1_Profile(HI_U32 u32AppAddr, HI_U32 u32vc1profile)
{
    ...
    VPSS_VC1_CTRL2.bits.fr2_vc1_profile = u32vc1profile;
...
HI_S32 VPSS_REG_SetFr2VC1_RangedFrm(HI_U32 u32AppAddr, HI_U32 u32vc1rangedfrm)
{
    ...
    VPSS_VC1_CTRL2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL2.u32));
    VPSS_VC1_CTRL2.bits.fr2_vc1_rangedfrm = u32vc1rangedfrm;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL2.u32), VPSS_VC1_CTRL2.u32);
...
HI_S32 VPSS_REG_SetFr2VC1_MapyFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapyflg)
{
    ...
    VPSS_VC1_CTRL2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL2.u32));
    VPSS_VC1_CTRL2.bits.fr2_vc1_mapyflg = u32vc1mapyflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL2.u32), VPSS_VC1_CTRL2.u32);
...
HI_S32 VPSS_REG_SetFr2VC1_MapcFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapcflg)
{
    ...
    VPSS_VC1_CTRL2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL2.u32));
    VPSS_VC1_CTRL2.bits.fr2_vc1_mapcflg = u32vc1mapcflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL2.u32), VPSS_VC1_CTRL2.u32);
...
HI_S32 VPSS_REG_SetFr2VC1_Mapy(HI_U32 u32AppAddr, HI_U32 u32vc1mapy)
{
    ...
    VPSS_VC1_CTRL2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL2.u32));
    VPSS_VC1_CTRL2.bits.fr2_vc1_mapy = u32vc1mapy;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL2.u32), VPSS_VC1_CTRL2.u32);

    return HI_SUCCESS;
} //lzx

HI_S32 VPSS_REG_SetFr2VC1_Mapc(HI_U32 u32AppAddr, HI_U32 u32vc1mapc)
{
    U_VPSS_VC1_CTRL2 VPSS_VC1_CTRL2;
    ...
    VPSS_VC1_CTRL2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL2.u32));
    VPSS_VC1_CTRL2.bits.fr2_vc1_mapc = u32vc1mapc;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL2.u32), VPSS_VC1_CTRL2.u32);
...
HI_S32 VPSS_REG_SetFr2VC1Enable(HI_U32 u32AppAddr, HI_BOOL bVc1Enable)
{
    ...
    VPSS_VC1_CTRL2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL2.u32));
    VPSS_VC1_CTRL2.bits.fr2_vc1_en = bVc1Enable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL2.u32), VPSS_VC1_CTRL2.u32);
...
HI_S32 VPSS_REG_SetFr3VC1_Profile(HI_U32 u32AppAddr, HI_U32 u32vc1profile)
{
    ...
    VPSS_VC1_CTRL3.bits.fr3_vc1_profile = u32vc1profile;
...
HI_S32 VPSS_REG_SetFr3VC1_RangedFrm(HI_U32 u32AppAddr, HI_U32 u32vc1rangedfrm)
{
    ...
    VPSS_VC1_CTRL3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL3.u32));
    VPSS_VC1_CTRL3.bits.fr3_vc1_rangedfrm = u32vc1rangedfrm;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL3.u32), VPSS_VC1_CTRL3.u32);
...
HI_S32 VPSS_REG_SetFr3VC1_MapyFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapyflg)
{
    ...
    VPSS_VC1_CTRL3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL3.u32));
    VPSS_VC1_CTRL3.bits.fr3_vc1_mapyflg = u32vc1mapyflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL3.u32), VPSS_VC1_CTRL3.u32);
...
HI_S32 VPSS_REG_SetFr3VC1_MapcFlg(HI_U32 u32AppAddr, HI_U32 u32vc1mapcflg)
{
    ...
    VPSS_VC1_CTRL3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL3.u32));
    VPSS_VC1_CTRL3.bits.fr3_vc1_mapcflg = u32vc1mapcflg;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL3.u32), VPSS_VC1_CTRL3.u32);
...
HI_S32 VPSS_REG_SetFr3VC1_Mapy(HI_U32 u32AppAddr, HI_U32 u32vc1mapy)
{
    ...
    VPSS_VC1_CTRL3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL3.u32));
    VPSS_VC1_CTRL3.bits.fr3_vc1_mapy = u32vc1mapy;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL3.u32), VPSS_VC1_CTRL3.u32);

    return HI_SUCCESS;
} //lzx

HI_S32 VPSS_REG_SetFr3VC1_Mapc(HI_U32 u32AppAddr, HI_U32 u32vc1mapc)
{
    U_VPSS_VC1_CTRL3 VPSS_VC1_CTRL3;
    ...
    VPSS_VC1_CTRL3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL3.u32));
    VPSS_VC1_CTRL3.bits.fr3_vc1_mapc = u32vc1mapc;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL3.u32), VPSS_VC1_CTRL3.u32);
...
HI_S32 VPSS_REG_SetFr3VC1Enable(HI_U32 u32AppAddr, HI_BOOL bVc1Enable)
{
    ...
    VPSS_VC1_CTRL3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VC1_CTRL3.u32));
    VPSS_VC1_CTRL3.bits.fr3_vc1_en = bVc1Enable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VC1_CTRL3.u32), VPSS_VC1_CTRL3.u32);
...
HI_S32 VPSS_REG_SetRch0SumSel(HI_U32 u32AppAddr, HI_U32 u32rch0sumsel)
{
    ...
    VPSS_CHK_SUM_SEL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CHK_SUM_SEL.u32));
    VPSS_CHK_SUM_SEL.bits.rch0_sum_sel = u32rch0sumsel;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CHK_SUM_SEL.u32), VPSS_CHK_SUM_SEL.u32);
...
HI_S32 VPSS_REG_SetRfrEn(HI_U32 u32AppAddr, HI_U32 u32RfrEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.rfr_en = u32RfrEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetTestPatEn(HI_U32 u32AppAddr, HI_U32 u32TestPatEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.test_pat_en = u32TestPatEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetMadRaddr(HI_U32 u32AppAddr, HI_U32 u32MadRaddr)
{
    ...
    VPSS_MAD_RADDR.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_MAD_RADDR.u32));
    VPSS_MAD_RADDR.bits.mad_raddr = u32MadRaddr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_MAD_RADDR.u32), VPSS_MAD_RADDR.u32);
...
HI_S32 VPSS_REG_SetMadWaddr(HI_U32 u32AppAddr, HI_U32 u32MadWaddr)
{
    ...
    VPSS_MAD_WADDR.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_MAD_WADDR.u32));
    VPSS_MAD_WADDR.bits.mad_waddr = u32MadWaddr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_MAD_WADDR.u32), VPSS_MAD_WADDR.u32);
...
HI_S32 VPSS_REG_SetMadStride(HI_U32 u32AppAddr, HI_U32 u32MadStride)
{
    ...
    VPSS_MADSTRIDE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_MADSTRIDE.u32));
    VPSS_MADSTRIDE.bits.mad_stride = u32MadStride;
    VPSS_REG_RegWrite(&(pstReg->VPSS_MADSTRIDE.u32), VPSS_MADSTRIDE.u32);
...
HI_S32 VPSS_REG_SetRfrAddr(HI_U32 u32AppAddr, HI_U32 u32RfrYaddr, HI_U32 u32RfrCaddr)
{
    ...
    VPSS_RFRYADDR.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_RFRYADDR.u32));
    VPSS_RFRYADDR.bits.rfry_addr = u32RfrYaddr;
    VPSS_RFRCADDR.bits.rfrc_addr = u32RfrCaddr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_RFRYADDR.u32), VPSS_RFRYADDR.u32);
...
HI_S32 VPSS_REG_SetRfrStride(HI_U32 u32AppAddr, HI_U32 u32RfrYStride, HI_U32 u32RfrCStride)
{
    ...
    VPSS_RFRSTRIDE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_RFRSTRIDE.u32));
    VPSS_RFRSTRIDE.bits.rfry_stride = u32RfrYStride;
    VPSS_RFRSTRIDE.bits.rfrc_stride = u32RfrCStride;
    VPSS_REG_RegWrite(&(pstReg->VPSS_RFRSTRIDE.u32), VPSS_RFRSTRIDE.u32);
...
HI_S32 VPSS_REG_SetRefSize(HI_U32 u32AppAddr, HI_U32 RefWidth, HI_U32 RefHight)
{
    ...
    VPSS_REFSIZE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_REFSIZE.u32));
    VPSS_REFSIZE.bits.refwidth = RefWidth - 1 ;
    VPSS_REFSIZE.bits.refheight = RefHight - 1 ;
    VPSS_REG_RegWrite(&(pstReg->VPSS_REFSIZE.u32), VPSS_REFSIZE.u32);
...
HI_S32 VPSS_REG_SetLcmpEn(HI_U32 u32AppAddr, HI_U32 LcmpEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.vhd0_lcmp_en = LcmpEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_Set_Y_Is_Lossless(HI_U32 u32AppAddr, HI_U32 u32YIslossless)
{
    ...
    VPSS_VHD0_LCMP_YINFO.bits.is_lossless = u32YIslossless;
...
HI_S32 VPSS_REG_Set_Y_Cmp_Mode(HI_U32 u32AppAddr, HI_U32 u32YCmpmode)
{
    ...
    VPSS_VHD0_LCMP_YINFO.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YINFO.u32));
    VPSS_VHD0_LCMP_YINFO.bits.cmp_mode = u32YCmpmode;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YINFO.u32), VPSS_VHD0_LCMP_YINFO.u32);
...
HI_S32 VPSS_REG_Set_Y_Dw_Mode(HI_U32 u32AppAddr, HI_U32 u32YDwmode)
{
    ...
    VPSS_VHD0_LCMP_YINFO.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YINFO.u32));
    VPSS_VHD0_LCMP_YINFO.bits.dw_mode = u32YDwmode;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YINFO.u32), VPSS_VHD0_LCMP_YINFO.u32);
...
HI_S32 VPSS_REG_Set_C_Is_Lossless(HI_U32 u32AppAddr, HI_U32 u32CIslossless)
{
    ...
    VPSS_VHD0_LCMP_CINFO.bits.is_lossless = u32CIslossless;
...
HI_S32 VPSS_REG_Set_C_Cmp_Mode(HI_U32 u32AppAddr, HI_U32 u32CCmpmode)
{
    ...
    VPSS_VHD0_LCMP_CINFO.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CINFO.u32));
    VPSS_VHD0_LCMP_CINFO.bits.cmp_mode = u32CCmpmode;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CINFO.u32), VPSS_VHD0_LCMP_CINFO.u32);
...
HI_S32 VPSS_REG_Set_C_Dw_Mode(HI_U32 u32AppAddr, HI_U32 u32CDwmode)
{
    ...
    VPSS_VHD0_LCMP_CINFO.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CINFO.u32));
    VPSS_VHD0_LCMP_CINFO.bits.dw_mode = u32CDwmode;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CINFO.u32), VPSS_VHD0_LCMP_CINFO.u32);
...
HI_S32 VPSS_REG_Set_Y_Frame_Width(HI_U32 u32AppAddr, HI_U32 u32YFramewidth)
{
    ...
    VPSS_VHD0_LCMP_YSIZE.bits.frame_width = u32YFramewidth - 1;
...
HI_S32 VPSS_REG_Set_Y_Frame_Height(HI_U32 u32AppAddr, HI_U32 u32YFramehight)
{
    ...
    VPSS_VHD0_LCMP_YSIZE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YSIZE.u32));
    VPSS_VHD0_LCMP_YSIZE.bits.frame_height = u32YFramehight - 1;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YSIZE.u32), VPSS_VHD0_LCMP_YSIZE.u32);
...
HI_S32 VPSS_REG_Set_C_Frame_Width(HI_U32 u32AppAddr, HI_U32 u32CFramewidth)
{
    ...
    VPSS_VHD0_LCMP_CSIZE.bits.frame_width = u32CFramewidth - 1;
...
HI_S32 VPSS_REG_Set_C_Frame_Height(HI_U32 u32AppAddr, HI_U32 u32CFramehight)
{
    ...
    VPSS_VHD0_LCMP_CSIZE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CSIZE.u32));
    VPSS_VHD0_LCMP_CSIZE.bits.frame_height = u32CFramehight - 1;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CSIZE.u32), VPSS_VHD0_LCMP_CSIZE.u32);
...
HI_S32 VPSS_REG_Set_Y_MbBits(HI_U32 u32AppAddr, HI_U32 u32YMb_bits)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG0.bits.mb_bits = u32YMb_bits;
...
HI_S32 VPSS_REG_Set_Y_RiBits(HI_U32 u32AppAddr, HI_U32 u32YRi_bits)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG0.u32));
    VPSS_VHD0_LCMP_YRCCFG0.bits.ri_bits = u32YRi_bits;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG0.u32), VPSS_VHD0_LCMP_YRCCFG0.u32);
...
HI_S32 VPSS_REG_Set_Y_MaxRgCompBits(HI_U32 u32AppAddr, HI_U32 u32YMaxRgCompB)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG0.u32));
    VPSS_VHD0_LCMP_YRCCFG0.bits.max_rg_comp_bits = u32YMaxRgCompB;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG0.u32), VPSS_VHD0_LCMP_YRCCFG0.u32);
...
HI_S32 VPSS_REG_Set_Y_MaxQp(HI_U32 u32AppAddr, HI_U32 u32YMaxQp)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG1.bits.max_qp = u32YMaxQp;
...
HI_S32 VPSS_REG_Set_Y_SadNgain(HI_U32 u32AppAddr, HI_U32 u32YSadNgain)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG1.u32));
    VPSS_VHD0_LCMP_YRCCFG1.bits.sad_bits_ngain = u32YSadNgain;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG1.u32), VPSS_VHD0_LCMP_YRCCFG1.u32);
...
HI_S32 VPSS_REG_Set_Y_RcSmthNgain(HI_U32 u32AppAddr, HI_U32 u32YRcSmthNgain)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG1.u32));
    VPSS_VHD0_LCMP_YRCCFG1.bits.rc_smth_ngain = u32YRcSmthNgain;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG1.u32), VPSS_VHD0_LCMP_YRCCFG1.u32);
...
HI_S32 VPSS_REG_Set_Y_SmthThr(HI_U32 u32AppAddr, HI_U32 u32YSmthThr)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG2.bits.smth_thr = u32YSmthThr;
...
HI_S32 VPSS_REG_Set_Y_SmthPixNumThr(HI_U32 u32AppAddr, HI_U32 u32YSmthPixNumThr)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG2.u32));
    VPSS_VHD0_LCMP_YRCCFG2.bits.smth_pix_num_thr = u32YSmthPixNumThr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG2.u32), VPSS_VHD0_LCMP_YRCCFG2.u32);
...
HI_S32 VPSS_REG_Set_Y_PixDiffThr(HI_U32 u32AppAddr, HI_U32 u32YPixDiffThr)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG2.u32));
    VPSS_VHD0_LCMP_YRCCFG2.bits.pix_diff_thr = u32YPixDiffThr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG2.u32), VPSS_VHD0_LCMP_YRCCFG2.u32);
...
HI_S32 VPSS_REG_Set_Y_AdjSadThr(HI_U32 u32AppAddr, HI_U32 u32YAdjSadThr)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG3.bits.adj_sad_thr = u32YAdjSadThr;
...
HI_S32 VPSS_REG_Set_Y_AdjSadBitThr(HI_U32 u32AppAddr, HI_U32 u32YAdjSadbitThr)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG3.u32));
    VPSS_VHD0_LCMP_YRCCFG3.bits.adj_sad_bit_thr = u32YAdjSadbitThr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG3.u32), VPSS_VHD0_LCMP_YRCCFG3.u32);
...
HI_S32 VPSS_REG_Set_Y_QpChg1BitsThr(HI_U32 u32AppAddr, HI_U32 u32YQpChg1Thr)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG4.bits.qp_chg1_bits_thr = u32YQpChg1Thr;
...
HI_S32 VPSS_REG_Set_Y_QpChg2BitsThr(HI_U32 u32AppAddr, HI_U32 u32YQpChg2Thr)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG4.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG4.u32));
    VPSS_VHD0_LCMP_YRCCFG4.bits.qp_chg2_bits_thr = u32YQpChg2Thr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG4.u32), VPSS_VHD0_LCMP_YRCCFG4.u32);
...
HI_S32 VPSS_REG_Set_Y_SmthQp0(HI_U32 u32AppAddr, HI_U32 u32YSmthQp0)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG5.bits.smth_qp0 = u32YSmthQp0;
...
HI_S32 VPSS_REG_Set_Y_SmthQp1(HI_U32 u32AppAddr, HI_U32 u32YSmthQp1)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG5.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG5.u32));
    VPSS_VHD0_LCMP_YRCCFG5.bits.smth_qp1 = u32YSmthQp1;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG5.u32), VPSS_VHD0_LCMP_YRCCFG5.u32);
...
HI_S32 VPSS_REG_Set_Y_SmthLftBThr0(HI_U32 u32AppAddr, HI_U32 u32YSmthLftBThr0)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG5.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG5.u32));
    VPSS_VHD0_LCMP_YRCCFG5.bits.smth_lftbits_thr0 = u32YSmthLftBThr0;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG5.u32), VPSS_VHD0_LCMP_YRCCFG5.u32);
...
HI_S32 VPSS_REG_Set_Y_SmthLftBThr1(HI_U32 u32AppAddr, HI_U32 u32YSmthLftBThr1)
{
    ...
    VPSS_VHD0_LCMP_YRCCFG5.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_YRCCFG5.u32));
    VPSS_VHD0_LCMP_YRCCFG5.bits.smth_lftbits_thr1 = u32YSmthLftBThr1;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_YRCCFG5.u32), VPSS_VHD0_LCMP_YRCCFG5.u32);
...
HI_S32 VPSS_REG_Set_Y_MaxRowLen(HI_U32 u32AppAddr, HI_U32 u32YMaxRowLen)
{
    ...
    VPSS_VHD0_LCMP_YMAXLEN.bits.max_row_len = u32YMaxRowLen;
...
HI_S32 VPSS_REG_SetMax_Row_Len(HI_U32 u32AppAddr, HI_U32 u32MaxRowLen)
{
    ...
    VPSS_VHD0_LCMP_CINFO.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CINFO.u32));
    VPSS_VHD0_LCMP_CINFO.bits.max_row_len = u32MaxRowLen;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CINFO.u32), VPSS_VHD0_LCMP_CINFO.u32);
    */
    return HI_SUCCESS;
} //lzx
...
HI_S32 VPSS_REG_Set_C_MbBits(HI_U32 u32AppAddr, HI_U32 u32CMb_bits)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG0.bits.mb_bits = u32CMb_bits;
...
HI_S32 VPSS_REG_Set_C_RiBits(HI_U32 u32AppAddr, HI_U32 u32CRi_bits)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG0.u32));
    VPSS_VHD0_LCMP_CRCCFG0.bits.ri_bits = u32CRi_bits;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG0.u32), VPSS_VHD0_LCMP_CRCCFG0.u32);
...
HI_S32 VPSS_REG_Set_C_MaxRgCompBits(HI_U32 u32AppAddr, HI_U32 u32CMaxRgCompB)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG0.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG0.u32));
    VPSS_VHD0_LCMP_CRCCFG0.bits.max_rg_comp_bits = u32CMaxRgCompB;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG0.u32), VPSS_VHD0_LCMP_CRCCFG0.u32);
...
HI_S32 VPSS_REG_Set_C_Max_Qp(HI_U32 u32AppAddr, HI_U32 u32CMaxQp)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG1.bits.max_qp = u32CMaxQp;
...
HI_S32 VPSS_REG_Set_C_SadNgain(HI_U32 u32AppAddr, HI_U32 u32CSadNgain)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG1.u32));
    VPSS_VHD0_LCMP_CRCCFG1.bits.sad_bits_ngain = u32CSadNgain;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG1.u32), VPSS_VHD0_LCMP_CRCCFG1.u32);
...
HI_S32 VPSS_REG_Set_C_RcSmthNgain(HI_U32 u32AppAddr, HI_U32 u32CRcSmthNgain)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG1.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG1.u32));
    VPSS_VHD0_LCMP_CRCCFG1.bits.rc_smth_ngain = u32CRcSmthNgain;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG1.u32), VPSS_VHD0_LCMP_CRCCFG1.u32);
...
HI_S32 VPSS_REG_Set_C_SmthThr(HI_U32 u32AppAddr, HI_U32 u32CSmthThr)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG2.bits.smth_thr = u32CSmthThr;
...
HI_S32 VPSS_REG_Set_C_SmthPixNumThr(HI_U32 u32AppAddr, HI_U32 u32CSmthPixNumThr)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG2.u32));
    VPSS_VHD0_LCMP_CRCCFG2.bits.smth_pix_num_thr = u32CSmthPixNumThr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG2.u32), VPSS_VHD0_LCMP_CRCCFG2.u32);
...
HI_S32 VPSS_REG_Set_C_PixDiffThr(HI_U32 u32AppAddr, HI_U32 u32CPixDiffThr)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG2.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG2.u32));
    VPSS_VHD0_LCMP_CRCCFG2.bits.pix_diff_thr = u32CPixDiffThr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG2.u32), VPSS_VHD0_LCMP_CRCCFG2.u32);
...
HI_S32 VPSS_REG_Set_C_AdjSadThr(HI_U32 u32AppAddr, HI_U32 u32CAdjSadThr)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG3.bits.adj_sad_thr = u32CAdjSadThr;
...
HI_S32 VPSS_REG_Set_C_AdjSadBitThr(HI_U32 u32AppAddr, HI_U32 u32CAdjSadbitThr)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG3.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG3.u32));
    VPSS_VHD0_LCMP_CRCCFG3.bits.adj_sad_bit_thr = u32CAdjSadbitThr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG3.u32), VPSS_VHD0_LCMP_CRCCFG3.u32);
...
HI_S32 VPSS_REG_Set_C_QpChg1BitsThr(HI_U32 u32AppAddr, HI_U32 u32CQpChg1Thr)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG4.bits.qp_chg1_bits_thr = u32CQpChg1Thr;
...
HI_S32 VPSS_REG_Set_C_QpChg2BitsThr(HI_U32 u32AppAddr, HI_U32 u32CQpChg2Thr)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG4.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG4.u32));
    VPSS_VHD0_LCMP_CRCCFG4.bits.qp_chg2_bits_thr = u32CQpChg2Thr;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG4.u32), VPSS_VHD0_LCMP_CRCCFG4.u32);
...
HI_S32 VPSS_REG_Set_C_SmthQp0(HI_U32 u32AppAddr, HI_U32 u32CSmthQp0)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG5.bits.smth_qp0 = u32CSmthQp0;
...
HI_S32 VPSS_REG_Set_C_SmthQp1(HI_U32 u32AppAddr, HI_U32 u32CSmthQp1)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG5.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG5.u32));
    VPSS_VHD0_LCMP_CRCCFG5.bits.smth_qp1 = u32CSmthQp1;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG5.u32), VPSS_VHD0_LCMP_CRCCFG5.u32);
...
HI_S32 VPSS_REG_Set_C_SmthLftBThr0(HI_U32 u32AppAddr, HI_U32 u32CSmthLftBThr0)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG5.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG5.u32));
    VPSS_VHD0_LCMP_CRCCFG5.bits.smth_lftbits_thr0 = u32CSmthLftBThr0;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG5.u32), VPSS_VHD0_LCMP_CRCCFG5.u32);
...
HI_S32 VPSS_REG_Set_C_SmthLftBThr1(HI_U32 u32AppAddr, HI_U32 u32CSmthLftBThr1)
{
    ...
    VPSS_VHD0_LCMP_CRCCFG5.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_LCMP_CRCCFG5.u32));
    VPSS_VHD0_LCMP_CRCCFG5.bits.smth_lftbits_thr1 = u32CSmthLftBThr1;
    VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_LCMP_CRCCFG5.u32), VPSS_VHD0_LCMP_CRCCFG5.u32);
...
HI_S32 VPSS_REG_Set_C_MaxRowLen(HI_U32 u32AppAddr, HI_U32 u32CMaxRowLen)
{
    ...
    VPSS_VHD0_LCMP_CMAXLEN.bits.max_row_len = u32CMaxRowLen;
...
HI_S32 VPSS_REG_SetAxiRID(HI_U32 u32AppAddr, REG_AXI_RID_CHN_E eChn, HI_U32 u32AxiRID)
{
    ...
    {
        case REG_NX2C_RID:
            VPSS_AXI_RID0.u32 = VPSS_REG_RegRead((volatile HI_U32 *) & (pstReg->VPSS_RID_CFG0.u32));
            VPSS_AXI_RID0.bits.nx2c_rid = u32AxiRID;
            VPSS_REG_RegWrite((volatile HI_U32 *) & (pstReg->VPSS_RID_CFG0.u32), VPSS_AXI_RID0.u32);
            break;
        case REG_NX2Y_RID:
            VPSS_AXI_RID0.u32 = VPSS_REG_RegRead((volatile HI_U32 *) & (pstReg->VPSS_RID_CFG0.u32));
        ...
        case REG_RST_RID:
            VPSS_AXI_RID0.u32 = VPSS_REG_RegRead((volatile HI_U32 *) & (pstReg->VPSS_RID_CFG0.u32));
            VPSS_AXI_RID0.bits.rst_rid = u32AxiRID;
            VPSS_REG_RegWrite((volatile HI_U32 *) & (pstReg->VPSS_RID_CFG0.u32), VPSS_AXI_RID0.u32);
            break;
        default:
...
HI_S32 VPSS_REG_SetDbmEn(HI_U32 u32AppAddr, HI_U32 DbmEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.dbm_en = DbmEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetTnrEn(HI_U32 u32AppAddr, HI_U32 TnrEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.tnr_en = TnrEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetLbaEn(HI_U32 u32AppAddr, HI_U32 LbaEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.vhd0_lba_en = LbaEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetIfmdEn(HI_U32 u32AppAddr, HI_U32 IfmdEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.ifmd_en = IfmdEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetIglbEn(HI_U32 u32AppAddr, HI_U32 IglbEnable)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.iglb_en = IglbEnable;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetFrmSize(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32Height, HI_U32 u32Width)
{
    ...
    //U_VPSS_STRSIZE VPSS_STRSIZE; //lzxd
    VPSS_REG_S *pstReg;
...
HI_S32 VPSS_REG_SetFrmAddr(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32Yaddr, HI_U32 u32Caddr)
{
    ...
    {
        case VPSS_REG_HD:
            VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0YADDR.u32), u32Yaddr);
            VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0CADDR.u32), u32Caddr);
            break; //lzx
            /*
            case VPSS_REG_STR://STR
...
HI_S32 VPSS_REG_SetFrmStride(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32YStride, HI_U32 u32CStride)
{
    ...
    //U_VPSS_STRSTRIDE VPSS_STRSTRIDE; //lzxd
...
HI_S32 VPSS_REG_SetFrmFormat(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_DRV_PIX_FORMAT_E eFormat)
{
    ...
    {
        case VPSS_REG_HD:
            VPSS_CTRL2.bits.vhd0_format = u32Format; //lzx_U_VPSS_CTRL2_vhd0_format
...
HI_S32 VPSS_REG_SetZmeEnable(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, REG_ZME_MODE_E eMode, HI_BOOL bEnable)
{
    ...
    //U_VPSS_STR_VSP VPSS_STR_VSP; //lzx

    U_VPSS_VHD0_HSP VPSS_VHD0_HSP; //lzx
    //U_VPSS_VSD_HSP VPSS_VSD_HSP;
    //U_VPSS_STR_HSP VPSS_STR_HSP; //lzx
    VPSS_REG_S *pstReg;
...
HI_S32 VPSS_REG_SetZmeInSize(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32Height, HI_U32 u32Width)
{
    /*
     ...
     //U_VPSS_VHD_ZMEIRESO VPSS_VHD_ZMEIRESO; //lzxd
...
HI_S32 VPSS_REG_SetZmeOutSize(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32Height, HI_U32 u32Width)
{
    ...
    // U_VPSS_STR_ZMEORESO VPSS_STR_ZMEORESO; //lzxd
    VPSS_REG_S *pstReg;
    ...
    {
        case VPSS_REG_HD:
            VPSS_VHD0_ZMEORESO.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_ZMEORESO.u32));
            VPSS_VHD0_ZMEORESO.bits.oh = u32Height - 1;
            VPSS_VHD0_ZMEORESO.bits.ow = u32Width - 1;
            VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_ZMEORESO.u32), VPSS_VHD0_ZMEORESO.u32);
            break;
            /*
            case VPSS_REG_SD://SD
                                ...
                                REG_ZME_MODE_E eMode, HI_BOOL bEnable)
{
    U_VPSS_VHD0_VSP VPSS_VHD0_VSP;
    //U_VPSS_VSD_VSP VPSS_VSD_VSP;
    //U_VPSS_STR_VSP VPSS_STR_VSP; //lzxd

    U_VPSS_VHD0_HSP VPSS_VHD0_HSP; //lzx
    //U_VPSS_VSD_HSP VPSS_VSD_HSP;
    //U_VPSS_STR_HSP VPSS_STR_HSP; //lzxd
...
{
    U_VPSS_VHD0_HSP VPSS_VHD0_HSP; //lzx
    U_VPSS_VHD0_VSR VPSS_VHD0_VSR;//lzx
    ...
    */ //lzxd
    ...
    switch (ePort)
    {
        case VPSS_REG_HD:
            if (eMode == REG_ZME_MODE_HORC)
            {
                VPSS_VHD0_ZME_CHADDR = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_ZME_CHADDR));
                VPSS_VHD0_ZME_CHADDR = u32Addr;
                VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_ZME_CHADDR), VPSS_VHD0_ZME_CHADDR);
            }
            else if (eMode == REG_ZME_MODE_HORL)
            {
                VPSS_VHD0_ZME_LHADDR = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_ZME_LHADDR));
                VPSS_VHD0_ZME_LHADDR = u32Addr;
                VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_ZME_LHADDR), VPSS_VHD0_ZME_LHADDR);
            }
            else if (eMode == REG_ZME_MODE_VERC)
            {
                VPSS_VHD0_ZME_CVADDR = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_ZME_CVADDR));
                VPSS_VHD0_ZME_CVADDR = u32Addr;
                VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_ZME_CVADDR), VPSS_VHD0_ZME_CVADDR);
            }
            else if (eMode == REG_ZME_MODE_VERL)
            {
                VPSS_VHD0_ZME_LVADDR = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_ZME_LVADDR));
                VPSS_VHD0_ZME_LVADDR = u32Addr;
                VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_ZME_LVADDR), VPSS_VHD0_ZME_LVADDR);
            }
            else
            {
                VPSS_FATAL("REG ERROR\n");
...
HI_S32 VPSS_REG_GetPccData(HI_U32 u32AppAddr, HI_S32 *ps32FFWD,
                           ...
                           HI_S32 *ps32FWDTKR, HI_S32 *ps32WDTKR)
{
    /*
    VPSS_REG_S *pstReg;
...
HI_S32 VPSS_REG_SetLBAEn(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_BOOL bEnLba)
{
    ...
    {
        case VPSS_REG_HD:
            VPSS_CTRL.bits.vhd0_lba_en = bEnLba;
            break;
            /*
            case VPSS_REG_SD:
...
HI_S32 VPSS_REG_SetLBABg(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32Color, HI_U32 u32Alpha)
{
    ...
    */
    ...
    //U_VPSS_STRLBA_BK VPSS_STRLBA_BK; //lzxd
    VPSS_REG_S *pstReg;
    ...
    switch (ePort)
    {
        case VPSS_REG_HD:
            ...
            VPSS_VHD0LBA_BK.bits.vbk_y = (u32Color & 0xff0000) >> 16;
            VPSS_VHD0LBA_BK.bits.vbk_cb = (u32Color & 0xff00) >> 8;
            VPSS_VHD0LBA_BK.bits.vbk_cr = u32Color & 0xff;
                              ...
                              HI_U32 u32Height, HI_U32 u32Width)
{
    ...
    */
    ...
    //U_VPSS_VHDLBA_DFPOS VPSS_VHDLBA_DFPOS; //lzxd
    U_VPSS_VHD0LBA_DSIZE VPSS_VHD0LBA_DSIZE;

    //U_VPSS_STRLBA_DFPOS VPSS_STRLBA_DFPOS; //lzxd
    ...
    {
        case VPSS_REG_HD:
            //VPSS_VHDLBA_DFPOS.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHDLBA_DFPOS.u32)); //lzxd
            VPSS_VHD0LBA_DSIZE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0LBA_DSIZE.u32));

            //VPSS_VHDLBA_DFPOS.bits.disp_xfpos = u32XFPos; //lzxd
            //VPSS_VHDLBA_DFPOS.bits.disp_yfpos = u32YFPos;//lzxd

            VPSS_VHD0LBA_DSIZE.bits.vhd0_lba_width = u32Width - 1;
            VPSS_VHD0LBA_DSIZE.bits.vhd0_lba_height = u32Height - 1;

            //VPSS_REG_RegWrite(&(pstReg->VPSS_VHDLBA_DFPOS.u32), VPSS_VHDLBA_DFPOS.u32); //lzxd
            ...
            */
        case VPSS_REG_STR:
            //VPSS_STRLBA_DFPOS.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_STRLBA_DFPOS.u32)); //lzxd
            //VPSS_STRLBA_DSIZE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_STRLBA_DSIZE.u32)); //lzxd

            // VPSS_STRLBA_DFPOS.bits.disp_xfpos = u32XFPos; //lzxd
            // VPSS_STRLBA_DFPOS.bits.disp_yfpos = u32YFPos;//lzxd

            //VPSS_STRLBA_DSIZE.bits.disp_width = u32Width -1; //lzxd
            //VPSS_STRLBA_DSIZE.bits.disp_height = u32Height -1; //lzxd

            //VPSS_REG_RegWrite(&(pstReg->VPSS_STRLBA_DFPOS.u32), VPSS_STRLBA_DFPOS.u32);//lzxd
            //VPSS_REG_RegWrite(&(pstReg->VPSS_STRLBA_DSIZE.u32), VPSS_STRLBA_DSIZE.u32); //lzxd
            break;
        default:
            VPSS_FATAL("\nReg Error\n");
    }
    ...
    */ //lzd
    ...
    switch (ePort)
    {
        case VPSS_REG_HD:
            ...
            //VPSS_VHDLBA_VSIZE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHDLBA_VSIZE.u32)); //lzxd
            ...
            ///VPSS_VHDLBA_VSIZE.bits.video_height = u32Height - 1; //lzxd


            VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0LBA_VFPOS.u32), VPSS_VHD0LBA_VFPOS.u32);
            //VPSS_REG_RegWrite(&(pstReg->VPSS_VHDLBA_VSIZE.u32), VPSS_VHDLBA_VSIZE.u32); //lzxd
            break;
            /*
            case VPSS_REG_SD:
    ...
    */
    ...
    switch (ePort)
    {
        case VPSS_REG_HD:
            ...
            VPSS_VHD0CROP_SIZE.bits.vhd0_crop_en = HI_TRUE;
...
HI_S32 VPSS_REG_SetTunlAddr(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32TunlAddr)
{
    ...
    */
    // HI_U32  VPSS_STR_TUNL_ADDR; //lzxd
    ...
    {
        case VPSS_REG_HD:
            VPSS_VHD_TUNL_ADDR = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0_TUNL_ADDR.u32));
            VPSS_VHD_TUNL_ADDR = u32TunlAddr;
            VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0_TUNL_ADDR.u32), VPSS_VHD_TUNL_ADDR);
            break; //lzx
            /*
            case VPSS_REG_STR:
...
HI_S32 VPSS_REG_SetInCropEn(HI_U32 u32AppAddr, HI_BOOL bInCropEn)
{
    ...
    VPSS_INCROP_POS.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_INCROP_POS.u32));
    VPSS_INCROP_POS.bits.cur_in_crop_en  = bInCropEn;
    VPSS_INCROP_POS.bits.ref_in_crop_en  = bInCropEn;
    VPSS_INCROP_POS.bits.nxt1_in_crop_en  = bInCropEn;
    VPSS_INCROP_POS.bits.nxt2_in_crop_en  = bInCropEn;
    VPSS_REG_RegWrite(&(pstReg->VPSS_INCROP_POS.u32), VPSS_INCROP_POS.u32);
...
HI_S32 VPSS_REG_SetCurInCropEn(HI_U32 u32AppAddr, HI_BOOL bCurInCropEn)
{
    ...
    VPSS_INCROP_POS.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_INCROP_POS.u32));
    VPSS_INCROP_POS.bits.cur_in_crop_en  = bCurInCropEn;
    VPSS_REG_RegWrite(&(pstReg->VPSS_INCROP_POS.u32), VPSS_INCROP_POS.u32);
...
HI_S32 VPSS_REG_SetRefInCropEn(HI_U32 u32AppAddr, HI_BOOL bRefInCropEn)
{
    ...
    VPSS_INCROP_POS.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_INCROP_POS.u32));
    VPSS_INCROP_POS.bits.ref_in_crop_en  = bRefInCropEn;
    VPSS_REG_RegWrite(&(pstReg->VPSS_INCROP_POS.u32), VPSS_INCROP_POS.u32);
...
HI_S32 VPSS_REG_SetNxt1InCropEn(HI_U32 u32AppAddr, HI_BOOL bNxt1InCropEn)
{
    ...
    VPSS_INCROP_POS.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_INCROP_POS.u32));
    VPSS_INCROP_POS.bits.nxt1_in_crop_en  = bNxt1InCropEn;
    VPSS_REG_RegWrite(&(pstReg->VPSS_INCROP_POS.u32), VPSS_INCROP_POS.u32);
...
HI_S32 VPSS_REG_SetNxt2InCropEn(HI_U32 u32AppAddr, HI_BOOL bNxt2InCropEn)
{
    ...
    VPSS_INCROP_POS.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_INCROP_POS.u32));
    VPSS_INCROP_POS.bits.nxt2_in_crop_en  = bNxt2InCropEn;
    VPSS_REG_RegWrite(&(pstReg->VPSS_INCROP_POS.u32), VPSS_INCROP_POS.u32);
...
HI_S32 VPSS_REG_SetPortCropPos(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32CropY, HI_U32 u32CropX)
{
    ...
    */
    U_VPSS_VHD0CROP_POS VPSS_VHD0CROP_POS;
    //U_VPSS_STRCROP_POS VPSS_STRCROP_POS; //lzxd
...
HI_S32 VPSS_REG_SetPortCropSize(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_U32 u32CropHeight, HI_U32 u32CropWidth)
{
    ...
    */
    U_VPSS_VHD0CROP_SIZE VPSS_VHD0CROP_SIZE;
    //U_VPSS_STRCROP_SIZE VPSS_STRCROP_SIZE; //lzxd
...
HI_S32 VPSS_REG_SetPortCropEn(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_BOOL bPortCropEn)
{
    ...
    U_VPSS_VSDCROP_SIZE VPSS_VSDCROP_SIZE;
    */
    U_VPSS_VHD0CROP_SIZE VPSS_VHD0CROP_SIZE; //lzx
    //U_VPSS_STRCROP_SIZE VPSS_STRCROP_SIZE; //lzxd
    ...
    switch (ePort)
    {
        ...
        case VPSS_REG_HD:
            VPSS_VHD0CROP_SIZE.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_VHD0CROP_SIZE.u32));
            VPSS_VHD0CROP_SIZE.bits.vhd0_crop_en = bPortCropEn;
            VPSS_REG_RegWrite(&(pstReg->VPSS_VHD0CROP_SIZE.u32), VPSS_VHD0CROP_SIZE.u32);
            break;
            /* //lzx
            case VPSS_REG_STR:
...
HI_S32 VPSS_REG_SetPortFlipEn(HI_U32 u32AppAddr, VPSS_REG_PORT_E ePort, HI_BOOL bFlipEn)
{
    ...
    U_VPSS_VHD0CTRL VPSS_VHD0CTRL; //lzxd
...
HI_S32 VPSS_REG_SetPreHfirEn(HI_U32 u32AppAddr, HI_BOOL bHfirEn)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.vhd0_pre_hfir_en = bHfirEn;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetPreHfirMode(HI_U32 u32AppAddr, HI_U32 u32HfirMode)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.vhd0_pre_hfir_mode = u32HfirMode;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetPreVfirEn(HI_U32 u32AppAddr, HI_BOOL bVfirEn)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.vhd0_pre_vfir_en = bVfirEn;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
...
HI_S32 VPSS_REG_SetPreVfirMode(HI_U32 u32AppAddr, HI_U32 u32VfirMode)
{
    ...
    VPSS_CTRL.u32 = VPSS_REG_RegRead(&(pstReg->VPSS_CTRL.u32));
    VPSS_CTRL.bits.vhd0_pre_vfir_mode = u32VfirMode;
    VPSS_REG_RegWrite(&(pstReg->VPSS_CTRL.u32), VPSS_CTRL.u32);
                          ...
                          VPSS_REG_PREZME_E enHor, VPSS_REG_PREZME_E enVer)
{
    ...
    {
        case PREZME_DISABLE:
            VPSS_CTRL.bits.vhd0_pre_vfir_en = 0x0;
            break;
        case PREZME_2X:
            VPSS_CTRL.bits.vhd0_pre_vfir_en = 0x1;
            VPSS_CTRL.bits.vhd0_pre_vfir_mode = 0x0;
            break;
        case PREZME_4X:
            VPSS_CTRL.bits.vhd0_pre_vfir_en = 0x1;
            VPSS_CTRL.bits.vhd0_pre_vfir_mode = 0x1;
            break;
        case PREZME_8X:
            VPSS_CTRL.bits.vhd0_pre_vfir_en = 0x1;
            VPSS_CTRL.bits.vhd0_pre_vfir_mode = 0x2;
            break;
        case PREZME_VFIELD:
            VPSS_CTRL.bits.vhd0_pre_vfir_en = 0x1;
            VPSS_CTRL.bits.vhd0_pre_vfir_mode = 0x3;
            break;
        default:
            VPSS_CTRL.bits.vhd0_pre_vfir_en = 0x0;
            break;
