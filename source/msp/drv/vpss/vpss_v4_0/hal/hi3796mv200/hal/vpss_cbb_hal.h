...
#define VPSS_HAL_VIDEOPHONE_SCENE(eScene) (((eScene) == HI_DRV_VPSS_SCENE_MODE_VP_PREVIEW)\
        || ((eScene) == HI_DRV_VPSS_SCENE_MODE_VP_REMOTE))
...
typedef enum hiVPSS_HAL_TASK_NODE_E
{
    ...
    VPSS_HAL_TASK_DETILE_FIRST3FIELD,
...
typedef enum hiVPSS_HAL_NODE_TYPE_E //根据逻辑设计走
{
    ...
    VPSS_HAL_NODE_2D_DETILE_FIRST3FIELD         = 20,
    VPSS_HAL_NODE_2D_DETILE_FIRST3FIELD_VIRTUAL = 21,

    /* rotation must be in the last position */
    VPSS_HAL_NODE_ROTATION_Y        = 22,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_Y_VIRTUAL = 23,

    VPSS_HAL_NODE_ROTATION_C        = 24,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_C_VIRTUAL = 25,
...
typedef struct hiVPSS_MCDEI_ST_S
{
    ...
    VPSS_ST_BLKMT_CFG_S  stBlkmtCfg;  //blkmt运动信息
#endif

#ifdef VPSS_SUPPORT_DICNT
    VPSS_ST_DICNT_CFG_S  stDiCntCfg;
#endif
