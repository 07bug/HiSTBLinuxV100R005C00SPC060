...
typedef enum hiVPSS_HAL_NODE_TYPE_E //根据逻辑设计走
{
    ...
    VPSS_HAL_NODE_ROTATION_Y        = 20,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_Y_VIRTUAL = 21,
    VPSS_HAL_NODE_ROTATION_C        = 22,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_C_VIRTUAL = 23,

    VPSS_HAL_NODE_2D_FIELD_MC_SPLIT_NODE1 = 24,
    VPSS_HAL_NODE_2D_FIELD_MC_SPLIT_NODE2 = 25,
    VPSS_HAL_NODE_2D_FIELD_MC_SPLIT_NODE3 = 26,
    VPSS_HAL_NODE_2D_FIELD_MC_SPLIT_NODE4 = 27,
    VPSS_HAL_NODE_2D_FIELD_MC_SPLIT_NODE5 = 28,
