...
// File name     :  vpss_reg.h
// Author        :  x57490
// Version       :  1.0
// Date          :  2017-08-02
// Description   :  Define all registers/tables for SYS
// Others        :  Generated automatically by nManager V4.0
// History       :  x57490 2017-08-02 Create file
//******************************************************************************
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_5            : 3   ; /* [24..22]  */
        unsigned int    ifmd_en               : 1   ; /* [25]  */
        unsigned int    igbm_en               : 1   ; /* [26]  */
        unsigned int    reserved_6            : 2   ; /* [28..27]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    cf_dcmp_mode          : 4   ; /* [19..16]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_0            : 24  ; /* [27..4]  */
...
typedef union
{
    ...
    struct
    {
        unsigned int    reserved_0            : 27  ; /* [26..0]  */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved_2            : 8   ; /* [28..21]  */
...
/* Define the union U_VPSS0_SMMU_SCB_TTBR_H */
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VPSS0_SMMU_CB_TTBR_H */
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VPSS0_SMMU_ERR_RDADDR_H_S */
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VPSS0_SMMU_ERR_WRADDR_H_S */
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VPSS0_SMMU_ERR_RDADDR_H_NS */
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VPSS0_SMMU_ERR_WRADDR_H_NS */
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_VPSS0_SMMU_FAULT_ADDRH_PTW_S */
typedef union
{
    /* Define the struct bits  */
    struct
    {
        unsigned int fault_addrh_ptw_s      : 32  ; /* [31..0]  */
    } bits;

    /* Define an unsigned member */
    unsigned int    u32;

} U_VPSS0_SMMU_FAULT_ADDRH_PTW_S;
...
/* Define the union U_VPSS0_SMMU_FAULT_ADDRH_PTW_NS */
typedef union
{
    /* Define the struct bits  */
    struct
    {
        unsigned int fault_addrh_ptw_ns     : 32  ; /* [31..0]  */
    } bits;

    /* Define an unsigned member */
    unsigned int    u32;

} U_VPSS0_SMMU_FAULT_ADDRH_PTW_NS;
...
typedef struct
{
    ...
    U_VPSS_REF_VC1_CTRL0   VPSS_REF_VC1_CTRL0                ; /* 0x69c */
    U_VPSS_CUR_VC1_CTRL0   VPSS_CUR_VC1_CTRL0                ; /* 0x6a0 */
    U_VPSS_NX1_VC1_CTRL0   VPSS_NX1_VC1_CTRL0                ; /* 0x6a4 */
    U_VPSS_NX2_VC1_CTRL0   VPSS_NX2_VC1_CTRL0                ; /* 0x6a8 */
    unsigned int           reserved_14[597]                     ; /* 0x6ac~0xffc */
    ...
    unsigned int           reserved_15[919]                     ; /* 0x11a4~0x1ffc */
    ...
    unsigned int           reserved_16[58]                     ; /* 0x2018~0x20fc */
    ...
    unsigned int           reserved_17[5]                     ; /* 0x213c~0x214c */
    ...
    unsigned int           reserved_18[4]                     ; /* 0x2180~0x218c */
    ...
    unsigned int           reserved_19[8]                     ; /* 0x21e0~0x21fc */
    ...
    unsigned int           reserved_20[32]                     ; /* 0x2280~0x22fc */
    ...
    unsigned int           reserved_21[1288]                     ; /* 0x23e0~0x37fc */
    ...
    unsigned int           reserved_22[40]                     ; /* 0x3860~0x38fc */
    ...
    unsigned int           reserved_23[12]                     ; /* 0x3910~0x393c */
    ...
    unsigned int           reserved_24[416]                     ; /* 0x3980~0x3ffc */
    ...
    unsigned int           reserved_25[980]                     ; /* 0x40b0~0x4ffc */
    U_VPSS_CHN_CFG_CTRL    VPSS_CHN_CFG_CTRL                 ; /* 0x5000 */
    unsigned int           reserved_26[3]                     ; /* 0x5004~0x500c */
    U_VPSS_STT_W_ADDR_LOW   VPSS_STT_W_ADDR_LOW              ; /* 0x5010 */
    unsigned int           reserved_27[4]                     ; /* 0x5014~0x5020 */
    U_VPSS_CF_RTUNL_CTRL   VPSS_CF_RTUNL_CTRL                ; /* 0x5024 */
    unsigned int           reserved_28                     ; /* 0x5028 */
    ...
    unsigned int           reserved_70[2]                     ; /* 0x5398~0x539c */
    U_VPSS_P3MV_CTRL       VPSS_P3MV_CTRL                    ; /* 0x53a0 */
    unsigned int           reserved_71[2]                     ; /* 0x53a4~0x53a8 */
    ...
    unsigned int           reserved_74                     ; /* 0x53dc */
    U_VPSS_P2RGMV_CTRL     VPSS_P2RGMV_CTRL                  ; /* 0x53e0 */
    unsigned int           reserved_75[2]                     ; /* 0x53e4~0x53e8 */
    ...
    unsigned int           reserved_97[3]                     ; /* 0x58d4~0x58dc */
    U_VPSS_DI_WST_CTRL     VPSS_DI_WST_CTRL                  ; /* 0x58e0 */
    unsigned int           reserved_98                     ; /* 0x58e4 */
    ...
    unsigned int           reserved_99[3]                     ; /* 0x58f4~0x58fc */
    U_VPSS_DI_WST_CNT_CTRL   VPSS_DI_WST_CNT_CTRL            ; /* 0x5900 */
    unsigned int           reserved_100                     ; /* 0x5904 */
    ...
    unsigned int           reserved_101[3]                     ; /* 0x5914~0x591c */
    U_VPSS_P2MT_CTRL       VPSS_P2MT_CTRL                    ; /* 0x5920 */
    unsigned int           reserved_102                     ; /* 0x5924 */
    ...
    unsigned int           reserved_103[3]                     ; /* 0x5934~0x593c */
    U_VPSS_CFMV_CTRL       VPSS_CFMV_CTRL                    ; /* 0x5940 */
    unsigned int           reserved_104                     ; /* 0x5944 */
    ...
    unsigned int           reserved_105[3]                     ; /* 0x5954~0x595c */
    U_VPSS_CFRGMV_CTRL     VPSS_CFRGMV_CTRL                  ; /* 0x5960 */
    unsigned int           reserved_106                     ; /* 0x5964 */
    ...
    unsigned int           reserved_107[3]                     ; /* 0x5974~0x597c */
    U_VPSS_WPRJH_CTRL      VPSS_WPRJH_CTRL                   ; /* 0x5980 */
    unsigned int           reserved_108                     ; /* 0x5984 */
    ...
    unsigned int           reserved_109[3]                     ; /* 0x5994~0x599c */
    U_VPSS_WPRJV_CTRL      VPSS_WPRJV_CTRL                   ; /* 0x59a0 */
    unsigned int           reserved_110                     ; /* 0x59a4 */
    ...
    unsigned int           reserved_111[9619]                     ; /* 0x59b4~0xeffc */
    U_VPSS0_SMMU_SCR       VPSS0_SMMU_SCR                    ; /* 0xf000 */
    unsigned int           reserved_112                     ; /* 0xf004 */
    ...
    unsigned int           reserved_113[172]                     ; /* 0xf030~0xf2dc */
    U_VPSS0_SMMU_SCB_TTBR_H   VPSS0_SMMU_SCB_TTBR_H          ; /* 0xf2e0 */
    U_VPSS0_SMMU_SCB_TTBR   VPSS0_SMMU_SCB_TTBR              ; /* 0xf2e4 */
    U_VPSS0_SMMU_CB_TTBR_H   VPSS0_SMMU_CB_TTBR_H            ; /* 0xf2e8 */
    U_VPSS0_SMMU_CB_TTBR   VPSS0_SMMU_CB_TTBR                ; /* 0xf2ec */
    U_VPSS0_SMMU_ERR_RDADDR_H_S   VPSS0_SMMU_ERR_RDADDR_H_S  ; /* 0xf2f0 */
    U_VPSS0_SMMU_ERR_RDADDR_S   VPSS0_SMMU_ERR_RDADDR_S      ; /* 0xf2f4 */
    U_VPSS0_SMMU_ERR_WRADDR_H_S   VPSS0_SMMU_ERR_WRADDR_H_S  ; /* 0xf2f8 */
    U_VPSS0_SMMU_ERR_WRADDR_S   VPSS0_SMMU_ERR_WRADDR_S      ; /* 0xf2fc */
    U_VPSS0_SMMU_ERR_RDADDR_H_NS   VPSS0_SMMU_ERR_RDADDR_H_NS ; /* 0xf300 */
    U_VPSS0_SMMU_ERR_RDADDR_NS   VPSS0_SMMU_ERR_RDADDR_NS    ; /* 0xf304 */
    U_VPSS0_SMMU_ERR_WRADDR_H_NS   VPSS0_SMMU_ERR_WRADDR_H_NS ; /* 0xf308 */
    U_VPSS0_SMMU_ERR_WRADDR_NS   VPSS0_SMMU_ERR_WRADDR_NS    ; /* 0xf30c */
    U_VPSS0_SMMU_FAULT_ADDRH_PTW_S   VPSS0_SMMU_FAULT_ADDRH_PTW_S ; /* 0xf310 */
    U_VPSS0_SMMU_FAULT_ADDR_PTW_S   VPSS0_SMMU_FAULT_ADDR_PTW_S ; /* 0xf314 */
    U_VPSS0_SMMU_FAULT_ID_PTW_S   VPSS0_SMMU_FAULT_ID_PTW_S  ; /* 0xf318 */
    U_VPSS0_SMMU_FAULT_ADDRH_PTW_NS   VPSS0_SMMU_FAULT_ADDRH_PTW_NS ; /* 0xf31c */
    ...
    unsigned int           reserved_114                     ; /* 0xf32c */
    ...
    unsigned int           reserved_115                     ; /* 0xf33c */
    ...
    unsigned int           reserved_116                     ; /* 0xf34c */
    ...
    unsigned int           reserved_117                     ; /* 0xf35c */
    ...
    unsigned int           reserved_118[100]                     ; /* 0xf390~0xf51c */
