...
HI_VOID VPSS_Sys_SetUvInvert(S_VPSS_REGS_TYPE *pstVpssRegs, HI_U32 uv_invert)
{
    U_VPSS_VHD0CTRL VPSS_VHD0CTRL;

    VPSS_VHD0CTRL.u32 = VPSS_RegRead((HI_U32) & (pstVpssRegs->VPSS_VHD0CTRL.u32));
    VPSS_VHD0CTRL.bits.vhd0_uv_invert = uv_invert;
    VPSS_RegWrite((HI_U32) & (pstVpssRegs->VPSS_VHD0CTRL.u32), VPSS_VHD0CTRL.u32);

    return ;
}

HI_VOID VPSS_Sys_SetMirror(S_VPSS_REGS_TYPE *pstVpssRegs, HI_U32 mirror)
{
    U_VPSS_VHD0CTRL VPSS_VHD0CTRL;

    VPSS_VHD0CTRL.u32 = VPSS_RegRead((HI_U32) & (pstVpssRegs->VPSS_VHD0CTRL.u32));
    VPSS_VHD0CTRL.bits.vhd0_mirror  = mirror;
    VPSS_RegWrite((HI_U32) & (pstVpssRegs->VPSS_VHD0CTRL.u32), VPSS_VHD0CTRL.u32);

    return ;
}

HI_VOID VPSS_Sys_SetFlip(S_VPSS_REGS_TYPE *pstVpssRegs, HI_U32 flip)
{
    U_VPSS_VHD0CTRL VPSS_VHD0CTRL;

    VPSS_VHD0CTRL.u32 = VPSS_RegRead((HI_U32) & (pstVpssRegs->VPSS_VHD0CTRL.u32));
    VPSS_VHD0CTRL.bits.vhd0_flip  = flip;
    VPSS_RegWrite((HI_U32) & (pstVpssRegs->VPSS_VHD0CTRL.u32), VPSS_VHD0CTRL.u32);
