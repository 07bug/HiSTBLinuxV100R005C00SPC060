...
#define VPSS_WBCREG_SIZE        ((sizeof(S_STT_REGS_TYPE) + 15) & 0xFFFFFFF0)
...
#define VPSS_SPLIT_MAX_NODE 5
#define VPSS_OVERLAP_HEIGHT 32
#define VPSS_SPLIT_TOTAL_NODE_CNT (1+4+4)
...
typedef enum hiVPSS_HAL_NODE_TYPE_E //根据逻辑设计走
{
    ...
    VPSS_HAL_NODE_3D_FRAME_L        = 13,//3D左眼
    VPSS_HAL_NODE_3D_FRAME_R        = 14,//3D右眼

    VPSS_HAL_NODE_HDR_DETILE_NOALG  = 15,

    VPSS_HAL_NODE_HDR_LC            = 16,



    VPSS_HAL_NODE_2D_H265_STEP1_INTERLACE       = 17,
    VPSS_HAL_NODE_2D_H265_STEP2_DEI             = 18,

    VPSS_HAL_NODE_2D_DEI_FIRST_3FIELD            = 19,
    VPSS_HAL_NODE_2D_DEI_FIRST_3FIELD_VIRTUAL    = 20,


    VPSS_HAL_NODE_2D_DEI_LAST_2FIELD            = 21,
    VPSS_HAL_NODE_2D_DEI_LAST_2FIELD_VIRTUAL    = 22,

    VPSS_HAL_NODE_ROTATION_Y        = 23,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_Y_VIRTUAL = 24,
    VPSS_HAL_NODE_ROTATION_C        = 25,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_C_VIRTUAL = 26,

    VPSS_HAL_NODE_2D_MC_SPLIT_NODE1 = 27,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE2 = 28,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE3 = 29,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE4 = 30,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE5 = 31,

    VPSS_HAL_NODE_2D_MC_SPLIT_NODE6 = 32,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE7 = 33,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE8 = 34,
    VPSS_HAL_NODE_2D_MC_SPLIT_NODE9 = 35,
...
typedef struct hiVPSS_MCDEI_ST_S
{
    ...
    VPSS_ST_BLKMT_CFG_S      stBlkmtCfg;
#endif
#ifdef VPSS_SUPPORT_DICNT
    VPSS_ST_DICNT_CFG_S      stDiCntCfg;//di运动信息
#endif
} VPSS_MCDEI_ST_S;
...
typedef enum
{
    ...
    VPSS_BURST_LEN_8 = 1,
    VPSS_BURST_LEN_4 = 2,
    VPSS_BURST_LEN_BUTT = 3,
} VPSS_BURST_LEN_E;

typedef enum
{
    VPSS_ADDR_SPLIT_4k = 0,
    VPSS_ADDR_SPLIT_128 = 1,
    VPSS_ADDR_SPLIT_256 = 2,
    VPSS_ADDR_SPLIT_BUTT = 3,

} VPSS_ADDR_SPLIT_E;

typedef struct hiVPSS_HDR_INFO_S
{
    HI_BOOL                 bEnable;
    HI_BOOL                 bHdrIn;
} VPSS_HDR_INFO_S;
...
extern  HI_S32 VPSS_HAL_CfgAXI(VPSS_IP_E enIP);
extern HI_S32 VPSS_HAL_SetTaskInfo(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, VPSS_HAL_TASK_TYPE_E enTaskId, HI_BOOL abNodeVaild[VPSS_HAL_NODE_BUTT]);
...
extern HI_S32 VPSS_HAL_Set_RotaY_VIRTUAL_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy);
extern HI_S32 VPSS_HAL_Set_RotaC_VIRTUAL_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy);
extern HI_S32 VPSS_HAL_Set_HDR_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32 u32AppPhy);
extern HI_S32 VPSS_HAL_Set_LCHDR_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir,
                                      HI_U32 u32AppPhy);
...
extern HI_S32 VPSS_HAL_DumpReg(VPSS_IP_E enIP, HI_U32 *pu32AppVir);
...
extern HI_S32 VPSS_HAL_Set_2DDei_Last2Field_Node(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstHalInfo, HI_U32 *pu32AppVir, HI_U32
        u32AppPhy);
extern HI_S32 VPSS_HAL_GetNodeAddr(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstVpssHalInfo, HI_U32 u32NodeId, HI_U8 **pstRegAddr, HI_CHAR **ppNodeName);
...
extern HI_S32 VPSS_HAL_SDDeiBuffer_Alloc(VPSS_IP_E enIP, VPSS_HAL_INFO_S *pstVpssHalInfo, HI_BOOL bSecure);
extern HI_VOID VPSS_HAL_SDDeiBuffer_Free(VPSS_HAL_INFO_S *pstVpssHalInfo);
extern HI_BOOL VPSS_HAL_SupportMcSplit(VPSS_MCDI_SPLIT_MODE_E enSplitMode, HI_U32 u32Width, HI_BOOL bProgressive);
extern HI_VOID VPSS_HAL_CalcSplitWth(HI_U32 u32Width, HI_U32 *pu32FirstWth, HI_U32 *pu32MidWth, HI_U32 *pu32LastWth, HI_U32 *pu32SplitCnt);
extern HI_S32 VPSS_HAL_FreeRotaBuf(VPSS_HAL_INFO_S *pstHalInfo);
#ifdef __cplusplus
#if __cplusplus
}
#endif
