...
HI_S32 VPSS_REG_ResetAppReg(S_VPSS_REGS_TYPE *pstVpssRegs, S_VPSS_REGS_TYPE *pstPqReg);
...
extern HI_VOID VPSS_DRV_Set_VPSS_CTRL2(S_VPSS_REGS_TYPE *pstVpssRegs , HI_U32 mode );
...
extern HI_VOID VPSS_DRV_Set_VPSS_SNR_CTRL(S_VPSS_REGS_TYPE *pstVpssRegs , HI_U32 dbm_out_mode , HI_U32 mad_mode , HI_U32 det_hy_en , HI_U32 dbm_demo_mode , HI_U32 dbm_demo_en , HI_U32 db_lum_hor_en , HI_U32 nr_en , HI_U32 dm_en , HI_U32 db_en );
extern HI_VOID VPSS_DRV_Set_VPSS_SNR_CTRL_db(S_VPSS_REGS_TYPE *pstVpssRegs , HI_U32 db_en );
extern HI_VOID VPSS_DRV_Set_VPSS_SNR_CTRL_dm(S_VPSS_REGS_TYPE *pstVpssRegs , HI_U32 dm_en );
extern HI_VOID VPSS_DRV_Set_VPSS_SNR_CTRL_nr(S_VPSS_REGS_TYPE *pstVpssRegs , HI_U32 nr_en );
...
extern HI_VOID VPSS_DRV_Set_VPSS_TNR_CONTRL(S_VPSS_REGS_TYPE *pstVpssRegs , HI_U32 motion_mode , HI_U32 mcnr_rgme_mode , HI_U32 marketcoor , HI_U32 marketmode , HI_U32 marketmodeen , HI_U32 sharemotionen , HI_U32 mcnr_meds_en , HI_U32 cnren , HI_U32 ynren , HI_U32 nren );
...
extern HI_VOID VPSS_DRV_Set_VPSS_TRANS_INFO(S_VPSS_REGS_TYPE *pstVpssRegs , HI_U32 trans_en, HI_U32
        trans_size, HI_U32  trans_prot, HI_U32 bypass);
...
extern HI_U32 VPSS_REG_RegRead(volatile HI_U32 *a);
extern HI_S32 VPSS_REG_RegWrite(volatile HI_U32 *a, HI_U32 b);
extern HI_S32 VPSS_REG_ResetAppReg(S_VPSS_REGS_TYPE *pstVpssRegs, S_VPSS_REGS_TYPE *pstPqReg);
