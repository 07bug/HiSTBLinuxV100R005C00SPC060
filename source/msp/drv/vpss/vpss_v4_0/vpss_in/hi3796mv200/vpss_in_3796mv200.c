...
HI_S32 VPSS_IN_NewImgInit(VPSS_IN_ENTITY_S *pstEntity, HI_DRV_VIDEO_FRAME_S *pstImage)
{
    ...
    stWbcAttr.enBitWidth = pstImage->enBitWidth; //96MV200, follow srcimg, For RWZB(only 8bit) need 8bit wbc.
...

{
    ...
    HI_DRV_FIELD_MODE_E enFieldMode_tmp;
    ...
    enFieldMode_tmp = pstWbc->enFieldMode;
    ...
    pstWbc->enFieldMode = enFieldMode_tmp;
