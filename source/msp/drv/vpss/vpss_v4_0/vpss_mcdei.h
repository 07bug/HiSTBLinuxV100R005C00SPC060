...
typedef struct hiVPSS_MCDEI_INFO_S
{
    ...
    VPSS_ST_BLKMT_S      stBlkmtInfo;  //blkmt运动队列
#endif
...
HI_S32 VPSS_INST_McDeiInit(VPSS_MCDEI_INFO_S *pstMcdeiInfo, HI_DRV_VIDEO_FRAME_S *pstSrcImage, VPSS_MCDI_SPLIT_INFO_S *pstSplitInfo);
