...
#define HI_ALIGN_10BIT_COMP_YSTRIDE(x)   HI_SYS_GET_STRIDE(HICEILING(x*10, 8))   /* l0bit紧凑模式 */
#define HI_ALIGN_16BIT_COMP_YSTRIDE(x)   HI_SYS_GET_STRIDE(HICEILING(x*16, 8))   /* CTS10bit模式 */
