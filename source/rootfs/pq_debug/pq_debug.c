...
/*-----------------------------------------------------------------------------*/
/* PQ Debug模块初始化 */
extern HI_S32        PQ_DRV_Tool_Init(HI_VOID);

/* PQ Debug模块去初始化 */
extern HI_S32        PQ_DRV_Tool_Deinit(HI_VOID);
/* PQ Debug 解析命令 */
...
int main(int argc, HI_CHAR *argv[])
{
    HI_S32 s32Ret = HI_FAILURE;

    /*1. pq 设备初始化*/
    s32Ret = PQ_DRV_Tool_Init();
...
static HI_VOID DBG_Destroy(HI_S32 sig)
{
    ...
    HI_INFO_PQ("PQ_DRV_Tool_Deinit!\n");
    (HI_VOID)PQ_DRV_Tool_Deinit();
