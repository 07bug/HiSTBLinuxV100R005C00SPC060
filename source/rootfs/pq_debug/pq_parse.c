...
static HI_S32 HI_PQ_Tool_ReadReg(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_WriteReg(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_ReadRegs(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_WriteRegs(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_ReadDCIHistgram(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
//static HI_S32 HI_PQ_Tool_ReadDCI(HI_S32 client_sockfd, HI_U8* pu8Buffer);
static HI_S32 HI_PQ_Tool_WriteACM(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_SetTNRLumaPixMean2Ratio(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_GetTNRLumaPixMean2Ratio(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_SetTNRChromPixMean2Ratio(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_GetTNRChromPixMean2Ratio(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_SetTNRLumaMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_GetTNRLumaMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_SetTNRChromMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_GetTNRChromMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_SetTNRLumaFinalMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_GetTNRLumaFinalMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_SetTNRChromFinalMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_GetTNRChromFinalMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_SetTNRFMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
static HI_S32 HI_PQ_Tool_GetTNRFMotionMapping(HI_S32 client_sockfd, HI_U8 *pu8Buffer);
...
HI_S32 PQ_DBG_ReadVirtualReg(HI_U32 u32RegAddr, HI_U32 *pu32Data, HI_U32 u32Len)
{
    ...
    return PQ_DRV_Tool_ReadFromPqDriver(u32RegAddr, pu32Data, u32Len);
}
...
HI_S32 PQ_DBG_WriteVirtualReg(HI_U32 u32RegAddr, HI_U32 *u32Data, HI_U32 u32Len)
{
    ...
    return PQ_DRV_Tool_WriteToPqDriver(u32RegAddr, u32Data, u32Len);
}
...
static HI_S32 HI_PQ_Tool_ReadReg(HI_S32 client_sockfd, HI_U8 *pu8Buffer)
{
    ...
    else
    {
        ...
        if (HI_SUCCESS != PQ_DRV_Tool_ReadReg(u32RegAddr, &u32Value, &stBitRange))
        {
            PQ_Parse_SendErrorFlag(client_sockfd, HI_BOARD_PROCESS_ERROR);
...
static HI_S32 HI_PQ_Tool_WriteReg(HI_S32 client_sockfd, HI_U8 *pu8Buffer)
{
    ...
    else
    {
        ...
        if (HI_SUCCESS != PQ_DRV_Tool_WriteReg(u32RegAddr, u32Value, &stBitRange))
        {
            PQ_Parse_SendErrorFlag(client_sockfd, HI_BOARD_PROCESS_ERROR);
...
HI_S32 HI_PQ_Tool_WriteACM(HI_S32 client_sockfd, HI_U8 *pu8Buffer)
{
    CHECK_PTR_REINT(pu8Buffer);
    ...
    s32Ret = PQ_DRV_Tool_WriteACM(u32RegAddr, pu8ValidData, u32MsgLen);
    CHECK_RETURN(s32Ret);
...
static HI_S32 HI_PQ_Tool_SetSnrMeanRatio(HI_S32 client_sockfd, HI_U8 *pu8Buffer)
{
    CHECK_PTR_REINT(pu8Buffer);
...
static HI_S32 HI_PQ_Tool_GetSnrMeanRatio(HI_S32 client_sockfd, HI_U8 *pu8Buffer)
{
    CHECK_PTR_REINT(pu8Buffer);
...
static HI_S32 HI_PQ_Tool_SetSnrEdgeStr(HI_S32 client_sockfd, HI_U8 *pu8Buffer)
{
    CHECK_PTR_REINT(pu8Buffer);
...
static HI_S32 HI_PQ_Tool_GetSnrEdgeStr(HI_S32 client_sockfd, HI_U8 *pu8Buffer)
{
    CHECK_PTR_REINT(pu8Buffer);
...
{
    {PQ_CMD_READ_REG,       HI_PQ_Tool_ReadReg},
    {PQ_CMD_WRITE_REG,      HI_PQ_Tool_WriteReg},

    {PQ_CMD_READ_MATRIX,    HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_MATRIX,   HI_PQ_Tool_WriteRegs},

    {PQ_CMD_READ_REGS,      HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_REGS,     HI_PQ_Tool_WriteRegs},

    {PQ_CMD_READ_GAMMA,     HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_GAMMA,    HI_PQ_Tool_WriteRegs},

    {PQ_CMD_READ_ACM,       HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_ACM,      HI_PQ_Tool_WriteACM},
    {PQ_CMD_READ_ACC,       HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_ACC,      HI_PQ_Tool_WriteRegs},

    {PQ_CMD_EXPORT_BIN,     HI_PQ_Tool_ReadRegs},
    {PQ_CMD_IMPORT_BIN,     HI_PQ_Tool_WriteRegs},
    {PQ_CMD_FIX_BIN,        HI_PQ_Tool_WriteRegs},

    {PQ_CMD_READ_DCI_LUT,   HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_DCI_LUT,  HI_PQ_Tool_WriteRegs},
    {PQ_CMD_READ_HIST,      HI_PQ_Tool_ReadDCIHistgram},

    {PQ_CMD_READ_SNR_MEAN_RATIO,                   HI_PQ_Tool_GetSnrMeanRatio},
    {PQ_CMD_WRITE_SNR_MEAN_RATIO,                  HI_PQ_Tool_SetSnrMeanRatio},
    {PQ_CMD_READ_SNR_EDGE_STR,                     HI_PQ_Tool_GetSnrEdgeStr},
    {PQ_CMD_WRITE_SNR_EDGE_STR,                    HI_PQ_Tool_SetSnrEdgeStr},

    {PQ_CMD_READ_TNR_PIXMEAN_TO_RATIO_LUMA,        HI_PQ_Tool_GetTNRLumaPixMean2Ratio},
    {PQ_CMD_READ_TNR_PIXMEAN_TO_RATIO_CHROMA,      HI_PQ_Tool_GetTNRChromPixMean2Ratio},
    {PQ_CMD_READ_TNR_MOTION_MAPPING_LUMA,          HI_PQ_Tool_GetTNRLumaMotionMapping},
    {PQ_CMD_READ_TNR_MOTION_MAPPING_CHROMA,        HI_PQ_Tool_GetTNRChromMotionMapping},
    {PQ_CMD_READ_TNR_FINAL_MOTION_MAPPING_LUMA,    HI_PQ_Tool_GetTNRLumaFinalMotionMapping},
    {PQ_CMD_READ_TNR_FINAL_MOTION_MAPPING_CHROMA,  HI_PQ_Tool_GetTNRChromFinalMotionMapping},
    {PQ_CMD_WRITE_TNR_PIXMEAN_TO_RATIO_LUMA,       HI_PQ_Tool_SetTNRLumaPixMean2Ratio},
    {PQ_CMD_WRITE_TNR_PIXMEAN_TO_RATIO_CHROMA,     HI_PQ_Tool_SetTNRChromPixMean2Ratio},
    {PQ_CMD_WRITE_TNR_MOTION_MAPPING_LUMA,         HI_PQ_Tool_SetTNRLumaMotionMapping},
    {PQ_CMD_WRITE_TNR_MOTION_MAPPING_CHROMA,       HI_PQ_Tool_SetTNRChromMotionMapping},
    {PQ_CMD_WRITE_TNR_FINAL_MOTION_MAPPING_LUMA,   HI_PQ_Tool_SetTNRLumaFinalMotionMapping},
    {PQ_CMD_WRITE_TNR_FINAL_MOTION_MAPPING_CHROMA, HI_PQ_Tool_SetTNRChromFinalMotionMapping},
    {PQ_CMD_READ_FMOTION_MAPPING,                  HI_PQ_Tool_GetTNRFMotionMapping},
    {PQ_CMD_WRITE_FMOTION_MAPPING,                 HI_PQ_Tool_SetTNRFMotionMapping},

    {PQ_CMD_READ_HDR_TM_LUT,    HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_HDR_TM_LUT,   HI_PQ_Tool_WriteRegs},
    {PQ_CMD_READ_HDR_TMAP,      HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_HDR_TMAP,     HI_PQ_Tool_WriteRegs},
    {PQ_CMD_READ_HDR_SMAP,      HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_HDR_SMAP,     HI_PQ_Tool_WriteRegs},

    {PQ_CMD_READ_GFXHDR_TM_LUT,    HI_PQ_Tool_ReadRegs},
    {PQ_CMD_WRITE_GFXHDR_TM_LUT,   HI_PQ_Tool_WriteRegs},
...
HI_S32 PQ_Parse_ProcessCmd(HI_S32 client_sockfd, HI_U8 *pu8Buf)
{
    ...
    u32CmdFuncTotal = sizeof(stPQCmdFunction) / sizeof(PQ_DBG_CMD_FUN_S);

    /* this stPQCmdFunction has less than the cmd num  */
    for (u32CmdItem = 0; u32CmdItem < u32CmdFuncTotal; u32CmdItem++)
    {
        if (u32Cmd == stPQCmdFunction[u32CmdItem].enDbgCmd )
        {
            ...
            {
                HI_ERR_PQ("stPQCmdFunction is NULL! \n");
            }
