...
enum TEEC_ReturnCode {
	...
	TEEC_ERROR_TARGET_DEAD         = 0xFFFF3024, /**< Trusted Application崩溃  used by qcom only*/
	TEEC_FAIL                      = 0xFFFF5002  /** used by qcom only*/
};
...
#define MAX_TA_SESSION 10   /** used by qcom only*/
#define QSEE_SEND_CMD_BUFFER_LEN 1024*36*2  /** used by qcom only*/
#define QSEE_TZ_APP_PATH "/firmware/image"  /** used by qcom only*/
#define QSEE_MAX_APP_NAME_LEN 16  /** used by qcom only*/
#define HUAWEI_TA_MAGIC_NUM  0x08171401  /** used by qcom only*/
#endif
/**
 * History: \n
