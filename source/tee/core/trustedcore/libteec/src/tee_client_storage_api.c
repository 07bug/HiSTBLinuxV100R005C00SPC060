...
int32_t TEEC_FCloseAndDelete(int32_t fd)
{
	...
	if (result != TEEC_SUCCESS) {
		tloge("---->TEEC_FCloseAndDelete Failed:0x%x\n", result);
		return -1;
	}
