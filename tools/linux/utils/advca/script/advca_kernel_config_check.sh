...
disable+=" STATUS    	 "
disable+=" CONFIG_DEBUG_MEMORY_INIT   "
#Debugging
disable+=" CONFIG_KGDB    	 "
...
disable+=" CONFIG_INET_DIAG              "
disable+=" CONFIG_INET_TCP_DIAG                  "
disable+=" CONFIG_IP_MULTICAST                 "
disable+=" CONFIG_INET_XFRM_MODE_BEET                "
disable+=" CONFIG_INET_XFRM_MODE_TUNNEL                   " 
disable+=" CONFIG_NET_ACTIVITY_STATS         "
disable+=" CONFIG_IP_NF_ARPTABLES        "
disable+=" CONFIG_BRIDGE_IGMP_SNOOPING          "
disable+=" CONFIG_NF_CONNTRACK_PROCFS          "
