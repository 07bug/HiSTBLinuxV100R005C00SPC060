...
grep_contents=" 'huawei|gets\(|strcpy|strcmp|strcat|sprintf|syslog|getopt|getopt_long|getpass|popen|realloc\(|alloca\(|system\(|passwd|url' "
...
exclude+=" --exclude-dir=$component_dir/drmengine "
exclude+=" --exclude-dir=$component_dir/gstreamer "
...
exclude+=" --exclude-dir=$component_dir/ha_codec/external "

exclude+=" --exclude-dir=$msp_dir/api/png/libpng_for_5.0 "
exclude+=" --exclude-dir=$msp_dir/api/png/libpng "
exclude+=" --exclude-dir=$msp_dir/api/png/patch/patch_1.6.29 "
exclude+=" --exclude-dir=$msp_dir/api/jpeg/src/src_turbo "
exclude+=" --exclude-dir=$msp_dir/api/jpeg/patch/patch_linux_9b "
exclude+=" --exclude-dir=$msp_dir/api/jpeg/patch/patch_turbo_1.4.2 "
exclude+=" --exclude-dir=$msp_dir/api/jpeg/patch/patch_turbo_1.5.1 "
exclude+=" --exclude-dir=$msp_dir/api/jpeg/patch/patch_android_6b "
...
exclude+=" --exclude-dir=$msp_dir/drv/cipher/cipher_v3/drivers/extend/mbedtls "
